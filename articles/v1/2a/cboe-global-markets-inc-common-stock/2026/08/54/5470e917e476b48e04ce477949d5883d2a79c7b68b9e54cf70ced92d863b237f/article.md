...
document_id: "5470e917e476b48e04ce477949d5883d2a79c7b68b9e54cf70ced92d863b237f"
...
canonical_url: "https://www.cboe.com/insights/posts/index-insights-july-2026/"
published_at: null
first_seen_at: "2026-08-06T01:54:08.629962+00:00"
fetched_at: "2026-08-06T01:54:10.681851+00:00"
content_hash: "sha256:4009b61aa9f23cbfd11454a607bb93f2e8aeca8aa0af112ca40dfe3bd7d5f397"
---

# Index Insights: July 2026

U.S. equities were mixed in July as leadership narrowed after June's small-cap rotation. The S&P 500® Index was fractionally lower on the month, near 7,490, while the Russell 2000® Index (RUT) fell 3.1% to 2,931, giving back much of June's 4.3% gain but remaining up just over 18% year-to-date. The Cboe S&P 500 Equal Weight Index (SPEQX) rose 0.9% and the Cboe Magnificent 10℠ Index (MGTN) added 0.6%.


Volatility was relatively stable with the Cboe Volatility Index® (the VIX® Index) sliding from 16.45 to 15.99, while the Cboe S&P 500 Three-Month Volatility Index (VIX3M) stayed near 19. Implied correlation moved higher with the Cboe One-Month Implied Correlation Index (COR1M) and the Cboe Six-Month Implied Correlation Index (COR6M) rising 6.9% and 17.2%, respectively. Both indices were still below long-term averages. Additionally, the Cboe S&P 500 Dispersion Index (VIXEQ) eased 6.3% and the Cboe VIX of VIX Index (VVIX) rose 5.5%.


Options-income strategies tracked the cap-size divergence. Russell-linked strategies declined with the underlying index. The Cboe Russell 2000 Daily Covered Call Index℠ (RTYDCC) decreased 2.8% and the Cboe Validus Russell 2000 PutWrite℠ Index (RUTD) decreased 2.4%. S&P 500 Index strategies held up better, with the Cboe S&P 500 BuyWrite Index℠ (BXM) increasing 1.8% and the Cboe S&P 500 PutWrite Index℠ (PUT) rising 1.2%.


Crypto benchmarks extended their advance with the Cboe Bitcoin U.S. ETF Index (CBTX) gaining about 7.1%, while the Cboe Bitcoin ETF Volatility Index (BITVX) fell 14.5%, pointing to a calmer rally than earlier in the year.
...
The[Cboe S&P 500 Index option](https://cdn.cboe.com/resources/spx/spx-fact-sheet.pdf) contract, known by its symbol SPX, is designed to track the underlying S&P 500 Index and help investors achieve broad market protection. SPX® options offer the potential opportunity to manage large-cap U.S. equity exposure and execute risk management, hedging, asset allocation, and income generation strategies. The[Cboe S&P 500 Equal Weighted Index option](https://cdn.cboe.com/resources/spx/spx-fact-sheet.pdf) contract, SPEQX, is the equal-weight version of the widely used S&P 500 divided by 10.0. The index includes the same constituents as the capitalization weighted S&P 500, but each company in the S&P 500 Equal Weight Index is allocated a fixed weight - or 0.2% of the index total at each quarterly rebalance. The[Russell 2000® Index (RUT)](https://cdn.cboe.com/resources/rut/rut-fact-sheet.pdf) measures the performance of small-cap segment of the U.S. equity universe. It is a subset of the Russell 3000® Index and includes approximately 2000 securities based on a combination of their market cap and current index membership. RUT options are valuable tools for increasing yields and managing risk. The[Cboe Magnificent 10](https://www.cboe.com/us/indices/dashboard/MGTN/)[SM](https://www.cboe.com/us/indices/dashboard/MGTN/)[Index (MGTN)](https://www.cboe.com/us/indices/dashboard/MGTN/) is an equal-weighted equity index designed to measure the price return of a select group of large-cap U.S. technology and growth-oriented companies with listed options. The Cboe U.S. Lead 50 Index measures the total return of the 50 best performing stocks, based on the total reinvested return of each Constituent Stock since the previous rebalance date, of the 100 Constituents Stocks in the Cboe U.S. Large-Mid Cap 100 Index (CEQX). The Cboe U.S. Lag 50 Index measures the total return of the 50 worst performing stocks, based on the total reinvested return of each Constituent Stock since the previous rebalance date, of the 100 Constituents Stocks in the Cboe U.S. Large-Mid Cap 100 Index (CEQX).
