...
document_id: "9b4415864348274697457c1158fde9b151ca159d4a1b1c4d9c2c4169fe8e3787"
company_key: "yc-thematic"
company: "Thematic"
source_id: "yc-thematic-news-import-d60ff6e474dd"
canonical_url: "https://getthematic.com/insights/measure-customer-effort-from-feedback"
published_at: null
first_seen_at: "2026-07-27T07:56:07.742058+00:00"
fetched_at: "2026-07-28T21:16:46.713740+00:00"
content_hash: "sha256:20ff168ef8e7868ef26ce5a65ae9a88804e9865e5dd3ec0f42f45141c31f7cdf"
---

# How Do You Measure Customer Effort (CES) From Open-Ended Feedback and Support Conversations?
...
Customer effort is the amount of work a customer has to do to get their problem solved or their goal met. The[Customer Effort Score (CES)](https://getthematic.com/insights/how-to-measure-customer-satisfaction) is the metric built to capture it. CES was created by CEB (now part of Gartner) and introduced in the 2010 Harvard Business Review article "[Stop Trying to Delight Your Customers](https://hbr.org/2010/07/stop-trying-to-delight-your-customers) ," based on a study of more than 75,000 customer interactions.


CES shows up in two standard forms:


- **The original question:** "How much effort did you personally have to put forth to handle your request?" rated from 1 (very low effort) to 5 (very high effort).
- **CES 2.0:** "\[Company\] made it easy for me to resolve my issue," rated on a 1-to-7 agreement scale, with the score reported as the percentage of customers who answer 5 or above.


Effort matters because it predicts loyalty better than satisfaction does.[Gartner found](https://www.gartner.com/smarterwithgartner/unveiling-the-new-and-improved-customer-effort-score) that customer effort is 40% more accurate at predicting loyalty than customer satisfaction. The CEB research behind CES found that 96% of customers who have a high-effort interaction become more disloyal, compared with just 9% of those who have a low-effort one. Low effort isn't a nice-to-have. It's the single clearest signal of whether a customer stays.


## What measuring effort from feedback actually requires
...
## Where survey-based CES falls short


A CES survey is a useful benchmark, but as the primary way to measure effort it has structural gaps:


- **The highest-effort customers respond least.** People who struggled are the least willing to complete another survey, so the sample is skewed toward the customers who had an easy time.
- **It measures one touchpoint, not the journey.** A post-contact CES survey captures the call, not the three failed self-service attempts that preceded it.
- **It arrives after the effort is spent.** By the time the survey goes out, the customer has already done the work and formed the impression.
- **It says how much, never why.** A CES of 4.2 doesn't tell you which broken step to fix.
...
## How Thematic measures effort from open-ended feedback and support conversations
...
**Thematic reads the signals that reveal effort.** Effort leaves fingerprints in[unstructured data](https://getthematic.com/insights/text-analytics-applications) : customers who contact you more than once about the same issue, tickets that escalate, sessions that switch channels, and language like "still not resolved" or "third time asking." Thematic detects these behavioral and linguistic signals across support tickets,[call summaries](https://getthematic.com/insights/contact-center-sentiment-analysis) , chat, reviews, and open-ended survey comments in one place.


**Thematic's[Scoring Agent](https://getthematic.com/insights/scoring-agent-voc-outcome-metrics) turns those signals into a predicted effort score.** Rather than requiring a survey, the Scoring Agent generates a predicted effort score directly from unstructured feedback, alongside metrics like predicted NPS and churn propensity. You define the metric in plain language and validate it with a human in the loop, so the score reflects how your business defines effort.
...
## A buyer's checklist for measuring effort from feedback


Before choosing how to measure customer effort, ask:


1. Can the tool score effort from support tickets, calls, and reviews, not just a survey question?
2. Can we define what "effort" means for our business in plain language?
3. When the effort score moves, does the tool show the theme that drove it?
4. Does every score trace back to the specific customer comments behind it?
5. Can it detect repeat contacts, escalations, and channel switching as effort signals?
6. Does the measure update continuously, or only when a survey cycle closes?
7. Can a skeptical stakeholder audit a score down to the raw verbatim?
