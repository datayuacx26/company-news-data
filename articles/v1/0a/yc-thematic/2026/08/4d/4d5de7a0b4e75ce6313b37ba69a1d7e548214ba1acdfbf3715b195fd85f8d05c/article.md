...
document_id: "4d5de7a0b4e75ce6313b37ba69a1d7e548214ba1acdfbf3715b195fd85f8d05c"
company_key: "yc-thematic"
company: "Thematic"
source_id: "yc-thematic-news-import-d60ff6e474dd"
canonical_url: "https://getthematic.com/insights/get-buy-in-customer-feedback-platform"
published_at: null
first_seen_at: "2026-08-06T16:42:40.019377+00:00"
fetched_at: "2026-08-06T16:42:41.247095+00:00"
content_hash: "sha256:8cb09912ebd7b07ffbbfbfc0963016ce46a61a089fee62365979b5bb95ae0d83"
---

# How to get buy-in for a new customer feedback platform (in 6 steps)

You've run the evaluation and you know which platform you want. Now you need five or six other people to agree, and at least two of them have never read a customer verbatim. This is where most[feedback analytics](https://getthematic.com/insights/customer-feedback-analysis-with-text-analytics) purchases stall, and it usually has nothing to do with the product.
...
[Gartner's research](https://www.gartner.com/en/newsroom/press-releases/2025-07-08-gartner-survey-shows-nearly-half-the-time-desired-results-from-new-customer-service-technology-dont-materialize) supports that ordering. In a 2025 survey of service and support leaders, being effective at organizational readiness raised the likelihood of hitting technology goals by 300%. Being effective at vendor evaluation raised it by only 50%.
...
The most common mistake is preparing for a conversation with one executive when the decision belongs to a committee. Forrester's[State of Business Buying, 2026](https://www.forrester.com/press-newsroom/forrester-2026-the-state-of-business-buying/) found that the typical B2B buying decision includes 13 internal stakeholders and nine external influencers. Procurement professionals are decision-makers in 53% of business buying cycles, engaging from the start of the process.
...
Count the hours your team spends manually[reading, coding, and tagging](https://getthematic.com/insights/coding-qualitative-data) open-ended feedback each cycle. Multiply by loaded cost. Add the analyses nobody runs for lack of capacity.
...
One deck for six audiences satisfies none of them.[Gartner's 2022 research](https://www.gartner.com/en/newsroom/press-releases/2022-07-12-gartner-finds-that-majority-of-technology-purchases-come-with-high-degree-of-regret) found that 67% of technology-buying decision participants work outside the IT department, so the questions differ sharply from person to person.


Gatekeeper What they are actually asking What to hand them


Executive sponsor Does this move a number I am accountable for? One page linking feedback themes to the metric in their objectives


Finance What is the return, and when? Three-year cost model with the status-quo baseline from Step 2


Procurement Is this the right commercial structure and vendor? Total cost of ownership, contract term, and what happens at renewal


IT and data engineering What will this cost my team to support? Integration list, data flow diagram, and implementation timeline


Information security Where does our customer data go? SOC 2 report, data processing agreement, and data residency answers


Incumbent tool owner Is this replacing what I bought? An explicit statement of what stays and what this adds
...
- **"Why not build it in-house?"** Answer with a[five-year total cost](https://getthematic.com/insights/cost-to-build-an-ai-feedback-analytics-platform) that includes engineering time, model maintenance, and the opportunity cost of that team not working on the product.
- **"Can't we use the AI tools we already pay for?"**[A general-purpose model](https://getthematic.com/insights/answers-for-analysts) summarizes a batch of feedback. It won't produce a theme that means the same thing this quarter as last, which is what makes trend reporting and score attribution defensible.
- **"We already own a CX suite."** Be precise about the layer. Survey platforms collect feedback well. Analyzing unstructured feedback consistently across every channel is[a different job](https://getthematic.com/insights/best-of-breed-cx-analytics-approach) .
...
- **Citing statistics that don't survive scrutiny.** The claim that it costs five times more to acquire a customer than to retain one has no traceable primary source.[McKinsey's finding](https://www.mckinsey.com/capabilities/growth-marketing-and-sales/our-insights/experience-led-growth-a-new-way-to-create-value) that compensating for one lost customer can require acquiring three new ones is sourced and does the same work.
...
- **Treating a stalled decision as a "no."** Research behind[The JOLT Effect](https://www.jolteffect.com/blog/whatiscustomerindecision) , based on 2.5 million recorded sales conversations, found that 40% to 60% of B2B deals are lost to customer indecision rather than to a competitor. Narrow the scope and reduce perceived risk instead of adding features.
