...
document_id: "5f5267cbda2ff1999957955c85517ba042e186906ef0b870e43b6ff4b73448d8"
company_key: "yc-thematic"
company: "Thematic"
source_id: "yc-thematic-news-import-d60ff6e474dd"
canonical_url: "https://getthematic.com/insights/per-seat-licensing-feedback-insights"
published_at: null
first_seen_at: "2026-08-03T06:45:35.751002+00:00"
fetched_at: "2026-08-03T11:29:23.074207+00:00"
content_hash: "sha256:af711f24d9250abbfd08bc1dd430508197fb958acdb0174698279280c32bf348"
---
...
Pricing unit What you pay for Cost of adding one more reader


Flat per-user Every named login, at one rate, whether the person builds analysis or only reads it A new line item, every time


Tiered by role Separate rates for people who build, people who explore, and people who only view Cheaper than a builder seat, still a per-head charge


Volume or scope The data processed and the analysis run on it Nothing. The bill doesn't move
...
A login is necessary and not sufficient. Removing the commercial barrier is one of three separate constraints, and teams that treat it as the only one end up with a lot of unused accounts. A[2026 literature review](https://www.sciencedirect.com/org/science/article/pii/S2334454726000018) on data democratization, self-service business intelligence, and data literacy separates them cleanly: access, tooling, and comprehension are distinct problems that need distinct fixes.
...
**A view built for that person.** A contact center team leader and a chief customer officer are looking at the same customer truth and need different cuts of it. Thematic handles this with[permissions and sharing controls](https://getthematic.com/insights/lenses-context-layer-customer-intelligence) by stakeholder group, so one core set of themes produces several decision-ready views instead of one dashboard everyone squints at.


**Something worth logging in for.** This is where most access programs die. The research on analytics adoption is unflattering.[BARC and Eckerson Group](https://barc.com/news/new-study-identifies-drivers-of-bi-and-analytics-adoption-in-companies-today/) surveyed 214 companies and found that about 25% of employees actively use business intelligence tools, a figure that has barely moved in seven years. Buying more seats doesn't fix that. Delivering a finished, standardized answer to someone's actual question does.
...
- **They produce seats nobody uses.**[Zylo's 2026 SaaS Management Index](https://zylo.com/news/2026-saas-management-index) put license utilization at 54%, up from 47% the year before. Close to half of purchased licenses still go unused. Organizations over-buy to avoid the friction of asking, then under-deploy.
...
Thematic uses what the company calls[volume-and-scope pricing](https://getthematic.com/insights/customer-feedback-analytics-software-cost) . Contracts are based on comment volume, the number of datasets, how each dataset is analyzed, and the support level, quoted as a[custom proposal](https://getthematic.com/product/plan-and-pricing) . The pricing unit is the work the platform does, not the number of people who benefit from it.
