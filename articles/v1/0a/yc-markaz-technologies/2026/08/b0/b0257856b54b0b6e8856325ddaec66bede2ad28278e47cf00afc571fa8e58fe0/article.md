...
document_id: "b0257856b54b0b6e8856325ddaec66bede2ad28278e47cf00afc571fa8e58fe0"
company_key: "yc-markaz-technologies"
company: "Markaz Technologies"
source_id: "yc-markaz-technologies-news-import-b61076cb3748"
canonical_url: "https://www.markaz.app/blog-post/daraz-affiliate-vs-markaz-affiliate-which-pays-better"
published_at: "2026-08-12T00:00:00+00:00"
first_seen_at: "2026-08-13T01:13:26.062293+00:00"
fetched_at: "2026-08-13T01:13:28.995075+00:00"
content_hash: "sha256:035256a5d8171773383a3634c5530a6857ed4e6f50f3aa570b3192771d0b99c1"
---
...
The short version: a marketplace affiliate program like Daraz pays you a commission on sales tracked to your link, from a very large catalogue you have no control over. The[Markaz affiliate program](https://www.markaz.app/affiliate) pays you for sharing products that get delivered and paid for at the door in PKR, and it lets you graduate into reselling, where you set the price and keep the margin instead of a fixed cut.
...
You join free, pick products from the[Markaz wholesale shop](https://www.markaz.app/shop) , and share them with your followers, friends or group. Markaz handles the supplier, the packing and the delivery. The customer pays **cash on delivery in PKR** — no card, no bank transfer, no online account needed at their end. Delivery inside Pakistan usually runs 3–5 days; items sourced from China take longer, around 10–17 days. There is a 7-day return window and buyer protection, which matters more than it sounds: an audience that knows it can send something back says yes more often.
...
Browse the[product categories](https://www.markaz.app/shop/categories) before you join — the fastest way to judge any program is to check whether it stocks things you could talk about honestly for a month. If you want the wider view, our roundup of the[best affiliate programs in Pakistan](https://www.markaz.app/blog-post/best-affiliate-programs-in-pakistan) lists what to look for across the market, not just here.
...
1. **What counts as a qualifying sale?** An order placed, an order shipped, or an order delivered and kept. The gap between the first and the last is every cancelled and returned parcel.
2. **How long does my credit last after a click?** The attribution window. Short windows punish considered purchases.
3. **What is clawed back?** Returns, refunds, cancellations, fraudulent orders — and how long the hold period is before the money is confirmed.
4. **What is excluded?** Categories, your own orders, voucher traffic, and any restriction on how you may promote.
5. **What is the payout threshold, and how am I paid?** A bank account, a mobile wallet, or store credit are very different outcomes. Store credit is not income.
6. **When does the money actually land?** Weekly, monthly, or 30–45 days after the month closes. Cash flow is the difference between a side income and a hobby.
...
- **You have a small but trusting audience.** Trust converts far better than reach, and that is where sharing a specific product beats dropping a generic link. Our guide to[starting affiliate marketing in Pakistan](https://www.markaz.app/blog-post/how-to-start-affiliate-marketing-in-pakistan) covers the first-week steps.
...
Reselling changes that. You pick a product at the catalogue price, set the selling price yourself, and keep the difference. You still hold no stock — you order after the customer has confirmed, and the courier collects the cash — but the margin is your decision instead of a rate card. That is the ceiling most people hit after a few months of sharing links, and it is why the[Markaz reseller program](https://www.markaz.app/reseller-pk) exists alongside the affiliate one. If you want to run it like a proper store, with your own catalogue and order flow, the[dropshipping portal](https://www.markaz.app/dropshipping-portal) is the next step up.


The two models are not rivals. A common path is to start as an affiliate to learn what your audience actually buys, then resell those same products at your own price once you know. We compare the two side by side in[affiliate marketing vs reselling in Pakistan](https://www.markaz.app/blog-post/affiliate-marketing-vs-reselling-in-pakistan) , and the seller-side economics of the two platforms — fees, COD, margins — are broken down in[Daraz vs Markaz for resellers](https://www.markaz.app/blog-post/daraz-vs-markaz-for-resellers-fees-cod-margins) .
...
Plan for that gap. Treat money as earned when it is in your account, not when a parcel is dispatched. And spend your effort on the things that keep parcels from coming back — confirming the order on a quick call, writing the full amount in the chat, getting a complete address with a landmark. If cash on delivery is new to you, the[COD dropshipping guide for Pakistan](https://www.markaz.app/blog-post/cod-dropshipping-in-pakistan) covers the whole flow.


## How to start this week


1. **Pick one audience and one category.** Not five. The person who shares kitchen items every day beats the person who shares everything once.
2. **Join free and read the terms.** Sign up on the[Markaz affiliate page](https://www.markaz.app/affiliate) and get answers to the six questions above before you share anything. Nothing legitimate charges you a joining fee — if a program asks for money to let you earn, it is selling memberships, not products.
3. **Order one thing yourself.** One sample tells you more about a program than a week of reading. You see the packing, the delivery time and the return process the way your buyer will.
4. **Share with a recommendation, not a link dump.** Two lines on why you picked it, one honest note on what it is not. That is the entire difference between a 0.5% and a 3% conversion.
5. **Track what sells for four weeks.** Then either double down on that category, or move those same products into reselling and set your own margin.


If you have no budget at all, that is not a blocker — see[affiliate marketing without investment in Pakistan](https://www.markaz.app/blog-post/affiliate-marketing-without-investment-in-pakistan) for the free-start version.
