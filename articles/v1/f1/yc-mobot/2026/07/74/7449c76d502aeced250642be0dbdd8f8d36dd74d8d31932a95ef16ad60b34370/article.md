...
document_id: "7449c76d502aeced250642be0dbdd8f8d36dd74d8d31932a95ef16ad60b34370"
company_key: "yc-mobot"
company: "Mobot"
source_id: "yc-mobot-news-import-407920ca352a"
canonical_url: "https://www.mobot.io/press/mobot-series-a-announce"
published_at: null
first_seen_at: "2026-07-24T11:36:33.903407+00:00"
fetched_at: "2026-07-28T21:37:36.757263+00:00"
content_hash: "sha256:5f80c6337e9f70e1ee0420364747041209a6a7502f82aa248b262e066d70b148"
---

# Mobot Launches the First Robot-Powered QA-as-a-Service Testing Platform for Mobile Apps with $12.5M

‍ *Within hours, companies can enlist Mobot's fleet of physical robots to battle test their software on devices the way humans actually use them, catching bugs QA software can't detect* ‍


NEW YORK, N.Y., August 18, 2022 - Today,[Mobot](https://www.mobot.io/) publicly launched its QA-as-a-service platform and announced $12.5 million in Series A funding from[Cota Capital](https://www.cotacapital.com/) , with participation from[Heavybit](https://www.heavybit.com/) ,[Uncorrelated Ventures](https://uncorrelated.com/) , and others.


Mobot’s first-of-its-kind platform uses physical robots to battle test mobile applications. Companies serving millions of users, including[Citizen](https://citizen.com/) ,[Persona](https://withpersona.com/) ,[Branch](https://branch.io/) ,[Mapbox](https://www.mapbox.com/) , and[Radar](https://radar.com/) , use Mobot to test apps on hundreds of devices, platforms, and operating systems within hours.
...
- **Streaming data stability,** particularly **** push notifications which are increasing in complexity and dependencies, such as Apple’s new[Live Activities](https://www.apple.com/ios/ios-16-preview/features/) feature for iOS 16.
...
Mobot founder and CEO[Eden Full Goh](https://www.linkedin.com/in/edenfull/) has over a decade of experience in engineering and product. Her career began when she dropped out of Princeton to build SunSaluter, a low-cost solar panel rotator used in developing countries around the world, with an entrepreneurship fellowship from The Thiel Foundation. Years later as a product manager for a critical medical device used in hospitals, she was baffled by how many hours her team spent manually testing the software on mobile devices. She started Mobot to address what she saw as a huge gap no one was talking about.


“Software is increasingly physical, and that means testing in a vacuum doesn't cut it anymore. But using humans to do real-world regression testing is a poor use of their creativity and potential,” said Eden Full Goh, founder and CEO at Mobot. "Robots do these jobs faster, more accurately, and can easily handle the fragmentation of software across devices and ecosystems. We're building the infrastructure that helps modern companies adapt to our device-dependent orld."


Learn more about[how Mobot works](https://www.mobot.io/how-it-works) , or sign up for a[free account](https://www.mobot.io/get-started-for-free) to submit your first mobile app test in a matter of minutes.


‍ **About Team Mobot, Inc.**


Mobot is the first robot-powered QA-as-a-service testing platform for mobile applications. Founded in 2018, it is the only solution that uses mechanical robots on real, physical devices to provide businesses with high quality, automated testing of their mobile apps. Popular mobile applications and growth-stage startups like Citizen, Persona, Branch, Mapbox, and Radar use Mobot to automate manual app testing. Headquartered in New York, Mobot is backed by Cota Capital, Heavybit, Uncorrelated Ventures, and Y Combinator.
...
‍[Press Kit](https://app.box.com/s/01ffejs59d001uizrg7bt7c1b2lj2xjb)
