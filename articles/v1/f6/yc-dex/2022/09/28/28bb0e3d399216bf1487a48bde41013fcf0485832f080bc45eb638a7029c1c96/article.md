...
document_id: "28bb0e3d399216bf1487a48bde41013fcf0485832f080bc45eb638a7029c1c96"
company_key: "yc-dex"
company: "Dex"
source_id: "yc-dex-rss-adf3eee30171"
canonical_url: "https://getdex.com/blog/expand-network/"
published_at: "2022-09-06T23:10:12+00:00"
first_seen_at: "2026-07-30T03:10:20.390177+00:00"
fetched_at: "2026-07-30T03:10:21.538159+00:00"
content_hash: "sha256:451475db168d0cd618cac50057638e5be3f22b51fc19590b841e1e48d0c8f2ff"
---

# 7 Uncommon Ways to Expand Your Network and Upgrade your Life [UPDATED 2026]

*Update from the author: we’ve updated the information and details about the different ways on how to expand your network to be current for 2026.*


Networking was never as simple as going to manufactured networking events and handing out cards to anyone who will lend you an ear.[Making genuine connections](https://getdex.com/blog/personal-connections/) is more than just showing up. It’s always about standing out, changing patterns, and engaging with people on an authentic, deeper level.
...
If you’re[fresh out of business school](https://getdex.com/blog/networking-for-mba-students/) , you might be looking for a mentor and your first job or internship. If you’re changing industries or looking for an opportunity at a higher level, you’ll be looking for people in your target company or role to learn from and connect with. If you’re networking to find customers for your new business, again, you’ll be looking in slightly different places and for slightly different things. The point is, that the specifics are down to your circumstances.
...
**Efficient use of time** – Networking should take up a significant portion of your time. Depending on the method and desired outcome, it may take[8-10 hours a week](https://www.bni.com/the-latest/blog-news/how-much-time-should-you-spend-networking) . However, this doesn’t mean that simply putting in the hours is enough. If you’re following the wrong path or don’t have a strategy at all, that time is wasted, and you’ll never expand the network with the right connections.
...
While you may find that everyone at a networking event is there for the same, self-serving reasons, the ones who come home with the most valuable connections are those who know[how to win friends and influence people](https://www.forbes.com/sites/francesbridges/2018/02/07/10-ways-to-make-people-like-you-from-how-to-make-friends-and-influence-people/) . So, the best networks are comprised of people who connect on a personal level.
...
Networks only succeed as mutually-beneficial arrangements, so[your part in a successful network](https://getdex.com/blog/how-to-market-yourself/) is to create value, with the understanding that this will be reciprocated down the line.
...
This might be the most obvious pointer on the list, but it’s also one of the most critical. You may have a loose plan in mind, or you may have no idea where to start, but you’re going to know exactly who you’re looking for and why you’re doing this before you set out.
...
Stories should have an establishing stage, a challenge that was overcome, and an appeal to emotion, so try to learn your tale with these factors in the right order. This will create a memorable image in the minds of your audience and[deepen connections immediately](https://getdex.com/blog/networking-strategies/) .
...
It takes people by surprise and greatly boosts engagement to[contact people directly](https://getdex.com/blog/offline-networking/) . Replying to an email with a phone call brings a personal touch, helps cultivate those real connections, and creates value across multiple channels.
...
### 5. Make use of team building principles
...
As such, implementing them is the first stage of how to expand a network; the next is[how to keep those connections hot](https://getdex.com/blog/personal-connections/) and how to nurture them to the point of your own value objectives.
...
**Use a CRM** – this becomes more necessary as your network grows. A good personal CRM like[Dex](https://getdex.com/) can help you with many of the above tips by keeping track of when and how you connected last and giving you reminders to keep in touch. It can integrate with your various platforms and consolidate your contacts into an easy-to-manage dashboard from which you can keep track of everyone and reach out when necessary.
...
To get there, it’s important to plan well, think outside the box, and make use of multiple approaches and platforms to[build your networking strategy](https://getdex.com/blog/networking-goals/) . From there, all you have to do is follow basic principles such as adding value, making sure to teach and learn, and fostering authentic relationships by showing that you personally care about the individual.
