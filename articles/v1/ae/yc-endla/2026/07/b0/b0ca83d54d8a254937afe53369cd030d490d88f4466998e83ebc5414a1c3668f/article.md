...
1. Preventing the formation wall from caving into the wellbore
2. Isolating the different formations to prevent the flow or crossflow of formation fluid
3. Providing a means of maintaining control of formation fluids and pressure as the well is drilled.


The physical makeup of the casing comprises of smaller pipe joints which are connected together as the casing is “ran” into the wellbore, prior to cementing. These joints are typically around 13m (40ft) for “full” joints, or can come in a variety of smaller sizes as “pup” joints. Joints are either manufactured with a male and female thread form or dual male thread forms, requiring the use of couplings to join them. The ends of a casing joint are defined by their associated thread form, defined as the pin end where the male thread form is and the box end where the female thread form is. The tube portion of the joint is the main body of the casing joint on which the thread forms are placed.


## Packers


Packers are a type of general purpose plug widely used in the industry, available in many variants and sizes. Given an appropriate design and application, they can be used to perform many tasks and hence are integral to an effective completion. They are used in a wide variety of applications, including but not limited to: pressure testing the blowout prevention (BOP) stack, the wellhead and casing; separating multiple production zones; isolating problematic zones from flow; preventing movement of the tubing string.
