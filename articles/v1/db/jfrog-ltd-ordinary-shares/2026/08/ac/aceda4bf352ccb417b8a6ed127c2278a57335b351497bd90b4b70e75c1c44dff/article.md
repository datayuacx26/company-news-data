...
document_id: "aceda4bf352ccb417b8a6ed127c2278a57335b351497bd90b4b70e75c1c44dff"
company_key: "jfrog-ltd-ordinary-shares"
company: "JFrog Ltd."
source_id: "jfrog-ltd-ordinary-shares-rss-4486f0fc66d1"
canonical_url: "https://jfrog.com/blog/swampup-2026-preview-trust-layer-agentic-software-supply-chain/"
published_at: "2026-08-04T19:02:35+00:00"
first_seen_at: "2026-08-05T09:23:17.014234+00:00"
fetched_at: "2026-08-05T09:23:18.753790+00:00"
content_hash: "sha256:3613492160b482432a9ff0d5983e80f7353b90c42c6ea88be525a8ab39308178"
---
...
**[swampUP](https://swampup.jfrog.com/)** is JFrog’s premier conference for leaders building software. Taking place **September 1-3 in New York** , the event will bring together practitioners and leaders across DevOps, DevSecOps, platform engineering, AI, and DevGovOps.
...
At swampUP,[Yoav Landman](https://www.linkedin.com/in/yoavlandman/) , co-founder and CTO, will take an architecture-first approach to show you how JFrog is the Trust Layer for the agentic software supply chain. JFrog product leaders will walk you through the latest product announcements that tackle trust along three dimensions:


- **Immunize.**[Yossi Shaul](https://www.linkedin.com/in/yossishaul/) , SVP & GM of Artifactory & System of Record, and[Ran Romano](https://www.linkedin.com/in/ranrom/) , VP of Product & Engineering, AI Security, will illustrate how safety has to run in both directions: what your agents consume and what they produce. They’ll show you what it looks like when every model, MCP server, skill, plugin, and package coming in is governed before it’s trusted, and everything agents pull together and ship back out is held to the same standard.
- **Heal.** Frontier AI can chain together multiple lower-severity vulnerabilities into one devastating multi-step exploit faster than any human remediation process can respond.[Eyal Dyment](https://www.linkedin.com/in/eyaldyment/) , VP of AppSec will discuss how the only way to keep pace is with a software supply chain that is self-healing, detecting and fixing what’s broken autonomously, at the same speed it was introduced.
- **Govern.**[Ronny Belinitsky](https://www.linkedin.com/in/ronnybel/) , DevGovOps Director of Product will explain why governance can’t be bolted onto the end of a pipeline as a checkpoint, and has to be engineered into the process itself, the way[JFrog AppTrust](https://jfrog.com/apptrust/) builds governance into every stage of the release lifecycle rather than gating it at the finish line.
...
*Training Day spots go fast, so be sure to[register](https://register.jfrog.com/761211) quickly.*
...
- Jason Clinton, Deputy CISO at[Anthropic](https://www.anthropic.com/) , will share how we should rethink security assumptions for the agentic development era.
- Tim Brown, Partner at[Team8](https://team8.vc/) (CISO at **SolarWinds** during one of the most consequential cyberattacks in history), will unpack the years-long work the world didn’t see and provide an unfiltered look at redefining resilience.
- **[Moderne](https://moderne.ai/) ,[Echo](https://www.echo.ai/) ,[Chainguard](https://www.chainguard.dev/) ,** and[Tanzu Division of Broadcom](https://investors.broadcom.com/) will join a panel on “Patching at the Speed of the Threat” to share where remediation is headed as model releases outpace traditional security cycles.
- [NVIDIA](https://www.nvidia.com/en-us/) will show how JFrog works as the system of record for NIM model infrastructure.
- [AWS](https://aws.amazon.com/) will talk about maintaining trust from curation through production on Amazon Bedrock AgentCore.
- **[Wiz](https://www.wiz.io/) ,[IBM/Red Hat (Lightwell)](https://www.redhat.com/en/lightwell)** , and[Echo](https://www.echo.ai/) will guide us on the future of threat detection when threats move faster than teams can respond manually.
...
- **Registration:**[swampUP 2026](https://register.jfrog.com/761211)
