...
document_id: "21c4d54d1a2a265cbe93b252db0124f67f950524fc4042698a3bdace9ece5456"
company_key: "yc-whatnot"
company: "Whatnot"
source_id: "yc-whatnot-rss-30861744a6f8"
canonical_url: "https://medium.com/whatnot-engineering/building-and-whatnot-772c33c57f63"
published_at: "2026-05-14T16:01:00+00:00"
first_seen_at: "2026-07-24T07:07:55.027426+00:00"
fetched_at: "2026-07-28T22:13:07.113521+00:00"
content_hash: "sha256:5806cd32197a03ec51f4c44077653e95c906a691df1c9dc1fbe09fed9abcf79e"
---
...
[Whatnot Engineering](https://medium.com/@whatnotengineering?source=post_page---byline--772c33c57f63---------------------------------------)
...
*Tom Verilli | Chief Product Officer*
...
All the time you spend playing management means your innate understanding of the issues is getting stale, your instincts for your customer are duller, and the likelihood you’re right is dropping.
...
Our PMs are mapped to problems, not to EMs. Those two often overlap, but aren’t the same thing. If you’re building a new sales format for fashion sellers, you’re going to be pretty hand in glove with the EMs who own how listings and inventory work, but equally with the logistics and payments EMs.
...
Finally, everybody ships, including me. I am always working directly with a team of engineers and designers to ship features as an IC, and so are both of our cofounders.


When it was time to test out if it was feasible for PMs to vibecode small features, I was the guinea pig. When it was time to onboard our first seller in Australia, it was our cofounder Logan doing it. When Zendesk started dropping customer tickets, it was our CEO Grant talking to their support engineer. As a company, we r[equire every employee to sell, buy and do CX tickets](https://www.fastcompany.com/91534161/how-whatnot-goes-beyond-dogfooding-to-instill-a-consumer-focus) , or we give them a “below expectations” rating. If we’re to lead a company with that commitment to customer centricity, we’ve gotta be deep in how things work and broad in why. We call it “being T-shaped” — having a breadth of context and the depth of your area, simultaneously. Depth and experience allow you to make decisions quickly, not having to wait for 5 layers of management to review it means those decisions become actions.


### Members of Technical Staff


There is so much noise right now about “building”… No, product requirement docs aren’t dead. A PRD is just a vessel for thinking clearly about a problem and articulating that to others. Make yours interactive if you like, no one cares. No, the cost of shipping a bad product hasn’t gone to zero; it’s still paid by your customers. Throwing spaghetti at them 16x faster is not, in fact, a revolution. It’s simply annoying. And no, everyone’s not gonna be an S-tier Engineer and Designer and PM all in one. A few folks will be, but the same drivers of specialization — what people enjoy and are good at — will still drive how we work.


What is shifting is the realization that being an IC is a way better use of many people's skills, experience, and limited time on this earth than redrafting the same document for the 5th time to fit the current pedant's preferred formatting. A few PMs at Whatnot are managers, but each spends 90%+ of their time as an IC. There’s no distinction in our titles or comp for those who manage or don’t because we see no inherent virtue in it. AI gives us incredible leverage — I can move faster at just about every task in the development process, whether that’s understanding data that used to require a data scientist to untangle or turn a PRD into every permutation of CX SOPs that would normally be the subject of long nights in the office on launch week. I can build a bot to triage the 100 questions a week from sales or to find the localization gaps we left in a recent experiment.
...
What’s especially encouraging about this trend is that it’s going to entice the best PMs back to doing actual PM work. The thinking about the needs of the customer and the business, and the good taste to solve it in the best way. As a customer of other companies, I’m excited to see the luminaries of our industry getting back to building — it’s gonna make their products better. As someone obsessed with building the smallest, most highly leveraged PM team in history, I’m excited for it to release the incredible humans who’ve been phoning in roadmap reviews for half a decade.


### Show, don’t tell


Below, I’m going to copy (in full) the one document we have about how we work on Product at Whatnot. If we’ve met even once, you won’t need me to tell you who the author is — this is how we talk and how we work.


You can also go look at who works on our team — there are at least six people on the team today who could be CPO at a series B-C startup who will spend their evening on the phone with sellers, 400 queries deep in a Hex Thread, or drafting v1 comms for tomorrow’s launch. It’s four former founders who have never in their lives agreed that something is outside their purview. It’s four ex-FAANG directors who no longer spend their days debating where people should live in a nine-box grid. It’s six early-stage PMs who have incredible taste, being told they need to try more things because we only learn by doing.


I doubt our erstwhile declaration of 20 PMs will last — the opportunity in front of us at Whatnot is so enormous that we won’t constrain ourselves arbitrarily — but the bar for who we hire will only go up as the industry and AI tools continue to reward great ICs with leverage. If you’re one of those folks, and what I’ve described above is what gets you going, you’ll work out how to get in touch with me.


## Building at Whatnot


Building great products is hard. It’s not just that you have to have the right insight as to the problem, get the details right, take it to market right, measure it correctly so you understand its performance or iterate on it quickly. It’s that you have to do all those things or it doesn’t work. Worse, failing is expensive. We have few teams and a massive amount of opportunity in front of us — batting .300 is great if you play in the MLB but to realize our aspirations we need closer to .500. Without a high average we either constrain growth in the short term or we couple business growth to headcount growth and constrain ourselves in the long term.


This document has 2 parts:


1. Our philosophy — this will not change
2. Our processes — these will evolve and current SOT kept here


### How we build gives us leverage


You can’t construct a building a room at a time, you have to design the whole building at once and build it all at once. Thankfully, we don’t work in construction, we work in software. Building iteratively is our superpower. We always launch the smallest unit that provides real user value and a solid user experience, but we design things further out to ensure we can scale it.
...
- You must be able to articulate that value explicitly: *“enable scaled retailers to sell products stored in multiple locations in a single show — by updating ‘ships from’ to be a product field, not a show field”*


Think about the system.


1. Is this product immediately valuable when launched?
2. Is it a ‘building block’ for other things?


If (1) isn’t true, do not proceed. If (1) is true, work out how it can become (2) over time.


**2) It’s something people want. Understand their pain points, desires, and behaviors to create a product for them.**


- You don’t know that unless you understand the user you’re building for *in detail* . Marry together qual and quant.
- Think about your product in the context of existing product workflow.
- Beware shiny objects. Especially shiny objects you’ve built elsewhere in the past.


**3) Customer needs do not align with our org charts / are never met with a single feature**


If you’re building locally you’re building naively.


- You must be working back from a complete customer experience, not code ownership. Go solve the problem, period.
- The inverse is true too — other PMs will need to push into “your area”. Help them.
...
**4) It’s the simplest possible solution that solves the problem.**


The key to building fast & reliable products that users love is avoiding unnecessary and non-impactful work


- Simple isn’t just fast to build, it’s typically also the most successful.
- *Thinking about the system does not mean build the whole system upfront.*
- The more you build before you know you’re right, the more expensive it is when you’re wrong.


**5) It was validated with the smallest possible audience.**


You’re just guessing until someone is using it.
...
- If you’re in validation mode, solving for awareness (internal or external) is a failure mode.


**6) Once validated, we iterate like crazy.**


Once live to customers, we’re shipping weekly if not daily improvements.


- If you hear “once we ship X we can move to Y” it is a giant red flag.
- Once we know it’s gonna be a thing you need to go back and solve for Catex and CX
...
Getting a spark is hard. Once you have one you’ve gotta pour on the fuel or it will die.


- Biggest risk to launching hyper-simple hyper-early products is they’re incomplete and thus not truly long term useful. Once you launch you’re on the clock to get from high potential to high impact.
- Zero in on maximizing the value you’re creating and not managing every little complaint, risk or repercussion.
...
**8) This ain’t the bachelor — decouple everything**
...
We have documented a product process whose intent is to ensure we’re working on the right things and in the right way. This includes visibility, approval and accountability functions. More important than blindly adhering to that process however is internalizing the underpinning philosophy — which is well articulated in this[twitter thread](https://x.com/jmwind/status/1493569303030816770) … (seriously, read it before proceeding)


1. In a complex system you need way more alignment than you think to actually get to the right answer. Because that word can be misinterpreted:
2. Autonomy at Whatnot is autonomy of implementation. No-one has or should expect autonomy of strategy. Without alignment autonomy is squandered.
3. To meet expectations at Whatnot a PM or Designer
