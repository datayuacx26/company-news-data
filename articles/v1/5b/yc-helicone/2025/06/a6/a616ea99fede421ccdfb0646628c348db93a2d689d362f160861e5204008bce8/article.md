...
document_id: "a616ea99fede421ccdfb0646628c348db93a2d689d362f160861e5204008bce8"
company_key: "yc-helicone"
company: "Helicone"
source_id: "yc-helicone-news-import-836d1e549638"
canonical_url: "https://www.helicone.ai/blog/how-ai-gateways-enhance-app-reliability"
published_at: "2025-06-21T00:00:00+00:00"
first_seen_at: "2026-07-24T11:13:05.720262+00:00"
fetched_at: "2026-07-28T22:01:03.825556+00:00"
content_hash: "sha256:192baaa7f0a7ab51c9db882fd601b6bfe19911e059b64646f1398656c6bebabe"
---
...
[Helicone's AI Gateway](https://github.com/Helicone/helicone-router/) is a Rust-based AI Gateway that is built specifically for AI workloads.
...
Using Rust and the Tower middleware framework, it achieves ~1-5ms[P95 latency](https://medium.com/javarevisited/mastering-latency-metrics-p90-p95-p99-d5427faea879) overhead while handling **~10,000 requests/second** .
...
**What Helicone AI Gateway provides:** The gateway implements latency-based[P2C (Power of Two Choices)](https://medium.com/the-intuition-project/load-balancing-the-intuition-behind-the-power-of-two-random-choices-6de2e139ac2f) with PeakEWMA load balancing out of the box. It also provides other load balancing strategies, all of which are health and rate-limit aware.


**Why it matters:**[experiments](https://linkerd.io/2016/03/16/beyond-round-robin-load-balancing-for-latency/) have shown significant latency reduction compared to more traditional strategies. Instead of blindly rotating through providers, your requests go to the fastest available option every time.
...
For a more detailed comparison, check out the[Top LLM Routers](https://www.helicone.ai/blog/top-llm-routers) article.
...
- **[Top 5 LLM Routers in 2025: The Complete Guide to Choosing an LLM Router](https://www.helicone.ai/blog/claude-3.7-benchmarks-and-examples)**
- **[Building Production-Grade AI Applications: Tools, Frameworks & Monitoring Best Practices](https://www.helicone.ai/blog/building-production-grade-ai-applications)**
- **[The Complete LLM Model Comparison Guide (2025): Top Models & API Providers](https://www.helicone.ai/blog/the-complete-llm-model-comparison-guide)**
