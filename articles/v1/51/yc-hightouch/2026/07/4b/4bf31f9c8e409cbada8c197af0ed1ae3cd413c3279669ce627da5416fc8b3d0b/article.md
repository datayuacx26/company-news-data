...
document_id: "4bf31f9c8e409cbada8c197af0ed1ae3cd413c3279669ce627da5416fc8b3d0b"
company_key: "yc-hightouch"
company: "Hightouch"
source_id: "yc-hightouch-news-import-8089bfc075a8"
canonical_url: "https://hightouch.com/blog/hightouch-funding-series-d"
published_at: null
first_seen_at: "2026-07-25T08:06:20.021758+00:00"
fetched_at: "2026-07-28T21:40:00.658555+00:00"
content_hash: "sha256:fb3fd9499ed36ff0f9e10171c787203e10c4162bd29fde49a549605d5a64c405"
---
...
1. Build the most comprehensive marketing context layer.
2. Build agents to create on-brand content and proactively identify opportunities.
3. Give agents tools for personalized, real-time marketing in any channel.
4. Learn and feed those learnings back into the context layer.
5. Repeat. (Very, very quickly).


If that seems exciting enough, you can stop reading and[ask for a demo](https://hightouch.com/demo-amp) . But if you want to keep learning, please, by all means - read on!


## From customer data to agentic marketing


Most know Hightouch as the company that helped define the[Composable CDP](https://hightouch.com/platform/composable-cdp) . For six years, we've built marketing technology on the data warehouse to help marketers self-serve audiences, orchestrate journeys, and activate data across channels. Today, we power marketing at brands like DraftKings, Domino's, Ramp, and Spotify.


What's next: expanding our customer data foundation so marketing agents can use more of the context that makes every brand unique, including customer data, brand knowledge, creative assets, channel performance, and market signals, and building an[Agentic Marketing Platform](https://hightouch.com/platform/agentic-marketing-platform) on top of it.
...
*"With Hightouch, we run agents across acquisition and lifecycle marketing. We[generate and launch ad creative](https://hightouch.com/platform/ad-studio) 80% faster, expanding reach by ~10%. New sign-ups flow into an Agentic Lifecycle system that outperforms previous efforts by 30%+ and replaced 60 manual journeys. Once accounts are funded, ML-powered predictive conversion events push to all ad platforms, driving $50M+ in incremental annual revenue from ads."*
...
The first is **context** . Agents are only as smart as the layers of context they operate from - customer attributes, behavioral data, channel performance, product SKUs, brand guidelines, legal requirements, and more. Hightouch connects to these sources across the customer’s stack so agents can work from current, governed information without making Hightouch the system of record for all context. Context is also never static. It grows as your business does. That’s why Hightouch integrates directly with your marketing channels, DAMs, creative tools like Figma, and more to keep agents working from live, current data.


The second is **content infrastructure** . We’ve had conversations with 50+ CMOs in the last year, and the same problem keeps coming up: general-purpose AI gets colors wrong, hallucinates products, and just doesn't meet the brand bar. Hightouch solves this by pairing state-of-the-art AI models with brand context from the systems marketers already use. We learn from and leverage your existing assets when possible, have LLM judges automatically grade the outputs, learn from user feedback, and keep generations on-brand, on the first try. We also handle the full lifecycle beyond generation: collaboration, editing, Figma integration, compliance, and approval workflows, all in one place.
...
Our first end-to-end product for this agentic marketing worklow is called[Hightouch Ad Studio](https://hightouch.com/platform/ad-studio) and it makes it so that performance marketers never run out of creative for their program again.
