...
document_id: "aebbe5bbca347fad7c9d7006a95de26a32810cc097daf8f72d6bb7c078bce0b0"
company_key: "yc-upflow"
company: "Upflow"
source_id: "yc-upflow-news-import-36cc956213ed"
canonical_url: "https://upflow.io/blog/ar-collections/past-due-invoices"
published_at: "2026-06-26T00:00:00+00:00"
first_seen_at: "2026-07-22T18:06:41.662513+00:00"
fetched_at: "2026-07-28T21:22:15.524600+00:00"
content_hash: "sha256:2b98d2b2bae036749fb5fe2cd2072cdc0f72d19abd670339cf310ab77abd65cd"
---
...
[Côme Chevallier](https://upflow.io/blog/authors/come)
...
[Past Due or Overdue Invoice Meaning](https://upflow.io/blog/ar-collections/past-due-invoices#past-due-or-overdue-invoice-meaning)[1. Analyze & focus on your most overdue accounts](https://upflow.io/blog/ar-collections/past-due-invoices#analyze-focus-on-your-most-overdue-accounts)[2. Send an overdue invoice email](https://upflow.io/blog/ar-collections/past-due-invoices#send-an-overdue-invoice-email)[3. Set a tempo for your overdue payment reminders](https://upflow.io/blog/ar-collections/past-due-invoices#set-a-tempo-for-your-overdue-payment-reminders)[4. How to Track Past Due Invoices at Scale](https://upflow.io/blog/ar-collections/past-due-invoices#how-to-track-past-due-invoices-at-scale)[5. Call your past-due accounts](https://upflow.io/blog/ar-collections/past-due-invoices#call-your-pastdue-accounts)[6. Involve your account managers](https://upflow.io/blog/ar-collections/past-due-invoices#involve-your-account-managers)[7. Follow up with a past due invoice letter](https://upflow.io/blog/ar-collections/past-due-invoices#follow-up-with-a-past-due-invoice-letter)[FAQs](https://upflow.io/blog/ar-collections/past-due-invoices#faqs)


Past due invoices are one of the most common cash flow problems in B2B. Even with clear payment terms and good customer relationships, invoices slip past their due dates, reminders go unanswered, and balances that should have been collected months ago are still sitting in your[AR aging report](https://upflow.io/blog/ar-metrics/aging-reports) .


The difference between finance teams that collect consistently and those that spend months chasing the same balances usually comes down to one thing: having a clear, repeatable[cash collection](https://upflow.io/blog/ar-collections/how-to-set-up-a-systematic-and-efficient-cash-collection) process rather than reacting to each overdue invoice as a one-off problem. Keep reading to know:


-


[What is a Past Due or Overdue Invoice?](https://upflow.io/blog/ar-collections/past-due-invoices#past-due-or-overdue-invoice-meaning)
...
[Analyze & focus on your most overdue accounts](https://upflow.io/blog/ar-collections/past-due-invoices#analyze-focus-on-your-most-overdue-accounts)


2.


[Send an overdue invoice email](https://upflow.io/blog/ar-collections/past-due-invoices#send-an-overdue-invoice-email)


3.


[Set a tempo for your overdue payment reminders](https://upflow.io/blog/ar-collections/past-due-invoices#set-a-tempo-for-your-overdue-payment-reminders)


4.


[How to Track Past Due Invoices at Scale](https://upflow.io/blog/ar-collections/past-due-invoices#how-to-track-past-due-invoices-at-scale)


5.


[Call your past-due accounts](https://upflow.io/blog/ar-collections/past-due-invoices#call-your-pastdue-accounts)


6.


[Involve your account managers](https://upflow.io/blog/ar-collections/past-due-invoices#involve-your-account-managers)


7.


[Follow up with a past due invoice letter](https://upflow.io/blog/ar-collections/past-due-invoices#follow-up-with-a-past-due-invoice-letter)


Need help writing effective payment reminders? Click on the banner below and download our free templates.


---


## Past Due or Overdue Invoice Meaning


A "past due" or "overdue" invoice refers to a bill that remains unpaid beyond its agreed-upon due date. Businesses typically set standard[payment terms](https://upflow.io/blog/ar-metrics/net-30-terms) such as net 30, 60, or 90 days, though these vary based on client agreements or negotiated payment plans.
...
Start with the accounts most likely to go unrecovered if you wait any longer. That means sorting your[AR aging report](https://upflow.io/blog/ar-metrics/aging-reports) by days overdue and total balance, then working down from the most at-risk.
...
Here is a template you can use for a first friendly[payment reminder](https://upflow.io/blog/payment-reminders/payment-reminders) :
...
If you are managing reminders manually in Gmail,[Boomerang](https://www.boomeranggmail.com/) lets you resurface emails automatically if there has been no reply. For teams handling more accounts than that approach can realistically support, Upflow lets you[set up automated collection workflows](https://upflow.io/accounts-receivable-automation/automate-collections) that send personalised reminders at each stage, log every interaction, and flag accounts that need manual intervention.


Are overdue payments piling-up? Have a look at our[free guide with tips to get paid on time!](https://insights.upflow.io/en/wp-tips-get-paid)
...
Your[AR aging report](https://upflow.io/blog/ar-metrics/aging-reports) is where this starts. It segments outstanding invoices by how long they have been overdue: 0 to 30 days, 31 to 60, 61 to 90, and beyond 90. That breakdown tells you where attention is most urgent and what action is appropriate at each stage.


Most finance teams know what the right sequence looks like. The problem is executing it consistently across dozens or hundreds of accounts without things slipping.[AR automation software](https://upflow.io/accounts-receivable-automation-software) like Upflow handles the tracking and follow-up automatically, flags accounts approaching the 90-day threshold, and logs every interaction, so your team can focus on the accounts that actually need human attention rather than manually monitoring the whole ledger.
...
After the call, follow up with a written summary immediately. Even if the call ended with a verbal commitment to pay, getting it in writing protects you and keeps the customer accountable. It also means your[accounts receivable management](https://upflow.io/blog/ar-collections/accounts-receivable-management) record stays accurate if you need to escalate later. For more on how to run effective[collection calls](https://upflow.io/blog/payment-reminders/collection-calls) , including scripts for trickier situations, we have a full guide.
...
At Upflow, we have seen many finance teams successfully[turn cash collection into a company-wide priority](https://upflow.io/blog/ar-collections/how-to-set-up-a-systematic-and-efficient-cash-collection) by building a simple handoff process: finance handles the first three steps, account managers take over when an account goes beyond 30 days without resolution. It removes the ambiguity about who is responsible at each stage and keeps the customer relationship intact while still applying appropriate pressure.
...
Sending letters at scale used to mean printing and posting costs. Services like[Lob](https://www.lob.com/) let you schedule and send physical mail online without handling any of it yourself. If you are sending a single letter, a[QR code](https://www.uniqode.com/qr-code-generator) linking to the outstanding invoices saves the cost of printing attachments.
...
Before escalating to a[collections agency](https://upflow.io/blog/ar-collections/collections-agency-is-not-the-answer-to-getting-paid-faster) , consider whether a payment plan makes more sense. If the customer is genuinely having cash flow difficulties, a structured plan recovers more than an agency referral in most cases, and it preserves the relationship.
...
That is where Upflow comes in. With real-time[AR dashboards](https://upflow.io/blog/ar-metrics/ar-dashboard) , automated collection workflows, and direct integrations with your billing software, Upflow handles the tracking and follow-up so your team can focus on the accounts that actually need human attention.
