...
document_id: "a221ac9ca8cbb0e067abc0f2a59ab8bcff0d422e62beb0dcf89d77f1a6139c03"
company_key: "yc-upflow"
company: "Upflow"
source_id: "yc-upflow-news-import-36cc956213ed"
canonical_url: "https://upflow.io/blog/ar-metrics/bad-debt-calculation"
published_at: null
first_seen_at: "2026-07-22T18:06:41.662513+00:00"
fetched_at: "2026-07-28T21:20:10.944044+00:00"
content_hash: "sha256:30205eafad8b9172357ce9c3f441b89600e4359bef544f9591b4212ffde2b241"
---
...
[What is Bad Debt?](https://upflow.io/blog/ar-metrics/bad-debt-calculation#what-is-bad-debt)[Bad Debt Expense Formula: How to Calculate It](https://upflow.io/blog/ar-metrics/bad-debt-calculation#bad-debt-expense-formula-how-to-calculate-it)[The Allowance Method](https://upflow.io/blog/ar-metrics/bad-debt-calculation#the-allowance-method)[What is Allowance for Doubtful Accounts?](https://upflow.io/blog/ar-metrics/bad-debt-calculation#what-is-allowance-for-doubtful-accounts)[The Direct Write-Off Method](https://upflow.io/blog/ar-metrics/bad-debt-calculation#the-direct-writeoff-method)[How to Record Bad Debt Expense (Journal Entry)](https://upflow.io/blog/ar-metrics/bad-debt-calculation#how-to-record-bad-debt-expense-journal-entry)[Bad Debt Provision](https://upflow.io/blog/ar-metrics/bad-debt-calculation#bad-debt-provision)[How to Reduce Bad Debt in AR](https://upflow.io/blog/ar-metrics/bad-debt-calculation#how-to-reduce-bad-debt-in-ar)[FAQs](https://upflow.io/blog/ar-metrics/bad-debt-calculation#faqs)
...
[What is Bad Debt?](https://upflow.io/blog/ar-metrics/bad-debt-calculation#what-is-bad-debt)


-


[Bad Debt Expense Formula: How to Calculate It](https://upflow.io/blog/ar-metrics/bad-debt-calculation#bad-debt-expense-formula-how-to-calculate-it)


-


[The Allowance Method](https://upflow.io/blog/ar-metrics/bad-debt-calculation#the-allowance-method)


-


[What is Allowance for Doubtful Accounts?](https://upflow.io/blog/ar-metrics/bad-debt-calculation#what-is-allowance-for-doubtful-accounts)


-


[The Direct Write-Off Method](https://upflow.io/blog/ar-metrics/bad-debt-calculation#the-direct-writeoff-method)


-


[How to Record Bad Debt Expense (Journal Entry)](https://upflow.io/blog/ar-metrics/bad-debt-calculation#how-to-record-bad-debt-expense-journal-entry)


-


[Bad Debt Provision](https://upflow.io/blog/ar-metrics/bad-debt-calculation#bad-debt-provision)


-


[How to Reduce Bad Debt in AR](https://upflow.io/blog/ar-metrics/bad-debt-calculation#how-to-reduce-bad-debt-in-ar)
...
Bad debt commonly arises when businesses extend credit, offering[Net 30 payment terms](https://upflow.io/blog/ar-metrics/net-30-terms) or similar, and the customer either can't or won't pay. The product or service has been delivered, the invoice sent, but the money never arrives.
...
For most B2B businesses, bad debt is a byproduct of extending credit. The goal isn't to eliminate it entirely. Some level of bad debt is normal. The goal is to keep it low, track it consistently, and act on[outstanding invoices](https://upflow.io/blog/ar-collections/outstanding-invoices) before they reach the point of no return.
...
This is called the[analysis of receivables method](https://upflow.io/blog/ar-metrics/analysis-of-receivables-method) and gives you a more accurate picture of actual collection risk than a flat percentage. For a deeper look at how to build and use aging buckets, see our guide to[AR aging reports](https://upflow.io/blog/ar-metrics/aging-reports) .
...
The allowance is reviewed and adjusted at the end of each accounting period based on your latest estimate. If your bad debt experience worsens, you increase it. If collections improve, you reduce it. Over time it becomes one of the clearest signals of how well your credit and[collections process](https://upflow.io/blog/ar-collections/improve-accounts-receivable-collection) is performing.
...
For a broader look at how to set credit policies that reduce write-offs in the first place, see our guide to[collecting unpaid invoices](https://upflow.io/blog/ar-collections/collect-unpaid-invoices) .
...
For a full picture of how these entries flow through your financials and affect your[cash flow analysis](https://upflow.io/blog/cfo-reads/cash-flow-analysis) , that guide covers the broader reporting context.
...
Tracking your bad debt provision alongside your[AR metrics](https://upflow.io/blog/ar-metrics/ar-metrics) gives you an early warning system for collection risk. A rising provision is one of the clearest indicators that your DSO is heading in the wrong direction, often before it shows up in your[days sales outstanding](https://upflow.io/blog/reduce-dso/days-sales-outstanding) figure.
...
Automated[payment reminders](https://upflow.io/blog/payment-reminders/payment-reminders) remove the dependency on manual follow-up. You set the cadence once and every overdue invoice gets chased consistently, regardless of how busy your team is.


**Monitor your AR aging report**


Your[AR aging report](https://upflow.io/blog/ar-metrics/aging-reports) is your earliest warning system for bad debt risk. Invoices sitting in the 61 to 90 day bucket today are your bad debt candidates tomorrow. Reviewing it weekly and acting on at-risk accounts before they age further is one of the highest-leverage habits your finance team can build.
...
Manual AR processes do not scale. As your business grows, the volume of invoices, reminders, and follow-ups grows with it.[AR automation](https://upflow.io/blog/ar-collections/accounts-receivable-automation) handles the repetitive work: sending reminders, escalating overdue accounts, matching payments, and flagging risk. Your team focuses on the accounts that need human judgment.
