...
document_id: "452cb49dfd28da8f1e5120dc4da22137d39f73de6672a993864b1aa005a3fef9"
company_key: "yc-grey"
company: "Grey"
source_id: "yc-grey-news-import-fd6b968aa507"
canonical_url: "https://grey.co/blog/freelance-contract-guide"
published_at: "2026-07-02T00:00:00+00:00"
first_seen_at: "2026-07-24T19:15:06.745268+00:00"
fetched_at: "2026-07-28T21:22:12.115321+00:00"
content_hash: "sha256:7482db2076989c82df7652965fef86f801caeb176cddc45743bbee1df8b46721"
---

# Freelance Contract: Template and Key Clauses | Grey
...
[Here are some tips for negotiating cross-border freelance contracts.](http://grey.co/blog/negotiating-cross-border-freelance-contracts-tips-and-templates)
...
**Read more:**[Best invoicing tools for freelancers working with international clients](https://grey.co/blog/best-invoicing-tools-for-freelancers-working-with-international-clients)
...
[Your Full Legal Name or Business Name] ("Freelancer")


and


[Client Full Legal Name or Company Name] ("Client")
...
The Freelancer agrees to provide the following services ("Work"):


[Describe the project scope in specific terms. Include deliverables, file formats, number of pages, word count, or any other measurable details.]


The Work does not include:


[List any services that are specifically excluded.]
...
First milestone / draft: [Date]
Final delivery: [Date]


The timeline depends on the Client providing feedback and required materials within [three] business days of each delivery. Delays in feedback may extend the delivery schedule.
...
Payment is due within [14] days of each invoice.


Invoices paid after this period will incur a late payment fee of [1.5%] per month.


All fees are quoted in [Currency]. If payment is made in another currency, the Client is responsible for ensuring the Freelancer receives the full invoiced amount after any conversion costs.
...
Additional revisions will be billed at the Freelancer's standard hourly rate.


5. Intellectual Property


All intellectual property rights remain with the Freelancer until full payment has been received.


Upon receipt of full payment, ownership transfers to the Client.


The Freelancer retains the right to display the completed work in their portfolio unless otherwise agreed in writing.


6. Confidentiality


The Freelancer agrees not to disclose confidential information shared during the project without the Client's written permission.


7. Termination


Either party may terminate this agreement by providing [seven] days' written notice.


If the Client cancels after work has commenced, they agree to pay [50%] of the remaining unpaid project fee, plus payment for work already completed.


If the Freelancer cancels, any fees paid for work not yet started will be refunded.


8. Independent Contractor


The Freelancer is an independent contractor and is responsible for their own taxes and insurance.
...
To receive international payments without conversion markups or correspondent bank deductions, you can[open a multi-currency account with Grey](https://grey.co/foreign-accounts) . With a Grey USD account, US clients can pay via[ACH](https://grey.co/blog/how-ach-payments-work-for-freelancers-outside-the-us) or[FedNow](https://grey.co/blog/receive-usd-payments-in-seconds-with-fednow-on-grey) , depending on their bank. FedNow, the Federal Reserve's instant payment system, allows eligible payments to arrive within seconds, while ACH remains a reliable option for standard bank transfers.


With a GBP account, UK clients can pay via Faster Payments (FPS), BACS, or CHAPS, while clients in Europe can send EUR via SEPA using your dedicated EUR account details. Grey charges a 0.8% deposit fee (minimum $2/£2/€2 and maximum $10/£10/€10), and you can convert your funds at a transparent exchange rate and withdraw them to your local bank whenever you choose. You can also[receive international payments](https://grey.co/money-transfer) from clients across freelancing platforms using the same Grey account.
...
[Open a multi-currency account with Grey](https://grey.co/foreign-accounts) to receive your freelance payments in USD, GBP, or EUR, convert at disclosed rates, and withdraw whenever you want.
