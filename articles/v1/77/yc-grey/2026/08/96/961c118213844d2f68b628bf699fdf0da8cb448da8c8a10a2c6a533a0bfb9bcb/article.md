...
document_id: "961c118213844d2f68b628bf699fdf0da8cb448da8c8a10a2c6a533a0bfb9bcb"
company_key: "yc-grey"
company: "Grey"
source_id: "yc-grey-news-import-fd6b968aa507"
canonical_url: "https://grey.co/blog/routing-number-on-check"
...
Think of it this way: the routing number tells a payment system which bank to go to. The account number tells the bank which specific account within its system to credit or debit. Both are required together to correctly direct a payment.
...
5. **ABA routing number lookup.** The[American Bankers Association](https://www.aba.com/) maintains an official record of routing numbers and oversees their assignment. You can use official lookup tools to confirm a routing number matches the correct institution.
...
For a closer look at how these payment types differ, see our guide on the[difference between ACH and wire transfers](https://grey.co/blog/ach-vs-wire-transfer) .
...
[Open a USD account with Grey](https://grey.co/foreign-accounts) to receive a real US routing number and account number, even if you live outside the United States. Freelancers, remote workers, and businesses invoicing US clients can use these details on invoices exactly as they would use a traditional US bank's routing number, and[receive money from abroad](https://grey.co/money-transfer) without the fees typically associated with international transfers.
...
[Receive US dollars with a Grey account](https://grey.co/foreign-accounts) using a real routing number, no matter where you live.
