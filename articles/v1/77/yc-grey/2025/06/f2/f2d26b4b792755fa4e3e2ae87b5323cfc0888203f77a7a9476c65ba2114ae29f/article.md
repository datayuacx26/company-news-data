...
document_id: "f2d26b4b792755fa4e3e2ae87b5323cfc0888203f77a7a9476c65ba2114ae29f"
company_key: "yc-grey"
company: "Grey"
source_id: "yc-grey-news-import-fd6b968aa507"
canonical_url: "https://grey.co/blog/visiting-morocco-heres-how-to-avoid-atm-issues-and-fx-losses"
...
**Also read:**[How to exchange currency safely when visiting Morocco](http://grey.co/blog/how-to-exchange-currency-safely-when-visiting-morocco)
...
**Also read:**[Where to buy Moroccan dirham online](http://grey.co/blog/where-to-buy-moroccan-dirham-online)


### The best ATM networks in Morocco
...
[Grey](https://grey.co/en-ma) provides a[virtual Visa card](http://grey.co/cards) linked directly to your foreign-currency accounts in USD, EUR, and GBP. When you convert from a foreign currency to MAD within Grey, the rate is shown before confirmation and conversions are charged at 1%.[Apple Pay](https://grey.co/blog/how-to-use-apple-pay-worldwide-with-your-grey-card) and[Google Pay](https://grey.co/blog/how-to-use-google-pay-worldwide-with-your-grey-virtual-card) are supported in eligible regions for contactless payments. Multiple cards can be created for different spending purposes, each with its own limit. Withdrawals to a local MAD account cost $2.


*Grey charges fees on deposits, conversions, withdrawals, and cross-border card transactions. Deposits via ACH, SEPA, or FPS incur a 0.8% fee (minimum $2/€2/£2, maximum $10/€10/£10). Currency conversions are charged at 1%. Exchange rates are variable and include a margin over the mid-market rate. Always review the rate before confirming a transaction. Visit*[https://grey.co/blog/fees-and-charges-on-grey](https://grey.co/blog/fees-and-charges-on-grey) *for current rates.*
...
**Ready to visit Morocco without worrying about ATM issues?**[Sign up on Grey today](https://grey.co/en-ma) **or**[download the mobile app](https://onelink.to/grey) to avoid FX losses when visiting Morocco.
