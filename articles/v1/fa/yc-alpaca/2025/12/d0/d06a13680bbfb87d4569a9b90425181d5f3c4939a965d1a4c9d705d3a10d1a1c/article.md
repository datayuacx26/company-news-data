...
Alpaca designed its[Instant Tokenization Network](https://alpaca.markets/blog/us-stock-market-ready-for-instant-tokenization-with-alpacas-newly-launched-network/) to bridge regulated market infrastructure with blockchain technology — enabling real-time settlement, programmable compliance, and scalable on-chain issuance.


“TradFi and digital assets are no longer two separate, distinct worlds. The same principles of investor protection and market integrity have to apply on-chain. Tokenization won’t reach its potential until we bridge legacy systems with the chain,” said[Yoshi Yokokawa](https://www.linkedin.com/in/yoshiyokokawa/?ref=alpaca.markets) , Co-Founder and CEO of Alpaca. “Alpaca’s position as a regulated clearing member across traditional assets and a crypto-native platform provides a practical foundation for tokenization. By building this infrastructure, we’re leading the way in bringing the whole global capital markets and financial services on-chain.”
...
If tokenization is a freight train, Alpaca is the railroad connecting TradFi and on-chain markets through their de facto global standard investing infrastructure. As the clearing broker for over 94% of the market share of tokenized US stocks and ETFs, and as partners continually onboard with their recently announced Instant Tokenization Network, Alpaca is positioning itself as a global leader in tokenization infrastructure. xStocks, one of Alpaca’s[earliest partners for the tokenization of US equities](https://alpaca.markets/blog/bridging-tradfi-and-defi-with-backeds-tokenized-xstocks-solution-powered-by-alpaca/) , recently surpassed $10 billion in Total Daily Volume across CEX and DEX.8
...
Learn more about tokenization at Alpaca:[alpaca.markets/tokenization](https://alpaca.markets/tokenization?ref=alpaca.markets)
...
1. “[Total Market Value of the U.S. Stock Market](https://siblisresearch.com/data/us-stock-market-value/?ref=alpaca.markets) ”, Siblis Research, 2025
2. “[Global Stock Exchange Market Capitalization Reaches Record $148 Trillion in October 2025](https://www.voronoiapp.com/markets/-Global-Stock-Exchange-Market-Capitalization-Reaches-Record-148-Trillion-in-October-2025-5178?ref=alpaca.markets) ”, Voroni, November 3, 2025
3. “[BlackRock CEO Larry Fink: We’re at the beginning of the tokenization of all assets](https://www.cnbc.com/video/2025/10/14/blackrock-ceo-larry-fink-were-at-the-beginning-of-the-tokenization-of-all-assets.html?ref=alpaca.markets) ”, CNBC, Squawk on the Street, October 14, 2025
4. “[BlackRock Advances Tokenized ETFs Amid Push for Regulatory Clarity](https://www.fintechweekly.com/magazine/articles/blackrock-tokenized-etfs-regulation-clarity?ref=alpaca.markets) ”, FinTech Weekly, October 22, 2025
5. “[Robinhood CEO: Tokenization is going to 'eat the whole global financial system](https://www.youtube.com/watch?v=nb4xxusbnOU&ref=alpaca.markets) '”, CNBC International Live, October 2, 2025
6. “[Blockchain and tokenization: Transforming asset management on behalf of clients](https://www.janushenderson.com/en-us/investor/article/blockchain-and-tokenization-transforming-asset-management-on-behalf-of-clients/?ref=alpaca.markets) ”, Janus Henderson Investors, August 18, 2025
7. “[Tokenization is finance’s next ETF moment – and Wall Street isn’t ready](https://www.janushenderson.com/en-hk/investor/article/tokenization-is-finances-next-etf-moment-and-wall-street-isnt-ready/?ref=alpaca.markets) ”, Janus Henderson Investors, October 8, 2025
8. “[xStocks Official Dashboard](https://dune.com/xstocks/xstocks?ref=alpaca.markets) ”, Dune, data pulled November 16, 2025


**Where large and mega-cap companies are defined as any NYSE and Nasdaq stock valued over $10 billion according to*[Nasdaq](https://www.nasdaq.com/market-activity/stocks/screener?page=1&rows_per_page=25&ref=alpaca.markets) *.*
