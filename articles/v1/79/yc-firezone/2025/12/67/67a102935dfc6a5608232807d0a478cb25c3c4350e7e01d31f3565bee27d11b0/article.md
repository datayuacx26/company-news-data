...
document_id: "67a102935dfc6a5608232807d0a478cb25c3c4350e7e01d31f3565bee27d11b0"
company_key: "yc-firezone"
company: "Firezone"
source_id: "yc-firezone-news-import-75fbee21a5d6"
canonical_url: "https://www.firezone.dev/blog/devlog/2025-12"
...
content_hash: "sha256:a96a408240cba55594c3408213b9927170efbafc4ea57d9742a6f03a36010114"
---
...
[refactor(portal): collapse umbrella into single app](https://github.com/firezone/firezone/pull/11517)↩


2.


[refactor(portal): move browser tokens to portal_sessions](https://github.com/firezone/firezone/pull/11127)↩


3.


[refactor(portal): move gateway tokens to dedicated table](https://github.com/firezone/firezone/pull/11104)↩


4.


[refactor(portal): move relay tokens to separate table](https://github.com/firezone/firezone/pull/11101)↩


5.


[refactor(portal): move email tokens to one_time_passcodes](https://github.com/firezone/firezone/pull/11109)↩


6.


[refactor(portal): move api_tokens to dedicated table](https://github.com/firezone/firezone/pull/11166)↩


7.


[refactor(portal): rename tokens to client_tokens](https://github.com/firezone/firezone/pull/11202)↩


8.


[fix(portal): invalidate tokens/sessions on auth_provider changes](https://github.com/firezone/firezone/pull/11293)↩


9.


[refactor(portal): ephemeral relays](https://github.com/firezone/firezone/pull/11587)↩


10.


[fix(portal): delay reactions to relay presence events](https://github.com/firezone/firezone/pull/11549)↩


11.


[fix(portal): prevent two identical relays from connecting](https://github.com/firezone/firezone/pull/11567)↩


12.


[fix(portal): always select nearest relays](https://github.com/firezone/firezone/pull/11545)↩


13.


[fix(portal): allocate tun addresses in O(1) time](https://github.com/firezone/firezone/pull/11154)↩


14.


[fix(portal): use gin indexes for fulltext_search](https://github.com/firezone/firezone/pull/11276)↩


15.


[refactor(portal): check billing limits more efficiently](https://github.com/firezone/firezone/pull/11550)↩


16.


[refactor(portal): use dedicated /readyz probe](https://github.com/firezone/firezone/pull/11533)↩


17.


[fix(apple): accumulate changes to NetworkSettings](https://github.com/firezone/firezone/pull/11191)↩


18.


[fix(connlib): only emit resource list on changes](https://github.com/firezone/firezone/pull/11129)↩


19.


[fix(phoenix-channel): try all addresses in parallel](https://github.com/firezone/firezone/pull/11115)↩


20.


[feat(portal): show client/session/token online status](https://github.com/firezone/firezone/pull/11240)↩


21.


[feat(portal): show synced entity counts](https://github.com/firezone/firezone/pull/11272)↩


22.


[feat(portal): show groups for each actor](https://github.com/firezone/firezone/pull/11419)↩


23.


[feat(portal): allow filtering clients by name + actor](https://github.com/firezone/firezone/pull/11257)↩


24.


[fix(gateway): retry binding DNS servers on TUN interface](https://github.com/firezone/firezone/pull/11208)↩


25.


[feat(gateway): report event-loop errors to Sentry](https://github.com/firezone/firezone/pull/11209)↩


26.


[fix(connlib): allow concurrent create_flow messages](https://github.com/firezone/firezone/pull/11438)↩
