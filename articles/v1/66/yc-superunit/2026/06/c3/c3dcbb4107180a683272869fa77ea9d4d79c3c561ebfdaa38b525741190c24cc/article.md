...
document_id: "c3dcbb4107180a683272869fa77ea9d4d79c3c561ebfdaa38b525741190c24cc"
company_key: "yc-superunit"
company: "Superunit"
source_id: "yc-superunit-news-import-57b6d5b65af6"
canonical_url: "https://www.superunit.com/blog/medical-canvassing-vs-records-retrieval"
...
content_hash: "sha256:e7d87dc2b07df7f56bf7d145928c31209e4deb406f489b81124e1c0c9f041f1b"
---

# Medical Canvassing vs. Records Retrieval vs. IME: Which Comes First and Why
...
Because the inquiry stops at existence and timing, no protected health information changes hands. A facility confirming that a claimant visited on a given date discloses nothing about diagnoses, test results, or billing, so it needs no signed release to answer ([LCS Record Retrieval](https://legalcopyservices.com/medical-canvassing-in-litigation-a-justifiable-strategy-and-precursor-for-record-requests/) ). Canvassing operates inside HIPAA by design, not around it.


Records retrieval is the next end of the same workflow. You go to the custodian of records at a confirmed facility and request the full clinical file, including physician notes, imaging reports, lab results, surgical and discharge summaries, and billing documentation ([recordrs.com](https://www.recordrs.com/blog/how-medical-record-retrieval-works/) ). Every one of those documents is PHI, so a signed HIPAA authorization, a court order, or a properly served subpoena must be in hand before a custodian can produce anything ([lexitaslegal.com](https://www.lexitaslegal.com/resources/medical-record-retrieval-for-litigation) ).
...
The delays compound because unproductive requests do not fail fast. A custodian sitting on the standard HIPAA response window can take up to 30 days before confirming there is nothing to send, and hospitals run[10 to 15 business days](https://www.lexitaslegal.com/resources/medical-record-retrieval-for-litigation) even when records exist. Blind retrieval spends that window on facilities a canvass would have eliminated in the scoping phase. A prior canvass narrows the request list to[verified treatment locations](https://legalcopyservices.com/medical-canvassing-in-litigation-a-justifiable-strategy-and-precursor-for-record-requests/) , so the retrieval fees and the wait both attach only to facilities that actually hold something.


Litigated claims carry a sharper version of the same risk. Incomplete canvassing before opposing counsel enters discovery means you may not know the full treatment history when records start moving, and damaging pre-existing conditions or contradictory evidence can[surface after they are already in opposing counsel's hands](https://legalcopyservices.com/medical-canvassing-in-litigation-a-justifiable-strategy-and-precursor-for-record-requests/) . Discovering a prior injury at the wrong moment changes your settlement posture after the leverage has already shifted away from you. A complete canvass establishes the treatment timeline and distinguishes pre-existing from incident-related conditions before a single records request is filed, which is exactly when that knowledge is worth the most.


The escalation order also protects your budget on every other front. Each step beyond the canvass adds cost and intrusiveness, and a canvass[ordered after surveillance and authorizations are already in motion](https://www.superunit.com/blog/what-is-medical-canvassing-insurance-siu) often confirms what those later steps could have skipped.
