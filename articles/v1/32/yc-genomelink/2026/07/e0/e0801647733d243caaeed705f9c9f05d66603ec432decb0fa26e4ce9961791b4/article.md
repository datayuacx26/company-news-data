...
document_id: "e0801647733d243caaeed705f9c9f05d66603ec432decb0fa26e4ce9961791b4"
company_key: "yc-genomelink"
company: "Genomelink"
source_id: "yc-genomelink-news-import-8fbbc111a31a"
canonical_url: "https://genomelink.io/blog/how-accurate-is-23andme"
published_at: null
first_seen_at: "2026-07-23T10:25:20.799015+00:00"
fetched_at: "2026-07-28T21:40:00.658555+00:00"
content_hash: "sha256:89c5883cadf746b410f91be0ac881e455ddfeb3787b189b4efaa6c2b5338d06c"
---

# How Accurate is 23andMe?

If you are wondering how accurate[23andMe](http://og.genomelink.io/posts/%20how-to-use-myheritage) is before you buy or after you’ve gotten your results, there are definitely some things you need to know. DNA testing kits are not as simple as a pregnancy test (or any other test looking for a single substance) and they can be much more complex than other types of DNA tests (such as a paternity test).
...
Since you can download this raw data from 23andMe, you can easily have this information analyzed by a[wide variety of other sites](https://genomelink.io/blog/best-raw-dna-data-upload-sites) to gain more valuable insights into your data.
...
While very rare, it should be no surprise that sometimes lab technicians and statisticians screw up. So technically, human error can be present in almost any step of the DNA testing process. However, 23andMe typically processes samples multiple times and does a[Quality Review](https://customercare.23andme.com/hc/en-us/articles/202904760-Quality-Review) of portions of your data before it is uploaded to your account. This almost always ensures that any sources of human error (such as mixing your sample with another person) are caught before your data is released.


## **How Accurate Is 23andMe for Ethnicity?**


23andMe DNA tests include results for ethnicities and ancestral locations of your haplogroup. The most in-depth information on deep ancestry is found in the Ancestry Composition Report.


The information in that report goes back many generations, but don’t expect to find Neanderthal ancestors; the Ancestry Composition Report from 23andMe is accurate for the past several hundred years.


Most people searching for family connections are focused on more recent history, around 200 years. For that information, check the Recent Ancestor Locations section embedded within the ancestry report.


To see the ethnicity percentages, click on the ethnic group you wish to learn about, such as British or Irish, and then click the likelihood indicator. Here you’ll find a list of specific regions with which your DNA is associated.


Is 23 and Me accurate? No DNA testing service is flawless, but ethnicity results are considered highly accurate, partly because they are based on multiple criteria. You should know these facts about how ethnicity percentages are measured:


- Identical pieces of DNA shared with more than 400,000 people are analyzed
- Likelihood indicators are based on multiple criteria
- A high likelihood means the company is at least 80% confident in its results
- Ethnicity percentages are tied to specific geographical areas to increase accuracy


What does it mean if your ethnicity reflects information you’ve never heard of before — does that mean 23andMe is inaccurate?


While inaccuracies are always a possibility with any type of scientific testing, it is more likely that family information is incorrect. Family stories and histories can get muddled with time. For example, great-grandparents who grew up in Ireland may not be aware that their great-grandparents were born in Syria.


## **How Accurate Is 23andMe for Family Connections? Let’s Sum It Up**


The answer to “How accurate is 23andMe?” depends greatly on which results you’re asking about. Recent ancestor locations are some of the most reliable pieces of information you can get from this service.


23andMe’s list of DNA relatives provides a ballpark measure of genetic connection to possible relatives. While that information may be technically accurate, it is not very specific. However, the list of DNA relatives provided by 23andMe does include a percentage of how much DNA is shared.


The family tree that the service automatically constructs may leave some people feeling that 23andMe is inaccurate. Some of the information included in the tree may be incorrect, but some could also be new information customers simply did not know about.


To get the most from your raw DNA data, you should use more than one source for research.[Genomelink](https://genomelink.io/) offers information on over 25 traits, and much of it is free. To double-check how accurate is 23andMe, upload your data to Genomelink and learn even more about your genetic traits.


## **Is 23 and Me Accurate for Health Reports?**


23andMe is accurate at a rate of over 99% for health information, but getting a DNA report is not the same as seeing a medical health professional. One of the great things about DNA testing is that it can give you information that allows you to build up your genetic weaknesses through healthy lifestyle changes.


To get the most benefit from this information, speak with your doctor about diagnostic testing, medications, and habits to improve your health. Think of DNA data as a tool in your healthcare arsenal, not a substitute for medical care.
...
As far as the editors here at[Genomelink](https://genomelink.io/) can tell, most users that claim “inaccuracies” in their 23andMe data have simply failed to grasp what their results are actually telling them. Let’s start with a simple physical trait to see how this can work.
