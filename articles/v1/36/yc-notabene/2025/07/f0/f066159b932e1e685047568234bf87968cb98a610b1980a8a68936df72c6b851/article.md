...
document_id: "f066159b932e1e685047568234bf87968cb98a610b1980a8a68936df72c6b851"
company_key: "yc-notabene"
company: "Notabene"
source_id: "yc-notabene-news-import-e4585f8c666e"
canonical_url: "https://notabene.id/post/cracking-the-six-reasons-vasps-are-considering-travel-rule-solutions-right-now"
published_at: "2025-07-24T00:00:00+00:00"
first_seen_at: "2026-07-26T08:22:57.520792+00:00"
fetched_at: "2026-07-28T22:01:03.825556+00:00"
content_hash: "sha256:355dbb350ab6d27eb9e71d03e1fbd8fd7945e9e298d67e83d68194bfad4b0140"
---

# 6 Reasons VASPs are Investing in Travel Rule Solutions Right Now

The world of crypto compliance has seen rapid changes over the past year. Since the[Financial Action Task Force (FATF)](https://notabene.id/crypto-travel-rule-101/fatf-financial-action-task-force) extended Travel Rule compliance for crypto custodians, global events and pivotal moments have rapidly propelled Virtual Asset Service Providers ([VASPs](https://notabene.id/crypto-travel-rule-101/vasps-virtual-asset-service-providers) ) from mere contemplation to active implementation of these AML compliance measures.
...
Additionally, Exchanges registered in a jurisdiction where the Travel Rule is already enforced: US,[Singapore](https://notabene.id/world/singapore) ,[Switzerland](https://notabene.id/world/switzerland) ,[Philippines](https://notabene.id/world/the-philippines) ,[South Korea](https://notabene.id/world/south-korea) ,[Germany](https://notabene.id/world/germany) ,[Canada](https://notabene.id/world/canada) , Indonesia,[Malaysia](https://notabene.id/world/malaysia) ,[Gibraltar](https://notabene.id/world/gibraltar) ,[Estonia](https://notabene.id/world/estonia) ,[Dubai](https://notabene.id/reports/fatf-travel-rule-requirements-in-dubai) ,[Liechtenstein](https://notabene.id/world/liechtenstein) , Malta, Portugal,[Japan](https://notabene.id/world/japan) ,[Hong Hong](https://notabene.id/reports/fatf-travel-rule-requirements-in-hong-kong) , the[United Kingdom](https://notabene.id/reports/fatf-travel-rule-requirements-in-the-united-kingdom) , as well as exchanges that send a large volume of transactions to VASPs in those jurisdictions, must roll out Travel Rule compliance as soon as possible.
...
Notabene’s[State of Crypto Travel Rule Compliance Report,](https://notabene.id/state-of-crypto-travel-rule-compliance-report) 2023, pg 37


Our[2023 State of Crypto Travel Rule Compliance Report](https://notabene.id/state-of-crypto-travel-rule-compliance-report) highlights that about 61% of respondents enforce transaction restrictions with non-cooperative counterparties: 8% need a Travel Rule message sent to the beneficiary VASP, 41% employ a risk-based approach, and 12% await a response from the Beneficiary VASP. Non-responsive counterparties risk losing transactions from compliant VASPs, making this a critical reason for VASPs to invest in compliance solutions.
...
Source: Notabene’s[State of Crypto Travel Rule Compliance Report,](https://notabene.id/state-of-crypto-travel-rule-compliance-report) 2023, pg 36 ****
...
When implemented correctly—[pre-transaction settlement](https://notabene.id/post/what-does-pre-transaction-decision-making-mean-for-crypto-compliance) — Travel Rule compliance equips VASPs with detailed insights into transactional counterparties and allows VASPs to ascertain if clients transact with sanctioned entities, wallets, or regions.


As the industry’s only[pre-transaction decision-making platform,](https://notabene.id/post/safetransact-cryptos-first-pre-transaction-decision-making-platform) Notabene's SafeTransact preemptively identifies and halts high-risk activity before reaching the exchange. Our platform offers a comprehensive view of crypto transactions, allowing users to automate real-time decisions, screen counterparties for sanctions, recognize self-hosted wallets, and ensure seamless global Travel Rule compliance following international regulations.
...
Features clients can use to block transactions with sanctioned parties (Source: Notabene).
...
Notabene's Rules Engine allows ou to set comprehensive controls to perform AML-related counterparty risk mitigation effectively.
...
[Learn more about SAFE Implementation](https://notabene.id/post/notabene-launches-safe-implementation-phases-for-travel-rule)
