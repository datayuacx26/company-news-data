...
document_id: "081bd4ebd948b094133ba7ebf385b3af202746191058f4ebe02d785b383d344e"
company_key: "yc-legalos"
company: "LegalOS"
source_id: "yc-legalos-news-import-0b4e0d11c53d"
canonical_url: "https://www.legalos.ai/post/h-1b-visa-complete-guide"
...
content_hash: "sha256:fedf302d4fe3c34cb58683ac66323054e34451bad6e91cc838b60ebbc9c10b10"
---

# H-1B Visa 2027: The Complete Guide to Requirements, Wage-Weighted Selection, Process, and Fees

## H-1B at a Glance: Quick-Reference Table
...
Total employer cost range ~$2,225 to $106,560+ (depends on company size and beneficiary location)


## What Is the H-1B Visa?


The H-1B is a[nonimmigrant work visa](https://travel.state.gov/content/travel/en/us-visas/employment/temporary-worker-visas.html) that allows United States employers to temporarily hire foreign workers in specialty occupations, meaning jobs requiring at least a bachelor's degree (or equivalent) in a specific field of study.
...
## What's New for the FY 2027 H-1B Season
...
Starting with FY 2027, USCIS no longer selects H-1B registrations by random lottery. A DHS[final rule, published December 29, 2025 and effective February 27, 2026](https://www.federalregister.gov/documents/2025/12/29/2025-23853/weighted-selection-process-for-registrants-and-petitioners-seeking-to-file-cap-subject-h-1b) , established a wage-level-weighted process that gives higher-paid positions a greater chance of selection. See the USCIS[H-1B Cap Season](https://www.uscis.gov/working-in-the-united-states/temporary-workers/h-1b-specialty-occupations/h-1b-cap-season) page for current guidance.
...
Wage Level Description Approximate Percentile Relative Selection Weight


Level I Entry-level ~17th percentile Lowest (1x)


Level II Qualified ~34th percentile Moderate (2x)


Level III Experienced ~50th percentile Higher (3x)


Level IV Fully competent ~67th percentile Highest (4x)


### The $100,000 Proclamation Fee


[Presidential Proclamation No. 10973](https://www.whitehouse.gov/presidential-actions/2025/09/restriction-on-entry-of-certain-nonimmigrant-workers/) , signed September 19, 2025, added a $100,000 one-time payment for new H-1B petitions filed for beneficiaries outside the United States who do not already hold a valid H-1B visa.
...
Litigation status as of April 2026: on December 23, 2025, the U.S. District Court for the District of Columbia upheld the proclamation in *Chamber of Commerce v. DHS* , finding the fee within the President's authority under Section 212(f) of the Immigration and Nationality Act. The U.S. Chamber of Commerce has appealed. Two additional challenges remain pending, including a multistate action filed in the District of Massachusetts ( *State of California, et al. v. Noem* , 1:25-cv-13829) and an earlier suit in the Northern District of California ( *Global Nurse Force v. Noem* ). USCIS[reaffirmed on March 31, 2026](https://www.uscis.gov/newsroom/alerts/h-1b-faq) that the fee still applies to covered FY 2027 filings.


Practical impact: for employers hiring H-1B workers who are currently abroad, total filing costs can exceed $106,000 per petition. Strategy has shifted toward sponsoring candidates already in the U.S. on another valid status such as F-1 OPT or[L-1](https://www.legalos.ai/post/l1visa-complete-guide) .


### Project Firewall: Heightened DOL Enforcement


The Department of Labor launched[Project Firewall](https://www.dol.gov/agencies/whd/immigration/h1b/projectfirewall) in September 2025, the most aggressive H-1B compliance initiative in over a decade. Key facts:


- Over 175 active investigations and more than $15 million in back wages assessed as of late 2025
- Interagency coordination between DOL, DOJ Civil Rights Division, EEOC, and USCIS
- Focus areas: underpayment of prevailing wages, mischaracterization of job duties or locations, "benching" (not paying H-1B workers during nonproductive periods), and discriminatory hiring
- Penalties include back wages, civil money fines, and debarment from the H-1B program
...
Need help navigating these changes?[LegalOS](https://www.legalos.ai/) immigration attorneys are up to speed on every FY 2027 rule change.
...
- A bona fide job offer for a specialty occupation position. The 2025 H-1B Modernization Rule replaced the older "employer-employee relationship" test with a more flexible standard, which also allows founders with a controlling ownership stake to sponsor themselves through their own companies (subject to heightened scrutiny and an 18-month initial validity limit).
- The ability and intent to pay the required wage, meaning the higher of the actual wage (what the employer pays similarly situated employees) or the prevailing wage for the occupation in the geographic area.
- A certified[Labor Condition Application (LCA)](https://flag.dol.gov/programs/LCA) from the Department of Labor.
...
- A bachelor's or higher degree in a specific field is the normal minimum requirement for entry into the position
- The degree requirement is common in the industry
- The employer normally requires a degree for the position
- The nature of the specific duties is so complex that the knowledge required is usually associated with a degree
...
- Financial analysts
- Architects and engineers (civil, mechanical, electrical)
- Accountants and financial professionals
- Medical professionals (certain roles)
...
## H-1B Visa Cap and the New Selection System
...
- 65,000 regular cap visas per fiscal year
- 20,000 additional visas reserved for individuals with a United States master's degree or higher (advanced degree cap)
...
USCIS operates an[electronic registration system](https://www.uscis.gov/working-in-the-united-states/temporary-workers/h-1b-specialty-occupations/h-1b-electronic-registration-process) (introduced in 2020) to streamline selection:


- Registration period: typically opens in early March and runs for approximately two weeks
- Selection: USCIS conducts the wage-weighted selection. Higher-wage registrations receive greater selection probability. Selection occurs first for the 65,000 regular cap, then for the 20,000 Master's cap among eligible beneficiaries not selected in the first round
- Petition filing: selected registrants and their employers file the complete H-1B petition
- Start date: cap-subject H-1Bs have an October 1 start date (the beginning of the fiscal year)
...
Registration opened March 4, 2026 (12:00 PM ET)


Registration closed March 19, 2026 (12:00 PM ET)


Selection notifications Announced by USCIS on March 31, 2026
...
### FY 2027 Selection Outcome and Odds


[USCIS confirmed on March 31, 2026](https://www.uscis.gov/newsroom/alerts/fy-2027-h-1b-initial-registration-selection-process-completed) that it received enough registrations to meet both the regular cap and the advanced degree exemption for FY 2027 and had completed the initial selection. Official registration totals have not yet been published, but early estimates from immigration practitioners indicate unique beneficiaries fell roughly 30 to 40 percent from the FY 2026 figure of 336,153, landing in the 200,000 to 250,000 range.
...
### Step 1: Employer Prepares and Registers (February to March 2026)
...
### Step 2: Selection Results (Late March 2026)
...
Before filing the H-1B petition, the employer must obtain a certified[LCA (Form ETA-9035)](https://flag.dol.gov/programs/LCA) from the Department of Labor. The LCA is the employer's formal attestation that it will pay the required wage and that hiring the H-1B worker will not negatively affect U.S. workers. LCA processing typically takes 7 to 10 business days and carries no filing fee.[LegalOS](https://www.legalos.ai/employment-based-visas/h1b) can help ensure the LCA is filed correctly. Errors here can delay or derail the entire petition.


### Step 4: File Form I-129 with USCIS (April to June 2026)


Selected employers have a 90-day window (April 1 through June 30, 2026) to file the H-1B petition (Form I-129) with USCIS. The petition package includes the I-129 form, the certified LCA, evidence of the beneficiary's qualifications, evidence that the position qualifies as a specialty occupation, and all required filing fees. This is where preparation quality matters most. A well-assembled petition with strong supporting evidence is the difference between a clean approval and a drawn-out[Request for Evidence](https://www.legalos.ai/post/understanding-rfe-process) .


### Step 5: USCIS Adjudication


Standard processing takes 3 to 6+ months.[Premium processing](https://www.uscis.gov/i-907) ($2,965 as of March 1, 2026) guarantees an initial response within 15 business days, which can be an approval, denial, or Request for Evidence (RFE).
...
### Step 6: Approval and Starting Work
...
If the worker is abroad (Consular Processing): the beneficiary must schedule and attend a visa interview at a U.S. embassy or consulate, obtain an H-1B visa stamp in their passport, and enter the U.S. with the I-797 approval notice. They may enter up to 10 days before the H-1B validity start date. Canadian citizens are exempt from the visa stamp requirement. See the[Department of State Temporary Worker Visas page](https://travel.state.gov/content/travel/en/us-visas/employment/temporary-worker-visas.html) for interview procedures.


Estimate your total H-1B filing costs with the[LegalOS USCIS Fee Calculator](https://www.legalos.ai/tools/uscis-fee-calculator) , updated for 2026.
...
- Support letter describing the job position, specific duties, and requirements
- Organizational information and financial stability documents
...
- Credential evaluation (if holding a foreign degree)
- Resume and comprehensive work history
- Prior immigration documents and travel history
...
Electronic Registration $215 per beneficiary Employer (required)


### Petition Filing Fees (if selected)


Fee Type Amount Who Pays


Base Filing Fee (I-129) $780 (paper) / $730 (online) Employer


ACWIA training fee (25+ employees) $1,500 Employer


ACWIA training fee (fewer than 25 employees) $750 Employer


Fraud prevention and detection fee $500 Employer


Asylum Program Fee (26+ FTEs) $600 Employer


Asylum Program Fee (25 or fewer FTEs) $300 Employer (nonprofits $0)
...
Proclamation 10973 Fee $100,000 New petitions for beneficiaries outside the U.S. without valid H-1B


Legal and immigration counsel fees Varies Usually employer


Attorney fees for H-1B preparation and filing typically range from $2,000 to $5,000, though this varies by firm and case complexity. At[LegalOS](https://www.legalos.ai/) , we offer transparent, competitive pricing.


Use the[USCIS Fee Calculator](https://www.uscis.gov/feecalculator) to estimate your total government filing costs.


## H-1B Selection Statistics and Trends
...
Total registrations ~780,884 ~479,953 ~343,981


Unique beneficiaries ~446,000 ~442,000 ~336,153


Initial selections 110,791 120,603 118,660


Selection rate (per beneficiary) ~25% ~29% ~35%
...
Standard processing: cases can take several months for a decision, depending on USCIS workload and case complexity. Check current estimates on the[USCIS case processing times page](https://egov.uscis.gov/processing-times/) .
...
- Initial H-1B period: up to 3 years of authorized employment
- First extension: up to 3 additional years (total authorized period: 6 years)
- Beyond 6 years: extension is possible if you have an approved I-140 (AC21 provision) immigrant petition or have been in the green card process for 365 or more days
...
The H-1B is not the only path to working in the U.S. Understanding the difference between[L-1 and H-1B visa categories](https://www.legalos.ai/post/l1visa-complete-guide) , or how the[O-1 visa and H-1B compare](https://www.legalos.ai/post/navigating-o-1a-visa-eligibility-essential-criteria-for-startup-founders) , can help you identify a faster, less expensive, or more flexible route. Here is how the most common options stack up.


Feature H-1B L-1 Visa O-1 Visa TN


Annual cap 85,000 None None None


Lottery required Yes (wage-weighted) No No No


Max duration 6 years 5 to 7 years Unlimited Unlimited


Employer change Yes (portability) No Yes (new petition) Yes (new petition)


Dual intent Yes Yes Flexible No


Best for Most specialty workers Intracompany transfers Extraordinary ability Canadian/Mexican professionals


If you are weighing an L-1 visa vs. H-1B, considering O-1A visa requirements, or exploring whether an[L-1A to green card pathway](https://www.legalos.ai/post/l1a-visa-vs-eb1c-visa) is right for you, a[LegalOS](https://www.legalos.ai/) attorney can assess your options. Our team handles H-1B, O-1A, L-1, and TN petitions.


Curious whether you qualify for the O-1A? Try the free[LegalOS O-1A Eligibility Checker](https://www.legalos.ai/tools/o-1a-visa-eligibility) . It takes two minutes.


## H-1B to Green Card: Pathways to Permanent Residence
...
- EB-2 or EB-3 (employer-sponsored employment-based green cards): requires PERM labor certification, which can take 1 to 3 or more years
- [EB-2 NIW (National Interest Waiver)](https://www.legalos.ai/post/eb2-niw-guide) : an EB-2 NIW self-petition allows you to apply for a green card without employer sponsorship if your work qualifies as being in the national interest. The current standard, set by *Matter of Dhanasar* (AAO 2016), requires demonstrating that your proposed endeavor has substantial merit and national importance, that you are well positioned to advance it, and that it is on balance beneficial to the U.S. to waive the job offer requirement.
- EB-1A (extraordinary ability): an[EB-1A self-petition](https://www.legalos.ai/post/the-eb-1-vs-eb-2-explained-requirements-criteria-and-qualification-strategies) is available if you demonstrate extraordinary ability in your field. EB-1A criteria include major awards, published material, original contributions, and other evidence of distinction. Unlike the EB-2/EB-3 route, EB-1A does not require PERM labor certification or employer sponsorship.
...
Planning your H-1B to green card transition? Read our[EB-2 NIW complete guide](https://www.legalos.ai/post/eb2-niw-guide) to understand national interest waiver requirements, or compare[EB-1A vs. EB-2 NIW](https://www.legalos.ai/post/the-eb-1-vs-eb-2-explained-requirements-criteria-and-qualification-strategies) to decide which self-petition path fits your profile.


## Starting a Business on an H-1B Visa
...
We have written a detailed guide on this topic:[Starting a Business While on an H-1B Visa](https://www.legalos.ai/post/starting-a-business-while-on-an-h-1b-visa) .


## Common H-1B Issues and Requests for Evidence


USCIS frequently issues[Requests for Evidence (RFEs)](https://www.legalos.ai/post/understanding-rfe-process) in H-1B cases. Understanding common issues helps you prepare stronger petitions.


- Specialty occupation determination: USCIS may question whether the job genuinely requires a degree in a specific field
- Employer-employee relationship: for staffing and consulting companies, USCIS scrutinizes whether a legitimate employment relationship exists
- Degree match: USCIS may question whether your educational background matches the specialty occupation
- Third-party placement: consultants placed at client sites face heightened scrutiny regarding the employment relationship


## H-1B Status vs. H-1B Visa: Important Distinctions


Understanding the difference between H-1B status and an H-1B visa is critical:


- H-1B status: your authorized period of lawful stay and employment within the United States
- H-1B visa: the visa stamp placed in your passport that permits you to enter the United States
...
## Changing Employers and H-1B Transfer
...
Lost your job while on an H-1B? Talk to a[LegalOS](https://www.legalos.ai/) attorney within the first week to maximize your options.


## H-4 Dependent Visa and H-4 EAD
...
H-4 EAD: certain H-4 spouses may apply for an[H-4 Employment Authorization Document (EAD)](https://www.uscis.gov/working-in-the-united-states/temporary-workers/h-1b-specialty-occupations/employment-authorization-for-certain-h-4-dependent-spouses) if the H-1B principal spouse has an approved Form I-140 immigrant petition. H-4 spouses may also be eligible if the H-1B worker has been granted an extension beyond the 6-year limit under AC21, which requires a PERM labor certification or I-140 petition pending for at least 365 days. The H-4 EAD permits independent employment in the United States.
...
### 1. Can I apply for an H-1B on my own?
...
### 2. What are my chances of being selected in the FY 2027 H-1B cap?
...
### 3. How long does H-1B approval take?


Standard H-1B processing can take several months. With[premium processing](https://www.uscis.gov/i-907) (optional fee of $2,965 as of March 1, 2026), USCIS guarantees a decision within 15 business days.


### 4. Can I stay in the United States after my H-1B expires?
...
### 5. What is the difference between cap-subject and cap-exempt H-1B?
...
### 6. Can I travel while my H-1B is pending?
...
### 7. What happens if my H-1B petition is denied?
...
### 8. What is the $100,000 H-1B fee?


[Presidential Proclamation 10973](https://www.whitehouse.gov/presidential-actions/2025/09/restriction-on-entry-of-certain-nonimmigrant-workers/) , signed September 19, 2025, requires a $100,000 payment for new H-1B petitions filed for beneficiaries outside the United States who do not already hold a valid H-1B visa. It does not apply to extensions, amendments, or Change of Status petitions. It is currently in effect, has been upheld by the D.C. district court (subject to appeal), and is set to expire September 21, 2026 unless extended.


### 9. Can I change employers while on an H-1B?
...
### 10. What happens if I lose my job on an H-1B?


You have a 60-day grace period (or until your I-94 expires, whichever is shorter) to find a new sponsor, change visa status, or prepare to depart. Act quickly and talk to a[LegalOS](https://www.legalos.ai/) attorney within the first week.


### 11. Can H-1B holders apply for a green card?


Yes. The H-1B is a dual-intent visa, so applying for permanent residency does not affect your status. Common pathways include EB-2 or EB-3 through PERM labor certification, an[EB-2 NIW self-petition](https://www.legalos.ai/post/eb2-niw-guide) (no employer sponsorship required), and an[EB-1A self-petition](https://www.legalos.ai/post/the-eb-1-vs-eb-2-explained-requirements-criteria-and-qualification-strategies) for extraordinary ability.


### 12. How does the new wage-weighted selection work?
...
### 13. How much does the H-1B cost?
