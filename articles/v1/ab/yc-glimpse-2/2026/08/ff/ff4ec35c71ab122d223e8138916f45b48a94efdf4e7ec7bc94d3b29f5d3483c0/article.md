...
document_id: "ff4ec35c71ab122d223e8138916f45b48a94efdf4e7ec7bc94d3b29f5d3483c0"
company_key: "yc-glimpse-2"
company: "Glimpse"
source_id: "yc-glimpse-2-news-import-cf1a5de9be11"
canonical_url: "https://www.tryglimpse.com/post/unfi-kehe-supplier-deductions"
...
content_hash: "sha256:9f629813825caee9497742245e2348ee7923801668316368aa8508d511721e12"
---

# UNFI and KeHE Deductions Guide for CPG Brands (July 2026)
...
- An automated deductions management tool, like[Glimpse](https://www.tryglimpse.com/) , disputes UNFI and KeHE deductions as a fully managed service, delivering an average 4.3x increase in dispute volume without added headcount.
...
Supplier Portal UNFI Supplier Portal (consolidated 2026) KeHE Connect


Dispute Window 30 to 60 days from submission; adjustments older than 12 months denied \[VERIFY: confirm exact window — source material lists both "30 to 45 days" and "30 to 60 days" in different sections\] 90-day filing window; dispute option removed after 6 months


Common Deduction Types Shortages (code 01), pricing discrepancies (code 02), damages (code 05), compliance fees (codes 30+), ad/promo (codes 10–12) MCBs, Everyday Pricing (EP) fees, compliance chargebacks


Most Frequently Invalid Shortage deductions (code 01) EP fees, compliance chargebacks with carrier-caused errors


Key Documentation Required PO, invoice, BOL, proof of delivery Signed BOL, proof of delivery, approved item file or deal confirmation


What Happens If You Miss the Deadline No escalation path available through the portal Dispute option disappears entirely from KeHE Connect
...
1. Shortage deductions succeed when your BOL and carrier confirmation show full delivery. Attach both. This is your strongest evidence, and it's the same approach Evermark used to uncover millions in invalid shortage deductions.
2. Pricing deductions succeed when you pull the signed trade promotion agreement or price confirmation email and reference the exact promotional period.
3. Compliance deductions succeed when you attach the original routing or labeling spec sheet. If the charge was applied incorrectly, that documentation is what gets it reversed.
...
1. Log into KeHE Connect and pull your open deductions from the Deductions tab. Filter by posting date so you can see which deductions are approaching the deadline first.
...
3. Gather your backup documentation. Shortage deductions require the signed BOL and proof of delivery. Pricing deductions require the approved item file or deal confirmation. Missing or mismatched backup is the most common reason disputes fail.
4. Submit the dispute through KeHE Connect with your documentation attached, writing a brief dispute reason that matches the deduction type exactly. Vague notes like "please review" slow down resolution and often trigger rejections. \[INTERNAL LINK: link to the Glimpse guide on disputing Walmart deductions for brands that also sell through mass retail.\]
5. Track your open disputes and follow up before the 90-day window closes. KeHE has started enforcing deadlines by removing the dispute option entirely for older deductions. \[INTERNAL LINK: link to Glimpse's guide on KeHE's 6-month dispute deadline.\]
