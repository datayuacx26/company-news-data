...
document_id: "bba413619525154a30f831f71698704f779543f3b14fc83fe6c732dffe8a994d"
company_key: "yc-same"
company: "Same"
source_id: "yc-same-news-import-393e713dbea1"
canonical_url: "https://million.dev/blog/virtual-dom.en-US"
...
content_hash: "sha256:7a6e2ad72059a3838b8d8c8249fc814eca61de0276cbbfce62dba57608478c79"
---
...
[AIDEN BAI (opens in a new tab)](https://aidenybai.com/) MAY 1 2023


---


Want to watch a 30 second summary by Fireship?[Watch it here (opens in a new tab)](https://youtu.be/VkezQMb1DHw?t=73%22%3E) .


---


A little over four years ago, Rich Harris released[Virtual DOM is pure overhead (opens in a new tab)](https://svelte.dev/blog/virtual-dom-is-pure-overhead) , analyzing the performance of traditional virtual DOM manipulation.\[0\]
...
Let's say we're given some React component` <
...
In 2022,[Blockdom (opens in a new tab)](https://github.com/ged-odoo/blockdom) was released. Taking a fundamentally different approach, Blockdom introduced the idea of a "block virtual DOM."
...
**Static Analysis** : The virtual DOM is analyzed to extract dynamic parts of the tree into an "Edit Map," or the list of the "edits" (mappings) of the dynamic parts of the virtual DOM to the state.
...
**Yes, but it's not a silver bullet.**[(View latest benchmark) (opens in a new tab)](https://krausest.github.io/js-framework-benchmark/2023/table_chrome_112.0.5615.49.html)
...
If you need to use undeterministic / unstable returns that follow a "List-like" shape, you can use the[< For />](https://old.million.dev/docs/quickstart#for-) component to help you:
...
That said, I'm excited to see what the future holds for it. Are you too? ([Go build your own! (opens in a new tab)](https://github.com/aidenybai/hundred#readme) )


[Discuss on Twitter (opens in a new tab)](https://twitter.com/search?q=https%3A%2F%2Fmillion.dev%2Fblog%2Fvirtual-dom) |[Edit on GitHub (opens in a new tab)](https://github.com/aidenybai/million/blob/main/website/pages/blog/virtual-dom.mdx)


### Acknowledgements


- [Seb Lorber (opens in a new tab)](https://twitter.com/sebastienlorber) for suggesting this post idea
- [Jesse Pense (opens in a new tab)](https://twitter.com/JessePence5) for helping read and edit the post
- [Dan Jutan (opens in a new tab)](https://twitter.com/jutanium) for making the[fastest investment of 2023 (opens in a new tab)](https://twitter.com/jutanium/status/1652907080330665984)
- [Rich Harris (opens in a new tab)](https://twitter.com/Rich_Harris) 's "Virtual DOM is pure overhead"
- [Dan Abramov (opens in a new tab)](https://twitter.com/dan_abramov) 's "React as a UI runtime"
- [Ryan Carniato (opens in a new tab)](https://twitter.com/RyanCarniato) 's "Components are Pure Overhead"
- [Chung Wu (opens in a new tab)](https://twitter.com/chungwu) 's "How React server components work: an in-depth guide"
