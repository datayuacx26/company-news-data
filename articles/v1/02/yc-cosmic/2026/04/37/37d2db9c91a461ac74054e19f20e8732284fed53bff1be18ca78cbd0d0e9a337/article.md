...
document_id: "37d2db9c91a461ac74054e19f20e8732284fed53bff1be18ca78cbd0d0e9a337"
...
content_hash: "sha256:2261c99bf2e64355ab9407e13066577980f4e19cfb306773970e920e00cfe6a2"
---
...
She created a Vercel-compatible serverless function in . The function:


- Accepts a request
- Reads the service account JSON from an environment variable ()
- Uses the SDK to create a client
- Requests an access token scoped to
...
Lisa generated a with the right dependencies (, ), a config routing POST requests to the handler, and a to keep credentials out of source control.
...
This is the part that genuinely surprised me. Lisa set the environment variable in the Vercel project dashboard, storing the credential securely so the function could access it at runtime without it ever appearing in the codebase.
...
I did not write a line of code. I did not open the Vercel dashboard. I did not know the right solution. I did not look up the docs.
