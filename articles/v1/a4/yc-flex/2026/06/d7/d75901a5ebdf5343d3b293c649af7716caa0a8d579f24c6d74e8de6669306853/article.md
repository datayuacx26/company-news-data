...
document_id: "d75901a5ebdf5343d3b293c649af7716caa0a8d579f24c6d74e8de6669306853"
company_key: "yc-flex"
company: "Flex"
source_id: "yc-flex-news-import-797b5d589915"
canonical_url: "https://www.withflex.com/blog/shop-pay-pay-another-way"
published_at: "2026-06-23T18:58:00+00:00"
first_seen_at: "2026-07-21T20:25:44.749599+00:00"
fetched_at: "2026-07-28T21:23:16.325685+00:00"
content_hash: "sha256:fb387f92665be97a758310b81aca0365137cb9630f8d4a2955a991977c53a3b5"
---

# Shop Pay “Pay Another Way”: A Faster Path to HSA/FSA Checkout on Shopify

*Shop Pay quietly added a "Pay another way" option at checkout. Here is what changed, why it matters for HSA/FSA conversion on Shopify, and what merchants on[Shop Pay](https://www.shopify.com/shop-pay) should do about it.*


## Overview


For a shopper logged into[Shop Pay](https://www.shopify.com/shop-pay) , the fastest checkout in the store has historically been one that couldn’t support HSA/FSA payments through Flex. Shop Pay is an accelerated checkout that loads a user’s saved information, including addresses and payment details, but it was not available to third-party payment options. To use Flex, that shopper had to abandon their saved profile, drop to a guest checkout, and re-enter information they had already stored.
...
Those orders convert, too.[Flex](https://www.withflex.com/) checkout sessions for the highest-volume merchants run at roughly 50% to 54%. An upstream Shop Pay drop-off, a logged-in shopper who bounces rather than re-enter their address, is a drop-off against that ~50% base, not against zero.
...
- Lean into the broader Shopify story while you're at it. If you're not yet set up to[accept HSA/FSA on your Shopify store](https://withflex.com/blog/grow-shopify-business-accept-hsa-fsa) , this lowers the friction on the single most-used path to doing so.
- Make sure your shopper-facing education covers the basics,[what HSAs and FSAs are](https://withflex.com/blog/what-are-hsas-fsas) and, for anyone who still misses the option at checkout, the[HSA reimbursement](https://withflex.com/blog/hsa-reimbursement) path as a fallback. The IRS sets which expenses qualify ([Publication 502](https://www.irs.gov/publications/p502) ).
