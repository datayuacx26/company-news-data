...
document_id: "e176dabc22e2c5219a8b67b1b196755754bb81be19533a5fa1708fb0091463b5"
company_key: "yc-khoj"
company: "Khoj"
source_id: "yc-khoj-rss-06f7f2cb1884"
canonical_url: "https://blog.khoj.dev/posts/evaluate-khoj-quality/"
...
content_hash: "sha256:9c98bf5c92d79d9f2af8631791223c9de953a33f5623becdf475e0c5f1d41077"
---
...
[Debanjum Singh Solanky](https://twitter.com/debanjum)
...
1. **OpenAI’s[SimpleQA](https://openai.com/index/introducing-simpleqa/)** : This is a recently released evaluation benchmark.
...
- **Default** : This is like an open book exam. Single shot retrieval is allowed. The agent can search for information online, run calculations in a[code sandbox](https://blog.khoj.dev/posts/ai-with-code-execution) .
...
- For reference the strongest model, o1-preview, scores a 43.5% and humans got a[94.4%](https://openai.com/index/introducing-simpleqa/#:~:text=We%20found%20that%20the%20third%20AI%20trainer%E2%80%99s%20answer%20matched%20the%20original%20agreed%20answers%2094.4%25%20of%20the%20time)7 .


#### Impact of Code Interpreter Tool


Khoj can[run code](https://blog.khoj.dev/posts/ai-with-code-execution) . This ability results in notable accuracy improvements. Here are the results of its impact on the FRAMES benchmark when run in Default mode:
...
We expect dangerous behaviors and capabilities to appear in AI agents before LLMs. Building systems to detect and isolate these at the AI agent layer is important. That topic needs a separate post. You can read[this](https://www.lesswrong.com/posts/ZoFxTqWRBkyanonyb/current-safety-training-techniques-do-not-fully-transfer-to#Discussion) post until then.↩
...
We verified that gemini-1.5-flash-002 in general mode on our eval get similar baseline score as gemini-1.5-flash-001 on the FRAMES[paper](https://arxiv.org/abs/2409.12941) of 26.3%.↩
