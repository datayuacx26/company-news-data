...
document_id: "3e4e380cd6cb407c11a74e23d34594784722931c549e75241047f1f3b36a652e"
company_key: "yc-riot"
company: "Riot"
source_id: "yc-riot-news-import-992df223e3e3"
canonical_url: "https://tryriot.com/blog/cybersecurity-courses/"
published_at: null
first_seen_at: "2026-07-22T11:58:46.553977+00:00"
fetched_at: "2026-07-28T21:38:24.318832+00:00"
content_hash: "sha256:e818fb3cc816aeb7b2dae05e11ff0f5169e298dc52771bac70bd0649df12c7af"
---

# How We Write Cybersecurity Courses That Get 91%+ Completion
...
Take passwords, for example. Instead of just coaching people to set strong passwords, we explore the[2019 SolarWinds incident](https://www.cnn.com/2021/02/26/politics/solarwinds123-password-intern/index.html) , where an intern was found to have used ‘solarwinds123’ as a password guarding entry to a critical server – and even made it public on GitHub.
...
***Learn more:[Your Boring Cybersecurity Training is Only Helping Scammers – Here Are 4 Ways We Can Do Better](https://tryriot.com/blog/boring-cybersecurity-training/)***


## #2: Focus less on the classroom, more on the conversation


People learn by doing. Instead of flat one-way classroom-style learning, we respond much more positively when we’re asked to[actively engage with the material](https://teaching.cornell.edu/teaching-resources/active-collaborative-learning/active-learning#:~:text=Active%20learning%20methods%20ask%20students,words%20through%20writing%20and%20discussion.) , testing it from different angles and offering our own thoughts, opinions, and responses.
...
For example, instead of simply warning learners about scammers using[AI-powered deepfakes](https://tryriot.com/blog/biggest-cyber-threats/) to generate someone’s voice or likeness and trick their colleagues into[handing over sensitive data](https://tryriot.com/blog/digital-footprint/) , we test their ability to distinguish between a real voice sample and a deepfake we generated.
...
**Our ‘Nudges’ feature also makes it easy to deliver quick refresher courses based on the latest cybersecurity news using generative AI.** Just give Albert an article (for example, the[MGM ransomware attack](https://www.vox.com/technology/2023/9/15/23875113/mgm-hack-casino-vishing-cybersecurity-ransomware) ) and he’ll turn it into a new conversation offering tips on how your team can stay safe from attacks like these (first tip: Don’t read out login credentials over the phone!).
...
The truth is, people are every organization’s biggest cybersecurity vulnerability. Just consider that[74% of the 5,199 US data breaches](https://www.verizon.com/about/news/2023-data-breach-investigations-report) in 2023 involved an element of human error. **That’s why our courses turn cybersecurity into a team sport, developing a shared level of awareness.**
...
That’s why we make it so easy to customize and deploy programs to suit different cohorts, giving you a[clear overview of learner progress](https://tryriot.com/toolbox/checklist-12-cybersecurity-metrics/) and highlighting where people need extra support. This helps you make cybersecurity an ongoing habit, rather than another annual compliance training.
...
Learning about best practices is one thing, but putting them to the test is something else. **That’s why we follow up our cybersecurity courses with[world-class phishing simulations](https://tryriot.com/blog/phishing-simulation/) to find out whether or not learners have actually increased their awareness.**
...
**If you’re ready to get started with a simulation of your own,[you can do it for free right here](https://tryriot.com/simulation) .** Now, let’s look at how we put these five steps in practice with our course on AI deepfakes.
...
As it turned out, this was a timely request: We’d also noticed an increase in scammers using generative AI models to impersonate victims’[colleagues](https://www.pcmag.com/news/hacker-deepfakes-employees-voice-in-phone-call-to-breach-it-company) ,[family members](https://www.cnn.com/2023/04/29/us/ai-scam-calls-kidnapping-cec/index.html) , or even their[bosses](https://www.aicpa-cima.com/news/article/deepfakes-emerge-as-real-cybersecurity-threat#:~:text=Real%2Dtime%20voice%20cloning%20allowed,recognized%20it%E2%80%9D%20on%20the%20phone.) , and we wanted to give our learners the tools they need to stay safe from these threats.
...
**Then, we needed to choose a story to kick off the course.** And we had the perfect one:[The Perkin family](https://www.businessinsider.com/couple-canada-reportedly-lost-21000-in-ai-generated-voice-scam-2023-3?r=US&IR=T) , who were scammed in early 2023 by a fraudster impersonating their son with a deepfake call purporting to be from jail, with a request for money ahead of a court appearance.
...
***Speaking of stopping scammers, check out our free checklist on[12 cybersecurity metrics that really matter](https://tryriot.com/toolbox/checklist-12-cybersecurity-metrics/) – and how you can move the needle.***
...
**To experience our refreshing take on cybersecurity awareness training for yourself,[get in touch with one of our experts today](https://tryriot.com/demo/?utm_source=direct_traffic&utm_medium=blog) .**
