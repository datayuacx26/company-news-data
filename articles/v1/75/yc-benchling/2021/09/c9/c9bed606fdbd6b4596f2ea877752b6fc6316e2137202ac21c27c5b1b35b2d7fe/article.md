...
– Tiffany Chen, Director of Discovery,[Rubius Therapeutics](https://www.benchling.com/customer-stories/rubius-optimizing-cell-engineering-with-unified-informatics-platform)
...
– Todd Rowe, Assoc. Director of Research Informatics,[Jounce Therapeutics](https://www.benchling.com/customer-stories/jounce-migrating-to-an-all-in-one-informatics-solution)
...
At[Inzen](https://www.benchling.com/customer-stories/inzen-therapeutics-accelerating-thanokine-based-therapeutics-with-a-modern-data-infrastructure) , where scientists are connecting cell death data to potential tumor-killing therapeutics, users insist on keeping all experimental data and tracking in a single software solution, Benchling. After exploring why, we found that 2/3 scientists feel Benchling makes data more findable and searchable, compared to alternatives they used in the past.
...
Notebook connects team members across geography and throughout the pipeline. One way is through the ability to bi-directionally link different Notebook entries, so that future experiments can reference relevant experiments from the past. This allows scientists in downstream groups to easily access a complete history of everything that happened upstream of them. This smooths out data handoffs between lab members and streamlines transitions between project phases, which ultimately makes collaboration easy and efficient. In fact, four out of five scientists at[TurtleTree Labs](https://www.benchling.com/customer-stories/turtletree-labs-data-foundation-to-scale-milk-production) agree Benchling increases the speed of collaboration.
...
— Brigitte Hofmeister, Bioinformatics Software Engineer,[Pairwise Plants](https://www.benchling.com/customer-stories/pairwise-cultivating-fruits-vegetables-of-tomorrow-case-study)
...
Companies are finding Benchling to be easy to adopt, and are seeing the productivity benefits of implementing Benching as early as possible. For instance,[Anagenex](https://www.benchling.com/customer-stories/anagenex-teaming-up-with-a-trailblazer-to-develop-next-gen-drug-discovery) estimates a 200% increase in speed thanks to starting with Benchling at the very beginning of the company's inception.
...
Beyond data entry and storage, Notebook—when integrated with[Benchling Insights](https://www.benchling.com/insights/) —gives scientists and executives the full history of experiments and a 360-degree view of R&D progress, enabling them to forecast resource requirements, optimize processes, and ultimately, make prompt, data-driven decisions.
