...
document_id: "e161314ab2efa89439fe9a50813e170b066341f381f1b6dc74fcf79bb5464d00"
company_key: "yc-benchling"
company: "Benchling"
source_id: "yc-benchling-rss-dcbca8149e4b"
canonical_url: "https://www.benchling.com/blog/benchtalk-2023"
...
content_hash: "sha256:7c472056d2e4e3c85d162bb0bbb9bef4017fca01e7d5bfee8a082372ad4bf894"
---

# Highlights from Benchtalk 2023: Moving science forward, together
...
Managing massive amounts of data is one of the primary challenges of the 21st century, and nowhere is that more evident than in science. To address this challenge, we had to start at the source — collecting, managing, and sharing data that comes from instruments. In our[2023 State of Tech in Biopharma report](https://www.benchling.com/state-of-tech) we found that 60% of the industry connects less than half their lab instruments. That leads to data inaccessibility, fragmented analytics, and ultimately friction in data flow across the lab, which slows down innovation.


*CPO Shawna Wolverton announced the release of our latest product, Benchling Connect.*


To address these issues, we launched[Benchling Connect](https://www.benchling.com/connect) : a flexible, open data platform built to help increase your R&D throughput and accuracy. It provides end-to-end data management, letting you connect, manage, and analyze data from all the lab instruments and data analysis tools you rely on.


Learn more about Benchling Connect in our[press release](https://www.benchling.com/news/benchling-connect-launches-instrument-connectivity-and-data-management) ,[blog post](https://www.benchling.com/blog/benchling-connect) , and[deep dive session](https://www.benchling.com/resources/benchling-connect-demo) .
...
*→ Read our*[intro to generative AI,](https://www.benchling.com/blog/biotech-intro-GenAI-LLMs) *authored by members of Benchling’s AL and ML team.*
...
*→ Read our latest white paper on*[transforming your R&D data strategy](https://www.benchling.com/resources/how-to-make-rd-data-your-competitive-advantage) .
...
As R&D data continues to grow exponentially and becomes increasingly paramount in how R&D is done, Benchling’s R&D Cloud is helping scientists across Fortune 500 biotech companies, startups, and academic institutions design and develop next generation biologics, collaborate on high throughput experiments, and ultimately get breakthrough products to market more quickly. Thank you to all of our customers, partners, and employees for joining us. One attendee, Simon Gumble, who works in R&D digital and technology at GSK, even[drew a depiction](https://www.linkedin.com/posts/simon-gumble-07117326_benchtalk-london-activity-7123438251213766656-Dg-8/?utm_source=share&utm_medium=member_ios) of the atmosphere we felt: such incredible energy!


Head on over to our online[Benchling community](https://community.benchling.com/) to continue the conversation, and I can’t wait to see everyone at Benchtalk 2024!
