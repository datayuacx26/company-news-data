...
document_id: "ca8aaa11c407bfcb29e25a1e2418925613d9a745495c939a6b95bce27aab2319"
company_key: "yc-benchling"
company: "Benchling"
source_id: "yc-benchling-rss-dcbca8149e4b"
canonical_url: "https://www.benchling.com/blog/benchling-biologics-delivers-antibody-design-and-registration"
...
We first[introduced](https://www.benchling.com/blog/introducing-benchling-biologics) Benchling Biologics last fall. With today's release, it's now the end-to-end platform for antibody R&D, giving teams the AI-ready data foundation they need to move faster.
...
### Design: Configure any format, same day
...
### Build and Test: From bench to result, in one environment
...
For teams running on automated workcells, Benchling integrates directly with laboratory automation systems, including[HighRes](https://www.benchling.com/blog/benchling-and-highres-lab-automation) , passing experimental parameters automatically and returning analyzed results to the original experiment entry.


If any of this work is outsourced, scientists can order biological materials and assay services without leaving their workflow with[Direct ordering](https://www.benchling.com/blog/one-click-ordering-for-experiments-and-data) . Ordering is available with Twist Bioscience for gene synthesis and antibody expression, Adaptyv for protein engineering and characterization services, and Ginkgo Bioworks for antibody developability screening. Each result returns tied to the originating design, making handoffs easy and speeding up validation cycles.
...
[Benchling AI](https://www.benchling.com/ai) can summarize learnings across experiments and help teams explore options for the next design cycle. Computational teams can access external sequence and structural datasets through Benchling's MCP-based[AI Connectors](https://www.benchling.com/ai/ecosystem-extensibility) to feed directly into antibody design models, or integrate data with PipeBio to analyze sequence and assay data together.


[Benchling Biologics](https://www.benchling.com/biologics) is available today.


**See it in action.** Join us on June 11 for a live walkthrough of Benchling Biologics: configuring formats, registering antibodies at scale, and building the AI-ready data foundation antibody R&D teams need.[Register for the webinar](https://info.edifydigitalmedia.com/webinar-session-2-introducing-benchling-biologics-ai-infrastructure-for-modern-drug-discovery-june-2026?utm_campaign=43765784-Benchling%20webinar%20session%202%20-%20June%2011th&utm_source=Benchling%20field%20Session%202&utm_medium=Benchling%20field%20Session%202) .
