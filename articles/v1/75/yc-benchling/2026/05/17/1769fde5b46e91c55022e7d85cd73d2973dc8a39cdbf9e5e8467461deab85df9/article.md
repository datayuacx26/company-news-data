...
document_id: "1769fde5b46e91c55022e7d85cd73d2973dc8a39cdbf9e5e8467461deab85df9"
company_key: "yc-benchling"
company: "Benchling"
source_id: "yc-benchling-rss-dcbca8149e4b"
canonical_url: "https://www.benchling.com/blog/what-a-difference-a-year-makes-the-evolution-of-the-ai-conversation"
...
This year, people arrived with opinions, not just questions. Nearly everyone in the room shared about their favorite Benchling AI tools and how often they're using them. The[Compose Agent](https://help.benchling.com/hc/en-us/articles/39437880024717-Create-entries-and-templates-with-the-Compose-Agent) and[Ask Agent](https://help.benchling.com/hc/en-us/articles/39455311469709-Explore-data-with-the-Ask-agent) , especially, are daily drivers for some teams. Jen Running Deer, one of our user group leaders and Associate Director of R&D Informatics at Outpace Bio, spoke about using the[Deep Research Agent](https://www.benchling.com/blog/deep-research) to show leadership what was possible with Benchling AI. It worked — their executives were impressed with the results it could surface. Hearing all these stories made me do a double take back to the conversations the year prior. Our other user group leader, Adam Murray, Laboratory Information Specialist at Lundbeck, shared a similar arc. Getting IT and legal approval was a long process as they were still developing evaluation criteria for AI tools. However, once that hurdle was cleared, they committed fully: onsite training, access rolled out to everyone at once, and a prompt library from their Customer Success Manager that gave scientists a concrete starting point. Now management actively encourages AI use wherever possible.
...
Data readiness came up in a new way this year. Jen shared that their flow cytometry data still isn't structured in Benchling due to the instrument-specific data format. Instead, it lives outside the system and only gets briefly referenced in entries. That gap matters when you're trying to use AI to reason across your data. We talked through how[AI Connectors](https://www.benchling.com/ai/connectors) can bring that external data into Benchling AI's context, so the agents can still draw on the full picture. Getting the data in the right shape is still real work, but now teams are able to problem solve using the full spectrum of tools at their disposal.


[Part of the AI journey is figuring out which tools are the best for the job and why.](https://www.benchling.com/blog/the-difference-between-purpose-built-agents-and-enterprise-ai-blog) We talked about using general LLMs to craft better prompts for Deep Research. I recommend this for getting the most out of your prompts on the first try, reducing the need for constant refinement. Scientists can then run prompts in Benchling, which has all the experimental context.
...
If you're earlier in your AI journey, the[Benchling Community](https://community.benchling.com/p/ai) and the[AI Resource Hub](https://www.benchling.com/ai/ai-for-science) are good places to start — it's where teams share what's working, what isn't, and how they got there. If you're further along and have something to add, we want to hear from you too! We're all figuring this out together and the more teams that share what they're learning, the faster everyone moves.
