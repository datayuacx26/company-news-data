...
document_id: "aec3a8987f09b2e90611c590da9cf74a2426c1df415728080de2ab0460599779"
company_key: "yc-ballerine"
company: "Ballerine"
source_id: "yc-ballerine-news-import-9376e18e0cef"
canonical_url: "https://ballerine.com/blog/merchant-underwriting-handbook-for-compliance-teams"
...
content_hash: "sha256:3d76ecaca40b131344d82e68c49d39ab7beaab03025778bfac95eaf874342054"
---
...
[Merchant underwriting](https://ballerine.com/solutions/merchant-underwriting) compliance requires documented policies, robust governance, and comprehensive audit trails to satisfy card schemes, regulators, and internal oversight. Compliance teams must ensure underwriting programs meet[Visa VARS](https://usa.visa.com/dam/VCOM/download/merchants/visa-global-acquirer-risk-standards.pdf) ,[Mastercard Security Rules](https://www.mastercard.us/content/dam/public/mastercardcom/na/global-site/documents/SPME-Manual.pdf) , and anti-money laundering obligations under[FATF standards](https://www.fatf-gafi.org/en/publications/Fatfrecommendations/Fatf-recommendations.html) .
...
## Regulatory and scheme drivers for underwriting compliance
...
Card schemes require documented underwriting programs that verify merchant legitimacy, assess risk, and maintain ongoing oversight.[Visa's Acceptance Risk Standards (VARS)](https://usa.visa.com/dam/VCOM/download/merchants/visa-global-acquirer-risk-standards.pdf) , effective October 2024, replaced the Global Acquirer Risk Standards with updated requirements emphasizing continuous monitoring and proactive risk detection.


‍


[Mastercard's Security Rules and Procedures](https://www.mastercard.us/content/dam/public/mastercardcom/na/global-site/documents/SPME-Manual.pdf) mandate that acquirers maintain adequate due diligence controls, screen merchants for compliance risks, and respond promptly to identified issues. Failure to meet scheme standards results in fines, operational restrictions, or program termination.


‍


For organizations serving high-risk portfolios,[understanding BRAM and VIRP compliance requirements](https://ballerine.com/blog/bram-and-virp-a-practical-professional-guide-for-psps-in-2026) is essential. These programs specifically target illegal activity, intellectual property infringement, and deceptive marketing practices that damage card brand integrity.
...
###### **AML and customer due diligence obligations**


Anti-money laundering regulations require payment service providers to perform customer due diligence.[FATF international standards](https://www.fatf-gafi.org/en/publications/Fatfrecommendations/Fatf-recommendations.html) require payment providers to verify customer identity, understand business activities, and monitor transactions for suspicious patterns.
...
## Underwriting policy and governance framework
...
###### **Merchant application and supporting documents**
...
###### **Verification and screening evidence**
...
Underwriting does not end at onboarding.[Continuous monitoring](https://ballerine.com/solutions/merchant-monitoring) generates records demonstrating ongoing oversight: transaction monitoring alerts and investigation results, periodic review outcomes and risk reassessments, triggered re-underwriting when risk indicators surface, adverse information identified after onboarding, and merchant communications regarding policy changes or compliance issues.
...
## Compliance screening and sanctions requirements
...
###### **Restricted industry validation**
...
###### **Decision documentation and approver identity**
...
###### **Risk scoring and rule application**
...
###### **Exception handling and override justification**
...
## Continuous monitoring and triggered reviews


‍


###### **Transaction monitoring and alert thresholds**


[Ongoing transaction monitoring](https://ballerine.com/solutions/merchant-monitoring) detects issues after onboarding: volume spikes exceeding projections, chargeback rate increases, unusual refund patterns, geographic shifts in transaction origins, and ticket size changes indicating business model drift.
...
[Ballerine's merchant risk platform](https://ballerine.com/) helps compliance teams automate this orchestration, surfacing complex patterns requiring investigation while reducing false positives that slow operations.
...
###### **Adverse information and event-driven reviews**
...
## Reporting and escalation to schemes and regulators


‍


###### **Scheme audit requests and compliance reporting**
...
###### **Regulatory examinations and remediation**
...
## Building a compliance-ready underwriting program
...
For[banking institutions](https://ballerine.com/industries/banking) and[fintech companies](https://ballerine.com/industries/fintech) , integrating compliance into underwriting workflows from the start prevents costly retrofitting when audits or exams reveal deficiencies.
