...
document_id: "df9a15ddc140b1a9b4b1acffb00a6ca5688c06f53216991113e55ac179aebe78"
company_key: "yc-ai-2"
company: "&AI"
source_id: "yc-ai-2-rss-536318f0f92f"
canonical_url: "https://www.tryandai.com/blog/hikma-v-amarin-induced-infringement"
...
content_hash: "sha256:8fa95ccedb8149af024e22a5b7386e036863210c08f892669630600c22a94f48"
---
...
- A unanimous Supreme Court held that a generic drugmaker does not induce infringement under §271(b) merely because it can foresee that doctors will prescribe its product for a patented use.
- To plead inducement, a patent owner must allege affirmative "active steps"—purposeful conduct designed to encourage infringement; ordinary acts of product distribution and mere knowledge of infringing use are not enough.
- A compliant "skinny label" plus standard, legally required labeling, without more, does not plausibly allege inducement—though skinny labels are not categorically immune.
- Inducement can be implicit, but it must be affirmative and clear to the audience; omissions and statements a doctor "could read" as encouragement do not suffice.
- The ruling raises the pleading bar for skinny-label inducement theories while leaving method-of-use patents fully enforceable.
...
What did the Supreme Court hold in Hikma v. Amarin?


The Court held that Amarin failed to plausibly plead a §271(b) induced-infringement claim. Foreseeing that doctors will use a generic drug for a patented use does not, by itself, amount to inducement; a patent owner must plausibly allege that the defendant took affirmative "active steps" designed to encourage the infringing use. The Court, unanimous, in an opinion by Justice Jackson on June 4, 2026, held the complaint could not survive Hikma's Rule 12(b)(6) motion to dismiss, and reversed and remanded the Federal Circuit.


Is foreseeability enough to prove induced infringement?


No. The Court reaffirmed that "mere knowledge of infringing potential or of actual infringing uses" is not enough. Inducement under §271(b) requires affirmative conduct designed to encourage infringement, not just awareness that it may occur.


What are the elements of induced infringement under §271(b)?


Three elements: (1) direct infringement by a third party; (2) the inducer's knowledge that the induced acts infringe; and (3) "active steps… to encourage direct infringement." Hikma v. Amarin turned on the third, the "active steps" requirement.


What is a skinny label, and how does Hikma v. Amarin affect it?


A skinny label is a generic drug label that carves out a brand's still-patented method of use under the Hatch-Waxman section viii pathway. Hikma v. Amarin is a helpful skinny-label decision, though not an absolute shield: a label that simply omits the patented use and uses legally required or standard industry language does not, without more, induce infringement.


How do you defend an induced infringement claim after Hikma?


Show that the challenged statements are compliance with legal or industry norms, neutral omissions, or too vague to be affirmative encouragement, and that the plaintiff's theory depends on speculation about how others might act. After Hikma, statements that merely could be read as encouragement are not "active steps."


What is the difference between induced and contributory infringement?


Both are forms of indirect infringement. Induced infringement (§271(b)) targets a party that actively encourages another to infringe; contributory infringement (§271(c)) targets supplying a component especially made for an infringing use with no substantial non-infringing use. Hikma v. Amarin addresses the "active steps" required for the inducement branch.


## Related insights


[Novo Nordisk Targets Hims & Hers’ Compounded Semaglutide Offerings in Patent Lawsuit Novo Nordisk's suit against Hims signals a new phase in the fight over compounded GLP-1 drugs. February 18, 2026](https://www.tryandai.com/blog/novo-nordisk-sues-hims-for-patent-infringement-over-compounded-semaglutide)[Sound View Innovations, LLC v. Hulu, LLC: Federal Circuit Affirms Noninfringement The Federal Circuit affirms noninfringement, clarifying implicit step-order requirements in method claims. February 7, 2026](https://www.tryandai.com/blog/sound-view-innovations-v-hulu)
