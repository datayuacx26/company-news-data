...
document_id: "230e9b1b6c2c46496d3031c0363b45b3e1f40d119f0b90786b265c2603f22f25"
company_key: "yc-concourse"
company: "Concourse"
source_id: "yc-concourse-news-import-c7979aaf4bde"
canonical_url: "https://www.concourse.ai/insights/best-treasury-management-software-2026"
published_at: "2026-07-30T13:00:00+00:00"
first_seen_at: "2026-08-01T00:34:23.381108+00:00"
fetched_at: "2026-08-01T00:34:25.194600+00:00"
content_hash: "sha256:980543829b6502da30f2964fef7eeff2679236a6550065bdfc4fed99ea57b3c2"
---
...
The treasury management system market was valued at about **$5.8 billion in 2024** and is projected to reach roughly **$15.1 billion by 2032** , growing at a **12.8% compound annual rate** , according to[Verified Market Research](https://www.verifiedmarketresearch.com/product/treasury-management-system-tms-market/) .
...
**Spreadsheets remain the default.** **91% of treasury teams** still use Excel as one of their cash-forecasting tools, according to Strategic Treasurer’s Cash Forecasting & Visibility Survey[reported by CTMfile](https://ctmfile.com/story/survey-says-treasurers-want-more-accurate-cash-forecasting) . Spreadsheets don’t refresh bank feeds, don’t audit themselves, and break silently when a formula shifts.


**Forecasting is getting harder, not easier.** The share of treasury teams calling cash forecasting "difficult" climbed from 39% in 2018 to **53% in 2025** , while the share calling it "easy" was cut in half, according to reporting on cash-forecasting trends in[CTMfile](https://ctmfile.com/story/treasury-cash-forecasting-rising-expectations-growing-complexity-ais-promise) . The data underneath is usually the bottleneck. Unreliable, fragmented bank and ERP data is the top reason forecasts miss.


**Accuracy is worse than most leaders assume.** An[EY-Parthenon analysis](https://www.ey.com/en_us/insights/strategy/cash-forecasting-difficult-and-more-urgent-than-ever) of roughly 2,400 of the largest global companies found that only **28% of cash forecasts landed within 10%** of actual free cash flow between 2017 and early 2023. When forecasts miss by that much, treasurers over-borrow, sit on idle cash, or get caught short. All of these are expensive mistakes.


That gap between what treasury is asked to deliver and what spreadsheets can support is exactly what modern treasury management software, and the AI agents now entering the category, is built to close. For the fundamentals of the discipline, see our primer on[what a treasury management system does](https://www.concourse.ai/insights/treasury-management-system) and[what a treasurer actually does](https://www.concourse.ai/insights/what-does-a-treasurer-do) .
...
**Keep in mind.** Concourse is an agentic execution and analysis layer, not a bank-connectivity-and-payments TMS. If your core need is SWIFT or host-to-host payment rails or in-house banking, run Concourse alongside a dedicated TMS rather than in place of one. See how Concourse[applies AI agents to treasury workflows](https://www.concourse.ai/insights/concourse-ai-agents-tools-treasury) .


### **2. Kyriba, Best for Large Global Enterprises**


Kyriba is the most widely deployed enterprise TMS and the default choice for large multinationals that need real-time cash visibility, payments control, and liquidity management at global scale.[Kyriba reports](https://www.kyriba.com/news/kyriba-launches-its-open-api-platform/) it serves more than 3,000 clients and processes over $15 trillion in payments annually across roughly 3 billion bank transactions.
...
GTreasury is a long-established enterprise TMS that has been in operation since 1986, combining cash forecasting, bank connectivity, and risk workflows in one place. In late 2025,[Ripple acquired GTreasury for $1 billion](https://ripple.com/ripple-press/ripple-breaks-into-corporate-treasury-with-gtreasury-acquisition/) and launched **Ripple Treasury** in January 2026, pairing an enterprise TMS that has processed roughly $12.5 trillion in annual payment volume with Ripple’s payments network and digital-asset infrastructure.
...
Nilus is an AI-native treasury platform that stands out when teams need forecasts they can *explain* , tied to the underlying drivers and to concrete treasury actions rather than a black-box number. Its[buyer’s guide](https://www.nilus.com/post/the-7-best-ai-native-treasury-platforms-in-2026-honest-buyers-guide) positions it for PE-backed and multi-entity teams that need policy-backed liquidity decisions.
...
Embat is a modern European challenger, founded in Madrid in 2021 by two ex-J.P. Morgan executives and now serving[400+ corporate clients across Europe](https://fintech.global/2026/05/12/embat-raises-e30m-series-b-to-drive-european-growth/) . It gives mid-market teams one platform for cash visibility, forecasting, reconciliation, intercompany workflows, and payments, connecting to 15,000+ banks. Its agentic assistant, TellMe, automates the last mile of treasury work under human review.
...
The right platform depends on your scale and your biggest bottleneck, but the clearest shift this year is from software that *shows* you cash to software that *acts* on it. If you want to see what AI agents can do across cash forecasting, variance analysis, collections, and liquidity reporting, all with every number traceable and board-ready,[book a demo of Concourse](https://www.concourse.ai/) and put an agent on your next forecast.
