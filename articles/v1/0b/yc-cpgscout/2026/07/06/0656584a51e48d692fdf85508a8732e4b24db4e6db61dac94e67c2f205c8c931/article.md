...
Understanding[what is syndicated data](https://www.cpgscout.ai/blog/what-is-syndicated-data) is a prerequisite here: SPINS, like the other major panels, sells subscriptions that let brands see aggregated weekly sales across its panel without having access to individual retailer files. A brand does not need a data-sharing agreement with Whole Foods to see total SPINS natural supermarket velocity for its category.
...
These metrics show up regularly across CPG data work. If terms like TDP or ACV feel new,[WTD, CWW & Other CPG Data Acronyms](https://www.cpgscout.ai/blog/wtd-cww-cpg-acronyms) is a useful reference to keep open alongside your SPINS reports.
