...
document_id: "8a624f9f9edf89e70b3fb10e49e8e3453a0d385e40a890f4a0c3cf9ccce2d055"
company_key: "yc-pointone"
company: "PointOne"
source_id: "yc-pointone-news-import-cfa073ae7806"
canonical_url: "https://pointone.com/blog/average-billable-hours-per-day-for-lawyers"
published_at: "2026-05-28T00:00:00+00:00"
first_seen_at: "2026-07-24T00:40:27.504989+00:00"
fetched_at: "2026-07-28T21:55:52.188627+00:00"
content_hash: "sha256:675cefbe77164e7511a1d206882fa503e82c92a6e4899fd2712709a850fe60f7"
---

# Low Billable Hours: Why 2.9 Is Average | PointOne - PointOne
...
Billable hours are the time attorneys spend on client work that can be invoiced. For most US law firms, billable hours are the primary way revenue gets generated. The[utilization rate](https://pointone.com/blog/blog-law-firm-kpis-managing-partner) —billable hours divided by total hours worked—measures how efficiently a firm converts attorney time into invoiced work. The gap between hours worked and hours billed is where revenue disappears. So what actually counts as billable versus non-billable time?
...
Reconstructing a day's work from memory, calendar, and inbox is the norm at most firms. Retrospective entry causes attorneys to underreport actual time spent. This "time leakage" represents real revenue that never gets invoiced.[Revenue leakage](https://pointone.com/blog/ai-time-capture-revenue-leakage-law-firms) represents real work that never gets invoiced.


### Non-compliant entries get written off before invoicing


Even when time is captured, entries that violate Outside Counsel Guidelines (OCGs) or firm policies get reduced or written off during pre-bill reviewEven when time is captured, entries that violate Outside Counsel Guidelines (OCGs) or firm policies get reduced or written off during[pre-bill review](https://pointone.com/blog/optimizing-legal-pre-bill-proforma-review) . OCGs are billing rules that corporate clients require their outside law firms to follow. Block billing, vague narratives, and rate violations are common triggers for write-downs.
...
For a 10-attorney firm, that's over $2.3 million in potential revenue that never gets billed. Even recovering a fraction of that gap through better capture dramatically improves firm economics and[realization rates](https://pointone.com/blog/blog-law-firm-realization-rate) .
...
Mid-size firms balance higher hour expectations with limited[operations infrastructure](https://pointone.com/blog/mid-sized-law-firm-operations-efficiency) . Firms running legacy systems like Aderant or Elite 3E often struggle with timekeeper compliance.
...
AI-generated narratives eliminate the blank-page problem.[AI tools](https://pointone.com/blog/ai-tools-for-lawyers) with timers and voice-to-entry capabilities let attorneys describe work verbally while the system handles formatting and compliance.


### 3. Use passive AI time capture to eliminate manual logging


[AI time tracking](https://pointone.com/blog/what-is-ai-time-tracking) software monitors desktop and phone activity passively, then auto-generates time entries for attorney review. This shifts the workflow from "entering time" to "reviewing time"—similar to working with a billing assistant.
...
AI checks entries against[OCG rules in real time](https://pointone.com/blog/blog-ai-vs-manual-workflows-legal) , preventing non-compliant entries from ever reaching the pre-bill stage. Block billing, vague narratives, and prohibited task codes get flagged before they become write-offs.
...
Alternative fee arrangements (AFAs) are growing, but accurate time data remains essential even when firms[move away from hourly billing](https://pointone.com/attorneyintelligence/the-billable-hour-is-not-dying-it-s-mutating/) . You can't price a flat-fee matter accurately without understanding how long similar matters actually take.
