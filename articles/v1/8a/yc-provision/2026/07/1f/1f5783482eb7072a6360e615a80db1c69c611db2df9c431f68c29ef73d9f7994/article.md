...
document_id: "1f5783482eb7072a6360e615a80db1c69c611db2df9c431f68c29ef73d9f7994"
company_key: "yc-provision"
company: "Provision"
source_id: "yc-provision-news-import-0c949e419e29"
canonical_url: "https://provision.com/blog/structural-steel-scope-hoisting-rigging-miscellaneous-metals"
published_at: "2026-07-21T00:00:00+00:00"
first_seen_at: "2026-07-24T13:11:13.739834+00:00"
fetched_at: "2026-07-28T21:38:29.998390+00:00"
content_hash: "sha256:be2e7e2e12df9bdbdb3634ef76af5e5421152c965b9439204834d820a23b59b8"
---

# Structural Steel Scope of Work: Hoisting, Rigging, and Miscellaneous Metals Responsibility
...
According to the[Scope Gap Playbook](https://provision.com/ebooks/scope-gap-playbook/trade-specific-scope-gaps) , structural steel is one of the highest-risk trade packages for scope gaps involving embeds, anchor bolts, hoisting, rigging, and miscellaneous metals scatter. Institutional construction volume is up 22% year-over-year in 2026, which means larger, more complex structural packages with more parties involved. The window for ambiguity has never been wider.
...
- Is the steel erector's crane available to other GC-directed trades? Yes or no.
- If yes, what is the cost basis — included in lump sum, unit rate per day, or billed at cost?
- Who pays for crane standby when structural steel erection is delayed by another trade?
- Who is responsible for crane operator costs after steel erection is substantially complete?
- Are there separate lifts required for miscellaneous metals or open-web steel joists?
...
The most common hoisting scope anti-pattern is "as per plans and specs." That language tells the steel erector almost nothing about shared crane access and nothing about standby cost responsibility. It is the most-cited scope anti-pattern in the[Scope Gap Playbook's contract language chapter](https://provision.com/ebooks/scope-gap-playbook/subcontract-language-scope) — and it lands steel erectors and GCs in disputes every single time there is a schedule compression or trade stacking.
...
The[Scope Gap Playbook](https://provision.com/ebooks/scope-gap-playbook/trade-specific-scope-gaps) specifically flags grouting base plates as a concrete/steel interface gap that appears on commercial projects across firm sizes. It is preventable. It requires one line in the scope package: "Furnish and install non-shrink grout at all column base plates per structural drawings."
...
- **Lintels over openings** — Are they included in the masonry scope or the structural steel scope? If both subs exclude them, they are the GC's problem.
- **Shelf angles for masonry veneer** — Often called out on structural drawings. Often missed by masonry subs who assume steel includes them. Often missed by steel subs who assume masonry includes them.
- **Pipe and equipment supports** — Mechanical subs typically exclude structural steel supports. If the structural steel sub is off site before mechanical starts, these become a separate mobilization.
- **Overhead door tracks and frames** — Called out in architectural. No one owns the structural blocking or steel angle above the door head unless you say so explicitly.
- **Roof hatch frames and ladder extensions** — Frequently missed in both roofing and steel scopes. Show up as RFIs in the field.
...
The Eight Habits framework from the[Scope Gap Playbook](https://provision.com/ebooks/scope-gap-playbook/trade-specific-scope-gaps) is directly applicable here. Habit 1 — drawings-first, not boilerplate-first — is the single most important principle for structural steel scope packages. The structural drawings tell you what is actually on this project. The boilerplate tells you what was on the last one.
...
If your pre-construction team is handling more structural packages in 2026 — and institutional volume data says they are — the question is whether your scope review process scales with the workload. If you want to see how Scope Agent handles a structural steel package,[book a demo](https://provision.com/request-a-demo) and bring a real bid set.
...
For more on how to structure scope packages across high-risk trades, the[Scope Gap Playbook trade-specific chapter](https://provision.com/ebooks/scope-gap-playbook/trade-specific-scope-gaps) covers steel, MEP, envelope, and specialty trades with operator-cited examples from GCs across North America.
