...
document_id: "ca014e26d29b08651678252ad49e29b70b1398a4cdf8d60c2afe46aa491d38ff"
company_key: "yc-ophelia"
company: "Ophelia"
source_id: "yc-ophelia-news-import-c646c2e00120"
canonical_url: "https://ophelia.com/blog/industrial-chemical-btmps-in-fentanyl"
...
BTMPS has no known psychoactive or sedative effects, so likely added on purpose to “cut” the drug”5. Cutting involves mixing drugs with other substances, often cheaper fillers or additives, to stretch supply and maximize profits. For example, fentanyl is sometimes cut with a bulking agent, like baking soda6. Fentanyl can also be[cut into other drugs](https://ophelia.com/blog/why-are-drugs-laced-with-fentanyl) , which is why people are encouraged to use fentanyl test strips[to identify this danger](https://ophelia.com/glossary/fentanyl-test-strips) .
...
Beyond using drug-checking services where available, other harm reduction strategies that can be used[to stay safer in the fentanyl crisis](https://ophelia.com/blog/why-is-the-fentanyl-crisis-so-bad) include the following10:
...
Ophelia is committed to[ongoing research and public health awareness](https://ophelia.com/research-insights) . We also have a dedicated[clinical care team](https://ophelia.com/meet) available to address individuals’ needs.


For patients struggling with opioid use disorder (OUD), one option is medications for addiction treatment (MAT). Considered the[gold standard of care for OUD](https://ophelia.com/glossary/mat) , MAT takes a whole-person approach to treatment, combining the use of medications with counseling and behavioral therapies.


Ophelia removes typical geographic, logistical, and financial barriers to MAT access by[making it available virtually](https://ophelia.com/how-it-works) . You can meet with your clinical care team and determine whether a prescription for Suboxone, a medication used in MAT programs, is right for you. If you’re a good candidate, the prescription is sent to your local pharmacy for pickup. The Ophelia team continues to provide ongoing medical support, seven days a week.
