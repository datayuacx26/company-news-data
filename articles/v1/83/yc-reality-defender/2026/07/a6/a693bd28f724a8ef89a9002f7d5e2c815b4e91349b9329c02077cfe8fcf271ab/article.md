...
document_id: "a693bd28f724a8ef89a9002f7d5e2c815b4e91349b9329c02077cfe8fcf271ab"
company_key: "yc-reality-defender"
company: "Reality Defender"
source_id: "yc-reality-defender-news-import-247f3b081c39"
canonical_url: "https://www.realitydefender.com/insights/history-of-deepfakes"
published_at: "2026-07-06T00:00:00+00:00"
first_seen_at: "2026-07-23T22:42:34.349058+00:00"
fetched_at: "2026-07-28T21:38:32.326002+00:00"
content_hash: "sha256:5c0df32d7e033822298d7c9eef06b1710d23e586317940bae6deeec21232f66e"
---
...
Governments around the world, including the United States, began exploring legislation to regulate the creation and distribution of deepfakes. Results have been mixed, but 2019 marked the beginning of formal regulatory interest and the introduction of the[Deepfake Report Act of 2019](https://www.wilmerhale.com/en/insights/client-alerts/20191223-first-federal-legislation-on-deepfakes-signed-into-law) .
...
Generative technologies continued to spread across social media;[deepfake content grew more than 550 percent between 2019 and 2023](https://www.deloitte.com/uk/en/Industries/tmt/analysis/the-rise-of-deepfakes-what-digital-platforms-and-technology-organizations-should-know.html) .
...
In 2024, the World Economic Forum identified deepfakes and AI-driven disinformation as one of the top global risks. Real-world harm became increasingly visible. A[McAfee report](https://www.mcafee.com/blogs/internet-security/state-of-the-scamiverse/) found that 26 percent of individuals encountered a deepfake scam in 2024, and 9 percent fell victim to one.


In one high-profile incident, a[Hong Kong finance worker transferred 25 million dollars](https://www.cnn.com/2024/02/04/asia/deepfake-cfo-scam-hong-kong-intl-hnk) after criminals used deepfaked executives in a live video meeting. This year made clear that deepfakes had become active tools for fraud, manipulation, and large-scale deception.


#### 2025: Deepfakes in Daily Life


By 2025, deepfakes actively shaped everyday digital interactions. People could create convincing synthetic media with almost no effort. A[Business Insider journalist](https://www.businessinsider.com/bank-account-scam-deepfakes-ai-voice-generator-crime-fraud-2025-5) proved this by cloning their own voice using a low-cost online tool and then using that clone to navigate a bank’s phone system. The voice sounded slightly robotic, but it still passed as real and raised no suspicion. What once required specialized expertise now sits in the hands of anyone willing to spend a few dollars.


The financial toll grew just as fast. Deepfake-related fraud losses tripled to roughly $1.1 billion in 2025, up from about $360 million the year before, and 83 percent of those losses traced back to social media platforms. \[[Surfshark](https://fortune.com/2026/03/03/boards-arent-ready-for-the-ai-age-what-happens-when-your-ceo-gets-deepfaked/) \] Executive impersonation drove much of the corporate damage, as attackers cloned the voices and faces of CEOs and CFOs to authorize fraudulent transfers. Voice, video, and image had all become routine attack surfaces.


At the same time, demand for generative AI skyrocketed. Platforms like[OpenAI’s Sora and Google’s Gemini 3 Pro](https://www.techradar.com/ai-platforms-assistants/gemini/openai-and-google-quietly-limit-free-sora-nano-banana-pro-and-gemini-3-pro-use-heres-what-it-means-for-you) started limiting free generations as global usage spiked and compute costs surged. These restrictions signal a world where synthetic media tools are not fringe experiments but everyday utilities that millions rely on, for both legitimate and malicious purposes.


Regulators responded by accelerating legislative action. A small cluster of[early deepfake laws](https://www.realitydefender.com/insights/the-state-of-deepfake-regulations-in-2025-what-businesses-need-to-know) quickly grew into hundreds of active proposals worldwide. The European Union advanced comprehensive protections through the AI Act. In the United States, state lawmakers introduced more than 50 AI-related bills each week, including roughly 25 bills focused specifically on deepfakes. Governments across the Asia-Pacific region also began shaping their own regulatory frameworks to address escalating risks.
...
**2026: Verification Becomes the Baseline**
By 2026, the response to deepfakes shifted from awareness to infrastructure. Governments, regulators, and insurers stopped treating synthetic media as an emerging risk and started treating it as an operating condition. In February 2026, the UK's National Cyber Security Centre and the US Cybersecurity and Infrastructure Security Agency issued a joint advisory to corporate treasury and finance teams. The warning was blunt. The voice or face on a call can no longer be trusted on its own. \[[NCSC/CISA advisory, Feb 2026](https://www.trustsphere.ai/post/deepfake%EE%80%80-ceo-fraud-goes-industrial-when-treasury%EE%80%80-calls-become-synthetic) \]


The financial sector felt it first. The FBI's 2025 Internet Crime Report, released in 2026, showed business email compromise losses tied to confirmed deepfake audio or video climbing sharply year over year. \[[FBI IC3 2025](https://cybelangel.com/blog/deepfake-ceo-fraud-how-voice-cloning-targets-us-executives/) \] Insurers reacted fast. Lloyd's syndicates and Munich Re began requiring out-of-band callback procedures, executive voice verification, and documented synthetic-media training before offering standard social-engineering coverage. Detection stopped being optional and became a condition of doing business.


Attackers kept innovating. In January 2026, researchers exposed a fraud operation that used roughly 90 AI-generated personas to populate messaging groups and steer victims into a fake trading app. They built an entire synthetic reality to sustain the scheme. \[[Check Point, Jan 2026](https://www.vectra.ai/topics/ai-scams) \] Deepfake job candidates continued slipping through remote interviews, using synthetic voices and faces to gain access to internal systems.


The pattern underneath all of it was simple. Organizations could no longer treat a convincing face or a familiar voice as proof. Verification moved from optional to baseline, and detection built into everyday workflows became the way institutions kept trust intact.


## The New Frontier of Synthetic Media


Deepfakes have moved far beyond face-swapping. What began as an experimental curiosity is now a complete synthetic media ecosystem capable of manipulating or fabricating nearly every dimension of human communication. Faces, voices, bodies, and environments can now be generated or altered with remarkable realism and speed. This evolution unlocks powerful creative and commercial opportunities, but it also introduces[profound risks](https://www.realitydefender.com/insights/five-deepfake-threats-to-act-on-now) .
...
Automated deepfake detection, built into the systems organizations already use, is rapidly becoming a core requirement for institutions, governments, and platforms.[Reality Defender](https://www.realitydefender.com/solutions) was founded in 2021 to provide scalable deepfake detection and help organizations protect identity and trust.
