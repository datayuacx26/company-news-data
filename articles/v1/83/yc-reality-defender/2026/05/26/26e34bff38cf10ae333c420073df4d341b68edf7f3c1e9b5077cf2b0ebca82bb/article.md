...
The[Take It Down Act](https://www.realitydefender.com/insights/the-state-of-deepfake-regulations) creates a notice-and-takedown regime for[non-consensual intimate imagery](https://www.realitydefender.com/insights/what-is-deepfake-pornography) . A survivor who finds an image or video of themselves on a covered platform can submit a request. The platform has 48 hours to remove the content and any identical copies. The FTC has the authority to enforce non-compliance.
...
## What does this new federal law leave unaddressed?


The Take It Down Act is a[reactive piece of legislation](https://www.realitydefender.com/insights/senate-passes-the-defiance-act) . It activates after the harm has already occurred. A deepfake of a survivor has to exist on a platform, then be found by the survivor or someone who tells them about it. From there, survivors can report it through the platform's removal process. Only then does the 48-hour clock start.
...
## Why does the burden fall on survivors?
...
[Advocates and survivors have been saying the same thing for years](https://www.realitydefender.com/insights/what-we-owe-to-victims-of-non-consensual-deepfakes) : the take-down regimen becomes a never-ending treadmill of trauma.


## What would upstream legislation require?


The technology to[detect synthetic intimate imagery at the time of upload](https://www.realitydefender.com/insights/how-deepfake-detection-works) exists today and is already in production.[Detection that verifies authenticity at the input level](https://www.realitydefender.com/insights/a-kitchen-sink-approach-to-deepfake-detection) turns the deepfake-NCII problem from a permanent treadmill into a closed door.
...
## What does the law going into effect mean?
...
The threat is here, not coming.[The technology to detect it is here](https://www.realitydefender.com/insights/reality-defender-launches-free-access-to-deepfake-detection-api) . Legislation simply needs to catch up.


## Four things to know about the Take It Down Act
