...
document_id: "425e25f62f15fd8a9ae72eec60e1ca49c67712347b192676bc636728ff3c5bd3"
company_key: "yc-flow-club"
company: "Flow Club"
source_id: "yc-flow-club-news-import-c01310733fef"
canonical_url: "https://www.flow.club/blog/adhd-time-blindness"
published_at: null
first_seen_at: "2026-07-21T20:31:26.955519+00:00"
fetched_at: "2026-07-28T21:20:58.380206+00:00"
content_hash: "sha256:476063b3dac92f0ddde1ad0f1fac49f3f3a3a0a98c909cabd2456343daca8978"
---

# Dealing with ADHD Time Blindness: 10 Tips to Make the Most of Your Time
...
Here are a few common[symptoms of time blindness](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8293837/) :
...
A[2019 research](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6556068/) suggests that people with ADHD struggle with time estimation and seem stuck in the present moment. Due to altered time perception, they may have a reduced ability to measure the duration of tasks and may struggle with punctuality.


[Gabor Maté,](https://www.amazon.com/Scattered-Attention-Deficit-Disorder-Originates/dp/0452279631) psychiatrist, researcher, and best-selling author of *Scattered: How Attention Deficit Disorder Originates and What You Can Do About It,* gave the theory that individuals with ADHD perceive time as constantly slipping by, causing distress that leads to inattention or hyperactivity and impulsive behaviors.


Moreover,[2017 research](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5487426/) showed that individuals with ADHD may experience dysfunction in the prefrontal cortex, which is linked to time perception and executive functions. According to[2021 research](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8293837/) , for people with ADHD, it might feel like time is moving faster than it actually is, which may lead to underestimating how much time is passing.
...
[Body doubling](https://www.flow.club/adhd-body-doubling) is a technique well-known in the ADHD community that involves working alongside another person to complete tasks. The other person is your ' *body double* ,' a term coined in 1996 by Linda Anderson, an ADHD coach.


There are various reasons why body doubling works for people with ADHD, including:


- **Increase in dopamine levels:** A[2019 study](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6486862/) showed that social interactions activate the brain's dopamine reward circuitry, increasing dopamine.
- **Imitating other people's behavior:**[Mirror neurons](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3510904/) are an integral part of the nervous system that allow individuals to respond to and imitate others behaviors **.** Just like you yawn when you see other people yawn, seeing other people focus on performing tasks makes you want to focus and accomplish your tasks.
...
- **Helps curb loneliness:** As[research](https://www.sciencedirect.com/science/article/abs/pii/S0891422217300033) suggests, loneliness is more prevalent in people with ADHD. Body doubling with one person or a group decreases the feeling of loneliness as you work alongside your community.


So, where can you find a body double?


Your body double can be anyone — friends, family, a stranger, or a group. You can also body double with an online community through platforms like[Flow Club](https://www.flow.club/coworking-for-adhd) .


I am working on this article in a Flow Club session hosted by[Samantha](https://in.flow.club/host/samjo) , and my productivity has definitely increased. The presence of the body doubles, in addition to the timer and my task list, helps me stay mindful of the passage of time and how I want to spend that time.


Try[Flow Club today for free](https://flow.club/coworking-for-adhd) and see if body doubling works for you!


### 2. Use a calendar to time-block


[Time blocking](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6406620/) is a method in which you divide your day into blocks of time, with each block designated for a specific task or set of tasks. Here's how you can do it:
...
Flow Club time blocking: set aside time and plan out the tasks for that time
...
Flow Club puts your tasks and time blocked to do them on your digital calendar
...
Sticky notes to keep tasks visible
...
[Dr Ari Tuckman](https://www.additudemag.com/slideshows/stop-wasting-time/) suggests breaking the final goal into small chunks and starting with the easiest one. He says, "Don't think of it as ‘I have to get ready for work,’ which might seem daunting. Think of it first as, ‘I have to brush my teeth,’ which is easy and accomplishable."


### 5. Try the Pomodoro Method


The[Pomodoro Technique](https://www.flow.club/pomodoro-technique-flow-club) uses a timer to break work into intervals, typically 25 minutes long, separated by short breaks. Here's how it works:
...
Flow Club amplifies the power of Pomodoro by combining it with body doubling. By joining[Flow Club Lounge](https://in.flow.club/lounge/) , you can use a Pomodoro Timer along with a to-do list and some asynchronous peer support as you check off tasks for a less intense version of body doubling.


‍


Flow Club Lounge is a social Pomodoro Timer that comes with body doubling
...
> 🖋️ **Pro-tip:** You can manage time more effectively by reviewing how you spend your time daily and adjusting your routine.
...
> 🖋️ **Pro-tip:** Use the extra time to take breaks and recharge. By embracing the concept of "less is more," you'll avoid feeling overwhelmed.
...
Using music playlists as timers can add a sense of rhythm and structure to your day while keeping you aware of time passing. I love the[Bridgerton Official Playlist](https://open.spotify.com/playlist/37i9dQZF1DX5Hl0iWtr5b3?si=b2bc119b82c647af) when I am deep cleaning or completing chores, and I swear by[Ed Callow's #Write 52 playlist](https://open.spotify.com/playlist/0gN55vz5Ml5WukXKkM7sNN?si=a98b332d50484ddc) while writing.
...
> 👀Check out this curated list of playlists guaranteed to help you focus:[Flow Club Playlist](https://www.flow.club/best-work-music)


### 9. Take breaks and practice self-care


According to[research](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6556068/) , time blindness in individuals with ADHD may beis due to dopamine deficiencies in our brains. This is why it's essential to prioritize your mental health and do tasks that bring you happiness.
...
As much as I find it hard to sleep, I love to sleep.[Research](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3630973/) shows that lack of sleep can worsen symptoms of time blindness and make it even harder to focus and manage time effectively. Here are some tips for prioritizing sleep:
...
Remember, you are not alone in this journey. There is a community of individuals who understand the unique challenges of ADHD time blindness, and one such community is Flow Club.[Try it out for free today](https://flow.club/coworking-for-adhd) !
