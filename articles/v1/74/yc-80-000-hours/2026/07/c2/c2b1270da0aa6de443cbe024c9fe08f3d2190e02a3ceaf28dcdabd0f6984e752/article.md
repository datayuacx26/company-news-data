...
document_id: "c2b1270da0aa6de443cbe024c9fe08f3d2190e02a3ceaf28dcdabd0f6984e752"
company_key: "yc-80-000-hours"
company: "80,000 Hours"
source_id: "yc-80-000-hours-rss-47a2c4d9a70a"
canonical_url: "https://80000hours.org/podcast/episodes/anton-leicht-middle-powers-agi-left-behind/"
published_at: "2026-07-14T17:40:14+00:00"
first_seen_at: "2026-07-20T23:19:51.476579+00:00"
fetched_at: "2026-07-28T20:41:19.924237+00:00"
content_hash: "sha256:131d29af38365745b88d14fd180eab7e04ff2e343c3876c540326d5da58061ab"
---

# Anton Leicht on how middle powers avoid losing everything in a post-AI world
...
- 2 Who’s Anton Leicht? \[00:00:43\]
- 3 Most countries face bleak AI futures \[00:01:06\]
- 4 How middle powers can strike AI deals \[00:06:10\]
- 5 The $500 billion AI moonshot \[00:12:17\]
- 6 Would the US crush allied AI? \[00:24:54\]
- 7 When to launch the AI moonshot \[00:31:57\]
- 8 Why AI dominance is forever \[00:35:45\]
- 9 Is AI dependence catastrophic? \[00:37:42\]
- 10 What’s left to sell in an AI-dominated world? \[00:42:45\]
- 11 Policies to avoid mass AI-layoffs \[00:47:47\]
- 12 Who really governs Anthropic? \[01:08:29\]
- 13 Why “pausing superintelligence” fails \[01:10:52\]
- 14 Is an American AI monopoly safe? \[01:21:08\]
- 15 Explaining AGI to the world \[01:28:40\]
- 16 Is Anton bullish or bearish on Germany? \[01:31:05\]
...
**Tom Reed:** Today I’m speaking with[Anton Leicht](https://www.antonleicht.me/) , who is a[fellow at the Carnegie Endowment for International Peace](https://carnegieendowment.org/people/anton-leicht) and[writer of the excellent policy blog Threading the Needle](https://writing.antonleicht.me/) .
...
**Tom Reed:** Are they striking these deals with the labs directly or through the US government? How do you envision this playing out? Is it[George Osborne](https://www.bbc.com/news/articles/cd6xz1jv4ezo) they’re calling up?
...
Like we’ve seen the UK–US[Technology Prosperity Deal](https://www.gov.uk/government/news/memorandum-of-understanding-between-the-government-of-the-united-states-of-america-and-the-government-of-the-united-kingdom-of-great-britain-and-north) that was in theory a model for some deepened tech cooperation that also included data centre buildouts as one pillar of the deal. That didn’t work very well, all things considered, because then last December the US brought food safety standards into the negotiations, and then OpenAI sort of reneged on the Stargate aspect of it, citing copyright and energy price reasons. And so that all didn’t really work out the way they would have hoped.
...
**Tom Reed:** But does that count for that much though? Because I feel like[Wired were reporting](https://www.wired.com/story/sk-telecom-anthropic-mythos-export-controls/) that the Fable export control was in part prompted by them giving Mythos access to SK Telecom, the South Korean company, which the admin alleged had ties to China or something. It just feels like, especially in the scenarios where things go crazy and where you most want access to the inference compute, the labs will be powerless if the US government decides that they should just pull the compute. How do you make sure that deal is not reneged on?
...
This is mostly insurance against the economic divergence specifically, because what you are worried about on the economic divergence is one market has access to abundant frontier AI and another market doesn’t have that. And I think for these cases, the security concerns are never all that high. Because if you are giving access to the entire US market, to all US firms that you aren’t really doing super intense[KYC](https://en.wikipedia.org/wiki/Know_your_customer) \[know your customer\] and very high defence-contractor-style security checks for, then it can’t be that bad. So that’s not the situation where things are going crazy. That’s not the thing that commercial access parity insulates against.


If we’re talking about[Glasswing-level access parity](https://www.anthropic.com/research/glasswing-initial-update) or even government access parity, I think for that, only the inference compute incentive doesn’t work out quite as much. I think for that you also need cooperation on security architectures. Which is to say, if I’m South Korea, for example, and I want to be included in something like Project Glasswing, then the firms that I propose my Project Glasswing is extended to have to pass some security standards that will probably be handed down from the US government. These security standards will be about cybersecurity architectures; they will also be about standard general security of the firms; and they will also be about China ties, inevitably. And I think that will have to be part of the cooperation.
...
**Anton Leicht:** I mean, what I expect is that this does not happen. And I think this is one of the reasons. I think there are smaller-scale versions of this where basically countries have been OK with making this kind of bet.[Airbus](https://en.wikipedia.org/wiki/Airbus) is one obvious example. I think framed and understood as, “This is just a critical strategic capability we need to have,” this would not be understood by countries as a money sink or not a money sink.
...
**Tom Reed:** People are still buying from[Mistral](https://en.wikipedia.org/wiki/Mistral_AI) .
...
**Tom Reed:** What policies do you think this nets out in right now for middle powers? If what you want is to own the robot factory, does that mean Germany should be banning Bezos’s new company[\[Prometheus\]](https://en.wikipedia.org/wiki/Prometheus_(company)) from buying out all new German manufacturing firms?
...
**Tom Reed:** What’s your preferred way to pay for these junior job subsidies or whatever else it is that you’re offering? I think you said[you prefer a corporation tax to something like a token tax](https://writing.antonleicht.me/p/betting-on-humans) ?
...
**Tom Reed:** To choose to stop people from releasing[MechaHitler](https://80000hours.org/videos/mechahitler/) .
