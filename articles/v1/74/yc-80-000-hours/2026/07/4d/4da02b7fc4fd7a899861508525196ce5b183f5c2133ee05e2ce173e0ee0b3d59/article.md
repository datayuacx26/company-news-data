...
document_id: "4da02b7fc4fd7a899861508525196ce5b183f5c2133ee05e2ce173e0ee0b3d59"
company_key: "yc-80-000-hours"
company: "80,000 Hours"
source_id: "yc-80-000-hours-rss-47a2c4d9a70a"
canonical_url: "https://80000hours.org/podcast/episodes/jasmine-sun-ai-anthropology/"
published_at: "2026-07-21T17:11:55+00:00"
first_seen_at: "2026-07-21T17:31:26.541953+00:00"
fetched_at: "2026-07-28T20:34:24.680558+00:00"
content_hash: "sha256:e6d31b65ed5eb54ae4ccf0cf69a9c47086cf4afa4d37e1329b4414d15f91d98b"
---
...
- 2 Who’s Jasmine Sun? \[00:00:30\]
- 3 Escaping the permanent underclass \[00:01:22\]
- 4 Jasmine’s “anthropology of disruption” \[00:14:02\]
- 5 Vice signalling in Silicon Valley \[00:18:46\]
- 6 AI populism will shape 2028 \[00:28:11\]
- 7 Does AI populism distract from safety? \[00:40:20\]
- 8 Americans don’t want Silicon Valley’s utopia \[00:44:06\]
- 9 Why the Chinese public embraces AI \[00:52:52\]
- 10 AI hype and the journalist’s dilemma \[00:59:04\]
- 11 There’s never been a better time to work in AI safety \[01:03:07\]
...
Now, if that sounds interesting to you,[Jasmine’s got a Substack](https://jasmi.news/) that I highly recommend checking out. She’s also a[guest contributor for The Atlantic](https://www.theatlantic.com/author/jasmine-sun/) . Jasmine, thank you so much for joining us.
...
**Zershaaneh Qureshi:** You wrote this[opinion piece recently for The New York Times](https://www.nytimes.com/2026/04/30/opinion/ai-labor-work-force-silicon-valley.html) , which opened with this really striking observation that most people you know in AI think that the median person is screwed.


Now, I’m assuming what you mean by that is — on the more moderate end of things — people are anticipating serious short-term disruption, things like job displacement and so on. But for some people, in some cases, people are talking about more extreme things like[existential-scale threats](https://80000hours.org/problem-profiles/artificial-intelligence/#4-a-rapid-ai-driven-transformation-would-raise-a-range-of-major-challenges-including-existential-risks) that affect all of humanity, and the idea of a permanent underclass.
...
On the economic front, it did become clear that there was this quiet consensus that, regardless of your future beliefs about whether there will be a[permanent underclass](https://jasmi.news/i/174127733/permanent-underclass) or more jobs than ever, the vast majority of people I know in the AI industry believe that in the near term, in the next few years, we are going to see mass job displacement. It’s going to be especially hard for a lot of young people, and a lot of current knowledge-work jobs are going to be disrupted and displaced completely.
...
The other thing that I noticed though, which is in some ways a little bit more disturbing to me or challenging for me, is a pretty broad sense of[techno-determinism](https://en.wikipedia.org/wiki/Technological_determinism) . I think a lot of people in the AI industry, and in tech more broadly, do think that[the path of technology](https://80000hours.org/podcast/episodes/allan-dafoe-unstoppable-technology-human-agency-agi/) is pre-set — that somebody is going to build AGI, somebody is going to build superintelligence.
...
**Jasmine Sun:** I think it’s fair. I think that when I report, I try to have an eye for some of the hyperbole. In the[permanent underclass piece](https://www.nytimes.com/2026/04/30/opinion/ai-labor-work-force-silicon-valley.html) , I try to make it pretty clear that in a lot of ways it is an edgy joke. Most people do not literally believe in a permanent underclass, even if they believe in[mass job displacement and increasing inequality](https://80000hours.org/podcast/episodes/rose-hadshar-ai-extreme-power-concentration/) , which I also think is somewhat concerning and worth talking about, even if it’s expressed in more extreme ways.
...
**Zershaaneh Qureshi:** If you’re trying to understand what the future of AI is going to look like and how AI is going to shape the future, the most natural thing — at least from my perspective — to do would be to focus directly on thinking about the technology itself, or maybe on surrounding[policy issues](https://80000hours.org/career-reviews/ai-policy-us-government/) .
...
**Jasmine Sun:** I think one example is just looking at the[history of the early internet](https://en.wikipedia.org/wiki/History_of_the_Internet) , which was not actually built — AI was primarily in these private megacorporations — but by a guy at[DARPA](https://en.wikipedia.org/wiki/DARPA) and a guy at Stanford working on these[TCP/IP protocols](https://en.wikipedia.org/wiki/Internet_protocol_suite) , building out[ARPANET](https://en.wikipedia.org/wiki/ARPANET) , building these versions of the internet where it was decided from the beginning that it should run on open protocols, that it should be this open ecosystem — that different networks between countries, between institutions, ought to be able to communicate with each other.


If you[read the interviews or the writing](https://blog.google/company-news/outreach-and-initiatives/public-policy/keep-internet-free-and-open/) of these folks like[Vint Cerf](https://en.wikipedia.org/wiki/Vint_Cerf) , they were very clear that they believed that the internet ought to be open. The whole point was this sort of interconnectedness that would transcend borders. And to this day, we are using the same internet based on these open architectures, right?


Similarly, I’ve been reading[Sebastian Mallaby’s biography of Demis and Google DeepMind](https://www.goodreads.com/en/book/show/241434373-the-infinity-machine) , and one of the things that I find so fascinating is how — in the early days of DeepMind, which is very arguably the first serious AGI lab — they could not get any funding at the beginning because no venture capitalist was willing to back a bunch of these weirdo scientists who insisted that you could build superintelligence in 2010 or whatever, who had no business plan, refused to commercialise, had no product, et cetera.


They were running out of money until[Luke Nosek](https://en.wikipedia.org/wiki/Luke_Nosek) from[Founders Fund](https://foundersfund.com/) — simply out of his personal belief that AGI ought to be possible, that the invention to end all inventions would just be in some ways the coolest thing ever — thought that it was worth a multimillion dollar bet, even while[Peter Thiel](https://en.wikipedia.org/wiki/Peter_Thiel) and many other venture capitalists were like, “You’re freaking crazy for even considering funding these guys without a business plan.”
...
But I think when you ask what is Silicon Valley’s political philosophy or what is its ideology in general, you can identify a bunch of little tribes: you can identify the[effective altruists](https://www.effectivealtruism.org/) here, and the progress studies people over there, and the[e/accs](https://en.wikipedia.org/wiki/Effective_accelerationism) \[effective accelerationists\] over here.
...
One thing that I’ve noticed rise over the past few years — even outside of AI, but in Silicon Valley broadly — is the[rise of vice signaling](https://jasmi.news/p/bait) : this idea that actually the edgy and cool thing to do is to build a startup like[Mechanize](https://www.mechanize.work/announcing-mechanize-inc/) , where the tagline is that, ‘We’re going to automate and replace all human labour,’ or to build something like[Cluely](https://cluely.com/) , where the tagline is, ‘Cheat on everything.’
...
The folks like[Marc Andreessen](https://en.wikipedia.org/wiki/Marc_Andreessen) and[David Sacks](https://en.wikipedia.org/wiki/David_Sacks) who are using the ‘doomer’ label most loosely, they are building this perception — on the American right in particular — that to be interested in AI safety is the same as being a ‘woke regulator’ who wants Facebook to censor all non-liberal content.


**Zershaaneh Qureshi:** I think what I’m interested in here is that at 80,000 Hours we see a lot of people who are very attracted to careers in the Bay Area at AI companies and the general AI ecosystem, specifically because they really genuinely want to[positively influence the trajectory of AI development](https://80000hours.org/ai/) .
...
**Jasmine Sun:** I think that folks who are working on[technical safety work](https://80000hours.org/career-reviews/ai-safety-technical-research/) , there are still[a lot of opportunities](https://jobs.80000hours.org/?jb_source=career-reviews__ai-safety-technical-research&refinementList%5Btags_area%5D%5B0%5D=AI%20safety%20%26%20policy) and a lot of support — both socially, financially, et cetera — professional ecosystems towards doing that kind of work.
...
One thing that I sometimes tell folks who are not in AI is what’s really notable is actually a lot of the researchers who have made the biggest breakthroughs in AI, people like Geoff Hinton, are some of the ones who are[raising the alarm the most on AI safety](https://www.nytimes.com/2023/05/01/technology/ai-google-chatbot-engineer-quits-hinton.html) being an important thing to work on. I think that affords working on technical safety quite a lot of status, at least within those technical research communities.
...
So it’s actually kind of low status in journalism to believe in these things. It’s low status in the policy community. I mean, Politico, I think last year or the year before was[running these stories](https://www.politico.com/news/2023/10/13/open-philanthropy-funding-ai-policy-00121362) , attempting to weed out and witch hunt anyone who has any connection to effective altruist fellowships within the AI policy community so that people would then go and discredit them.


I’ve had, again, senior media people tell me very similar things where they’re going after all the[Tarbell fellows](https://www.tarbellcenter.org/fellowship) and saying these people are just Anthropic shills, or these people are shills for some crazy Silicon Valley billionaires.


So especially because these are the roles that I already think are less supported — they are not as well remunerated as roles at the labs, you don’t have this social and professional ecosystem — I tend to worry more so about people who are in academia, in research and policy, and in[journalism](https://80000hours.org/career-reviews/journalism/) who take AI really seriously and whether they are supported to do their work.
...
You’ve spent a bunch of time with, I guess, a group of people that you would describe as[AI populists](https://jasmi.news/p/warning-shots) . Can you tell us more about who these people are, what their views and motivations are and so on?
...
I specifically really wanted to talk to folks who are not part of either the industry or the sort of classic AI safety community, but people who are actually coming from[other factions within American politics who have only recently begun engaging on AI](https://80000hours.org/podcast/episodes/sneha-revanur-ai-advocacy/) .


This includes maybe labour groups who are labour-union advocates, who are worried about the job stuff. This includes maybe social conservatives who are very concerned about AI replacing human relationships with AI companions and AI relationships. It might include environmentalists who are worried about data centres energy-use impacts, or states-rights advocates who are worried about things like[federal preemption](https://en.wikipedia.org/wiki/Federal_preemption) .
...
I think that when I see things like[data centre protests](https://www.datacenterwatch.org/report) or[booing at college graduations](https://www.npr.org/2026/05/20/nx-s1-5822419/ai-colleges-commencement-booing) or whatever, I don’t necessarily think that they’re the smartest levers to make AI safer or whatever, but I think that they are the only levers that people feel that they have access to.
...
And then the AI people will say, but it also might cure cancer. And they’ll say, “Where is the cancer cure?” I hear this all the time. The[AI CEOs keep talking about curing all diseases](https://www.cbsnews.com/news/artificial-intelligence-google-deepmind-ceo-demis-hassabis-60-minutes-transcript/) . Where are the cures to the diseases? At a certain point, you’re just not a credible actor anymore.
...
Recently there have been some[attacks on Sam Altman’s house](https://edition.cnn.com/2026/04/17/tech/anti-ai-attack-sam-altman) and also on the house of, I think, a[councilman who had just approved a data centre project](https://www.cbsnews.com/news/indianapolis-councilor-ron-gibson-home-shooting-data-centers-note/) . Obviously these things are extremely horrific.


I think what I want to know from you is what you think the natural trajectory is for these kinds of attitudes and behaviours. Are you anticipating that AI populism is going to start influencing political campaigns a lot more? Are you sort of envisioning that there’d be some kind of, I don’t know,[Luddite-style](https://en.wikipedia.org/wiki/Luddite) revolt in which rather than smashing looms, people are attacking data centres? How do you see this playing out?
...
For[Elizabeth Warren](https://time.com/article/2026/05/27/why-we-need-to-tax-ai/) it’s, “I want to tax the companies and we should do it because of AI.” Or for people who wanted to regulate how much kids had access to technology for social conservative reasons, they’re like, “We should do it because of AI.”


I’m already seeing some of the candidates who we expect to be running in 2028, whether it’s[Mark Kelly](https://www.kelly.senate.gov/newsroom/press-releases/support-rolls-in-for-kellys-ai-for-america/) or[Ro Khanna](https://www.thenation.com/article/society/ro-khanna-ai-democracy-blueprint/) on the Democratic side, maybe[Josh Hawley](https://www.axios.com/2026/01/30/josh-hawley-anti-ai-strategy) on the Republican side. They’re already announcing these big, bold AI action plans because they see AI as a new issue that Americans are extremely scared about, and that creates an opportunity for them to define their campaign.
...
Also you had just had this new social contract that FDR introduced to introduce[better working legislation](https://www.fdrlibrary.org/wagner-act) in general.
...
I think that means that when people are really pissed off, they start going for social media cancellation and[stochastic violence](https://en.wikipedia.org/wiki/Stochastic_terrorism) , and all these more diffuse forms of political backlash. I think I just have a view that public sentiment will find an outlet. And right now we’re just going to see quite a lot of it from very different directions, at least until people feel credibly reassured that they will have the downsides cap, that they will share in the growth that AI gives, et cetera.
...
But there are clearly some folks from[Future of Life](https://futureoflife.org/) , et cetera, who have actually really leaned into the idea that you can[build coalitions and build bridges with some of these AI populists](https://80000hours.org/podcast/episodes/sneha-revanur-ai-advocacy/) because they have existing networks, they have existing relationships with policymakers, they have bases who they can activate around the issue of AI — where a lot of people were probably never going to quite[grok](https://en.wikipedia.org/wiki/Grok) a lot of frontier safety issues, but maybe they could be brought on board through some of these other issues, like kids safety or the environment that they otherwise cared about.
...
Like you said, I think that the fact that the[AI water use issue](https://blog.andymasley.com/p/the-ai-water-issue-is-fake) is still as salient in conversations as it is — that it’s something that’s an extremely widespread belief among, say, college students — is pretty crazy because I think it would be a total misallocation of legislative energy for us to focus on legislating data centres’ water use.
...
I will say that it’s possible that the politics of the issue and the broad politics of the issue can coexist with more precise and technocratic policymaking at the legislative level. Especially now that[Mythos](https://80000hours.org/podcast/episodes/claude-mythos-hacking-alignment/) and the[Pentagon fiasco](https://fortune.com/2026/06/14/how-a-warning-from-amazon-led-the-white-house-to-shut-down-anthropics-mythos-model/) have sort of gotten a lot of the policy and expert community much more worried about the existential risk side of things.
...
A huge part of it is just that so much of the messaging coming out of the AI industry for the past five years has been focused on the risks. So even if we turn around now and say Sam Altman says, “Actually, I don’t want AI to replace you, I want AI to be a tool.” There are still videos and[on-the-record statements](https://blog.samaltman.com/machine-intelligence-part-1) from all of these executives about the risks that AI poses. So people see it as flip-flopping.
...
But I’m actually cautiously optimistic about things like the[OpenAI Foundation](https://openaifoundation.org/) : if they can be independent from the corporate side, and they are able to fund an incredible amount of public goods, community programs, research, et cetera,[maybe it’ll help](https://80000hours.org/podcast/episodes/tyler-whitmer-openai-saved-attorneys-general/) . I think they’re good people, they’re doing their best.
...
**Zershaaneh Qureshi:** I want to move on here because you’ve also spent a lot of time in China, where I think public attitudes towards AI at least seem on the surface to be very different to what they’re like in the US. You’ve got this situation where people’s[grandparents in nursing homes are just exuberant users of DeepSeek](https://en.people.cn/n3/2025/0324/c90000-20292932.html) .


Also when you have, I think, some[survey results](https://hai.stanford.edu/ai-index/2025-ai-index-report/public-opinion) , you can see that in China most people see more benefit than drawback to AI, which is a very different picture from in the US.
...
Second of all, with things like jobs, China already has a lot of white-collar unemployment. It’s already a very competitive job market. It’s sort of: “If I don’t use[OpenClaw](https://en.wikipedia.org/wiki/OpenClaw) , I’m going to fall off and somebody else who is using OpenClaw is going to take my spot.” So a lot of the attitudes around AI are just much more practical. There’s no choice economically and politically except to get on board with AI.
...
One example that slightly goes against the grain of what you’re saying is that I know there has been some backlash to technology in China. There was definitely some public scrutiny and reaction to, I believe,[delivery driver algorithms](https://carnegieendowment.org/posts/2022/11/how-food-delivery-workers-shaped-chinese-algorithm-regulations) some time ago. I know this is just one example.
...
At the same time, the China scholar Matt Sheehan, who’s been tracking some of the AI regulatory conversation in China really well,[he did note](https://mattsheehan.substack.com/p/china-is-getting-worried-about-ai) that he heard in his conversations with the Chinese policy community that the robo-taxi protests were part of what inspired Chinese policymakers to be more active on the labour legislation front in particular.


The other thing that I’ll say is that the Chinese government, while overall still being a promoter of AI and a promoter of technology very broadly, they are more willing to introduce lots of little pieces of[iterative legislation around the potential societal harms of AI](https://carnegieendowment.org/research/2024/02/tracing-the-roots-of-chinas-ai-regulations) .


There’s a[recent court case in Beijing](https://news.cgtn.com/news/2025-12-27/New-ruling-for-workers-Can-you-be-fired-if-a-job-is-replaced-by-AI--1JrgAsI2J8I/index.html) that ruled it wouldn’t count as just cause to fire a worker because of AI, or China has also[legislated companion chatbots quite aggressively](https://english.news.cn/20260715/4bf39cb3c4db42babc10ed37932cfd94/c.html) .


They obviously have a lot of speech regulations. When I was talking to my aunt who works at a state-owned enterprise in China, she mentioned like, “Yeah, I use[Doubao](https://en.wikipedia.org/wiki/Doubao) ,” which is their chatbot, “and it can probably do the job of two employees. But they’re not going to lay us off because there’s been a promise to at least the state-owned enterprise workers that we will not lay you off because of AI. That’s not a good enough reason.”
...
If there’s an issue that actually it looks like a lot of these entities agree on, for example, I feel like cyber risk and[biorisk](https://80000hours.org/podcast/episodes/richard-moulange-ai-bioweapons-biorisk/) are things that you can find a lot of people both inside and outside of the companies to say, “We’re all pretty worried about this, and this is a real serious thing that might happen.” Then it’s probably not hype, because a bunch of people who don’t have financial incentives to say so are saying it too.
...
That’s partly because, as I’ve started to engage a little bit more with the policy and the political conversation, it’s clear to me that the[Overton window](https://en.wikipedia.org/wiki/Overton_window) in, one, policy and, two, actually philanthropy, both seem to be expanding extremely quickly.
...
There’s things like the OpenAI Foundation, but also the traditional philanthropic actors, whether[Gates](https://www.gatesfoundation.org/) or[Rockefeller](https://www.rockefellerfoundation.org/) or whatever — all of them are starting to build out their own AI plans. There are billions of dollars in the next couple years that could go towards tackling AI-related issues. Once again, I think that there is more desire to spend the money than there actually are organisations and solutions to fund.
