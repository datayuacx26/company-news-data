...
document_id: "bb0287915c0437c14a5b1c917b62334114238d5b7abc2f5732751c01431765be"
company_key: "yc-80-000-hours"
company: "80,000 Hours"
source_id: "yc-80-000-hours-rss-47a2c4d9a70a"
canonical_url: "https://80000hours.org/podcast/episodes/sneha-revanur-ai-advocacy/"
published_at: "2026-07-08T17:13:57+00:00"
first_seen_at: "2026-07-20T23:19:51.476579+00:00"
fetched_at: "2026-07-28T21:08:44.176891+00:00"
content_hash: "sha256:8800cc82ee68e0abd291a6800cf22cc012aea01adc1ab52182847146daf58c9d"
---
...
- 2 Who’s Sneha Revanur? \[00:00:32\]
- 3 Sneha’s awakening to AI’s deeper risks \[00:01:16\]
- 4 “If you do everything, you will win” \[00:04:04\]
- 5 Influencing politics from the outside \[00:06:39\]
- 6 The challenge of grassroots \[00:11:16\]
- 7 Mums, musicians, and conservatives vs Big Tech \[00:14:21\]
- 8 How vetoed bills can still provide wins \[00:19:31\]
- 9 OpenAI’s subpoena, served at dinner \[00:27:33\]
- 10 How AI money plays in politics \[00:37:19\]
- 11 Balancing easy wins vs high-upside bets \[00:43:25\]
- 12 Advice for aspiring AI advocates \[00:48:03\]
...
**Zershaaneh Qureshi:** Today, I’m speaking with Sneha Revanur, who pretty remarkably founded a US nonprofit at the age of only 15. So this nonprofit,[Encode](https://encodeai.org/) , it’s focused on AI advocacy and has done a lot of exciting things, like helping to pass landmark AI-safety laws in California and New York, successfully fighting against federal preemption, and helping to criminalise the sharing of deepfake pornography.


Now, Sneha has been doing this for about six years now, so I’m just excited to get to talk to her about what she’s learned from trying to[influence AI policy from the outside through advocacy](https://80000hours.org/career-reviews/ai-safety-advocacy/) , and through lobbying. Sneha, thank you so much for joining us.
...
**Zershaaneh Qureshi:** A lot of people though who we come across who, like you, are anticipating that AI is going to get much more capable and pose these catastrophic risks — so things like[losing control over AI systems](https://80000hours.org/problem-profiles/risks-from-power-seeking-ai/) or[AI extremely concentrating power within society](https://80000hours.org/problem-profiles/extreme-power-concentration/) — a lot of the people who are worried about these things are particularly concerned about the prospect of shorter timelines. The thought here is that AI will advance rapidly enough that we might be in very serious trouble in just a few years.
...
I think Encode takes a lot of swings. Some of them were successful. Others we, like I mentioned, didn’t know would fail until we tried. For example, I was really proud to see the California and New York laws passed with the leadership of our determined sponsors —[Scott Wiener](https://sd11.senate.ca.gov/) ,[Alex Bores](https://time.com/collections/time100-ai-2025/7305812/alex-bores/) , and[Andrew Gounardes](https://www.nysenate.gov/senators/andrew-gounardes) .
...
And we’ve talked about these state laws that you’ve helped to pass in California and New York as two examples —[SB-53](https://leginfo.legislature.ca.gov/faces/billTextClient.xhtml?bill_id=202520260SB53) and the[RAISE Act](https://en.wikipedia.org/wiki/Responsible_AI_Safety_and_Education_Act) . I’m wondering whether you think you’d have been able to shape these bills more effectively if you’d been, say, working as a staffer for the legislators behind them?


**Sneha Revanur:** There are two things that I would say off the bat.


The first is that in California, there’s actually a pretty interesting feature of the way that state bills work, which is that organisations actually can be in the room when the details of a bill are being decided, in the form of acting as cosponsors. So when we cosponsored[SB-1047](https://leginfo.legislature.ca.gov/faces/billNavClient.xhtml?bill_id=202320240SB1047) and cosponsored SB-53, we were in the room for a lot of those negotiations.
...
So, for example, my colleague Nathan, who’s a lawyer — who’s our general counsel and also is a person who brings this fine-toothed comb to all the bills that we’re looking at — he’s someone who, as we all do, cares very deeply about the[First Amendment](https://constitution.congress.gov/constitution/amendment-1/) and thinks really hard about free speech. And so every single time we’re taking a look at a kid-safety bill that one of our partners wants us to support, Nathan will be there making sure that we are thinking very hard about how this trades off against free speech, and how we think about these goals that we obviously value equally. And so I think that having those limiting principles in place really, really helps when you’re weighing in on complex legislation.
...
After SB-1047 was vetoed,[Governor Newsom](https://www.gov.ca.gov/) convened a high-level commission of experts like[Fei-Fei Li](https://profiles.stanford.edu/fei-fei-li) and[Tino Cuéllar](https://en.wikipedia.org/wiki/Mariano-Florentino_Cu%C3%A9llar) that did great work and eventually put forward a report recommending transparency requirements and whistleblower protections, and those ended up being the core bones of SB-53.
...
But I also would make a few points to push back here. First of all, we were also cosponsors of SB-1047 and that bill passed the legislature. We did a lot of work wrangling labour unions and Hollywood actors and coordinating these diverse letters of support. And[Elon Musk even tweeted about the bill](https://x.com/elonmusk/status/1828205685386936567?lang=en) .
...
And I think that especially on the heels of[Mythos](https://80000hours.org/podcast/episodes/claude-mythos-hacking-alignment/) , a lot of people are especially concerned about the risks that might emerge from internal deployments and the lack of transparency around that by default. Especially because at this point, the most capable models that exist aren’t available to the public and aren’t externally deployed.
...
**Sneha Revanur:** Yeah, I mean, the fact that California didn’t pass third party audits clearly didn’t stop[Illinois from just passing third-party audits](https://www.ilga.gov/Legislation/BillStatus?GAID=18&DocNum=315&DocTypeID=SB&LegId=157797&SessionID=114) yesterday, right?
...
The context on this is: last year, early 2025, Encode filed an[amicus brief](https://en.wikipedia.org/wiki/Amicus_curiae) in the[Musk vs Altman lawsuit](https://en.wikipedia.org/wiki/Musk_v._Altman) surrounding the restructuring of OpenAI into a for-profit. We were among a chorus of voices that had a bunch of concerns about this, and weren’t certain that this would lead to the optimal outcome in terms of board governance or allocation to the OpenAI Foundation, and kind of just felt[very contrary to the founding charter of OpenAI](https://80000hours.org/podcast/episodes/tyler-whitmer-openai-saved-attorneys-general/) .
...
I mean, overall, the biggest takeaway from the entire experience was like, damn, I guess we’re kind of playing in the big leagues. You know, for the first time we had all this attention on us:[Nathan Calvin’s thread went viral on Twitter](https://x.com/_NathanCalvin/status/1976649051396620514) , got 6 million views, and prompted Jason Kwon — who is a chief strategy officer and a very senior executive at OpenAI — to publish a[thread detailing OpenAI’s response](https://x.com/jasonkwon/status/1976762546041634878) to this.
...
**Zershaaneh Qureshi:** I mean, in the end, it did seem to me that you’d been pretty intimidated and shaken by this.[You put out this statement on Twitter](https://x.com/SnehaRevanur/status/1977747169181667498) , where it kind of looked like you were letting them off the hook a little bit. You said things like, “it was reasonable for OpenAI to have concerns about collusion.” You said, “OpenAI wants to be a force for good,” that its success “is critical to American dominance,” that it’s “criticized disproportionately.”
...
**Zershaaneh Qureshi:** Now, I believe that AI regulation is now one of the most heavily funded single issues in American politics. You’ve got the super PAC Leading the Future, which is pretty anti-regulation and it’s raised $125 million for the midterms this year. It’s the biggest spender in this year’s midterms, I believe. You’ve also got the emergence of a[counter PAC that’s backed by Anthropic](https://en.wikipedia.org/wiki/Public_First_Action) . I’m interested in how this influx in cash and attention actually shapes your attention agenda?
...
One thing I’m also thinking quite a bit about is[power-concentration risk](https://80000hours.org/problem-profiles/extreme-power-concentration/) : what will it mean to empower this person with superintelligence, potentially? And who would we trust to hold the keys in that moment?


One thing I’m really concerned about is it’s very likely, based on what we’re seeing so far, that the[executive branch](https://en.wikipedia.org/wiki/Federal_government_of_the_United_States#Executive_branch) is going to be the first to wake up to just how powerful AI is, and is really going to leave the[judicial branch](https://en.wikipedia.org/wiki/Federal_government_of_the_United_States#Judicial_branch) and the[legislative branch](https://en.wikipedia.org/wiki/Federal_government_of_the_United_States#Legislative_branch) in the dark, which will just really mess up the balance of power. I think there’s already been some concern about this, and I think this will potentially get substantially worse once we actually have much more powerful models and much more national-security-relevant models.
