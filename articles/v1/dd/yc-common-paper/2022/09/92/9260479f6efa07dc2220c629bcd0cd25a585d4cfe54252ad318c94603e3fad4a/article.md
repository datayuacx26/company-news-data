...
document_id: "9260479f6efa07dc2220c629bcd0cd25a585d4cfe54252ad318c94603e3fad4a"
company_key: "yc-common-paper"
company: "Common Paper"
source_id: "yc-common-paper-rss-3b76f5ee637c"
canonical_url: "https://commonpaper.com/blog/design-partner/"
published_at: "2022-09-08T18:22:03+00:00"
first_seen_at: "2026-07-20T23:20:15.555416+00:00"
fetched_at: "2026-07-28T21:03:09.867162+00:00"
content_hash: "sha256:b750c2296b65c3a3cc52c8c662486530943e2756832d52ffebbd4a770334c035"
---

# How To Work With Design Partners

TLDR: We interviewed more than a dozen founders, VC’s, and early stage sales experts to help founders learn how to build a design partner program that grounds relationships with their first users and customers on solid footing.


In the earliest days of a startup, you don’t have much. Customer development helps you to validate the problem you’re solving and understand what has been tried in the past. You have a limited runway and you need to build something that people want as quickly as possible.
...
The better approach is to work with **design partners.** There’s a lot of talk in startup circles about this concept, but what does a design partnership actually entail? And how do you actually structure the relationship? Should you charge them? What about signing a[Design Partner Agreement](https://commonpaper.com/standards/design-partner-agreement/) or a[Letter of Intent](https://commonpaper.com/documents/letter-of-intent) ? We cover all of this and more below.


In addition to the[committee of 30+ attorneys](https://commonpaper.com/committee/) that creates all of our agreements, for the Design Partner Agreement we also sought out feedback from early-stage investors, founders, and operators. Special thanks to Adam Nelson at[First Mark](https://firstmarkcap.com/) , Alex Bard and Patrick Chase at[Redpoint](https://redpoint.com/) , Andy McLoughlin at[Uncork](https://uncorkcapital.com/) , Ed Sim at[Boldstart](https://boldstart.vc/) , Ethan Schechter at[Snyk](https://snyk.io/) , Justin Dignelli and Peter Zawistowicz at[Pace](https://www.paceapp.com/) , Liam Mulcahy at[Kleiner Perkins](https://www.kleinerperkins.com/) , Mark Munro at[First Round](https://firstround.com/) , Martin Gontovnikas at[Hypergrowth Partners](https://www.hypergrowthpartners.com/) , and Shanea Leven at[Codesee](https://www.codesee.io/) .


## What is a design partner?


Design partners are early believers in your vision. They have an urgent problem to solve, and they are willing to take a risk on your startup, which does not yet have product market fit. In exchange for their early buy-in, you go above and beyond a normal vendor-customer relationship. That might include:


- Build the product around the design partner’s needs
- Provide extra services
- Better terms and/or free access


You get frequent, invaluable feedback and the design partner gets a highly discounted product that (hopefully) solves their specific problem in a new or novel way.
...
Pilots (or trials, proofs of concept, etc.) are when a customer tries out an already-built product for a limited time period. Expectations are usually clear – if the product solves their problem, the end of the pilot results in a longer-term deal. Feedback from customers on pilots is helpful, but it’s not the main goal. Rather, the purpose of the pilot is to see if the product, as it exists today, solves the customer’s problem.


Beta features are new, often unpolished additions to, or versions of, an existing product. You expect beta users to report bugs and give feedback, but these people are typically already using your more fully-baked product. The beta is scoped to specific feature additions or improvements.


Design partnerships are about answering fundamental questions of product-market fit. They are high-touch and in-depth. Most startups start with five or fewer design partners, a number that allows you as a founder to own and cultivate these high-value relationships. So who are they?
...
The Common Paper[Design Partner Agreement](https://commonpaper.com/standards/design-partner-agreement/) helps you navigate this conversation by providing a simple structure for your and your design partner’s commitments: feedback sessions, private/public references, roadmap influence, discounts, services, and more.


This contract also allows either party to terminate the agreement at any time, for any reason. So much is uncertain at the earliest stage of a startup, and it would be unrealistic to try to lock in either side to a long-term relationship. This is one of many differences between contracts at the design partner stage versus what you would use when selling a production-ready application, like the[Cloud Service Agreement](https://commonpaper.com/standards/cloud-service-agreement/) . It’s also why the Design Partner Agreement is much shorter.


[Generate Your Free Design Partner Agreement](https://app.commonpaper.com/auth/auth0?screen_hint=signup)
...
Working this expectation into your design partnerships becomes easier in a contract like the standard Design Partner Agreement, which is set up to handle the expectation of future discounts. Laying out financial expectations on both sides of the partnership makes it easier for your partner to say “yes” and more likely that you’ll convert them into a paying customer once the partnership ends.


If you’re building a company and ready to start working closely with your first few early believers, the[Design Partner Agreement](https://commonpaper.com/standards/design-partner-agreement/) has everything you need. You can download it for free or use[Common Paper](https://commonpaper.com/) to build, send, and sign your contract in a single workflow, in minutes.
