...
document_id: "3768926e63a03a70380b7659484da289582687e6f2486daae4bfa36d831466ba"
company_key: "klaviyo-inc-series-a-common-stock"
company: "Klaviyo Inc."
source_id: "klaviyo-inc-series-a-common-stock-news-import-8aaa3dad80da"
canonical_url: "https://www.klaviyo.com/blog/ai-shopping-agent-strategy"
published_at: "2026-08-10T13:36:26.127+00:00"
first_seen_at: "2026-08-10T17:33:48.617594+00:00"
fetched_at: "2026-08-10T17:33:49.869009+00:00"
content_hash: "sha256:8af69038e36bf91cb63a3a968c75b8bc2a81354229e492edaecd3445f201d604"
---

# AI Shopping Agents are Changing How Brands Sell - Klaviyo
...
It’s a fair question. Accenture's 2026[Talk to My AI Agent Report](https://www.accenture.com/us-en/insights/consulting/talk-my-ai-agent) found that 71% of consumers expect generative AI to influence at least half of their spending decisions over the next 12 months.


And according to Klaviyo's 2026[AI Consumer Trends Report](https://www.klaviyo.com/marketing-resources/ai-consumer-trends) , 60% of consumers interact with AI at least weekly, and 39% have purchased a product from an AI recommendation.
...
[K:AI Customer Agent](https://www.klaviyo.com/solutions/ai/customer-agent) , for example, generates answers based on each customer’s browsing behavior, purchase history, and stated preferences. Customers can also start a conversation on your website and continue it on another channel, such as email, text messaging, or WhatsApp.


The data flows both ways, too. Whenever customers ask product questions or provide details like their favorite color or fabric, the AI agent can feed that information back into their[customer profile](https://www.klaviyo.com/features/customer-profiles) and use it later to personalize future interactions.


Now that apparel brand[Naked Wardrobe](https://nakedwardrobe.com/) has added an AI customer agent to their website, shoppers can type queries like, "I’m looking for a dress for a party," and the AI agent can recommend pieces from the catalog, the same way ChatGPT might.


Over 90 days, the brand’s AI agent autonomously resolved[86% of customer queries](https://www.klaviyo.com/customers/case-studies/naked-wardrobe) and 94% of product recommendation requests.
...
According to Klaviyo’s 2025[Future of Consumer Marketing Report](https://www.klaviyo.com/marketing-resources/future-of-consumer-marketing) , 74% of consumers expect personalized experiences from brands. When I work with enterprise brands in particular, two personalization goals come up again and again: increasing retention and improving first-to-second purchase rates.


Delivering that at scale takes[unified customer data](https://www.klaviyo.com/solutions/customer-data-platform) , real-time orchestration across channels, and predictive analytics. Here’s what that looks like in practice:


### Personalize send time for each subscriber


Rather than sending a campaign to everyone at 8 a.m.,[personalized send time](https://www.klaviyo.com/blog/personalized-send-time-optimization) uses AI to deliver campaign messages when each subscriber is most likely to engage.
...
Shoe brand[Marc Fisher Footwear](https://marcfisherfootwear.com/) is a good example. Running 6 brands on Klaviyo, they used AI-powered channel affinity to send one message on the channel where each subscriber is most likely to engage, cutting duplicate sends across email and SMS. This strategy is part of a program that delivered[46% YoY growth in SMS revenue](https://www.klaviyo.com/customers/case-studies/marc-fisher-footwear) across their portfolio in H2 2025.


### Predict when and what customers will order next


[Predictive analytics](https://www.klaviyo.com/solutions/ai/what-are-predictive-analytics) can help you act on behavior before it happens.
...
Before a campaign goes out,[audience optimization](https://help.klaviyo.com/hc/en-us/articles/48320692341019) removes profiles it predicts are unlikely to engage and likely to unsubscribe or churn. Think of it as a lookalike model pointed inward, at your own database, protecting your deliverability.
...
This level of personalization should continue on your site.[Klaviyo Customer Hub](https://www.klaviyo.com/products/customer-experience-hub) can recognize shoppers via tracking tokens, whether they’re logged in or not.
...
In a single quarter, Customer Hub drove more than[$120,000 in revenue](https://www.klaviyo.com/customers/case-studies/harney-and-sons-klaviyo-service) for fine tea brand[Harney & Sons](https://www.harney.com/) , and 12% higher average order value from Customer Hub users than from shoppers overall.
...
[Klaviyo Composer](https://www.klaviyo.com/composer) plans and builds campaigns from a plain-language prompt. It drafts the audience, copy, and timing, and it learns your brand voice so the output sounds like you.
...
Teams also need less distance between a question and an answer.[Klaviyo's Model Context Protocol (MCP) server](https://developers.klaviyo.com/en/docs/klaviyo_mcp_server) connects approved AI tools like ChatGPT and Claude directly to your Klaviyo data, so you can ask for performance insights in plain language instead of exporting reports or clicking through dashboards.
...
[Klaviyo B2C CRM](https://www.klaviyo.com/platform) brings your customer data, marketing, service, analytics, and AI onto one platform, so you can:


- **Answer questions and recommend products in real time.**[K:AI Customer Agent](https://www.klaviyo.com/solutions/ai/customer-agent) resolves questions and suggests products across web chat, email, text messages, and WhatsApp.
- **Personalize every send.** Personalized send time, channel affinity, predictive analytics, and other[AI personalization features](https://www.klaviyo.com/solutions/ai) empower you to tailor timing, channel, and content for each customer.
- **Build campaigns by describing them.**[Klaviyo Composer](https://www.klaviyo.com/composer) plans and drafts campaigns from a brief, with human review at every step.
