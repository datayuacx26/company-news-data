...
document_id: "db439dc4efd286b198a56f4fec8c81355797ced66ba42441ec315f91ed8efe18"
company_key: "yc-protocol-labs"
company: "Protocol Labs"
source_id: "yc-protocol-labs-rss-95d08b63fd6d"
canonical_url: "https://pl.xyz/blog/transcription-pl-vision-driving-a-breakthroughs-in-computing-to-push-humanity-forward/"
...
content_hash: "sha256:8b0e40cad9a5e9128db2392c6ff8a7210ab34e3aecc7d2d66f4b1eebca780975"
---
...
In[a thought provoking talk (opens new window)](https://www.youtube.com/watch?v=sHvdBRj3kxE&t=912s&ab_channel=ProtocolLabs) given at LabWeek23 in Istanbul, Juan Benet, founder of Protocol Labs, describes his vision for the future of the innovation network and for pioneering tech, in the context of the three pillars. We’ve transcribed Juan’s remarks below, with light edits for clarity.


## # The Vision: Protocol Labs[01:10 (opens new window)](https://www.youtube.com/watch?v=sHvdBRj3kxE&t=70s)
...
## # Technological Advancements and Challenges[2:45 (opens new window)](https://youtu.be/sHvdBRj3kxE?t=165)
...
## # Digital Human Rights: Improving the Internet for All[7:02 (opens new window)](https://youtu.be/sHvdBRj3kxE?t=422)
...
## # Rectifying Inadequacies in Economies and Governance for a Better Future[11:28 (opens new window)](https://youtu.be/sHvdBRj3kxE?t=693)
...
## # Public Goods Funding: A New Financing Mechanism[14:49 (opens new window)](https://youtu.be/sHvdBRj3kxE?t=889)


Within the crypto community, there is a sub-movement actively experimenting with mechanism design, focusing on prototyping and scaling these mechanisms. Conferences like[Funding the Commons (opens new window)](http://fundingthecommons.io/) and[Shelling Point (opens new window)](https://schellingpoint.gitcoin.co/) are hotbeds for this work, with active participation from the PL, Ethereum, and Filecoin communities. The exciting phase now involves experimenting with a myriad of mechanisms that have evolved into composable primitives, ready to be integrated into various projects and initiatives across the network.
...
## # Building Advanced Technologies: AI, AR, AGI, BCI & Much More[15:27 (opens new window)](https://youtu.be/sHvdBRj3kxE?t=920)
...
## # Collaboration is Key to Shape Our Future[17:02 (opens new window)](https://youtu.be/sHvdBRj3kxE?t=1068)
