...
#### 1. Get more visibility and go further


Way back as far as 2018, a KPMG[survey](https://assets.kpmg/content/dam/kpmg/uk/pdf/2018/11/is-open-banking-open-for-business.pdf) found that over 40% of early adopters would gladly pay for a dashboard of all a business’ financial accounts; or for software that managed regular payments. 32% would pay for rapid loan application processes. Today, the day-to-day financial management applications built on open banking are hugely diverse, new ideas are proliferating, and industry’s trust of open banking is improving all the time (not least because we are increasingly happy with open banking services in our personal lives). A[report](https://www.pwc.co.uk/financial-services/assets/open-banking-report-web-interactive.pdf) produced by PwC and the Open Data Institute points to several typical key areas in which CFOs could leverage open banking to improve their businesses:
...
financial information all in one place for a better view of the business
...
automating previously manual tasks for fewer errors and less wasted time
...
insightful trends for better financial management
...
But perhaps most importantly, open banking can smooth the way for both one-off and first-time payments– essential as many businesses have developed their online sales capacity in order to survive the pandemic (Digital Commerce 360[reports](https://www.digitalcommerce360.com/2021/02/15/ecommerce-during-coronavirus-pandemic-in-charts) that “consumers spent $861.12 billion online with U.S. retailers in 2020, up 44.0% from $598.02 billion in 2019.”) GoCardless, for example, has just launched its[Instant Bank Pay](https://gocardless.com/en-us/solutions/instant-bank-pay) functionality (live in the UK and c to drive low-cost one-off payments.


Open banking can help ensure that a customer has funds in their account - and make contact for remedial action rather than dropping the transaction. It can therefore reduce the number of void transactions and customer churn; and add predictability to subscription or repeat order operations – all wrapped in a seamless customer experience. As Arjun Kakkar, VP Strategy and Operations at ID/verification specialists,[Ekata](https://www.pymnts.com/news/digital-banking/2020/open-road-for-open-banking) told PYMNTS, “Merchants can offer checkout options way beyond our imagination that could optimize customer value creation.”


And you can also save on transaction costs with open banking as these new payment methods easily rival card payments. As a bank-to-bank payment, open banking transactions are faster, more flexible and avoid the expensive transaction fees associated with credit cards. For example, an analysis of UK transactions by The[Fintech Times](https://thefintechtimes.com/how-open-banking-could-cut-uks-575m-card-network-fee-bill) took typical purchases via Amazon, eBay and Shopify, and calculated that moving credit card transactions to open banking transactions would cut transaction fees by 92% and save over £80M.
...
GoCardless’ own Duncan Barrigan sees open banking growing with usage and time. “Over time, we see open banking payments mounting a very credible challenge to the dominance of cards, once consumers and businesses alike experience the advantages.” London’s Financial Times[writes](https://www.ft.com/paidpost/LBS/how_fintech_is_revolutionizing_the_traditional_cfo_role/index.html) , “The CFO role has to be a lot more strategic, especially because of the need to make fast decisions in the modern market.”. Open banking offers a new source of valuable data to support those rapid decisions and changes needed to keep pace.
