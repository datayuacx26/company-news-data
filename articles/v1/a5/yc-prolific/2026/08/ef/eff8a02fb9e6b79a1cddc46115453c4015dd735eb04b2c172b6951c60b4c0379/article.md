...
document_id: "eff8a02fb9e6b79a1cddc46115453c4015dd735eb04b2c172b6951c60b4c0379"
company_key: "yc-prolific"
company: "Prolific"
source_id: "yc-prolific-news-import-3a1392a67315"
canonical_url: "https://www.prolific.com/resources/what-s-new-run-multi-modal-evaluations-end-to-end-smart-participant-filtering-and-more"
published_at: null
first_seen_at: "2026-08-11T00:25:59.632542+00:00"
fetched_at: "2026-08-11T00:26:00.293676+00:00"
content_hash: "sha256:7b43d84f28b830e8e5af4ad9fe7426ed409fcdae1d7b56e45dd5c1cfd2b80a70"
---
...
Video is now live in[AI Task Builder](https://www.prolific.com/ai-task-builder) , which means you can handles the full range of multimodal evaluations end to end with Prolific. Recruit verified participants and run your text, image, audio or video study in a single workflow.


- **Every media type, one task.**


Present any combination of text, image, audio and video in a single item. Video renders as a native player (play, pause, seek), right alongside your evaluation questions.


- **Side-by-side comparisons for preference evals.**


Use the configurable two-column layout to put Video / Image A next to Video / Image B for pairwise evals, or RLHF-style preference judgements. Ask questions against each item as participants compare, then collapse into summary questions about the pair (which is better overall, how confident and why). Available in the API and CLI first, coming soon to the UI!


- **Streamlined flow.**


Split a task into distinct pages so you can build a clear flow for participants, complete with an outro once the task is done. Drop images into your task guidance too: screenshots, scoring rubrics, anything that helps participants understand exactly what to do. Higher participant comprehension means higher quality data.


- **Real responses at API speed.**


Describe your evaluation and our API handles the rest for you: targeted recruitment from 300,000+ verified participants, study execution and delivery, with a median time to first response of just 4 minutes. Build it into your pipeline via the API or CLI, so no need to tool switch.


**Get started**


All live now, you can build multimodal studies directly in the[UI](https://app.prolific.com/) , or via the[API](https://docs.prolific.com/api-reference/ai-task-builder/defining-a-dataset-schema) and[CLI](https://github.com/prolific-oss/cli) to drop them straight into your pipeline.


Not sure where to start?[Talk to our team](https://www.prolific.com/) and we'll set your first multimodal study up with you.
...
Explore[in platform](https://app.prolific.com/) or via the[API](https://docs.prolific.com/api-reference/filters/advanced-filtering) .
...
Take a look in the[UI](https://app.prolific.com/) and the[API](https://docs.prolific.com/api-reference/filters/advanced-filtering) .
...
Use our[Audience Finder](https://www.prolific.com/audience-finder) to check your audience, or find specialists in-app under Participants > Add screeners >[Domain Experts](https://researcher-help.prolific.com/en/articles/445228-domain-experts) .


To find them under the API, take a look[here](https://docs.prolific.com/documentation/core-concepts/finding-the-right-participants#find-specialist-and-domain-experts) .


## Watch: The latest episodes in the Frontier Series


In our[Frontier Series](https://www.youtube.com/playlist?list=PLFc0vY4YexlCh_tkVk9eWXJNJm4l7zd_R) , we interview frontline AI researchers who build the systems, run the studies and explore the questions that don't yet have clean answers.
...
Prolific's[Nora Petrova](https://www.linkedin.com/in/nora-petrova/) and[John Burden](https://www.linkedin.com/in/john-burden-10966b358/) sit down with Henry Conklin (Princeton/Cohere) and Tom Hosking (Cohere), to unpack[their paper on treating LLM training as a form of lossy compression](https://arxiv.org/abs/2604.07569) . They dig into the two-phase pattern they observed across model sizes during training, and why smaller models may fundamentally struggle to compress enough to generalise well.


[Watch Episode 4](https://www.youtube.com/watch?v=J2qL-hqT1v4&list=PLFc0vY4YexlCh_tkVk9eWXJNJm4l7zd_R&index=3)
...
[Watch Episode 5](https://www.youtube.com/watch?v=jS2e0_SNkCo&list=PLFc0vY4YexlCh_tkVk9eWXJNJm4l7zd_R&index=2)
