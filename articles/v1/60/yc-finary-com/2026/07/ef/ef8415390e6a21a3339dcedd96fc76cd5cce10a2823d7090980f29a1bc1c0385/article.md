...
document_id: "ef8415390e6a21a3339dcedd96fc76cd5cce10a2823d7090980f29a1bc1c0385"
company_key: "yc-finary-com"
company: "Finary.com"
source_id: "yc-finary-com-news-import-ac1e84866483"
canonical_url: "https://finary.com/en/blog/bourse/etf/gold-etf"
published_at: "2026-07-31T00:00:00+00:00"
first_seen_at: "2026-08-06T23:16:09.483477+00:00"
fetched_at: "2026-08-06T23:16:11.376844+00:00"
content_hash: "sha256:35f2fe0543e56ef645d7730e22d6e1b2ba1fc24506fc19ebc353f6d50684dd3c"
---
...
- The four largest physical gold ETCs listed in Europe charge management fees of 0.12% to 0.15% a year.
- Because gold is not a European share, a gold ETC cannot be held in a PEA (Plan d'Épargne en Actions, France's equity savings plan).
- A physically replicated ETC is backed by gold allocated in a vault; a synthetic ETC exposes you to the issuer's counterparty risk.
- On resale, the gain on a gold ETC is subject to the flat tax of 31.4% in 2026, unless you opt for the progressive income tax scale.
- Physical gold falls under a separate regime: a flat levy of 11.5% of the sale price, with no exemption threshold.
...
An[ETF](https://finary.com/fr/blog/bourse/etf/etf-tout-savoir) (Exchange Traded Fund) is an index fund tied to a listed asset, designed to replicate a benchmark index. It therefore lets you invest in all the companies that make up that index in a single order, for example every company in the CAC 40 for a[CAC 40 ETF](https://finary.com/fr/blog/bourse/etf/cac-40) .


A gold ETF is not really an ETF but an ETC (Exchange Traded Commodity). That means its purpose is to track the price of commodities listed on the market. A gold ETF therefore aims to replicate the price of physical gold as faithfully as possible. The same is true of a[commodities ETF](https://finary.com/fr/blog/bourse/etf/etf-matiere-premiere) .


The main advantage of a gold tracker lies in its passive, and therefore inexpensive, management. Management fees on gold ETCs listed in Europe range from 0% to 0.99% a year, and the four largest by assets sit between 0.12% and 0.15% ([justETF, as at 30 July 2026](https://www.justetf.com/fr/how-to/gold-etfs.html) ).


Good to know


: Pay attention to how your gold ETF replicates its underlying. The aim here is not to lose money, so read up on the difference between synthetic and physical replication. **Physically replicated** ETCs hold a stock of physical gold as collateral.
...
In theory, when you buy a tracker, **you own the ETF, which in turn owns the underlying** , whether that is[shares](https://finary.com/fr/blog/bourse/actions/comment-acheter-des-actions) or bonds. Indirectly, you therefore own a "piece" of every company invested in. A gold ETF does not work that way.
...
: While a gold ETF looks like a simple, fast way to invest in gold, **how it works is more complex than it appears** . To gauge the risk level of a gold ETF, you can look at **the actual stock held by the fund** . That stock is what serves as collateral for investors, and it is also referred to as **"Gold Backed".**
...
Physical gold ETC ISIN Assets Storage Currency Fees (TER)


iShares Physical Gold IE00B4ND3602 ~€29.4 billion London EUR, USD, GBP 0.12%


Invesco Physical Gold IE00B579F325 ~€22.6 billion London EUR, USD, GBP, CHF 0.12%


Xetra-Gold DE000A0S9GB0 ~€19.5 billion Frankfurt EUR 0% management fees, 0.36% custody fees charged separately


Amundi Physical Gold ETC FR0013416716 ~€9.4 billion London EUR, USD, GBP 0.12%


WisdomTree Physical Swiss Gold JE00B588CD74 ~€4.2 billion Zurich EUR, USD, GBP 0.15%


Indicative data as at 30 July 2026 (source:[justETF, comparison of gold ETCs listed in Europe](https://www.justetf.com/fr/how-to/gold-etfs.html) ). Assets vary daily with the gold price.


Good to know


: Pay attention to **what gold ETFs actually hold** . Some trackers labelled "Or" or "Gold" **in fact track the share prices of gold miners** and other companies that derive their revenue from gold and its derivatives, and some are precious metals ETFs.
...
So, paper gold or physical gold? It all depends on **your objective** . Depending on your[wealth management](https://finary.com/fr/blog/epargne/ou-placer/comment-investir/guide-de-la-gestion-de-patrimoine) strategy, each has its advantages. The important thing to keep in mind is that **a gold ETF is very much a stock market investment product** , not a product for protecting your wealth. To separate these two ways of buying, let us look at three things: **fees, storage and the security of your investment** .
...
A gold ETF has one major advantage: **its low management fees** . At the four largest physical gold ETCs listed in Europe, they run between 0.12% and 0.15% a year ([justETF, as at 30 July 2026](https://www.justetf.com/fr/how-to/gold-etfs.html) ). That may appeal to a passive investor looking to keep costs down.
...
[Invest from €300](https://qxtk.adj.st/invest?adj_t=qhb6ybm&adj_campaign=websitefinarylife&adj_fallback=https%3A%2F%2Fapp.finary.com%2Fv2%2Finvest%2Flife-insurance%2Fmy-project&adj_redirect_macos=https%3A%2F%2Fapp.finary.com%2Fv2%2Finvest%2Flife-insurance%2Fmy-project&adj_deeplink_js=1)


Non-contractual document for promotional purposes. **Investment in unit-linked vehicles carries a risk of capital loss, since their value is subject to fluctuation, both upwards and downwards, depending in particular on developments in the financial markets. The insurer guarantees the number of unit-linked vehicles and not their value, which it does not guarantee.** The e-vie life insurance policy is an individual life insurance policy, denominated in euros and/or unit-linked vehicles, underwritten by Generali Vie, a company governed by the French Insurance Code. Finary SAS, 58 rue de Monceau 75380 Paris 8, an investment firm authorised by the ACPR under no. 19283, member of AMAFI. Insurance broker registered with ORIAS under no. 21001279, member of the CNCGP (association approved by the AMF). Crypto-Asset Service Provider (CASP) authorised by the AMF under the MiCA regime, references no. A2026-026 and no. N2026-008.
...
: Gold ETFs are an interesting stock market product, but **they do not allow you to protect your wealth** . An allocation to gold should be considered in light of your personal situation; an authorised adviser can help you. Physical gold and paper gold answer different logics when it comes to ownership and liquidity. Some investors are also interested in[bitcoin](https://finary.com/fr/blog/crypto/investir/bitcoin) . Crypto-assets are highly volatile and speculative assets carrying a risk of total capital loss (MiCA framework).


## How is a gold ETF taxed?


Taxation depends on the wrapper. A gold ETF (ETC) is held in an ordinary securities account: it is not PEA-eligible. On resale, the gain is subject to the[flat tax (PFU) of 31.4%](https://www.impots.gouv.fr/particulier/questions/jai-realise-une-plus-value-mobiliere-comment-est-elle-imposee) in 2026 (12.8% income tax and 18.6% social levies), unless you opt for the progressive income tax scale.


Physical gold (bars, investment coins) falls under a separate regime. On sale, you owe the flat levy on precious metals of 11%, to which the CRDS of 0.5% is added, making 11.5% of the sale price, whatever the size of the transaction. The €5,000 exemption threshold that is often quoted applies only to jewellery and to items of art, collection or antiquity: the[BOFiP](https://bofip.impots.gouv.fr/bofip/4151-PGP.html/identifiant=BOI-RPPM-PVBMC-20-10-20181231) states that "these provisions do not apply to sales or exports of precious metals". You may, however, on production of evidence of the purchase date and price, opt for the capital gains regime on movable property: an allowance of 5% a year applies from the third year of ownership, giving full exemption after 22 years.
...
[AMF: ETFs (trackers), features and risks](https://www.amf-france.org/fr/sujets/etf)


[impots.gouv.fr: taxation of capital gains on securities, flat tax of 31.4%](https://www.impots.gouv.fr/particulier/questions/jai-realise-une-plus-value-mobiliere-comment-est-elle-imposee)


[impots.gouv.fr: flat levy on sales of precious metals, form 2091-SD](https://www.impots.gouv.fr/formulaire/2091-sd/taxe-forfaitaire-sur-les-cessions-ou-exportations-de-metaux-precieux)


[BOFiP: flat levy on precious objects, scope and exclusion of precious metals](https://bofip.impots.gouv.fr/bofip/4151-PGP.html/identifiant=BOI-RPPM-PVBMC-20-10-20181231)


[justETF: comparison of gold ETCs listed in Europe, assets and management fees](https://www.justetf.com/fr/how-to/gold-etfs.html)


[Deutsche Börse: Xetra-Gold, custody fees and gold storage](https://live.deutsche-boerse.com/en/wissen/wertpapiere/etfs-und-etps/xetra-gold)
