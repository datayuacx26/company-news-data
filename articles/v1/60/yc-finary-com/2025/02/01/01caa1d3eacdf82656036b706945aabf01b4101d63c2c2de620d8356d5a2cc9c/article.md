...
document_id: "01caa1d3eacdf82656036b706945aabf01b4101d63c2c2de620d8356d5a2cc9c"
company_key: "yc-finary-com"
company: "Finary.com"
source_id: "yc-finary-com-news-import-ac1e84866483"
canonical_url: "https://finary.com/en/blog/bourse/actions/comment-acheter-des-actions"
published_at: "2025-02-01T00:00:00+00:00"
first_seen_at: "2026-07-27T07:43:00.834411+00:00"
fetched_at: "2026-07-28T21:32:04.842955+00:00"
content_hash: "sha256:5139b40cd3d110c4a91f446cf952cf20bc72ab373291a903a5706f31b38c399c"
---

# Comment acheter des actions ? Le guide ultime
...
: Comme nous vous le présentons dans notre article investir en bourse, **la performance annuelle moyenne des actions est très intéressante sur le long terme** . Si on prend l’exemple du CAC 40, le rendement annuel moyen est de 8,5% depuis 1987. Un rendement largement supérieur aux livrets bancaires, pourtant très sollicités par les français (livret A, LDD, etc.). A cette performance, peut être ajoutée une stratégie très connue des meilleurs investisseurs. Cela consiste à acheter des actions d’entreprises reconnues pour leur “générosité”. C’est-à-dire, des entreprises qui distribuent régulièrement et de manière importante des dividendes.On dit que ces investisseurs se constituent un portefeuille d’actions à dividendes (voir plus bas dans la partie consacrée à la stratégie). Mais ces derniers ne s’arrêtent pas là. Au lieu d’encaisser leurs dividendes, ils les réinvestissent dans de nouvelles actions du même type. Cet effet “boule de neige” est à connaître. Car il permet de bénéficier à long terme de la puissance des[intérêts composés](https://finary.com/fr/blog/epargne/ou-placer/comment-investir/les-interets-composes-et-linvestissement) , en capitalisant à la fois sur la performance des actions et sur les dividendes.
...
L’ordre à plage de déclenchement permet d’effectuer un ordre limité qui s’active lorsque la plage de déclenchement est atteinte ou dépassée. Vous fixez donc une plage de déclenchement de votre ordre et un prix d’achat limité à ne pas dépasser. Vous diminuez fortement de nombreux risques de fluctuations, mais vous êtes limité par la liquidité.
...
Pour en savoir plus, vous pouvez lire notre article[Gestion active vs passive (ETF)](https://finary.com/fr/blog/bourse/etf/etf-gestion-active-ou-passive-quelle-est-la-meilleure) .
...
### Des actions adaptées à son profil et à sa stratégie
...
Ce support présente des avantages en cas de succession. Selon l’âge du détenteur lors des versements, il permet d’exonérer tout ou partie des droits de succession (source :[impots.gouv.fr](https://www.impots.gouv.fr/portail/international-particulier/questions/comment-sont-imposees-les-assurances-vie-en-cas-de-deces-du) ).


Bon à savoir


: Le CTO est pour nous le meilleur support d’investissement. Pourquoi ? Pour sa simplicité et pour la liberté qu’il offre à l’investisseur, de pouvoir acheter des actions (et d’autres titres financiers) sans limite géographique ni plafond de versement. Le PEA reste intéressant. Notamment pour la gestion passive, si on cherche à bénéficier de l’exonération d’impôt sur le revenu. L’assurance-vie est surtout utile pour transmettre son patrimoine avec une fiscalité avantageuse. Nous avons consacré un article complètement dédié au choix entre[PEA ou Assurance Vie](https://finances.finary.com/investir-en-bourse/pea-plan-epargne-actions-pea/pea-ou-assurance-vie/) . Spoiler : dans ce match, notre coeur balance plutôt du côté du PEA.


‍


Logez toutes vos enveloppes fiscales au même endroit
...
Le code ISIN (International Securities Identification Numbers) est un identifiant international unique. Composé de 12 caractères, il permet d’identifier précisément une action (mais aussi d’autres titres financiers comme les bons, les obligations, les[ETF](https://finary.com/fr/blog/bourse/etf/etf-gestion-active-ou-passive-quelle-est-la-meilleure) , etc.). Par exemple, l’ISIN d’Apple est : US0378331005.
...
Pour en savoir plus, nous avons écrit un article totalement dédié à[la psychologie de l’investisseur](https://finary.com/fr/blog/epargne/ou-placer/comment-investir/psychologie-investisseur) .
...
L’investissement est une affaire de patience et de rigueur. En investissant prudemment de manière régulière et sur le long terme, vous bénéficiez des effets surpuissants de la 8ème merveille du monde : les[intérêts composés](https://finary.com/fr/blog/epargne/ou-placer/comment-investir/les-interets-composes-et-linvestissement) .
...
**Rejoignez la communauté Finary et questionnez plusieurs milliers d'investisseurs en France et ailleurs**


[JE M'INSCRIS GRATUITEMENT](https://app.finary.com/v2/signup)


‍


## Autres questions sur l’achat d’actions


**Pourquoi acheter des actions ?**


Lorsque vous achetez une action, vous aidez l’entreprise en lui apportant votre argent. En contrepartie, vous espérez faire fructifier cet argent en réalisant une plus-value (la valeur de l’action augmente avec le temps) et / ou en recevant des dividendes (l’entreprise rémunère les actionnaires en fonction des performances).


Acheter des actions s'avère être un des placements financiers les plus rentables sur les 30 dernières années. En effet, depuis 1987, la performance moyenne des actions est de 8,5% par an, soit nettement plus qu’un livret A ou un livret de développement durable par exemple, qui ne dépasse pas les 2%.


**Comment acheter des actions ?**


Ensuite, pour acheter des actions, il vous faut choisir votre enveloppe fiscale (compte-titres ordinaire,[PEA ou assurance-vie](https://finary.com/fr/blog/epargne/plans/pea/pea-ou-assurance-vie) ), ouvrir un compte chez un courtier (votre banque traditionnelle, banque en ligne, ou autre courtier pour le compte-titres ordinaire ou l’assurance-vie), rechercher l’action qui vous intéresse par son nom ou son code ISIN, et enfin placer un ordre en fonction de votre stratégie d’investissement.


**Comment choisir les actions à acheter ?**


Le choix de l’action va beaucoup dépendre de la personnalité de chacun et de sa stratégie d’investissement. En effet, si vous vous intéressez fortement à l'économie française et êtes à l’aise avec les sociétés du CAC 40 en plus de suivre leur actualité, il sera judicieux de choisir parmi les actions françaises, vous pourrez par exemple acheter une action FDJ, ou une action LVMH par exemple.


Si en revanche vous vous intéressez de près à l'activité économique des Etats-unis et aux géants de la tech, il sera intéressant de suivre les actions américaines et acheter des actions Apple, ou des actions tesla par exemple. Ce schéma peut s’appliquer à tous les pays disposant d’une place boursière ou à tous les secteurs économiques représentés en bourse.


**Quels sont les risques lorsqu’on achète des actions ?**


Lorsque vous achetez des actions en bourse, votre capital est assujetti au risque de perte partielle ou totale de votre investissement si la ou les actions venaient à perdre de la valeur ou que l’entreprise venait à faire faillite. Un autre risque moins connu mais tout aussi important est celui des biais cognitifs, qui nous amène à prendre des décisions irrationnelles et en désaccord avec notre stratégie d’investissement. Il faut donc éviter d’aborder l’achat d’actions avec une mémoire sélective, une aversion trop importante au risque, ou encore l’effet de groupe.


Acheter des actions implique l’exposition du capital, il est donc important de se former et de s’informer avant tout investissement. Vous pouvez par exemple vous renseigner auprès de notre communauté d’investisseurs avant de vous lancer.
