...
These are the most important benchmarks and leverage points for fee for service dental collections in 2026 — what separates the top 10% of FFS practices ([98%+ collection rates](https://www.dentalintel.com/blog-posts/where-do-you-fit-in-average-dental-office-collections-current-statistics-and-trends) ) from the industry average.


- **A healthy FFS collection rate is 98% or higher** — the industry average is just[91%](https://www.2740consulting.com/dental-collections-statistics/) , meaning most practices leave significant revenue on the table every month.
...
- [FFS practices](https://veritasdentalresources.com/post/dental-insurance-vs-fee-for-service-a-side-by-side-look-at-two-proven-practice-models) **produce 30–45% more revenue per patient** than PPO-heavy practices, but only if collections are optimized to match that production level.
...
- **Every missed call is a missed collections opportunity** — in a cash-pay practice, a patient who doesn't reach you books with someone else. An[AI receptionist](https://www.arini.ai/) answering 24/7 ensures no revenue slips through after hours.
...
FFS vs Insurance-Based Practice Comparison Dimension FFS Practice Insurance-Based Practice


**Primary payer** Patient Insurance carrier + patient copay


**Collection timing** Time of service 30–90 days after claim


**Write-offs** None (unless financial hardship) Contractual write-offs required


**AR complexity** Lower — patient-only balances Higher — insurance + patient AR


**Phone inquiry type** "What does it cost?" "Is my insurance accepted?"


**Collections risk** High (patient may not pay) Shared with carrier


## **The FFS Collection Rate Benchmark: 98%+**


The gold standard for fee for service dental collections is a **98% net collection rate or higher** . Anything consistently below 95% signals a systemic problem worth auditing. The industry average across all dental practices sits around **91%** , according to[Dental Economics](https://www.dentaleconomics.com/practice/article/16385653/benchmarking-payment-goals) and American Dental Association practice benchmarking reports. For FFS practices specifically — where no contractual write-offs affect the calculation — a 91% rate reflects pure cash flow leakage, not insurance timing gaps.
...
Fee-for-service dentistry is one of the fastest-growing models in dentistry. Approximately 35% of dentists now plan to drop at least one PPO network within 24 months.[Dental insurance reform laws passed](https://www.cosmeticsgrowth.com/blog/dental-insurance-reform-fee-for-service) in 2025 are accelerating this shift. As FFS becomes more common, the gap between practices with strong collections systems and those without will widen.


FFS practices produce **30–45% more revenue per patient** than PPO-heavy practices ([Veritas Dental Resources](https://veritasdentalresources.com/post/dental-insurance-vs-fee-for-service-a-side-by-side-look-at-two-proven-practice-models) ). That revenue advantage only materializes if collections infrastructure keeps pace. Three forces are compressing the margin for error in 2026:
...
- **Collection rate** — the probability of collecting a balance drops with every day that passes after the appointment. Balances collected same-day approach 100%; balances that age past 90 days drop to[30% or less](https://www.pearly.co/dentistry-huddle/dental-practice-benchmarking-for-accounts-receivable) .
...
1. **Provide the treatment estimate at the consultation or confirmation call** — patients should never hear a number for the first time at checkout.
2. **Frame checkout as a normal process** — "Today's total is $X. Will you be paying with the card we have on file, or would you prefer a different method?" normalizes immediate payment.
3. **Have a card-on-file system** — capturing a payment method at intake enables seamless same-day billing without a checkout conversation. Patients authorize you to charge the card on file after each visit.
4. **Offer in-office financing for larger cases** — a $5,000 implant case requires a different conversation than a $200 cleaning. Having CareCredit or Sunbit available lets you close larger treatment plans same-day without requiring out-of-pocket payment in full.


Collecting at time of service is consistently more effective than billing after the appointment. The[DentistryIQ patient collections guide](https://www.dentistryiq.com/front-office/collections/article/16352978/how-to-successfully-collect-payment-from-your-dental-patients-at-time-of-service) documents this finding in detail.
...
Payment Methods Table Payment Method Why It Matters


**Credit/debit cards** Table stakes — every practice should accept all major cards.


**ACH/eCheck** Lower processing fees; good for practices with recurring plans.


**Text-to-pay** Generates significantly higher response rates vs. 20–30% for paper statements.


**Online patient portal** 24/7 access for patients who prefer to pay outside office hours.


**Third-party financing (CareCredit, Sunbit)** Critical for large treatment plans; patients can apply in minutes.


**Card on file** Enables automatic billing after appointments; reduces checkout friction.
...
- **CareCredit** — widely recognized, promotional interest-free periods for 6–24 months; accepted at over[285,000 healthcare providers nationwide](https://www.carecredit.com/about/) .
...
- Dental offices collect only[26.6% of balances that are one year past due](https://www.2740consulting.com/dental-collections-statistics/) .
...
1. **Pull the 0–30, 31–60, 61–90, and 90+ aging buckets** — the 90+ column is your highest-risk revenue.
2. **Work the 90+ column first** — these balances are at real risk of becoming uncollectable; prioritize outreach.
3. **Send automated text reminders for 31–60 day balances** — text-to-pay links at this stage convert far better than waiting to mail a statement.
4. **Call the 61–90 day balances** — a phone call from a known practice team member recovers more revenue than any automated system; use it for mid-range aging.
5. **Set a write-off threshold and stick to it** — define at what point a balance goes to a collections agency or is written off; don't let indefinite follow-up create false AR.
...
Your PMS is the hub for all patient financial data. Ensure your team is using its collections reporting features fully. Most modern PMS platforms include AR aging reports, automated statement generation, and patient payment history tracking. The most widely used[dental PMS platforms](https://www.darkhorsetech.com/blogs/dental-pms-market-share-where-complexity-really-begins) for FFS practices include Open Dental, Dentrix, Eaglesoft, Denticon, and Curve Dental. See the Open Dental optimization guide or Dentrix guide for PMS-specific collections settings.
...
Revenue Cycle KPI Table Metric Target Review Cadence


**Net collection rate** ≥98% Monthly


**AR days outstanding** <30 days Weekly


**AR over 90 days** <5% of total AR Weekly


**Same-day collection rate** ≥85% of appointments Weekly


**Text-to-pay open rate** ≥40% Monthly


**Time-of-service collection rate** ≥90% of new patients Monthly


**Collections agency referral rate** <2% of total AR Quarterly
...
This is where[Arini's AI receptionist](https://www.arini.ai/) creates a direct impact on FFS collections.
...
Kare Mobile Dental saw **$56,000 in new patient appointments in their first month** using Arini.[Unified Dental Care](https://www.arini.ai/case-study/unified-dental-care) achieved a **12% revenue increase** . Normandy Lake Dental reached a **90% call answer rate** , recovering production that was previously lost to missed calls.
...
Each of the following mistakes represents a specific revenue leak. Avoiding them is as important as implementing the strategies above — together they account for the gap between a 91% (industry average) and a[98%+ (top-tier) collection rate](https://dentx.ca/blog/dental-collection-rate-benchmarks/) .
...
- **Mailing paper statements as the primary follow-up** — paper statement collection rates average[20–30%](https://pearly.co/dental-payment-processing-by-text) for outstanding balances. Text-to-pay and phone follow-up consistently outperform mail.
...
- **If your collection rate is**[below 95%](https://www.curvedental.com/dental-blog/dental-collections-ratio-what-the-number-reveals-about-your-practices-billing-health) , a high-impact lever is time-of-service collection. Get payment before the patient leaves. Everything else compounds once that baseline is in place.
...
A healthy FFS dental collection rate is[98% or higher](https://dentx.ca/blog/dental-collection-rate-benchmarks/) . The industry average across all dental practices is approximately[91%](https://www.dentalintel.com/blog-posts/where-do-you-fit-in-average-dental-office-collections-current-statistics-and-trends) , but fee-for-service practices — with no insurance write-offs affecting the calculation — should consistently achieve 96–99%. Anything below 95% indicates a systemic issue worth auditing, whether in your financial policy, time-of-service collection process, or AR follow-up workflow.
...
Yes. Dental offices can send unpaid patient balances to third-party collections agencies, typically after 90 to 180 days of failed internal follow-up. Most practices exhaust internal outreach first — automated text reminders, phone calls, and payment plan offers — before referring an account to an outside agency. Sending a balance to collections is a last resort: it damages the patient relationship and agencies retain[25–50%](https://www.swrecovery.com/resources/blog/collection-agency-fees-average-percentage-who-pays/) of recovered amounts as their fee.
...
[Book a Demo](https://arini.ai/) to see how a 24/7 AI receptionist answers every patient call, books appointments directly into your PMS, and ensures your FFS practice captures production it would otherwise lose to missed calls and after-hours inquiries.
