...
document_id: "e4878ff27c9f90c7ef00327f51e42487ac378165425ec1766177d9ecdda9a9b9"
company_key: "yc-cloudanix"
company: "Cloudanix"
source_id: "yc-cloudanix-rss-5201a91d9952"
canonical_url: "https://www.cloudanix.com/blog/the-devops-jobs-report/"
...
content_hash: "sha256:97c4dcb83cb8e74b06cb43103cd61d12901ab020e12c49d27e0d39567a428d93"
---

# The DevOps Jobs Report

The DevOps jobs market is growing, and there has been a rising demand for DevOps professionals. Companies of all scales have seen compelling evidence of the benefits DevOps has to offer in terms of productivity, improved quality of service, higher customer satisfaction, and cost savings. This theory is backed by many surveys – including[this](https://www.atlassian.com/blog/devops/state-of-devops-survey/) one by Atlassian. Even startups have seen the benefits of DevOps. I published a comprehensive list of the best DevOps practices for startups last month, which you can read[here](https://www.cloudanix.com/blog/a-comprehensive-list-of-devops-best-practices-for-startups) .


Many individuals who have practiced DevOps in their day-to-day work activities have shown significant levels of high productivity. You can read more about practicing individual DevOps[here](https://www.cloudanix.com/blog/a-complete-guide-on-how-an-individual-can-practice-continuous-devops) .


In this article, I will be presenting my findings after analyzing data from 1,104 job postings from[Indeed](https://www.indeed.com/stc/?ref=cloudanix.com) to explore the current DevOps jobs market in the United States. The 1,104 job postings used here have been posted from mid-February to mid-March in 2021.
...
We can also see that states like Nevada, Wyoming, South Dakota, Oklahoma, and Mississippi are states where no DevOps job openings are posted during the mid-February to mid-March period. According to an article by[Forbes](https://www.forbes.com/sites/laurabegleybloom/2017/03/28/the-10-most-and-10-least-innovative-states-in-the-u-s/?sh=1b22240010a6) , this is not big of a surprise as South Dakota, Oklahoma, and Mississippi are considered the least innovative US states.
...
Companies based in New York City, Boston, Washington DC, Austin, Reston, and San Francisco have the highest job offers for a DevOps position. This is not very surprising because these cities are[massive tech hubs in the United States](https://www.worth.com/the-11-most-important-tech-cities-in-the-u-s/?ref=cloudanix.com) .
...
Note that 27.71% of these jobs did not specify any degree requirements. That is a fair amount of job postings that are not looking for a degree requirement, but perhaps they are looking for work experience or any associated certifications. You can check this blog post by me for a[list of DevOps certifications](https://www.cloudanix.com/blog/devops-and-cloud-certifications-to-invest-in-2023) you must have to upskill yourself.
...
Another core fundamental of DevOps is continuous integration and continuous delivery or CI/CD. Tools like Jenkins and Ansible help achieve this, and hence they make it in the list of top 5 DevOps tools. To know more about the different DevOps tools, you should check out[this article](https://www.cloudanix.com/blog/devops-must-have-top-10-tools-for-collaboration-around-cloud-workloads) .


## Compliance Standards That A DevOps Professional Must Know


We saw about DevSecOps earlier and how it is a growing subset within the DevOps domain. With DevSecOps, you also need to know the various security compliance standards. If you are an aspiring DevOps professional, you should get ahead of the curve and know about some security compliance standards in the industry that almost every tech company needs to adhere to, for instance,[GDPR](https://www.cloudanix.com/blog/what-is-gdpr-compliance) .
...
As you can see, in 56 job postings, the employer expects the candidate to know the CIS compliance standard. 38 job postings expect the candidate to know about the[NIST compliance](https://www.cloudanix.com/learn/what-is-nist-compliance) standard and 33 job postings demand the candidate know about the ISO compliance standard. You should check my post on the[CIS, NIST, and ISO compliance standards](https://www.cloudanix.com/blog/what-is-the-difference-between-nist-cis-sans-20-iso-27001-compliance-standards) and the difference between them while you’re here.[HIPAA](https://www.cloudanix.com/blog/a-quick-introduction-to-hipaa-compliance-for-a-busy-cloud-user) is also an essential compliance standard, and as you can see, 41 job posts express the candidate should know about it.


If you are getting started in the DevOps industry or want to know about these compliance standards briefly, check out[this blog post where I discuss many compliance standards like the GDPR, PCI DSS, NIST, HIPAA, and more!](https://www.cloudanix.com/blog/a-definitive-list-of-various-compliance-standards-and-what-they-mean)
...
I want to thank you for reading this report. I hope this report gave you some valuable insights! We at[Cloudanix](https://www.cloudanix.com/) would love to hear from you now! DevOps can be tricky to implement at times. Here is a free checklist that will help you if you are doing DevOps the wrong way!
...
- [DevOps and Cloud Certifications To Invest In 2023](https://www.cloudanix.com/blog/devops-and-cloud-certifications-to-invest-in-2023)
...
- [DevOps Must Have Top 10 Tools For Collaboration around Cloud Workloads](https://www.cloudanix.com/blog/devops-must-have-top-10-tools-for-collaboration-around-cloud-workloads)
- [Metrics For Defining Your DevOps Goals](https://www.cloudanix.com/blog/metrics-for-defining-your-devops-goals-and-call-it-a-success)
- [Transitioning from DevOps to DevSecOps](https://www.cloudanix.com/blog/transitioning-from-devops-to-devsecops)
- [If You Are Doing These DevOps Things, You Are Doing It Completely Wrong](https://www.cloudanix.com/blog/if-you-are-doing-these-devops-things-you-are-doing-it-completely-wrong)
