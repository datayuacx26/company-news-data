...
document_id: "f169e5d58098075403c165726005560ebc7223a93c78a259cf0e94f582e66fc1"
company_key: "yc-mantle"
company: "Mantle"
source_id: "yc-mantle-rss-aa2f82cfb1c8"
canonical_url: "https://blog.withmantle.com/how-safes-work/"
published_at: "2026-06-20T20:57:00+00:00"
first_seen_at: "2026-07-27T03:39:14.723809+00:00"
fetched_at: "2026-07-28T21:10:52.268184+00:00"
content_hash: "sha256:88dc96486f5d7e22d2ca7706155d51919186703263d25e30477eb838a5dc7df3"
---

# How SAFEs Work for Early-Stage Startups

For early-stage startups seeking initial funding, a Simple Agreement for Future Equity (SAFE) has become a popular and efficient financial contract. Pioneered by the renowned accelerator[Y Combinator in 2013](https://www.ycombinator.com/documents) , SAFEs offer a simpler option than traditional equity financing.
...
At its core, how a SAFE works revolves around its nature as a convertible instrument. Unlike a direct purchase of equity, when an investor provides capital through a SAFE, they are essentially buying the right to receive equity in the company at a future point. This conversion into equity isn’t immediate;[it’s triggered by a specific event](https://www.varnumlaw.com/insights/simple-agreement-for-future-equity-safe-an-innovative-investment-tool/#) .


The most common event that dictates how a SAFE works and converts is a[priced equity round](https://www.holloway.com/g/venture-capital/sections/priced-rounds-vs-convertible-instruments) . This occurs when the startup sells shares of its equity to new investors at a pre-determined price per share. However, other events, such as an acquisition or an Initial Public Offering (IPO), can also trigger the conversion of a SAFE into equity.
...
4. **Not Debt, But Future Equity:** It’s important to know that SAFEs aren’t debt like[convertible notes](https://blog.withmantle.com/safes-vs-convertible-notes/) . They don’t accrue interest or have a repayment deadline. Instead, a SAFE investment is a bet on the company’s future, with the expectation of becoming equity later.
...
- ***Example:** Company ABC has a SAFE investor with a $5M valuation cap. When Company ABC raises a new round at a $10M valuation, the new investors pay the $10M price, but the SAFE investor’s shares are calculated as if the valuation were only $5M. This means the SAFE holder gets more shares for the same investment.*
...
- ***Example:** Using the same scenario, a 20% discount on a $10M valuation means the SAFE holder’s conversion price is based on a $8M valuation. If both a valuation cap and discount exist, the investor usually benefits from whichever term gives them a better deal.*


**Pro Rata Rights:** When a SAFE converts to equity, the investor receives shares, but these shares can be diluted by new investments. Pro rata rights, often detailed in[side letters](https://www.ycombinator.com/documents) , dictate how a SAFE works for existing investors in later funding rounds. They give these early investors the option to invest more money to maintain their initial percentage ownership.


- ***Example:** A SAFE investor expects to own 10% initially. After new investment dilutes their stake to 8%, pro rata rights allow them to invest more at the new valuation to[get back to their 10% target](https://www.contractscounsel.com/t/us/safe-agreement) .*
...
- ***Example:*** *An early investor has a SAFE with a $5M cap. If a later investor gets a $3M cap, the MFN clause means the first investor’s cap also drops to $3M.*
...
- **Post-Money SAFE:** This clearly defines the investor’s ownership percentage *after* their investment and *after* accounting for all other SAFEs and convertibles, but *before* any new money comes in during the next priced round. It offers a more immediate understanding of the ownership stake.


- ***Example:** A $1M investment in a post-money SAFE with a $5M cap means the investor expects 20% ownership ($1M/$5M) before the next funding round.*


- **Pre-Money SAFE:** Here, the investor’s ownership isn’t as immediately clear. The conversion depends on the company’s valuation *before* the new money and *before* the conversion of the SAFE itself. It also factors in the full option pool. This makes the final ownership percentage less predictable than with a post-money SAFE.


- ***Example:** A $1M investment in a pre-money SAFE with a $5M cap won’t guarantee 20% ownership, as other SAFEs and the option pool will affect the final calculation.*
...
- Post-Money SAFE Conversion (Investor 2)


- As seen before, the post-money SAFE converts based on the post-money valuation cap, resulting in 7% ownership.


- Pre-Money SAFE Conversion (Investor 1)


- The conversion price for a pre-money SAFE is calculated differently.
- Pre-Money Valuation / (Pre-Money Shares + New Option Pool Shares) = Conversion Price


- $20,000,000 / (10,000,000 + 1,774,194) = **~$1.699/share**


- Shares Issued to Pre-Money SAFE Holder


- Principal / Conversion Price = Shares
- $2,000,000 / $1.699 per share = **~1,177,419 shares**


- Ownership Comparison


- The pre-money SAFE holder ends up with a slightly lower ownership stake (6.6%) compared to the post-money SAFE holder (7%). The difference in equity is typically allocated to the founders.
...
- **Issue SAFEs:** Quickly generate and send SAFEs to investors with customizable terms.
- **Track Investments:** Monitor all SAFE agreemeents in one place, ensuring transparency and organization.
- **Update the Cap Table:** Automatically update your cap table in real-time as SAFEs convert, giving you a clear picture of ownership and dilution.
- **Model Future Scenarios:** Use Mantle’s scenario modeling tools to simulate future funding rounds and understand potential impacts on ownership.
...
**Ready to streamline your SAFE management?**[Sign up for Mantle today](https://withmantle.com/register?utm_source=blog&utm_medium=website&utm_campaign=how-safes-convert) and take the hassle out of fundraising.


[Get started](https://withmantle.com/register?utm_source=blog&utm_medium=website&utm_campaign=how-safes-convert)


[Learn more](https://withmantle.com/demo?utm_source=blog&utm_medium=website&utm_campaign=how-safes-convert)


### Share this:


- [Share on X (Opens in new window) X](https://blog.withmantle.com/how-safes-work/?share=twitter)
- [Share on LinkedIn (Opens in new window) LinkedIn](https://blog.withmantle.com/how-safes-work/?share=linkedin)
-
