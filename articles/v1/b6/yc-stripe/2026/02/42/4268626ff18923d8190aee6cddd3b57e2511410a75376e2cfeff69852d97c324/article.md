...
document_id: "4268626ff18923d8190aee6cddd3b57e2511410a75376e2cfeff69852d97c324"
company_key: "yc-stripe"
company: "Stripe"
source_id: "yc-stripe-news-import-cb4f1d0345d1"
canonical_url: "https://stripe.com/newsroom/news/stripe-2025-update"
...
content_hash: "sha256:ef7b5bdfd302f8ed9a5481d36604c090d670ced0ab4711e25d039349b223234e"
---
...
Stripe also published its 2025[annual letter](https://stripe.com/annual-updates/2025) to the Stripe community, detailing a strong year for businesses on Stripe and the internet economy overall. Businesses running on Stripe generated $1.9 trillion in total volume, up 34% from 2024, and equivalent to roughly 1.6% of global GDP. Beyond payments, Stripe’s Revenue suite (comprising[Stripe Billing](https://stripe.com/billing) ,[Invoicing](https://stripe.com/invoicing) ,[Tax](https://stripe.com/tax) , and more) is on track to hit an annual run rate of $1 billion this year.


In the letter, cofounders Patrick and John Collison wrote:


"Our programmable financial services now power more than 5 million businesses directly or via platforms, including all of the top AI companies, many of the largest blue-chip companies (90% of the Dow Jones Industrial Average), most of the biggest tech companies (80% of the Nasdaq 100), and a significant fraction of freshly minted startups (25% of all Delaware corporations are now created with[Stripe Atlas](https://stripe.com/atlas) ) \[...\] Stripe remained robustly profitable, allowing us to continue investing heavily in product development (with more than 350 product updates last year) as well as acquisitions. \[…\] All in all, 2025 was a strong year for the internet economy, and we’re delighted to see so many of Stripe’s customers do so well.”
...
Over the last few years, the country-by-country expansion model has melted away. The “domestic market” for a new generation of internet businesses is the internet itself. Nearly every recognizable AI product launched globally by default, including[ChatGPT](https://stripe.com/newsroom/news/stripe-and-openai) ,[Claude](https://stripe.com/customers/anthropic) , Replit,[Lovable](https://stripe.com/newsroom/news/lovable-and-stripe) , Base44, Vercel,[Cursor](https://stripe.com/customers/cursor) , Midjourney, and many more. Among Stripe businesses with mostly international revenue, 30% of that revenue comes from countries that are neither their home market nor one of the top 10 global economies.
...
- With OpenAI, Stripe developed the[Agentic Commerce Protocol](https://stripe.com/newsroom/news/stripe-openai-instant-checkout) (ACP) to establish a shared technical language between AI platforms and businesses, open by design.


- Stripe launched an[Agentic Commerce Suite](https://stripe.com/newsroom/news/agentic-commerce-suite) , which provides tooling for businesses to sell across multiple AI interfaces and protocols with a single integration. Brands already onboarding include Anthropologie, Urban Outfitters, Etsy, Coach, and Kate Spade.


- Stripe introduced[Shared Payment Tokens](https://stripe.com/blog/introducing-our-agentic-commerce-solutions) , a new payment primitive that lets agents initiate payments without exposing credentials, usable even by businesses that don’t process payments with Stripe.


- Stripe launched[machine payments](https://x.com/jeff_weinstein/status/2021331763960873058) , a way for developers to charge agents directly for API calls, MCP usage, and HTTP requests using stablecoin micropayments.


- Stripe partnered with[OpenAI](https://stripe.com/newsroom/news/stripe-openai-instant-checkout) to power the first shopping experiences inside ChatGPT. Stripe is also collaborating with[Microsoft](https://stripe.com/newsroom/news/microsoft-copilot-and-stripe) to bring similar capabilities to Copilot.
...
In 2025, the price of Bitcoin dropped precipitously, but stablecoin payments volume doubled to around[$400 billion](https://www.linkedin.com/pulse/stablecoins-payments-what-raw-transaction-numbers-4qjke) , 60% of which is estimated to represent B2B payments.[Bridge](https://www.bridge.xyz/) , the stablecoin orchestration platform Stripe acquired last year, saw volume more than quadruple.


In July, Stripe acquired[Privy](https://www.privy.io/) , which powers more than 110 million programmable wallets. In September, Stripe unveiled[Tempo](https://tempo.xyz/) , a blockchain purpose-built for payments, incubated together with Paradigm. With Tempo, businesses get dedicated payment lanes, sub-second finality, opt-in privacy, and interoperability with compliance and accounting systems—important features for supporting real world economic activity.
...
For more information, Stripe’s full 2025[annual letter](https://stripe.com/annual-updates/2025) is available online.
