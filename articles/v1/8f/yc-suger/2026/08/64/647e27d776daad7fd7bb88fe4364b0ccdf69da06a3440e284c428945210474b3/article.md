...
document_id: "647e27d776daad7fd7bb88fe4364b0ccdf69da06a3440e284c428945210474b3"
company_key: "yc-suger"
company: "Suger"
source_id: "yc-suger-news-import-2505a48c7131"
canonical_url: "https://www.suger.io/resources/blog/cloud-gtm-glossary/"
published_at: "2026-08-06T00:00:00+00:00"
first_seen_at: "2026-08-07T06:20:29.574702+00:00"
fetched_at: "2026-08-07T06:20:30.243690+00:00"
content_hash: "sha256:d949b48a046e7195ba4f2feef68183a26edc3d108ab43ae88e6d62a526d98e12"
---

# Cloud GTM Glossary: 40 Marketplace Terms Defined
...
**A cloud marketplace platform** is third-party software that operates marketplace listings, offers, metering, and co-sell from one system instead of one console per cloud.[How to choose a cloud marketplace platform](https://www.suger.io/resources/blog/how-to-choose-a-cloud-marketplace-platform/) covers the evaluation criteria.
...
**A free trial** is time-limited or usage-limited free access granted through the listing, after which the buyer converts to a paid subscription.[Free trials on cloud marketplaces](https://www.suger.io/resources/blog/free-trials-on-cloud-marketplaces/) covers how each cloud implements them.
...
**An express private offer** is AWS’s automated version: the buyer requests an offer from the listing and AWS generates it from rate cards the seller configured in advance.[Express private offers, explained](https://www.suger.io/resources/blog/aws-marketplace-express-private-offers/) covers the setup.
...
**EDP** — the AWS Enterprise Discount Program — is AWS’s committed spend agreement, where a customer commits to a spend level in exchange for discounts.[AWS EDP: what sellers need to know](https://www.suger.io/resources/blog/aws-edp-what-sellers-need-to-know/) covers the seller’s angle.


**MACC** — the Microsoft Azure Consumption Commitment — is Microsoft’s equivalent.[What is a MACC?](https://www.suger.io/resources/blog/what-is-a-macc-azure-committed-spend-explained/) explains how marketplace purchases apply to it.
...
**ACE** — APN Customer Engagements — is AWS’s co-sell system, where opportunities are shared between partner and AWS.[AWS ACE: a practical co-sell guide](https://www.suger.io/resources/blog/aws-ace-guide-for-isv-sellers/) covers how sharing actually works.
...
**MDF** — market development funds — is cloud provider money for joint demand generation: campaigns, events, and content.[AWS partner funding programs](https://www.suger.io/resources/blog/aws-partner-funding-programs/) covers MDF alongside the other incentives.
...
**A reseller private offer plan** is Google Cloud’s version: the ISV publishes a plan the reseller accepts once, and the reseller creates customer offers from it.[CPPO vs MPO](https://www.suger.io/resources/blog/cppo-vs-mpo-multiparty-private-offers/) compares all three.


**Deal registration** is the process where a partner formally claims an opportunity with you, protecting it from conflict and locking in their commission.[Deal registration software for ISVs](https://www.suger.io/resources/blog/deal-registration-software-for-isvs/) covers the lifecycle and where it breaks.
...
**A listing fee** is the percentage a marketplace takes from a transaction. On AWS it varies by product type, offer type, and total contract value —[what a marketplace dollar actually costs you](https://www.suger.io/resources/blog/what-a-marketplace-dollar-costs-you/) works through the arithmetic.
...
New to the motion?[The complete guide to Cloud GTM for ISVs](https://www.suger.io/resources/guides/cloud-gtm/) puts these terms into the sequence a real marketplace program runs in.
