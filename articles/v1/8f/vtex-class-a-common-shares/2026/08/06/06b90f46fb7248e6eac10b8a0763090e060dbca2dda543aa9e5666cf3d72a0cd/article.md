...
document_id: "06b90f46fb7248e6eac10b8a0763090e060dbca2dda543aa9e5666cf3d72a0cd"
company_key: "vtex-class-a-common-shares"
company: "VTEX"
source_id: "vtex-class-a-common-shares-rss-fffff04a1e70"
canonical_url: "https://vtextech.substack.com/p/why-staff-engineers-should-write"
published_at: "2026-08-10T21:16:16+00:00"
first_seen_at: "2026-08-10T21:57:32.651719+00:00"
fetched_at: "2026-08-10T21:57:33.664896+00:00"
content_hash: "sha256:1f5c40283b0b6df2319ed4258a96464ef2b80002e870aedbc9f2ec63acc22739"
---
...
and[Lucas Schlee](https://substack.com/@lschlee)
...
### Articulating a problem is already half the battle
...
Using AI tools during the


*brainstorming* process is encouraged precisely because they’re good at pointing out gaps and weak assumptions, but it’s still up to the engineer to properly articulate what is being solved.
...
### A document can replace many meetings
...
### A document helps prioritize solving a problem
...
### Unwritten knowledge is easily lost


Technical discussions can produce excellent solutions, but all of it can easily be forgotten within a few months.


**Documenting decisions means creating institutional memory** . It ensures the reasoning behind a choice doesn’t disappear along with the person who made it.
...
### Invisible work also needs to be documented
...
For anyone pursuing career growth, this point is especially relevant. It’s common for engineers to struggle to clearly demonstrate the impact of their work. That happens, in part, because so much of it was never documented.


**The documents you’ve written are concrete evidence of the sophistication of your technical thinking.**


### Context for artificial intelligence tools


Generative AI tools are already part of the daily routine of VTEX’s Software Engineering organization. Whether for writing code, reviewing PRs, exploring solutions, supporting incident investigations, or understanding unfamiliar systems. The fundamental factor that determines the quality of what these tools deliver is the
...
Technical documents like RFCs, ADRs, incident reports, and glossaries help AI tools produce better results, letting them factor in VTEX’s actual context rather than generic market knowledge. The richer the input, the higher the odds of good solutions.


**If the input is poor, the output tends to be poor too** .
...
#### Write about the next problem you run into
...
[Staff Engineer: How to find time to work on broader-scope problems](https://vtextech.substack.com/p/staff-engineer-how-to-find-time-to) - on the VTEX Tech Blog, about the transition from Senior to Staff Engineer.
