...
document_id: "c4b4e6ddd780c7b98d957443b98f6d91887b5830c82f2e9eb98ea5c6a1cb3d4d"
...
canonical_url: "https://www.galaxy.com/insights/research/weekly-research-brief-clarity-act-10-percent-sec-reg-crypto-coldcard-losses-bip-110-bitcoin-fork"
published_at: null
first_seen_at: "2026-08-15T03:26:33.262717+00:00"
fetched_at: "2026-08-15T03:26:35.266579+00:00"
content_hash: "sha256:c66ba16735805216c05b60af78eea11795d68be2d6bd8c2a746a162b23e92a7b"
---
...
*Got feedback on this newsletter? Email*[\[email protected\]](https://www.galaxy.com/cdn-cgi/l/email-protection#7d0f180e181c0f1e153d1a1c111c0504531e1210) *. We’d love to hear from you.*


## 📄 Fizzling CLARITY Act Odds Leave Agencies Scrambling to Act


**With odds**[fading](https://polymarket.com/event/clarity-act-signed-into-law-in-2026) **for CLARITY Act passage in 2026, the Securities and Exchange Commission was**[poised](https://www.bloomberg.com/news/articles/2026-08-11/sec-poised-to-unveil-major-crypto-plans-as-clarity-act-stalls) **to unveil major exemptions to safely promote crypto innovation, but later backtracked.**


The SEC was set to unveil two long-awaited regulatory exemptions this week: Reg Crypto, which will create a new pathway for the primary issuance of cryptoassets to the public; and the Innovation Exemption, which will allow for secondary trading of tokenized securities in decentralized finance. Bloomberg had[reported](https://www.bloomberg.com/news/articles/2026-05-18/sec-is-said-to-ready-plan-for-trading-crypto-versions-of-stocks) in May that the SEC was on the verge of publishing these exemptions, but the agency then[backtracked](https://finance.yahoo.com/markets/crypto/articles/sec-delays-tokenized-stocks-innovation-204637484.html) after significant pushback from the traditional securities industry. New reporting[suggested](https://www.bloomberg.com/news/articles/2026-08-11/sec-poised-to-unveil-major-crypto-plans-as-clarity-act-stalls) Tuesday that those exemptions were now imminent, but again the SEC appears to be backtracking after Eleanor Terret reported that the innovation exemption was again delayed. And late Thursday, the SEC[published](https://www.sec.gov/newsroom/meetings-events/sunshine-act-notice-open-081426-cancellation) a notice about their planned Friday open meeting, which was believed to be about Reg Crypto.


The Commodity Futures Trading Commission is aggressively moving to cement its jurisdiction over prediction market contracts, which it argues are swaps under the Commodities and Exchange Act. This week the CFTC[issued](https://www.cftc.gov/PressRoom/PressReleases/9281-26) an emergency order seeking to countermand New York Attorney General Letitia James' effort to secure a *nationwide* temporary restraining order blocking Kalshi from offering event contracts (not just sports, bets: James sought to stop the firm from offering trades on “culture, elections, and *other events,* ” emphasis added). The latest salvo follows months of lawsuits between prediction markets venues, U.S. states, and the CFTC, some involving events contracts generally, others focused on sports-related contracts, but all involving questions state vs. federal authority over these markets.


After the successful, bipartisan[markup](https://www.galaxy.com/insights/research/weekly-top-stories-05-15-26-clarity-act-markup-hyperliquid-usdc-ppi-inflation) of CLARITY Act by the Senate Banking Committee in May, odds had climbed that the bill could pass the Senate before the August recess (which began on Aug. 7). But as the[weeks](https://www.galaxy.com/insights/research/clarity-act-passage-odds-60-percent-senate-calendar-june-2026)[wore](https://www.galaxy.com/insights/research/weekly-top-stories-06-26-26-trump-quantum-eo-clarity-act-odds-gnosis-ens-dao-governance) on, several factors[obstructed](https://www.galaxy.com/insights/research/clarity-act-30-percent-odds) the bill's progress. First, the issue of increased ethics controls for government officials' involvement in crypto, which had been tabled throughout the committee’s processes, reared its head and could not be resolved despite substantial bipartisan efforts. Second, increased pressure from banks – community banks in particular – resulted in some backsliding of support for the bill even from Republicans. Third, calls for further weakening of the developer protections in the Blockchain Regulatory Certainty Act (BRCA) from illicit finance hawks swirled as a specter over the negotiations, though late-stage moderation on the issue by some law enforcement groups seemed to temper fears this issue could derail the bill. All of these factors made it difficult for Senate Majority Leader John Thune (R-SD) to corral the 60 votes needed to overcome a filibuster, and as the calendar waned into the August recess, he declined to call a vote. At the very end of the work period, Sen. Thune did finally "notice" the first vote on the bill, meaning the Senate now plans to vote on CLARITY when it returns from recess in mid-September.
...
There is some evidence that the exploit has increased fear of and damaged the narrative about self-custody, at least for the near and medium terms. The count of small transfers (<1 BTC) flowing into exchanges reached a local high following the incident; inflows to exchanges[exceeded](https://x.com/SaniExp/status/2084234660414976062?s=20) 22k BTC in just the first four days after the attacks began; and as of Aug. 8, exchange balances stood at 3.683m BTC, an all-time high. Some traditional financial firms seemed to jump on the moment, with BlackRock[announcing](https://www.fxstreet.com/cryptocurrencies/news/blackrock-lowers-bitcoin-etf-in-kind-conversion-minimum-to-1m-202608110059) that the minimum to in-kind create IBIT ETF shares from native BTC had been lowered to $1m (from $25m).
...
**The soft fork that was supposed to save Bitcoin from “spam"**[lasted two blocks](https://www.coindesk.com/tech/2026/08/09/controversial-bitcoin-fork-bip-110-mines-two-blocks-then-stops) **.**


BIP-110, formally the Reduced Data Temporary Softfork, was the brainchild of pseudonymous developer Dathon Ohm with input from Luke Dashjr, creator of the Bitcoin Knots node software, former chairman and CTO of the Ocean mining pool, and a polarizing figure in the Bitcoin community. It called for a one-year consensus-level restriction on arbitrary data in Bitcoin transactions. This includes Ordinals inscriptions (Bitcoin’s answer to NFTs), BRC-20 and Runes (both fungible token standards), and oversized[OP_RETURN](https://www.galaxy.com/insights/research/bitcoin-wallet-opreturn-salomon-brothers-abandoned-property-constructive-possession) . The proposal contained seven rules capping most outputs at 34 bytes, OP_RETURN at 83, data pushes at 256, plus restrictions on Taproot annexes and control blocks.
...
Miners never came close. In the last difficulty period before the window opened, 51 of 2,016 blocks signaled. That is 2.53% against a threshold its own authors had already cut nearly in half from the standard. According to[block data](https://bitcoinmagazine.com/bip-110-signaling-monitor) , every one of those 51 blocks came from Ocean.


Block 961,632 landed on Aug. 8 at 19:35:55 UTC. AntPool mined a non-signaling block that the network accepted, and BIP-110 nodes rejected it.[Roughnecks](https://x.com/Roughnecks110/status/2086300532709409140?s=20) , mining through Ocean’s DATUM system, produced the competing block.


The minority chain reached 961,633 and stopped. Roughnecks quit the next day and told other miners to do the same, then reversed on Aug. 10 and resumed, saying it would keep going until a “sensible POW change” arrived. The main Bitcoin chain is now several hundred blocks ahead. Strategy Executive Chairman[Michael Saylor commented](https://x.com/saylor/status/2086388338521497714?s=20) on the pitiful fork attempt, saying “Bitcoin worked exactly as designed” (by remaining unaffected in the face of the ill-fated fork attempt).


Ocean was the only pool signaling in favor of BIP-110. Days after the split, it disclosed that a[Stratum](https://bitcoinmagazine.com/glossary/stratum-v2) configuration error had routed some of its miners onto the BIP-110 chain (rather than the *real* Bitcoin chain) for roughly 18 hours. The pool restored its default endpoint and committed to roughly 0.3 BTC in direct rebates within 72 hours. Cryptographer and Bitcoin OG[Adam Back suggested](https://x.com/adam3us/status/2086648078845493425?s=20) the losses come out of Dashjr’s salary. Ocean’s reported hashrate has since fallen 96%, and miners have publicly called for leadership changes.


On Aug. 9, Bitcoin Improvement Proposal editor[Mark “Murch” Erhardt filed a motion](https://x.com/murchandamus/status/2086528140361515243?s=20) to the Bitcoin development mailing list recommending that fellow editor Luke Dashjr be removed as an editor. Erhardt cited Dashjr’s conflict of interest, minimal contribution, championing a contentious fork, and a coordination breakdown with the other editors.


The next day, it was done. Jon Atack merged the pull request (a one-line deletion) and longtime Bitcoin Core contributor Bryan Bishop confirmed the repository permissions were revoked. Bishop, Atack, Erhardt, Olaoluwa Osuntokun, and Ruben Somsen remain as BIP editors. Dashjr also[announced a sabbatical](https://x.com/LukeDashjr/status/2086919123599036926?s=20) from Ocean. He continues to[refer to the majority chain as “Bpedo.”](https://x.com/LukeDashjr/status/2087183652555817033?s=20) (One of his arguments for limiting arbitrary data was the alleged risk of child sexual abuse material being published onchain.)


Dathon Ohm’s response to the 2.53% tally was to accuse the large pools of collusion and announce work on a proof-of-work change to “fire the miners.” Dashjr backed it,[citing ASICBoost](https://x.com/LukeDashjr/status/2073499243638116722?s=20) when pressed on what was wrong with SHA-256d, the hash function at the core of Bitcoin. (ASICBoost is a technique for speeding up mining.)
...
The PoW pivot makes this all worse for Ocean. Miners rejected BIP-110, and the response was to try to change the electorate. And ASIC resistance may not even be the point.[Per one of the Knots strategy channels](https://x.com/RobinSeyr/status/2086580715714658472?s=20) , the stated logic was to adopt an altcoin’s algorithm so ASICs would exist for the new chain on day one. Basically, cannibalize the hardware of an asset Bitcoiners would call valueless (they use an indelicate term for these; it rhymes with “bitcoin”). Bitcoin Gold ran this experiment in 2017 and nobody bothers citing it as a cautionary tale anymore.


*Luke Dashjr laying out proof-of-work design criteria in the Bitcoin Knots Discord channel. Source:*[Bitcoin.com News](https://news.bitcoin.com/crypto-news/bip-110-backers-plot-minority-chains-pow-reset-to-fire-bitcoin-miners/)


What to watch is whether Ocean’s 96% drawdown proves permanent. The pool building the most credible answer to Bitcoin mining centralization bet itself on a fork its chairman championed, and lost.[- Will Owens](https://x.com/wowens)
...
🔍 **Tether**[completes audit](https://tether.io/news/tether-completes-the-largest-inaugural-financial-audit-in-history/) with **KPMG U.S.** , a Big Four firm; USDT issuer has come[a](https://www.coindesk.com/markets/2018/01/27/tether-confirms-its-relationship-with-auditor-has-dissolved)[long](https://www.coindesk.com/markets/2018/06/20/tether-review-claims-crypto-asset-fully-backed-but-theres-a-catch)[way](https://www.coindesk.com/markets/2018/11/05/deltec-chairman-says-tether-letter-on-bank-relationship-is-authentic)


-


🤦‍♂️ **Trezor** hardware wallet customer data[exposed](https://decrypt.co/375556/trezor-customer-data-exposed-in-shipping-partner-breach) in shipping provider breach


-


🏴‍☠️ **Trump** authorizes hiring of[privateers](https://www.whitehouse.gov/presidential-actions/2026/08/expanding-capabilities-to-combat-transnational-cyber-enabled-crime/) to hack crime rings (with $1m bond)


-


😓 **Solana**[narrowly avoids outage](https://unchainedcrypto.com/a-routing-fault-at-one-hosting-provider-took-29-of-solanas-stake-offline-marinade-says/) as routing fault knocks 29% of stake offline


-


🏭 **Nvidia**[taps](https://www.cnn.com/2026/08/11/business/nvidia-wall-street-500-billion-financing-intl) Wall Street firms to raise $500b+ for[‘AI factory](https://x.com/JensenHuang/status/2086934705207959965?s=48) ’ buildout


-


🔮 **Kalshi** said to[top $4b](https://www.theinformation.com/articles/kalshi-tops-4-billion-annualized-revenue-seeks-40-billion-valuation) in annualized revenue and seek $40b valuation...


-


🛜 ...as it[streams](https://www.theblock.co/news/markets/2026-08-12-kalshi-first-prediction-market-to-stream-full-order-books-via-doublezero-411589) order books via **DoubleZero** ’s high-speed data network


-


◀️ Crypto infra provider **Zerohash** ’s U.S. bank application “returned”[without decision](https://www.coindesk.com/policy/2026/08/12/morgan-stanley-s-infrastructure-partner-zerohash-rebuffed-in-pitch-to-be-u-s-trust-bank)


-


🔌 **Anthropic**[said](https://www.bloomberg.com/news/articles/2026-08-11/anthropic-strikes-9-billion-deal-with-cloud-computing-firm-riot) to be $9.1b tenant[leasing 191 MW](https://www.sec.gov/ix?doc=/Archives/edgar/data/0001167419/000110465926093448/riot-20260630x10q.htm) from **Riot Platforms...**


-


💰 ...which[sold 4,300 BTC](https://cryptobriefing.com/riot-platforms-sells-btc-ai-expansion/) in 2Q to[fund pivot](https://d2ghdaxqb194v2.cloudfront.net/2865/200991.pdf) from mining to AI data centers
...
For more insights, stay tuned for Galaxy Research’s quarterly leverage report, coming soon.[– Zack Pokorny](https://x.com/ZackPokorny_)
