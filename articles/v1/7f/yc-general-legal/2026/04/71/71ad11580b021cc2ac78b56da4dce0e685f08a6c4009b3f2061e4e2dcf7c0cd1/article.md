...
document_id: "71ad11580b021cc2ac78b56da4dce0e685f08a6c4009b3f2061e4e2dcf7c0cd1"
company_key: "yc-general-legal"
company: "General Legal"
source_id: "yc-general-legal-news-import-cc42147fa719"
canonical_url: "https://general.legal/blog/returning-to-the-agentic-office"
...
content_hash: "sha256:ca38c48658472883bd56a63eb2b9d956d5c33c8333e034838bf1ed9b2d8e2949"
---

# Returning to the Agentic Office

One of the reasons I was so excited to start my internship at General Legal was the chance to finally use the latest AI tools in a professional environment. I’ve spent the last year almost entirely focused on my law school studies. Law school is an amazing place to learn, but ([for many valid reasons](https://publications.lawschool.cornell.edu/jlpp/2025/04/09/ai-in-law-the-real-risks-beyond-hallucinated-cases/) ) it takes a conservative approach to technology adoption. My legal writing professor told me the program’s entire strategy for teaching incoming first-years to use AI was a single in-class activity in their spring semester. Incoming students will not learn how to use these tools until spring *2027* .
...
It would be comforting to think this is a passing trend, but the models keep getting better at exactly the kind of reasoning legal and many other types of work demand. The recent release of Claude Fable 5, Anthropic’s first publicly available Mythos-class model, is the latest marker. Reporting on the launch noted that it excels at software engineering and knowledge work while shipping with hard safety limits in high-risk domains ([TechCrunch](https://techcrunch.com/2026/06/09/anthropics-claude-fable-5-is-a-version-of-mythos-the-public-can-access-today/) ). While Anthropic withdrew access to Fable under pressure from the US Government, who cited national security concerns, the continual improvement in the models’ capabilities is undeniable ([Anthropic](https://www.anthropic.com/news/claude-fable-5-mythos-5) ).
...
If you’re a founder or operator looking for legal counsel built for the speed of the AI era, General Legal delivers high-quality, predictable work backed by experienced attorneys focused on your business goals. Ready to see the difference an AI-native approach makes? Sign up here to get started.


## Sources


Jessica Rosberger, *AI in Law: The Real Risks Beyond Hallucinated Cases* , Cornell J.L. & Pub. Pol'y (Apr. 9, 2025),[https://publications.lawschool.cornell.edu/jlpp/2025/04/09/ai-in-law-the-real-risks-beyond-hallucinated-cases/](https://publications.lawschool.cornell.edu/jlpp/2025/04/09/ai-in-law-the-real-risks-beyond-hallucinated-cases/) .


Anthropic, *Claude Fable 5* , Anthropic (June 9, 2026),[https://www.anthropic.com/news/claude-fable-5-mythos-5](https://www.anthropic.com/news/claude-fable-5-mythos-5) .


Jessica Rosberger, *TechCrunch: Anthropic’s Claude Fable 5 is a version of Mythos the public can access today* , TechCrunch (June 9, 2026),[https://techcrunch.com/2026/06/09/anthropics-claude-fable-5-is-a-version-of-mythos-the-public-can-access-today/](https://techcrunch.com/2026/06/09/anthropics-claude-fable-5-is-a-version-of-mythos-the-public-can-access-today/) .
