...
document_id: "d6cfb9f0b122de1713cff6ddde15163e119658c789f44102a2b8d649f505fa94"
company_key: "yc-numeral"
company: "Numeral"
source_id: "yc-numeral-news-import-ccb600506820"
canonical_url: "https://www.numeral.com/blog/sales-tax-compliance"
published_at: "2026-07-14T00:00:00+00:00"
first_seen_at: "2026-08-06T00:04:43.829703+00:00"
fetched_at: "2026-08-06T00:04:45.209604+00:00"
content_hash: "sha256:4ca09c138eefd21efb6c9ef46ba267f5f9b60d2154d31582475a88f1626e009f"
---
...
The good news is that managing sales tax compliance doesn't have to be an impossible task. If you follow just six simple steps, you can ensure that you operate within the rules and protect your company from[getting into trouble](https://www.numeral.com/blog/what-happens-if-you-dont-collect-or-remit-sales-tax) with tax authorities trying to collect unpaid funds:
...
In the past, a company needed a physical presence in a state to have nexus and be required to collect tax. However, the Supreme Court overruled the physical presence requirement in a case called[South Dakota v. Wayfair, Inc.](https://www.numeral.com/blog/south-dakota-v-wayfair) , opening the door to states taxing[online purchases](https://www.numeral.com/blog/collect-sales-tax-when-selling-online) .


Under the current rules, nexus can now be created in one of several ways, including the following:


- [Physical nexus](https://www.numeral.com/blog/physical-nexus) is created if a store has in-person connections to the state. This can happen if it has office or retail locations, stores inventory, or employs many people within the state.
- [Economic nexus](https://www.numeral.com/blog/economic-nexus) is created if a company engages in a certain level of economic activity in a state, even if it has no physical presence there. State laws differ on how much business a company must do, but typically they must either have a certain number of transactions (often 200+) or over a certain amount in sales (often $100,000).
...
[Numeral](https://www.numeral.com/) makes it easy to track nexus. We monitor when your business has established nexus, send alerts, and even take care of registering with the state on the company's behalf. Best of all, you can[track nexus with Numeral](https://www.numeral.com/product/nexus-tracking) completely for free.
...
Each state has its own registration process. For example, in Florida, companies can register online or submit a paper form,[Form DR-1](https://floridarevenue.com/Forms_library/current/dr1.pdf) . This form requires specific information about the registering business including:
...
If your exposure is significant, you may want to consider a[Voluntary Disclosure Agreement (VDA)](https://www.numeral.com/blog/voluntary-disclosure-agreement) . VDAs let you come forward proactively about missed past tax liabilities, and most states reward that by limiting the lookback period and/or waiving penalties, which is far less costly than an audit.


[Numeral can handle registrations](https://www.numeral.com/product/registrations) for customers automatically. As you're approaching nexus in a state, we send you an alert and automatically register in new states when needed with our Autoregister feature.


## Step 3: Determine Taxable Products and Services


Sales tax compliance is complicated by the fact that not all products and[services](https://www.numeral.com/blog/sales-tax-on-services) are taxable, and the rules for exempt goods vary by jurisdiction. Some examples of items that are often considered non-taxable include:
...
[Software as a service (SaaS)](https://www.numeral.com/blog/sales-tax-on-saas) and[digital goods](https://www.numeral.com/blog/sales-tax-on-digital-goods) may also be non-taxable, although a growing number of jurisdictions are starting to tax products and services delivered electronically.


When it comes to services, on the other hand,[some states default to not taxing most services](https://www.numeral.com/blog/sales-tax-on-services) , but *some* services remain subject to sales tax. Services to businesses, services to real property such as carpentry work, and professional services such as legal work are often not taxed, but the rules do differ by location.
...
The right software solution, such as[Numeral](https://www.numeral.com/) , can automate this process, integrating with your billing platforms to ensure that when customers across different states make purchases, they are taxed only on items that are taxable within their location.


## Step 4: Collect the Right Amount of Sales Tax


Sales tax rates also vary by location. For example, while[California](https://www.numeral.com/blog/california-sales-tax-guide) charges a 7.25% sales tax rate,[New York's](https://www.numeral.com/blog/new-york-sales-tax-guide) sales tax rate is just 4%. Further complicating matters, some cities and counties impose an additional sales tax. For example, customers in Philadelphia may be required to pay:


- A[6% Pennsylvania sales tax](https://www.numeral.com/blog/pennsylvania-sales-tax-guide)
- A[2% Philadelphia county tax](https://www.pa.gov/agencies/revenue/resources/tax-types-and-information/sales-use-and-hotel-occupancy-tax)
...
The taxable amount can also shift with promotions.[Discounts, coupons, and gift cards are taxed differently](https://www.numeral.com/blog/sales-tax-on-discounts-coupons-gift-cards) depending on who funds the discount and when it's applied.


While all of this is often confusing for businesses, sales tax software like[Numeral](https://www.numeral.com/) can make this process effortless. Numeral automatically determines what rules apply to each transaction,[what tax rates apply](https://www.numeral.com/blog/what-is-a-tax-engine) , what products are taxable, and how much tax is due. Customers are charged the correct amount instantly and effortlessly, and your business stays in full compliance with sales tax rules in each state where you have nexus.
...
Before moving onto how to file and remit, it's worth noting that if you sell through platforms like Amazon, Etsy, or eBay,[marketplace facilitator laws](https://www.numeral.com/blog/marketplace-facilitator) may affect your obligations. In all 45 states that have sales tax, these platforms are required to collect and[remit sales tax](https://www.numeral.com/blog/remit-sales-tax) on your behalf for sales made on them. In this case, you typically won't owe tax on those transactions. Some states do, however, require you to report marketplace sales on your return even when the facilitator has already remitted the tax.
...
Departments of Revenue conduct[audits](https://www.numeral.com/blog/sales-tax-audit) periodically to ensure sales tax is paid as required. Companies must be prepared and ready in case they become the target of these audits as they will need to demonstrate that they have met their sales tax compliance obligations.
...
- Invoices
- Returns
- [Exemption Certificates](https://www.numeral.com/blog/sales-tax-exemption-certificates) , which are collected when items are purchased by a tax-exempt buyer such as an eligible nonprofit or government agencies
...
[Exemption Certificate Management (ECM) software solutions](https://www.numeral.com/product/exemption-certificate-management) like Numeral can help. We store all exemption certificates, invoices, returns, and other key documents in one central place. Records are easily searchable to find the information needed, and licensed tax experts can help answer questions to ensure that every business is audit-ready.
...
- **Industry-specific challenges.** Some companies, such as[eCommerce businesses](https://www.numeral.com/blog/ecommerce-sales-tax) and[SaaS companies](https://www.numeral.com/blog/sales-tax-on-saas) , face added complexities due to doing business in many jurisdictions, some with complicated rules. For example,[Connecticut mandates that SaaS is taxed](https://www.numeral.com/blog/saas-sales-tax-connecticut) at full tax rates, but SaaS for business use is taxed at a reduced 1% rate.


Overcoming these challenges is crucial to successfully scale operations across multiple states or internationally. If you're expanding, book a[demo with Numeral](https://www.numeral.com/demo) to see how we can help you stay compliant with just a few minutes of your time each month.
...
- **Training staff to understand and follow best practices** such as collecting exemption certificates at the point of sale when exempt entities make purchases and knowing[when exemption certificates expire in each state](https://www.numeral.com/blog/sales-tax-exemption-certificate-expiration-by-state) .
...
- **Using tax automation tools such as Numeral** . With[Numeral](https://www.numeral.com/) , companies can spend as little as five minutes monthly on sales tax compliance while enjoying the peace of mind that comes with knowing they've embraced a solution trusted by leading eCommerce and SaaS businesses.


Implementing effective solutions, like[Numeral](https://www.numeral.com/) , as early as possible helps companies establish best practices that protect them against audits and ensure successful sales tax management.
...
Nexus is the connection between your business and a state that creates a sales tax obligation. It can be[physical](https://www.numeral.com/blog/physical-nexus) —such as having an office, warehouse, or employees in the state—or[economic](https://www.numeral.com/blog/economic-nexus) —such as when you’ve exceeded $100,000 in annual sales or 200 transactions in the state, though rules vary by state.
...
Common exemptions include groceries, prescription drugs, clothing (in some states), and sales to nonprofits or government entities with a valid[exemption certificate](https://www.numeral.com/blog/sales-tax-exemption-certificates) . Exemptions vary by state, so you’ll need to verify taxability in each state where you have nexus.
...
A[VDA](https://www.numeral.com/blog/voluntary-disclosure-agreement) lets businesses with past sales tax exposure come forward proactively. Most states will limit the lookback period and waive penalties in exchange, making it far less costly than waiting for an audit.


### What is the difference between sales tax and use tax?


Sales tax is collected by the seller at the point of sale. Use tax is owed by the buyer when sales tax wasn’t charged, such as on purchases from out-of-state vendors, and must be self-reported. Learn more in our[sales tax vs. use tax guide](https://www.numeral.com/blog/use-tax-vs-sales-tax) .


### Do I need to collect sales tax on SaaS or digital products?


It depends on the state.[Some states tax SaaS](https://www.numeral.com/blog/sales-tax-on-saas) and[digital goods](https://www.numeral.com/blog/sales-tax-on-digital-goods) ; others don’t. The rules vary widely and continue to evolve, so you’ll need to check taxability in each state where you have nexus.


### How do marketplace facilitator laws affect my sales tax obligations?


In all 45 states that require sales tax,[marketplace facilitator laws](https://www.numeral.com/blog/marketplace-facilitator) require platforms like Amazon, Etsy, and eBay to collect and remit sales tax on marketplace sales on your behalf. Note that you’re still responsible for sales made through your own website or other direct channels.
