...
document_id: "db8a698460f43aa6e945eb61c0f88d1d1bf34b76af9ce541970a18ad52bf1d2b"
company_key: "yc-numeral"
company: "Numeral"
source_id: "yc-numeral-news-import-ccb600506820"
canonical_url: "https://www.numeral.com/blog/eu-vat-one-stop-shop-oss"
published_at: "2026-07-07T00:00:00+00:00"
first_seen_at: "2026-07-24T06:42:38.988035+00:00"
fetched_at: "2026-07-28T21:38:32.326002+00:00"
content_hash: "sha256:18326510889fc22bbe90265343b53d72000d0ed24899041d9b6338b7f407c550"
---
...
In 2021, this system was replaced as part of the VAT E-Commerce Package, which introduced new VAT rules, including the One Stop Shop (OSS) framework. This framework includes three schemes: One Stop Shop,[Import One Stop Shop](https://www.numeral.com/blog/import-one-stop-shop-ioss) , and the Non-Union One Stop Shop.
...
OSS didn't completely eliminate all VAT registration requirements, and you must be eligible to take part in it. However, it greatly simplified the[VAT compliance](https://www.numeral.com/blog/vat-compliance) process for companies selling across the EU.
...
For eligible companies, the One Stop Shop (OSS) simplifies the[EU VAT compliance](https://www.numeral.com/blog/eu-vat-compliance) process by allowing the business to select one country and register for OSS within that country. The EU country you select is your[member state of identification (MSI)](https://vat-one-stop-shop.ec.europa.eu/one-stop-shop/register-oss_en) .


Each state has its own registration process. For example, in Spain, you can register online using[Form 035](https://sede.agenciatributaria.gob.es/Sede/en_gb/censos-nif-domicilio-fiscal/formulario-035-cumplimentacion-presentacion-telematica.html) .


Once you've registered for OSS in your member state, you file a single quarterly return through your MSI portal if you are part of the union or non-union schemes. You file a monthly return and remit payments monthly if you are part of the[Import One Stop Shop Scheme](https://www.numeral.com/blog/import-one-stop-shop-ioss) .
...
- **What does it cover:** The supply of services directly to EU customers (B2C), including digital sales, consulting,[SaaS subscriptions](https://www.numeral.com/blog/global-vat-compliance-for-saas-and-software-companies) , ebooks, professional services, and more.
- **Where you register:** You can select any member state as your MSI. However, U.S.-based sellers often choose a country with an English-language portal, such as[Ireland](https://www.revenue.ie/en/vat/vat-ecommerce/non-union-scheme/index.aspx) , to make registration simpler.
...
The[Import One Stop Shop (IOSS) scheme](https://www.numeral.com/blog/import-one-stop-shop-ioss) was introduced as part of the EU VAT E-Commerce Package and came into effect on 1 July 2021. IOSS is used for non-EU businesses shipping low-value goods from outside of the EU, while OSS is for intra-EU sales.
...
## Who should use OSS (and who it doesn't help)
...
This means, for example, that if you want to sell across France, Germany, Italy, Spain, and Poland, through[Amazon's FBA](https://sellercentral-europe.amazon.com/help/hub/reference/external/G201855460?locale=en-GB) , you would need to directly register in all five countries.
...
A different scheme, called[reverse charge](https://www.numeral.com/blog/reverse-charge-vat) , applies to B2B transactions. If you are not established in the EU and sell to an EU-established buyer with a valid VAT number, the VAT compliance obligation shifts to the buyer under the reverse charge scheme.
...
Registering for the[One Stop Shop](https://vat-one-stop-shop.ec.europa.eu/one-stop-shop_en) is completed through your chosen member state of identification. Your options for your MSI depend on your company's status:
...
OSS returns[must be filed quarterly](https://vat-one-stop-shop.ec.europa.eu/one-stop-shop/declare-and-pay-oss_en) and they are due by the end of the month after each quarter. The table below shows the schedule for when returns must be submitted.
...
You must keep records of all OSS transactions for[10 years](https://europa.eu/youreurope/business/taxation/vat/one-stop-shop/index_en.htm) , and those records must be available electronically and provided to tax authorities upon request.
...
The fact that you cannot recover input VAT through OSS can be a major disadvantage if you have significant business costs in the EU. With[VAT rates in the EU](https://www.numeral.com/blog/eu-vat-rates) ranging from 17% to 27%, limits on your ability to quickly reclaim VAT paid on business purchases may have a large cost.


In order to[recover input VAT](https://taxation-customs.ec.europa.eu/taxation/vat/vat-directive/vat-refunds_en) that you paid in European countries where you have not submitted a local VAT registration, you must:
...
- **Use the**[13th Directive (86/560/EEC)](https://eur-lex.europa.eu/legal-content/EN/ALL/?uri=celex:31986L0560) **procedure** , which is for non-EU businesses. You can use this approach only if you meet specific requirements, including your business being located in a country that offers reciprocity or provides a process for a similar VAT refund to companies in EU countries.
...
Fortunately,[Numeral](https://www.numeral.com/) makes compliance effortless, including in truly complex situations, like for companies that have FBA inventory, sell multiple product types, or sell goods or services from both within and outside of the EU.


Numeral helps with[global tax compliance](https://www.numeral.com/solutions/global) by:
...
[Book a demo](https://www.numeral.com/demo) to learn more about how Numeral can help your business stay compliant across the globe.
