...
document_id: "6bf839d2bd231bbf81013547261bb7888b25a7dd79af09ca8395f0ab79e7e316"
company_key: "yc-numeral"
company: "Numeral"
source_id: "yc-numeral-news-import-ccb600506820"
canonical_url: "https://www.numeral.com/blog/ecommerce-sales-tax"
published_at: "2026-07-14T00:00:00+00:00"
first_seen_at: "2026-07-22T06:38:05.353492+00:00"
fetched_at: "2026-07-28T21:22:05.726331+00:00"
content_hash: "sha256:86cb21557fc0316f2b4c9073b4602cce5d91d1eba51a46c4155c48f2666ecd6b"
---
...
An e-commerce business is said to have nexus in a state when it has established a presence there that creates an obligation to collect sales tax. There are two types of nexus: physical and economic. Nexus thresholds vary from state to state, so[figuring out where you have nexus](https://www.numeral.com/blog/how-to-determine-nexus-with-every-state) isn’t always straightforward.
...
Physical nexus used to be the only type of nexus that businesses had to keep track of. But in 2018, the Supreme Court’s ruling in **[South Dakota v. Wayfair, Inc.](https://www.numeral.com/blog/south-dakota-v-wayfair) allowed states to start setting economic thresholds for nexus — typically, a total amount in annual sales and/or a number of transactions in a year.
...
Complicating matters, these thresholds vary from state to state. For instance, in Nevada, the threshold for total sales is $100,000. Next door in[California](https://www.numeral.com/blog/california-sales-tax-rules-for-online-sellers) , it’s $500,000. In Arkansas, you establish economic nexus when you have 200 separate transactions there in a calendar year. In New York, there is a revenue and transaction threshold.
...
For instance,[Texas](https://www.numeral.com/blog/texas-sales-tax-guide) has a statewide sales tax rate of 6.25%, but some cities and counties add their own taxes on top, meaning the total rate for a sale in Texas could be as high as 8.25%.
...
We offer[free nexus monitoring](https://www.numeral.com/product/nexus-tracking) that simplifies this process for businesses.
...
Note that these permits often have expiration dates. Permits in some states, such as[Arkansas](https://www.numeral.com/blog/arkansas-sales-tax-guide) , are active until canceled, while those in other states, such as Colorado, need to be renewed every two years. It’s really important to keep track of these renewal dates to avoid accidentally doing business without a valid permit.


Here at Numeral, we can help you[automatically register](https://www.numeral.com/product/registrations) in states once you establish nexus.
...
Since[exempt buyers](https://www.numeral.com/blog/sales-tax-exemption-certificates) aren't paying taxes on taxable items, they must provide exemption certificates, which prove to the seller that they should not be taxed on their purchases.
...
It’s important to note that exempt transactions can sometimes count toward[establishing economic nexus](https://www.numeral.com/blog/economic-nexus) .


You also need to consider whether you have to chargesales tax on coupons, discounts, and gift cards , as rules vary by state.


### 5. File your sales tax returns on time


Each state has[specific filing schedules,](https://www.numeral.com/blog/sales-tax-due-dates) and they are often tied to sales volume. For instance, if you’re collecting less than $100 in tax each month in a state, you may need to file only quarterly, while higher monthly amounts could mean filing monthly.
...
It helps to keep a visible, updated filing schedule for each state. For example, in[Missouri](https://www.numeral.com/blog/missouri-sales-tax-guide) , monthly sales tax returns are due on the very last day of the month, while quarterly returns are due on the last day of the month following the quarter’s end.


**Tip:** Create a tax calendar that maps out every filing deadline for each state where you’re registered. Better yet, use[Numeral for automatic filing and remittance](https://www.numeral.com/product/filing-and-remittance) .
...
[E-commerce sales tax software](https://www.numeral.com/blog/ecommerce-sales-tax-software) can simplify everything from tracking nexus to automatically calculating the right tax rates based on each buyer’s address, and even filing your returns on schedule. As your business grows, investing in a tool like[Numeral](https://www.numeral.com/) ,[TaxJar](https://www.taxjar.com/) , or[Avalara](https://www.avalara.com/eu/en/index.html) can help you confidently stay compliant, save time, and reduce the risk of errors.
...
Alabama Yes[$250,000](https://www.numeral.com/nexus/alabama) 4.00% 9.29%


Alaska Yes, locally[$100,000](https://www.numeral.com/nexus/alaska) 0.00% 1.82%


Arizona Yes[$100,000](https://www.numeral.com/nexus/arizona) 5.60% 8.38%


Arkansas Yes[$100,000 or 200 transactions](https://www.numeral.com/nexus/arkansas) 6.50% 9.45%


California Yes[$500,000](https://www.numeral.com/nexus/california) 7.25% 8.85%


Colorado Yes[$100,000](https://www.numeral.com/nexus/colorado) 2.90% 7.81%


Connecticut Yes[$100,000 and 200 transactions](https://www.numeral.com/nexus/connecticut) 6.35% 6.35%


Delaware No[N/A](https://www.numeral.com/nexus/delaware) 0.00% 0.00%


District of Columbia Yes $100,000 or 200 transactions 6.00% 6.00%


Florida Yes[$100,000](https://www.numeral.com/nexus/florida) 6.00% 7.00%


Georgia Yes[$100,000 or 200 transactions](https://www.numeral.com/nexus/georgia) 4.00% 7.38%


Hawaii Yes[$100,000 or 200 transactions](https://www.numeral.com/nexus/hawaii) 4.00% 4.50%


Idaho Yes[$100,000](https://www.numeral.com/nexus/idaho) 6.00% 6.03%


Illinois Yes[$100,000 or 200 transactions](https://www.numeral.com/nexus/illinois) 6.25% 8.86%


Indiana Yes[$100,000](https://www.numeral.com/nexus/indiana) 7.00% 7.00%


Iowa Yes[$100,000](https://www.numeral.com/nexus/iowa) 6.00% 6.94%


Kansas Yes[$100,000](https://www.numeral.com/nexus/kansas) 6.50% 8.65%


Kentucky Yes[$100,000 or 200 transactions](https://www.numeral.com/nexus/kentucky) 6.00% 6.00%


Louisiana Yes[$100,000](https://www.numeral.com/nexus/louisiana) 5.00% 9.56%


Maine Yes[$100,000](https://www.numeral.com/nexus/maine) 5.50% 5.50%


Maryland Yes[$100,000 or 200 transactions](https://www.numeral.com/nexus/maryland) 6.00% 6.00%


Massachusetts Yes[$100,000](https://www.numeral.com/nexus/massachusetts) 6.25% 6.25%


Michigan Yes[$100,000 or 200 transactions](https://www.numeral.com/nexus/michigan) 6.00% 6.00%


Minnesota Yes[$100,000 or 200 transactions](https://www.numeral.com/nexus/minnesota) 6.88% 8.04%


If you’re selling through a platform like Amazon or eBay, your sales tax process can look a little different. These platforms are subject to[marketplace facilitator laws](https://www.numeral.com/blog/marketplace-facilitator) , which means they’re responsible for collecting and remitting sales tax on your behalf in states where such laws are active.
...
While[collecting sales tax through Shopify](https://www.numeral.com/blog/does-shopify-collect-and-remit-sales-tax) is pretty straightforward, remember that you’re responsible for filing and remitting amounts to the right states. The easiest way to do this is to use a[Shopify app](https://www.numeral.com/blog/best-sales-tax-apps-for-shopify) or third-party sales tax software like Numeral to automate tax collection and filing. Read our[guide to setting up sales tax on your Shopify store](https://www.numeral.com/blog/set-up-sales-tax-on-shopify) to learn more.


**>> Using WooCommerce?**[Learn about setting up WooCommerce sales tax here](https://www.numeral.com/blog/woocommerce-sales-tax)


## What happens if you get audited?


State officials can perform a[sales tax audit](https://www.numeral.com/blog/sales-tax-audit) on your business in order to make sure you're in full compliance with sales tax laws.
...
One option is to participate in a[sales tax amnesty program](https://www.numeral.com/blog/sales-tax-amnesty-programs) . States sometimes offer amnesty programs at the discretion of taxing authorities to encourage companies to come forward, voluntarily report unpaid taxes, and come into compliance.
...
[Voluntary disclosure agreements](https://www.numeral.com/blog/voluntary-disclosure-agreement) (VDAs) are another alternative, and this may be a more viable option since you control when you enter into one. When you create a VDA, you negotiate an agreement with the Department of Revenue for the state where you owe back taxes. If there are multiple states, you can choose to submit a[Multistate Voluntary Disclosure application](https://www.mtc.gov/nexus/multistate-voluntary-disclosure-program/) .
...
SST member states are typically required to have just one local tax rate, and they must use standard definitions for administrative terms, products, and services. Sellers can also use a single platform, the[SST Registration System](https://www.sstregister.org/) , to register to collect sales tax in all of the member states, and they can use a standard[one-page exemption certificate](https://www.streamlinedsalestax.org/Shared-Pages/exemptions-) for all exempt transactions within SST states.


## **What should dropshippers know?**


Dropshippers send products directly from manufacturers to consumers, without keeping items in inventory. Unfortunately, sales tax compliance can become[complicated for dropshippers](https://www.numeral.com/blog/dropshipping-and-sales-tax) . In general:
...
Cross-border sales usually require the collection of[value-added tax (VAT)](https://www.numeral.com/blog/vat-compliance) or goods and services tax (GST), on top of any other local sales taxes. Unlike U.S. sales tax, VAT and GST are consumption taxes paid by the end customer, and they’re often included in the product price.
...
- **United Kingdom:** Cross-border e-commerce sellers shipping to the UK need to collect and remit[UK VAT](https://www.numeral.com/blog/uk-vat-rates-compliance) if the consignment value is £135 or less. For amounts above £135, the buyer is responsible for paying VAT at customs.
- **Canada:** GST/HST registration is required if your[Canadian sales exceed CA$30,000 annually](https://www.numeral.com/blog/sales-tax-compliance-when-selling-into-canada) . Note that[sales tax rates in Canada](https://www.numeral.com/blog/canada-gst-hst-rates-compliance) are different in each province.
...
Understanding and managing sales tax is a crucial part of[e-commerce accounting](https://www.numeral.com/blog/ecommerce-accounting) and running an e-commerce business, in general.
