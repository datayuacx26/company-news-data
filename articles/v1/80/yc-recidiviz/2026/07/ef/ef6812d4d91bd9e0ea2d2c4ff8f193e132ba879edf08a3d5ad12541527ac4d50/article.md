...
document_id: "ef6812d4d91bd9e0ea2d2c4ff8f193e132ba879edf08a3d5ad12541527ac4d50"
company_key: "yc-recidiviz"
company: "Recidiviz"
source_id: "yc-recidiviz-news-import-9fcc86c2623e"
canonical_url: "https://www.recidiviz.org/updates/reentry-resource-network-case-planning"
published_at: null
first_seen_at: "2026-07-22T11:03:47.789737+00:00"
fetched_at: "2026-07-28T21:38:24.318832+00:00"
content_hash: "sha256:ce553f8442119e24eb255ab00e9e93f09544d8b212044d4b4a7e1baf3e1712d8"
---
...
The[Case Planning Assistant's](https://www.recidiviz.org/case-planning-assistant) Action Plan already provides a structured, personalized roadmap for people reentering the community — including local resources, concrete next steps, and short- and long-term goals designed to support stability after release.
...
- [Center for Employment Opportunities (CEO)](https://www.ceoworks.org/) — a nonprofit that provides immediate and comprehensive employment services exclusively to people recently released from incarceration. Through their transitional employment program, CEO gives participants a pathway to full-time work and long-term financial stability.
- [FreeWorld](https://freeworld.org/) — a tech-enabled nonprofit dedicated to ending generational poverty and recidivism. Through their Document Assistant, people can secure birth certificates and Social Security cards — foundational documents required for employment, housing, and benefits enrollment.
- [mRelief](https://www.mrelief.com/) — a technology nonprofit that provides SNAP (food stamp) enrollment support. For people in the early days after release, benefits access can be a critical source of stability — and one less barrier for officers managing their transition.
- [SkillUp Coalition](https://skillup.org/) — a nonprofit that matches people skilled through alternative routes with living-wage jobs, offers personalized career guidance and connects them to training and advancement opportunities. SkillUp’s platform facilitates meaningful career progress, which is one of the strongest predictors of long-term success.
...
FreeWorld is a tech-enabled nonprofit that educates returning citizens in high-demand, high-wage careers so they can live fulfilling lives, prison-free. Their mission is to end generational poverty and recidivism.[Learn more →](https://www.freeworld.org/)


### **mRelief**


mRelief is a technology nonprofit whose mission is to transform access to social services for the inherent dignity of all people. Since 2014, mRelief has helped more than 5.6 million people unlock more than $2.3 billion in SNAP benefits across all 50 states, DC, Guam and the U.S. Virgin Islands.[Learn more →](https://www.mrelief.com/)


### **SkillUp Coalition**


SkillUp Coalition is a nonprofit that connects workers with quality, living-wage jobs and career growth opportunities — no college degree required. Their platform has connected more than 4.3 million workers to career, training, and job support nationwide.[Learn more →](https://www.skillup.org/)
