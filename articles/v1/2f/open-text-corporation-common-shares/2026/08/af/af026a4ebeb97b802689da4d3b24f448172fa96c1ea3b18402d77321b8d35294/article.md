...
document_id: "af026a4ebeb97b802689da4d3b24f448172fa96c1ea3b18402d77321b8d35294"
...
**For updates on OpenText Core Capture,**[read the blog](https://blogs.opentext.com/whats-new-in-opentext-core-capture/) **.**
...
### What’s new in OpenText Core Signature CE 25.1
...
**Find out what’s new in**[OpenText™ Core Capture](https://blogs.opentext.com/whats-new-in-opentext-core-capture/) **.**
...
**You can also find out what’s new in**[OpenText™ Core Capture](https://blogs.opentext.com/whats-new-in-opentext-core-capture/) .
...
Find out what’s new in Core Capture CE 24.1[in this blog](https://blogs.opentext.com/whats-new-in-opentext-core-capture/) .
...
## October 2022:[What’s new in Core Content CE 22.4](https://blogs.opentext.com/enable-users-to-work-how-they-want-while-securing-company-ip/)
...
## June 2022:[What’s new in OpenText Core Content CE 22.2](https://blogs.opentext.com/power-modern-work-with-a-complete-saas-content-services-platform/)


### User experience enhancements


Enhancements include integration with Microsoft® Teams to deliver the combination of information management, collaboration, business processes and compliance in one SaaS content services platform, as well as integration with[OpenText™ Core Capture](https://www.opentext.com/products-and-solutions/products/enterprise-content-management/intelligent-capture/core-capture) to provide a complete intelligent capture solution. This release also enables users to create a shareable link quickly and easily for external collaboration and adds the power to create, manage and apply centralized records policies across the organization.
...
Recent enhancements include the integration of[OpenText™ Core Signature](https://www.opentext.com/products-and-solutions/products/opentext-core-signature) with[OpenText™ Core Content](https://www.opentext.com/products-and-solutions/products/saas-content-services-platform) **** and[OpenText ™ Core for SAP Success Factors®](https://www.opentext.com/products-and-solutions/products/opentext-suite-for-sap/opentext-core-for-sap-successfactors) **,** delivering complementary e-signature capabilities to simplify complex business processes and keep approval workflows moving. Enhancements to[OpenText™ Core Signature Service](https://www.opentext.com/file_source/OpenText/en_US/PDF/opentext-po-core-signature-service-en.pdf) **** offer enhanced control over document forwarding, plus access to a rich set of APIs and tools to customize the user experience while retaining visibility, security, and control.


## November 2021:[What’s new in OpenText Core Content CE 21.4](https://blogs.opentext.com/whats-new-in-opentext-core-content-ce-21-4/)
