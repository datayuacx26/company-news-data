...
document_id: "21060a52569fa32123d3c759e742e9494a34b43c3a1a310f306e05b3cc1a1b16"
company_key: "yc-validere"
company: "Validere"
source_id: "yc-validere-rss-c552d02067af"
canonical_url: "https://blog.validere.com/ogmp-2-0"
published_at: "2026-08-04T15:52:40+00:00"
first_seen_at: "2026-08-04T17:40:07.261275+00:00"
fetched_at: "2026-08-04T18:43:13.169222+00:00"
content_hash: "sha256:6fc380f3596dd1ea73f9a164c05d44eb9fbe508485f061713401f372dbe45c5a"
---

# OGMP 2.0 Guide: Levels, Reporting & Gold Standard | Validere
...
OGMP 2.0 is UNEP’s flagship methane reporting and mitigation programme for oil and gas. UNEP describes it as the[only comprehensive measurement-based international reporting framework](https://www.ogmpartnership.org/) for the sector. As of UNEP’s April 2025 introduction materials, member companies represent over 150 organizations and more than 42% of global oil and gas production.
...
[Download: OGMP 2.0 Implementation Checklist →](https://blog.validere.com/hubfs/OGMP%202.0%20Implementation%20Checklist%20_%20Validere.pdf) **.** One-page companion for Year 1 foundations through reconciliation readiness.


### At a glance


- **What it is:** UNEP’s measurement-based methane reporting and mitigation framework for oil and gas, covering operated and non-operated assets across the value chain (excluding end use).
- **What “Gold Standard” means:** A credible pathway to Level 4/5 for material assets within three years (operated) and five years (non-operated), then progress toward annual Level 5 reporting.
- **What Level 5 is:** Reconciliation of a Level 4 source inventory with independent site-level measurements, not site-level measurement alone.
- **What it is not:** A regulation, a technology mandate, or a product certification scheme such as[MiQ](https://miq.org/the-technical-standard/) .
...
### The Four Pillars of Successful OGMP Implementation (Validere synthesis)


UNEP defines the reporting levels and Gold Standard clocks. What the Framework does not name explicitly is the operating system underneath a programme that works. Based on the[OGMP 2.0 Reporting Framework](https://www.ogmpartnership.org/sites/default/files/documents/2025-04/OGMP_20_Reporting_Framework.pdf) , related guidance, and common implementation patterns, Validere groups successful programme design around four pillars:
...
### History: from OGMP to OGMP 2.0


The original Oil & Gas Methane Partnership launched in 2014 under the Climate and Clean Air Coalition and was implemented by UNEP ([partnership overview](https://www.ogmpartnership.org/partnership) ). Early public reporting emphasized participation, core sources, mitigation status, and reductions. It did not put company methane emission totals into the public domain in the way stakeholders later demanded.
...
### Purpose and relationship to IMEO
...
OGMP data also feed UNEP’s[International Methane Emissions Observatory (IMEO)](https://methanedata.unep.org/oil-gas-methane-partnership) . IMEO integrates company reporting with satellite observations, scientific measurement studies, and national inventories. On the[Eye on Methane data platform](https://methanedata.unep.org/oil-gas-methane-partnership) , IMEO describes a four-step assurance process: data quality review, analytics across the partnership, integration of independent datasets, and implementation-plan review. IMEO is also a core implementing partner of the[Global Methane Pledge](https://www.globalmethanepledge.org/) .
...
- Scope 1 methane only
- Operated assets and non-operated joint ventures subject to materiality rules
- Upstream exploration and production, gathering and processing, LNG liquefaction and regasification, gas transmission, underground storage, and distribution
- Oil production where associated gas is co-produced
- All methane sources: venting, fugitives, and incomplete combustion (including flaring)
...
- Scope 2 and Scope 3
- Oil refining and chemical manufacturing (treated as end users; possible later phase)
- Gas end use
- Non-operated joint ventures where equity is below 5% (still listed as excluded)
...
1. Define and disclose a methane reduction target (absolute or intensity-based)
2. Submit an implementation plan describing the pathway to Gold Standard
3. Report annually on methane emissions from operated and non-operated assets, revising the plan as needed
...
## Why the industry moved beyond emission-factor reporting
...
Traditional inventories multiply activity data by generic emission factors. That approach is fast, comparable, and cheap. It is also structurally weak on the sources that matter most for mitigation. Scientific literature and UNEP’s[Uncertainty and Reconciliation guidance](https://www.ogmpartnership.org/sites/default/files/2025-04/OGMP-2.0-UR-Guidance-document-SG-approved%20%281%29.pdf) both emphasize that methane distributions are often skewed and fat-tailed. A small number of sources or sites can account for a disproportionate share of emissions. Sampling designs that assume a neat average systematically understate risk.


The International Energy Agency’s[Global Methane Tracker 2025](https://www.iea.org/reports/global-methane-tracker-2025/key-findings) puts the credibility problem in numbers. Measured emissions tend to be higher than reported emissions. Little or no measurement-based data is used for reporting in most of the world. Around 10% of emissions reported into OGMP 2.0 now sit in the most stringent data category, and some companies reached that highest reporting level in 2024.
...
[EU Methane Regulation (EU) 2024/1787](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX%3A32024R1787)
...
[US EPA Subpart W](https://www.epa.gov/system/files/documents/2024-05/subpart-w-rule-fact-sheet.pdf) **(May 2024 amendments)**
...
[Canada / ECCC](https://www.canada.ca/en/environment-climate-change/services/climate-change/greenhouse-gas-emissions/inventory/technical-overview-changes-british-columbia-oil-gas-methane-emissions.html) **national inventory**
...
## Understanding the five OGMP reporting levels
...
Do not equate OGMP levels with IPCC inventory tiers. The Framework warns they differ conceptually. The[official FAQ](https://www.ogmpartnership.org/frequently-asked-questions) notes congruence with IPCC approaches, then adds that OGMP requires reconciliation of source-level and site-level reporting beyond IPCC Tier 3.
...
### Level 1: consolidated venture, asset, or country reporting
...
### Level 2: category-level reporting
...
### Level 4: detailed source types with specific emission and activity factors
...
- source-level measurement and sampling
- measurement-derived company emission factors
- detailed engineering calculations or simulation tools where appropriate
...
### Level 5: Level 4 plus independent site-level measurement and reconciliation
...
### Materiality rules that determine where Level 4/5 applies


**Portfolio level**


1. Rank assets by absolute emissions on a 100% basis (not equity) using at least Level 3 for operated assets.
2. Assets accounting for 95% of total emissions are material and must progress to Level 4/5 on the operated or non-operated timeline.
3. The bottom 5% are still reported but are not required to reach Level 4/5.
4. Non-operated assets below 5% equity are not material and are listed as excluded.


**Asset level**


1. Rank sources using best available data (minimum Level 3).
2. Perform Level 4 on sources that account for at least 70% of the asset’s methane emissions, with justification if coverage does not exceed 90%.
3. Prioritize deeper Level 4 coverage on assets that dominate operator-level emissions.
...
## How OGMP reporting works in practice
...
### 2. Produce a complete Level 3 map before chasing measurement theatre
...
### 3. Run portfolio and asset materiality
...
### 4. Set the methane target and write the implementation plan
...
### 5. Design measurement and sampling for Level 4 and Level 5 separately
...
### 6. Quantify, quality-check, and estimate uncertainty
...
### 7. Reconcile where Level 5 applies
...
### 8. Complete templates, submit by 31 May, and prepare for review
...
### Reasonable and demonstrable effort for joint ventures
...
## What an OGMP implementation roadmap actually looks like
...
- Confirm MoU, governance owners, and reporting calendar through 31 May
- Build the operated and NOJV asset universe, including equity and operator flags
- Agree asset / site / source hierarchies with operations, HSE, and sustainability
- Produce a complete Level 3 source inventory for ranking
- Run portfolio and asset materiality
- Set the methane target and draft the implementation plan by asset
- Identify where existing LDAR, flare, and production data already support Level 4 methods
- Stand up evidence standards: method versions, campaign metadata, approvals
...
### Year 2: Level 4 depth


- Prioritize Level 4 methods on the largest sources inside the largest assets
- Design sampling for fat-tailed distributions, not convenience samples
- Separate source-level measurement campaigns from any planned site-level work
- Quantify uncertainty where it can change decisions
- Reconcile method changes versus actual reductions in internal management reports
- Expand NOJV engagement with documented requests and barriers
- Pilot Level 5 on a bounded set of sites or populations (often aligned with UNEP’s “about one-third” demonstration guidance)
...
### Year 3: reconciliation and Gold Standard for operated assets


- Expand Level 5 coverage across material operated assets
- Institutionalize reconciliation: compare, investigate, adjust, revise Level 4 methods, replan sampling
- Tighten QA/QC and audit trails so the May submission is a package, not a scramble
- Use reconciled results to redirect mitigation spend toward confirmed material sources
- Refresh materiality if portfolio or emissions changed significantly
- Keep the non-operated plan on the five-year clock with visible progress
...
### Years 4 to 5 and beyond: optimize and sustain


- Bring material NOJVs to Level 4/5 where data access allows
- Move from campaign-centric measurement toward risk-based frequency, including continuous monitoring where it answers a real temporal question
- Maintain Gold Standard by progressing toward annual Level 5 reporting
- Reuse the same governed data for regulatory, certification, and ESG outputs where boundaries allow
- Treat mitigation response time as a programme KPI, not only inventory quality
...
OGI, handheld[LDAR](https://www.validere.com/ldar-software) , close-range sensors
...
### Satellite caveats that belong in every Level 5 plan
...
### How technologies should complement one another
...
### Sampling that ignores fat tails
...
### Reconciliation treated as arithmetic
...
## How software supports successful OGMP programmes
...
As organizations progress from Level 3 inventories toward Level 4 and Level 5 reporting, the challenge increasingly shifts from measurement alone to coordinating operational data, measurement results, calculation methodologies, QA/QC processes, and reporting evidence across multiple systems. That is where[emissions management software](https://blog.validere.com/emissions-management-software) becomes operational infrastructure rather than a reporting tool.


Platforms designed for industrial emissions programmes, including Validere, are built around that coordination problem: connecting operational data, hardware-agnostic[measurement inputs](https://www.validere.com/emissions-measurement-and-response) , calculation methods, and reporting evidence so methane programmes can move from factor-based inventories toward measurement-informed and reconciled reporting without rebuilding the process every May.


Validere is not required for OGMP membership, is not UNEP-endorsed, and does not replace measurement providers or engineering judgment. Where it fits is as an example of an[Air & GHG](https://www.validere.com/emissions) approach that treats OGMP as an operating workflow: asset hierarchies, measurement integration, calculation transparency, and audit-ready lineage supporting[voluntary emissions reporting](https://www.validere.com/voluntary-emissions-reporting) pathways that include OGMP 2.0 alongside[regulatory air and GHG reporting](https://www.validere.com/regulatory-air-and-ghg-reporting) .


Teams evaluating software for methane programmes should look past dashboards and ask how exceptions are investigated, how method versions are preserved, and whether the same governed data can support[emissions reporting](https://blog.validere.com/emissions-reporting-software) ,[LDAR programme management](https://blog.validere.com/ldar-software) , and broader[environmental compliance](https://blog.validere.com/how-to-choose-environmental-compliance-software) work without parallel shadow systems.


---


## If you are starting an OGMP programme tomorrow


Begin with these five actions:


1. **Build your asset hierarchy** with operations, HSE, and sustainability in the same room until “asset,” “site,” and “source” mean one thing.
2. **Finish your Level 3 inventory** for ranking before commissioning another measurement campaign.
3. **Identify material assets** using the 95% absolute-emissions rule, then rank sources inside those assets.
4. **Do not buy technology before you know your measurement questions.** Map each purchase to a Level 4 method need or a Level 5 reconciliation need.
5. **Treat reconciliation as a recurring operating process** , with owners, evidence standards, and a place to record investigation findings.
...
[Download the one-page OGMP 2.0 Implementation Checklist →](https://blog.validere.com/hubfs/OGMP%202.0%20Implementation%20Checklist%20_%20Validere.pdf)
...
- OGMP 2.0 exists because two similar inventories can conceal very different real-world methane performance. Measurement and reconciliation are how that gap closes.
- The five levels increase source granularity, method specificity, and, at Level 5, independent site-level reconciliation.
- Successful programmes tend to share four characteristics in Validere’s synthesis: complete inventory, representative measurement, governed reconciliation, and continuous improvement.
- Gold Standard is a pathway and performance designation with three- and five-year clocks. Level 5 is the methodological endpoint those clocks aim toward.
- A practical roadmap sequences foundation, Level 4 depth, then reconciliation at scale. Inverting that order is a common and expensive failure mode.
- Software should support the workflow after the educational questions are clear: hierarchy, methods, measurements, evidence, and reusable reporting.
...
### What are the five reporting levels?
...
### Does OGMP prescribe specific technologies?
...
### Can satellites alone achieve Level 5?
...
### Must companies climb one level per year?
...
### Can different assets be reported at different levels?
