...
document_id: "c129090bd4453559075111beaf3c0c7c22055118991275d155507d54a3da4fdb"
company_key: "yc-validere"
company: "Validere"
source_id: "yc-validere-rss-c552d02067af"
canonical_url: "https://blog.validere.com/epa-ghgrp-reporting-guide"
published_at: "2026-08-09T21:44:59+00:00"
first_seen_at: "2026-08-10T04:00:32.999626+00:00"
fetched_at: "2026-08-10T04:00:33.737799+00:00"
content_hash: "sha256:152f5138fc385900c5a9f181a3203730f32cdc5cb5de531aef1092cc7dcaf1f3"
---

# EPA GHGRP Reporting Guide for Oil & Gas | Validere

EPA’s Greenhouse Gas Reporting Program requires covered oil and gas facilities and suppliers to do more than report an annual emissions total. Depending on the applicable[40 CFR Part 98](https://www.ecfr.gov/current/title-40/chapter-I/subchapter-C/part-98) requirements, teams may need to collect operational and measurement data, apply prescribed calculation methods, complete QA/QC, retain supporting records, submit through e-GGRT, and respond to EPA verification questions.
...
The GHGRP is EPA’s mandatory federal program, codified at[40 CFR Part 98](https://www.ecfr.gov/current/title-40/chapter-I/subchapter-C/part-98) , that requires reporting of greenhouse gas (GHG) data and other relevant information from large GHG emission sources, fuel and industrial gas suppliers, and CO2 injection sites in the United States. See[What is the GHGRP?](https://www.epa.gov/ghgreporting/what-ghgrp) and the[GHGRP homepage](https://www.epa.gov/ghgreporting) .
...
- Facilities calculate emissions using methodologies specified in Part 98 and submit data through EPA’s electronic Greenhouse Gas Reporting Tool ([e-GGRT](https://ghgreporting.epa.gov/ghg/login.do) ).
...
[May 14, 2024](https://www.epa.gov/ghgreporting/rulemaking-notices-ghg-reporting) final rule revising Subpart W, with related revisions to Subparts A and C (89 FR 42062)


Final amendments. EPA phased implementation across RY2024 and RY2025, with most changes applying beginning with RY2025 reports. See the[Subpart W rule fact sheet](https://www.epa.gov/system/files/documents/2024-05/subpart-w-rule-fact-sheet.pdf) .


Final


[February 27, 2026](https://www.epa.gov/ghgreporting/rulemaking-notices-ghg-reporting) final rule extending the RY2025 deadline to October 30, 2026 (91 FR 9712)
...
EPA states the WEC regulation no longer has force of law and is not in effect. See the[rulemaking notices](https://www.epa.gov/ghgreporting/rulemaking-notices-ghg-reporting) WEC section.


Proposed only


[September 16, 2025](https://www.epa.gov/ghgreporting/rulemaking-notices-ghg-reporting) proposed reconsideration (90 FR 44591)
...
EPA’s general description of annual timing remains March 31 for the prior calendar year, subject to specific-year changes such as the RY2025 extension to October 30, 2026. Confirm the current deadline on EPA’s[rulemaking notices](https://www.epa.gov/ghgreporting/rulemaking-notices-ghg-reporting) and e-GGRT notices before filing.
...
EPA’s[For GHG Reporters](https://www.epa.gov/ghgreporting/ghg-reporters) page states that Part 98 applies to certain facilities that emit 25,000 metric tons or more of GHGs per year; certain suppliers of fossil fuels, industrial GHGs, and products containing GHGs; and facilities that inject CO2 underground.


On[What is the GHGRP?](https://www.epa.gov/ghgreporting/what-ghgrp) , EPA explains that facilities and suppliers determine whether they are required to report based on industrial operations, emission levels, or other factors. EPA also states that facilities and suppliers are generally required to submit annual reports under Part 98 if:
...
[Subpart W](https://www.epa.gov/ghgreporting/subpart-w-petroleum-and-natural-gas-systems) – Petroleum and Natural Gas Systems
...
[Subpart Y](https://www.epa.gov/ghgreporting/subpart-y-petroleum-refineries) – Petroleum Refineries
...
[Subpart MM](https://www.epa.gov/ghgreporting/subpart-mm-suppliers-petroleum-products) – Suppliers of Petroleum Products
...
[Subpart NN](https://www.epa.gov/ghgreporting/subpart-nn-suppliers-natural-gas-and-natural-gas-liquids) – Suppliers of Natural Gas and Natural Gas Liquids
...
In May 2024, EPA finalized amendments intended to address reporting gaps, expand or improve calculation methodologies so reporting is based more on empirical data, and improve verification and transparency, with implementation phased across RY2024 and RY2025. For current text, use the[eCFR Subpart W](https://www.ecfr.gov/current/title-40/chapter-I/subchapter-C/part-98/subpart-W) and EPA’s[Subpart W hub](https://www.epa.gov/ghgreporting/subpart-w-petroleum-and-natural-gas-systems) .


### Subpart Y: Petroleum Refineries


[Subpart Y](https://www.epa.gov/ghgreporting/subpart-y-petroleum-refineries) covers petroleum refineries that meet the source category definition. EPA states that Subpart Y does not specify a minimum emissions threshold, so it applies to all petroleum refineries that meet that definition. Refineries may also have obligations under other subparts (for example, combustion under Subpart C, or supplier reporting under Subpart MM).


### Subpart MM: Suppliers of Petroleum Products


[Subpart MM](https://www.epa.gov/ghgreporting/subpart-mm-suppliers-petroleum-products) is supplier-oriented. EPA’s Subpart MM page states that suppliers who must report include refiners (owners and operators of petroleum refineries producing covered petroleum products through distillation of crude oil), and importers and exporters of listed petroleum products or natural gas liquids in quantities equivalent to 25,000 metric tons CO2e or more per year. Under Subpart MM, reporters report information related to the CO2 that would be emitted if supplied products were combusted, released, or oxidized, rather than facility direct process emissions under that subpart.


### Subpart NN: Suppliers of Natural Gas and Natural Gas Liquids


[Subpart NN](https://www.epa.gov/ghgreporting/subpart-nn-suppliers-natural-gas-and-natural-gas-liquids) applies to natural gas and natural gas liquids suppliers. EPA’s oil and gas overview states that Subpart NN applies to all fractionators of natural gas liquids and to natural gas distribution companies that deliver 460,000 Mscf or more of natural gas per year. Facilities subject to Subpart NN report the emissions that would result from complete combustion or oxidation of the products they sell.
...
Capabilities environmental teams often evaluate in[emissions reporting software](https://blog.validere.com/emissions-reporting-software) and[emissions management software](https://blog.validere.com/emissions-management-software) include integrating source data; maintaining calculation logic under version control; preserving traceability from reported values to underlying inputs; supporting QA/QC and exception review; managing supporting evidence; tracking changes; generating reporting-ready outputs for internal review before e-GGRT submission; and supporting audit and management review workflows.


For teams that also automate multi-framework reporting packages, see[automating greenhouse gas reporting](https://blog.validere.com/automate-greenhouse-gas-reporting-emissions-software) .


Validere supports[regulatory air and GHG reporting](https://www.validere.com/regulatory-air-and-ghg-reporting) workflows by connecting environmental and operational data, emissions calculations, calculation transparency, QA processes, and evidence needed for review.


See how Validere supports[regulatory air and GHG reporting](https://www.validere.com/regulatory-air-and-ghg-reporting) .
...
EPA states that facilities report data using the electronic Greenhouse Gas Reporting Tool (e-GGRT). See EPA’s[For GHG Repor ters](https://www.epa.gov/ghgreporting/ghg-reporters) page and e-GGRT.
