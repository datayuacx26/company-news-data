...
document_id: "68294ae5a2cfd52e4d56c8f1ae073efa4bbc45bfa71c2482f8c7081eb67223c3"
company_key: "yc-didit"
company: "Didit"
source_id: "yc-didit-news-import-d47711ec305c"
canonical_url: "https://didit.me/blog/eu-ai-act-deepfake-labelling-2026/"
published_at: "2026-08-18T16:01:51.069+00:00"
first_seen_at: "2026-08-18T22:03:07.820071+00:00"
fetched_at: "2026-08-18T22:03:09.000730+00:00"
content_hash: "sha256:c785b5333f3ee9338c6651da6aaa0bca55c7cad8fe676d303cba8d49fb91d0b5"
---
...
1 Aug 2024 **The AI Act enters into force** — Regulation (EU) 2024/1689, published in the Official Journal on 12 July 2024, in force on the twentieth day after. Passed


2 Feb 2025 **Prohibited practices banned** — Chapters I and II apply: social scoring, certain manipulation and scraping practices. Passed


2 Aug 2025 **General-purpose AI model duties** — Chapter V applies to providers of general-purpose models placed on the market from this date. Passed


10 Jun 2026 **Code of Practice published** — Voluntary code on marking and labelling AI-generated content; Commission press release IP/26/1328. Passed


2 Aug 2026 **Article 50 applies** — The regulation as a whole applies. Marking, deepfake disclosure, chatbot identification and emotion-recognition notice duties are live. Fines to EUR 15m or 3%. In force


2 Dec 2026 **Marking grace period ends** — Systems placed on the market before 2 August 2026 must meet the machine-readable marking duty, per Commission guidance. Ahead


2 Aug 2027 **Article 6(1) high-risk duties apply** — The final tranche: high-risk classification for products under existing EU safety legislation. Ahead
...
Regulators have used that structure before: put the obligation where compliance can actually be obtained, so that the absence of the expected signal becomes informative. If mainstream generative systems mark their output machine-readably, unmarked synthetic content becomes the anomaly, and software on the receiving end has something to test for. The Gambling Commission's assessment of[AI on both sides of the identity check](https://didit.me/blog/gambling-commission-ai-identity-checks-2026/) described the attacking side; Article 50 is the first attempt to make that side announce itself.
...
The modules map onto the attack.[Passive Liveness](https://docs.didit.me/core-technology/liveness/) at **$0.10 per check** tests that a live person, not a replayed or generated video, is in front of the camera.[Face Match (1:1)](https://docs.didit.me/core-technology/face-match/) at **$0.05 per check** is precisely the confirmation Annex III describes: it compares the live capture against the document portrait to confirm the person is who they claim to be.[ID Verification](https://docs.didit.me/core-technology/id-verification/) at **$0.15 per check** reads and validates the document itself, and where the document carries a chip,[NFC Reading](https://docs.didit.me/core-technology/nfc-verification/) at **$0.15 per check** pulls cryptographically signed data that a screen-presented fake cannot supply. Current prices are on the[pricing page](https://didit.me/pricing/) .
...
- [AI is now on both sides of the gambling identity check](https://didit.me/blog/gambling-commission-ai-identity-checks-2026/) — The UK regulator's 30 July risk assessment names the deepfakes this labelling rule is aimed at.
- [EU law lets five years pass before you recheck who owns a customer](https://didit.me/blog/eu-amlr-ongoing-monitoring-article-26/) — The EU's other identity instrument, drafted with the same staged-dates pattern.
- [Asia is moving the cost of weak identity checks onto banks and platforms](https://didit.me/blog/asia-identity-verification-rules-2026/) — Japan is retiring photo-upload verification as deepfakes overtake document checks.
- [AMLR Article 26: how often must you recheck?](https://didit.me/blog/eu-amlr-ongoing-monitoring-article-26/) — What the EU expects after onboarding, from the same generation of rulebooks.


## Sources


1. [Regulation (EU) 2024/1689 laying down harmonised rules on artificial intelligence](https://eur-lex.europa.eu/legal-content/EN/TXT/HTML/?uri=CELEX:32024R1689) — European Parliament and Council · EUR-Lex · Articles 3(60), 50, 99, 113 and Annex III · applies from 2 August 2026
2. [Commission publishes Code of Practice on marking and labelling AI-generated content](https://ec.europa.eu/commission/presscorner/detail/en/ip_26_1328) — European Commission press release IP/26/1328 · 10 June 2026 · source of the Virkkunen statement
3. [Guidelines on transparency obligations for providers and deployers of certain AI systems](https://digital-strategy.ec.europa.eu/en/policies/guidelines-transparency-ai-generated-content) — European Commission · policy page updated 6 August 2026
4. [Transparency obligations under Article 50 of the AI Act](https://digital-strategy.ec.europa.eu/en/faqs/transparency-obligations-under-article-50-ai-act) — European Commission FAQ · source for the 2 December 2026 transitional and enforcement allocation
5. [Code of Practice on Transparency of AI-generated Content](https://digital-strategy.ec.europa.eu/en/policies/code-practice-ai-generated-content) — European Commission · voluntary compliance route for the marking and labelling duties
...
- [The stablecoin identity rule covers issuance and redemption, not what happens next](https://didit.me/blog/stablecoin-issuer-customer-identification-2026/)
