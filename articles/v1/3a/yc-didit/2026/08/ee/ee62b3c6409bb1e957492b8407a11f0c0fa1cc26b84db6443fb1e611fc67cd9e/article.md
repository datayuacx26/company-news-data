...
document_id: "ee62b3c6409bb1e957492b8407a11f0c0fa1cc26b84db6443fb1e611fc67cd9e"
company_key: "yc-didit"
company: "Didit"
source_id: "yc-didit-news-import-d47711ec305c"
canonical_url: "https://didit.me/blog/fcc-know-your-customer-voice-providers-2026/"
published_at: "2026-08-01T18:45:46.174+00:00"
first_seen_at: "2026-08-01T23:05:44.332956+00:00"
fetched_at: "2026-08-01T23:05:45.074472+00:00"
content_hash: "sha256:0917b5c6d2a148053abdf918ac419be270eff6af0e42f4d7bd67fd67a1a0bdd7"
---

# The FCC wants phone companies to run bank-style KYC.

[Back to blog](https://didit.me/blog/) Blog · August 1, 2026
...
The FCC also asked whether a tiered approach should apply: stricter requirements for high-volume callers, for callers using equipment associated with robocalling, or for particular traffic patterns. That is risk-based customer checking by another name, and it will be familiar to anyone who has built[point-of-sale identity checks for a newly regulated sector](https://didit.me/blog/austrac-tranche-2-precious-metals-dealers-guide/) .
...
For providers, the practical posture is the one that fits any rulemaking with a closed record and no adopted text: the fields and the verification steps are now reasonably predictable, the timetable is not. That is a familiar position, and the discipline that works is the same one that works for[any multi-year regulatory transition](https://didit.me/blog/austrac-reporting-transition-timeline-2026-2029/) : build against what the regulator has actually written down, and date every assumption.


Taken together, the two proceedings show the FCC pushing identity requirements at two different points in the call chain: who may hold phone numbers, and who may put calls on the network. The pattern will look familiar to anyone who has watched a financial regulator[extend obligations into sectors that never had them](https://didit.me/blog/austrac-tranche-2-precious-metals-dealers-guide/) .
...
Published rates are **$0.15** per ID Verification check, **$0.20** per Proof of Address, **from $0.03** per Phone Verification and **$2.00** per KYB bundle. The Full KYC bundle is **$0.33** per check, with 500 free every month. Current module prices are listed on the[pricing page](https://didit.me/pricing/) .
...
- [AUSTRAC Tranche 2 for dealers in precious metals & stones](https://didit.me/blog/austrac-tranche-2-precious-metals-dealers-guide/) — What point-of-sale identity checks look like when a sector is pulled into a regime for the first time.
- [The new AUSTRAC SMR form (2026)](https://didit.me/blog/austrac-new-smr-form-2026-guide/) — Expanded reportable details, and how reporting deadlines and record-keeping run on separate clocks.
- [Prediction markets: who are your users?](https://didit.me/blog/prediction-markets-identity-checks-2026/) — Three regulators examined a new market in 2026 and all landed on the same question about identity.
- [AUSTRAC new forms transition timeline (2026–2029)](https://didit.me/blog/austrac-reporting-transition-timeline-2026-2029/) — How to read a multi-year regulatory transition without missing the dates that bind.


## Sources


1. [Advanced Methods to Target and Eliminate Unlawful Robocalls; Rules and Regulations Implementing the Telephone Consumer Protection Act of 1991. Further Notice of Proposed Rulemaking, FCC 26-27](https://docs.fcc.gov/public/attachments/FCC-26-27A1.pdf) — Federal Communications Commission · Adopted 30 April 2026, released 1 May 2026
2. [Consumer and Governmental Affairs Bureau Announces Comment Dates for Know-Your-Customer Further Notice of Proposed Rulemaking. Public Notice DA 26-523](https://docs.fcc.gov/public/attachments/DA-26-523A1.pdf) — Federal Communications Commission · 26 May 2026
3. [Enhancing Know-Your-Customer Requirements](https://www.federalregister.gov/documents/2026/05/26/2026-10407/enhancing-know-your-customer-requirements) — Federal Register · Published 26 May 2026
4. [FCC Seeks Comment on Enhanced Know-Your-Customer Requirements](https://www.fcc.gov/document/fcc-seeks-comment-enhanced-know-your-customer-requirements) — Federal Communications Commission · Proceeding page
5. [50 State and Territory Attorneys General Urge Stronger KYC Rules to Fight Illegal Robocalls](https://www.naag.org/press-releases/50-state-and-territory-attorneys-general-urge-stronger-kyc-rules-to-fight-illegal-robocalls/) — National Association of Attorneys General · 28 July 2026
6. [Attorney General Jackley Urges Federal Government to Strengthen "Know Your Customer" Rules Against Illegal Robocalls](https://news.sd.gov/news?id=news_kb_article_view&sys_id=8fcfaa6e1b5e4f50464487f5604bcbeb) — Office of the Attorney General, South Dakota · 28 July 2026
7. [Bipartisan Coalition of 49 Attorneys General Urges Federal Action on Illegal Robocalls](https://www.naag.org/press-releases/bipartisan-coalition-of-49-attorneys-general-urges-federal-action-on-illegal-robocalls/) — National Association of Attorneys General · 8 July 2026 · numbering resources proceeding
8. [Trades Support FCC Effort to Strengthen Know Your Customer Safeguards on Telecom Providers](https://bpi.com/trades-support-fcc-effort-to-strengthen-know-your-customer-safeguards-on-telecom-providers/) — Joint comment of eleven financial trade associations · 25 June 2026
9. [CCA Files FCC Comments on Enhanced Know-Your-Customer Requirements](https://www.cloudcommunications.com/news/cca-files-fcc-comments-on-fyc) — Cloud Communications Alliance · 29 June 2026
10. [31 CFR § 1020.220: Customer identification program requirements for banks](https://www.ecfr.gov/current/title-31/subtitle-B/chapter-X/part-1020/subpart-B/section-1020.220) — US Department of the Treasury · Electronic Code of Federal Regulations
11. [47 CFR § 64.1200: Delivery restrictions](https://www.ecfr.gov/current/title-47/chapter-I/subchapter-B/part-64/subpart-L/section-64.1200) — Federal Communications Commission · Electronic Code of Federal Regulations
...
- [Asia is moving the cost of weak identity checks onto banks and platforms](https://didit.me/blog/asia-identity-verification-rules-2026/)
- [Six Latin American economies rewrote their identity rules in 21 months](https://didit.me/blog/latam-identity-verification-rules-2026/)
- [EU law lets five years pass before you recheck who owns a customer.](https://didit.me/blog/eu-amlr-ongoing-monitoring-article-26/)
- [The firms reporting the most risk to the FCA report the widest control gaps.](https://didit.me/blog/fca-asset-management-financial-crime-controls-2026/)
- [A risk assessment that did not work cost one operator £4.75 million.](https://didit.me/blog/gambling-commission-aml-enforcement-2026/)
- [Regulators are asking prediction markets about identity, not trading.](https://didit.me/blog/prediction-markets-identity-checks-2026/)
