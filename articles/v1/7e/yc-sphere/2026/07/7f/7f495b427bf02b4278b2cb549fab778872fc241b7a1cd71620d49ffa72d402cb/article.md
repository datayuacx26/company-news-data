...
document_id: "7f495b427bf02b4278b2cb549fab778872fc241b7a1cd71620d49ffa72d402cb"
company_key: "yc-sphere"
company: "Sphere"
source_id: "yc-sphere-news-import-5ec0a2b1b77f"
canonical_url: "https://www.getsphere.com/blog/south-korea-vat"
published_at: "2026-07-28T00:00:00+00:00"
first_seen_at: "2026-07-28T20:40:10.452362+00:00"
fetched_at: "2026-07-28T21:33:52.463534+00:00"
content_hash: "sha256:9415f417317c634758ebe96f93309a4cee206d831896e9bbae5f6d669a1f8546"
---

# South Korea VAT Guide for Digital Services

**South Korean VAT Facts**


**Taxes B2C Software:** Yes


**Taxes B2B Software:** Reverse charge applies


**South Korean’s VAT Rate:** 10% for most goods and services


**Requires local representative:** No (not with Simplified Registration Scheme)


**Administration difficulty:** 3 out of 5


**Tax authority website:**[National Tax Service (NTS)](https://hometax.go.kr/)
...
South Korea has a 10% standard VAT rate. This applies to most goods and services, including[software as a service (SAAS)](https://www.getsphere.com/blog/are-subscriptions-taxable) and other digital goods. South Korea has no reduced VAT rate and few or no exemptions or zero-rated items when it comes to selling SaaS or digital services.


VAT in South Korea is administered by the[National Tax Service (NTS)](https://hometax.go.kr/) , and the country has two separate VAT schemes. Businesses with physical presence or selling physical goods in the country are subject to the General VAT scheme. Nonresident businesses selling electronic services can take advantage of the Simplified Business Registration.


Non-resident digital service providers must register for South Korea's 10% VAT immediately upon their first sale. Consumer purchases (B2C) require the provider to charge VAT directly. Business-to-business sales (B2B) use[reverse charge](https://www.getsphere.com/blog/reverse-charge-vat) , where the purchasing business handles VAT obligations.
...
Businesses can register for South Korean VAT at the[NTS HOMETAX portal](https://hometax.go.kr/websquare/websquare.html?w2xPath=/ui/pp/a/a/UTXPPADA01.xml&menuCd=UTXPPADA00) . Unlike some jurisdictions, no local entity or fiscal representative is required.
...
1. Visit the[NTS HOMETAX portal](https://hometax.go.kr/websquare/websquare.html?w2xPath=/ui/pp/a/a/UTXPPADA01.xml&menuCd=UTXPPADA00)
2. Create an account
3. Click on “Simplified Business Operator Registration" (or equivalent wording)
4. Fill in your business details. This will include:


1. Business name, overseas address and contact info
...
## South Korea VAT Registration ProcessH2: Charging VAT on B2C vs B2B Sales
...
### Marketplace and Intermediary VAT Liability


If you sell through a marketplace, app store or other intermediary that collects payment from buyers on your behalf, that third party is generally responsible for VAT. This means the marketplace itself must register for VAT, collect the right amount, and remit at the end of the taxable period.


If all of your digital sales into South Korea are handled through third-party platforms that collect and remit VAT on your behalf, you might not be required to register separately for a VAT account. However, it’s vital to confirm in writing that your sales platform is handling the VAT on your behalf. And note that if you sell both through a third-party marketplace or app store and your own store, you’re still responsible for VAT for your own sales.
...
- A brief description of the goods and services supplied
- Invoice number
- VAT rate charged
- Total VAT charged
...
Also, for audit purposes, be sure to retain all invoices and other sales records for 5 years. Keeping track of your billing and tax obligations via a service like[Sphere](https://www.getsphere.com/) will save time and keep your books audit-ready.
...
Late filing or paying? Late VAT accrues a penalty of 0.02% interest per day. A service like[Sphere](https://www.getsphere.com/) handles VAT remittance in South Korea and around the world, ensuring you never pay fines or penalties.


## Penalties and Risks of VAT Non-Compliance


South Korea takes VAT noncompliance seriously. When expanding into the South Korean market, dealing with indirect taxes and VAT compliance should be one of your first concerns. If you sell B2C, you’re required to register for VAT before your first sale.


As of January 1, 2024, businesses that fail to complete simplified registration on time face a penalty equal to 1% of the supply price of their electronic services for the period before registration. On top of that, South Korea levies a 20% penalty plus 0.02% daily interest for filing late, paying late, or underpaying.
...
Managing South Korean VAT alongside other global tax obligations can quickly become overwhelming, which is why platforms like[Sphere](https://www.getsphere.com/) handle the entire compliance workflow - from monitoring sales thresholds and triggering registrations to calculating taxes, generating compliant invoices, and filing returns.
