...
document_id: "18788638d387d8d12ef1598933bc7f40c0dbff2647e7359212599195677bb111"
company_key: "yc-plivo"
company: "Plivo"
source_id: "yc-plivo-rss-7fc8cee78b57"
canonical_url: "https://www.plivo.com/blog/phone-numbers-for-texting/"
published_at: "2022-08-18T00:00:00+00:00"
first_seen_at: "2026-07-20T23:20:51.132542+00:00"
fetched_at: "2026-07-28T21:03:19.340687+00:00"
content_hash: "sha256:41d52f8b4d6575a7228e42113a2c658aad5434ec327d856cbba3624ad236fe13"
---

# Choosing the Best Phone Number Type for Texting

[SMS](https://www.plivo.com/sms/) — short message service — is one of the best tools for building relationships with your customers.[81% of Americans use SMS every day, and more than three-quarters of Americans wish they could text with a business](https://www.localproject.net/docs/texting-stats/) .


We could go on and on about the[benefits of using SMS](https://www.plivo.com/blog/what-is-sms/) , but let’s say you’re convinced that SMS can be a valuable tool for your business and you’re raring to get started. Before you implement any text messaging campaigns, one of the first things you need to do is figure out what kind of phone number to use to send out messages and receive responses.
...
- [10DLC](https://www.plivo.com/blog/10dlc-10-digit-long-code/) (10-digit long code) is a service offered by major US carriers to explicitly allow commercial application-to-person (A2P) SMS traffic over long code phone numbers. How do you turn long codes into 10DLC numbers? You have to register them with your carrier. 10DLC is exclusively a US service; you can use long codes for sending and receiving SMS and[MMS](https://www.plivo.com/blog/what-is-mms-messaging/) messages in Canada and other countries.
- [Toll-free numbers](https://www.plivo.com/sms/toll-free/) are used by businesses that want their customers to reach them at no cost. Incoming calls are billed to the called party and are free of charge for the calling party. Most countries reserve a set of dialing prefixes to denote toll-free services. In North America, 800, 888, 877, 866, 855, 844, and 833 denote toll-free numbers. You can use toll-free numbers for two-way messaging as well as voice.
- [Short codes](https://www.plivo.com/sms/shortcode/) are five- or six-digit numbers (for example, 123456) used to send and receive SMS messages. Unlike 10DLC and long code numbers, short codes are not tied to an area code, so they can be used across a country to provide a nationwide brand identity under one easy-to-remember number. Unlike long codes and toll-free numbers, you can’t use short codes for voice calls. You can order a regular short code or a vanity one, which allows you to choose the number you want instead of getting assigned a random number. Vanity short codes cost more to lease, but they can be worth the money if you can get a memorable number as your short code. 7-Eleven, for instance, has the vanity short code 711711.


We’ve created an infographic to help you decide what number types might work for your messaging use cases.[Download it](https://go.plivo.com/hubfs/Collateral/Plivo_infographic_phone_number_types.pdf) for reference or share it with colleagues.
...
A lot of factors affect the cost of a text messaging campaign. This chart shows costs for the four different number types in the US.[Plivo](https://www.plivo.com/) offers SMS services in 190+ countries — check our[pricing page](https://www.plivo.com/sms/pricing/us/) for up-to-date costs in the countries you’re interested in.
...
One-Time Setup $44 None None $1,500
