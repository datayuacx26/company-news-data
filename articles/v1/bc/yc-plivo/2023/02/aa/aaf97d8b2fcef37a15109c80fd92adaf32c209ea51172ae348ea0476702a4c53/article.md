...
document_id: "aaf97d8b2fcef37a15109c80fd92adaf32c209ea51172ae348ea0476702a4c53"
company_key: "yc-plivo"
company: "Plivo"
source_id: "yc-plivo-rss-7fc8cee78b57"
canonical_url: "https://www.plivo.com/blog/how-government-agencies-can-leverage-sms/"
published_at: "2023-02-06T00:00:00+00:00"
first_seen_at: "2026-07-20T23:20:51.132542+00:00"
fetched_at: "2026-07-28T21:02:31.747135+00:00"
content_hash: "sha256:2430ceb96aa6c74b421df34b73222b7d223620e27a40fb46cac945be0bfb6bf8"
---
...
Public agencies can benefit from adding SMS to their communications toolbox. Virtually everyone has a cellphone, so virtually everyone can access SMS. Text messages have a[98% open rate](https://textsanity.com/text-message-marketing/sms-open-rates/) , and[90% of texts are opened within three minutes](https://info.sopranodesign.com/the-power-of-mobile-communications) .
...
Almost every government agency can use SMS for[community text marketing](https://www.plivo.com/use-case/government/) . It’s a great way to share news about special events, holidays, changes in hours of business, and other kinds of general news. Text messages don’t require agreeing upon a mutual time to communicate. People open them quickly. And digital messages are easy to include in the public record to satisfy transparency laws.
...
Courts can send reminders for plaintiffs, defendants, and jurors about when they have to appear at hearings. A[study](https://www.science.org/doi/abs/10.1126/science.abb6591) from New York courts showed that text reminders reduce the failure-to-appear rate by up to 21%.


Business licensing authorities can nudge[business owners](https://www.businessinsuranceusa.com/news/insurance/5-common-business-insurance-mistakes-to-avoid/) about business registration renewal deadlines.
...
Finally, security best practices call for organizations to use[two-factor authentication](https://www.plivo.com/use-case/two-factor-authentication/) (2FA) before permitting authorized users to access their digital assets. For many organizations, 2FA involves the use of one-time passwords (OTP) delivered via SMS.


## The right way to support SMS


Clearly SMS is a useful communications channel, but government agencies can’t let individual workers use their personal cell phones for official business. They need to set up an SMS communications platform that uses an[SMS API](https://www.plivo.com/sms/) to programmatically send and receive messages and route them appropriately.


[Plivo helps governments and public sector agencies](https://www.plivo.com/use-case/government/) keep their constituents informed.
