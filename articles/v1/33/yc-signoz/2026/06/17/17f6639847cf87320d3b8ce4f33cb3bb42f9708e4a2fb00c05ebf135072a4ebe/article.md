...
document_id: "17f6639847cf87320d3b8ce4f33cb3bb42f9708e4a2fb00c05ebf135072a4ebe"
company_key: "yc-signoz"
company: "SigNoz"
source_id: "yc-signoz-rss-564a62b873f8"
canonical_url: "https://signoz.io/blog/opentelemetry-apm"
published_at: "2026-06-30T00:00:00+00:00"
first_seen_at: "2026-07-20T23:20:42.602972+00:00"
fetched_at: "2026-07-28T21:08:50.237722+00:00"
content_hash: "sha256:3049b50b8dc43efe7b640e238766339dc2deea280db09ad0ab356bfdc10b0bed"
---

# OpenTelemetry APM: An Open Source Approach
...
OpenTelemetry is a Cloud Native Computing Foundation([CNCF](https://www.cncf.io/) ) project aimed at standardizing the way we[instrument applications](https://signoz.io/docs/instrumentation/) for generating telemetry data(logs, metrics, and traces). However, OpenTelemetry does not provide storage and visualization for the collected telemetry data. And that's where an OpenTelemetry APM is needed.
...
[OpenTelemetry](https://signoz.io/opentelemetry/) is an open-source collection of tools, APIs, and SDKs that aims to standardize the way we generate and collect telemetry data. The[OpenTelemetry specification](https://github.com/open-telemetry/opentelemetry-specification) has design and implementation guidelines on how the instrumentation libraries should be implemented. In addition, it provides client libraries in all the major programming languages which follow the specification.
...
An OpenTelemetry backend should have native support to store data with OpenTelemetry semantic conventions. Existing observability vendors usually transform the data collected using OpenTelemetry semantic conventions into their propriety formats. But OpenTelemetry has a[huge list](https://github.com/open-telemetry/semantic-conventions) of semantic conventions which might not be fully utilized in such scenarios.
...
**Open Source**
OpenTelemetry is an open-source standard with huge community backing. It is a testament to the fact that community-driven projects can solve large, complex engineering problems. It is not strictly necessary for an OpenTelemetry APM to be open-source.
...
SigNoz is an OpenTelemetry-native observability platform that unifies traces, metrics, and logs in one place, providing full-stack[open-source APM](https://signoz.io/application-performance-monitoring/) capabilities. It serves as a backend for storing telemetry data (logs, metrics, and traces), and leverages the power of a columnar database for highly effective log analytics.
...
*How OpenTelemetry fits within a microservice-based application and an observability backend - SigNoz*
