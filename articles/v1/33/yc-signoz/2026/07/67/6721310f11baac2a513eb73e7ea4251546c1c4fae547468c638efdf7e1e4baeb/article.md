...
document_id: "6721310f11baac2a513eb73e7ea4251546c1c4fae547468c638efdf7e1e4baeb"
company_key: "yc-signoz"
company: "SigNoz"
source_id: "yc-signoz-rss-564a62b873f8"
canonical_url: "https://signoz.io/blog/opentelemetry-apache-server-metrics-monitoring"
published_at: "2026-07-14T00:00:00+00:00"
first_seen_at: "2026-07-20T23:20:42.602972+00:00"
fetched_at: "2026-07-28T20:41:19.924237+00:00"
content_hash: "sha256:d6485b8bc420e62c6d55e0c32c77bf16c370d62ff3135fa295a05f247d4abfd5"
---
...
The OTLP receiver accepts data through gRPC or HTTP in the[OTLP](https://github.com/open-telemetry/opentelemetry-proto/blob/main/docs/specification.md) format. There are advanced configurations that you can enable via the YAML file.
...
- [Apache Installed](https://httpd.apache.org/download.cgi)
...
The OpenTelemetry Collector offers various deployment options to suit different environments and preferences. It can be deployed using Docker, Kubernetes, Nomad, or directly on Linux systems. You can find all the installation options[here](https://opentelemetry.io/docs/collector/installation) . For the purpose of this article, the OpenTelemetry Collector will be installed manually.
...
*You can find ingestion key details under settings tab of SigNoz*


You can find more information on OpenTelemetry Apache receiver[here](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/main/receiver/apachereceiver) .
...
*Collected Apache metrics for visualization*
...
*Monitoring dashboard for Apache*


Visit the SigNoz[documentation](https://signoz.io/docs/userguide/manage-dashboards/) to learn more about creating dashboards and running queries. To replicate the above dashboard shown, use the JSON configuration[here](https://github.com/SigNoz/dashboards/tree/main/apache-web-server) .
...
*Create alerts on important Apache metrics*
...
You can visit the[Apache receiver](https://github.com/open-telemetry/opentelemetry-collector-contrib/blob/main/receiver/apachereceiver/documentation.md#apache) GitHub repo to learn more about these metrics.
...
You can see these resource attributes in the[OpenTelemetry Collector Contrib](https://github.com/open-telemetry/opentelemetry-collector-contrib/blob/main/receiver/apachereceiver/documentation.md#resource-attributes) repo for the Apache receiver.
