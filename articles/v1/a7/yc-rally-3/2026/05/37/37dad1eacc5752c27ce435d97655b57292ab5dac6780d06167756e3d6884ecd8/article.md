...
document_id: "37dad1eacc5752c27ce435d97655b57292ab5dac6780d06167756e3d6884ecd8"
company_key: "yc-rally-3"
company: "Rally"
source_id: "yc-rally-3-news-import-75685e7d2a3f"
canonical_url: "https://www.getrally.com/blog/company-car-fuel-benefit-and-vat-on-fuel-cards"
published_at: "2026-05-11T00:00:00+00:00"
first_seen_at: "2026-07-22T10:49:14.710560+00:00"
fetched_at: "2026-07-28T21:45:28.384377+00:00"
content_hash: "sha256:e9a7877d4f07908ceaac759d3ce1f656c8f955ed433deb1904d6586c1306bf9b"
---
...
## The Three Layers Most Finance Teams Confuse
...
## The Company Car Fuel Benefit Charge in 2026/27
...
## VAT on Fuel Cards — What You Can and Can't Reclaim
...
If your fuel card sits inside a broader expense platform — for example one that also covers tolls, parking, and[company expense cards](https://www.getrally.com/company-cards) — you can carry the same logic across all categories: one VAT-compliant invoice per supplier per period, with line-level data ready to recover.


## HMRC Advisory Fuel Rates — Quarterly, but Often Forgotten
...
- **Reimbursing employees who buy business fuel out of pocket.** Pay at or below the relevant AFR and the reimbursement is free of income tax and NI.
- **Recharging private mileage on a company-paid fuel card.** Recover from the employee at the relevant AFR and HMRC accepts that there is no fuel benefit charge on the private element, because the employee has effectively paid for it themselves.
...
For a deeper walkthrough of the current quarterly rates and how they map to your fleet's vehicles, check the HMRC Advisory Fuel Rates that HMRC publishes each quarter.


## The Three Patterns Fleets Use to Avoid the Fuel Benefit Charge
...
## How Fuel Cards Help in Practice
...
**Direct ERP and accounting export.** Pre-classified VAT line items flow into the ledger through[ERP and accounting integrations](https://www.getrally.com/accounting) , so the VAT recovery position is correct by construction and the audit trail is one click deep, not three spreadsheets deep. If you want a step-by-step walkthrough of the workflow at a transaction level, see[how a fuel card works in practice](https://www.getrally.com/blog/how-does-a-fuel-card-work-in-practice) .


**One card, one acceptance network.** The[Rally business fuel card](https://www.getrally.com/fuel-cards) is Visa-backed, so it is accepted at virtually any UK or European fuel station, EV charger, or merchant — with billing at the pump price rather than a marked-up network rate. That matters for tax compliance in two ways: drivers stop buying fuel on personal cards (which would land back as expense claims with weak VAT evidence), and your evidence base covers your whole footprint, not just one branded network.
...
## When to Talk to Your Accountant (Not a Fuel-Card Vendor)
...
- **Salary sacrifice arrangements** for cars or charging infrastructure, where Optional Remuneration Arrangement (OpRA) rules can apply.
- **Mixed business and private use cars** where the split is unstable from year to year.
- **Multi-employee shared cars** where attribution of benefit is non-trivial.
- **International assignments** where the employee is tax-resident in more than one jurisdiction.
- **Acquisitions and TUPE transfers** that move fleets between employers mid-tax-year.
...
If you would like to see how Rally's controls and reporting feed into that workflow,[book a demo](https://www.getrally.com/demo?source=blog_inline) and we will walk through your fleet's actual numbers.
