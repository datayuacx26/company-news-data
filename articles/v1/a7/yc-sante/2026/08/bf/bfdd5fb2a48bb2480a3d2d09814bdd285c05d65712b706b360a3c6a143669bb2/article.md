...
document_id: "bfdd5fb2a48bb2480a3d2d09814bdd285c05d65712b706b360a3c6a143669bb2"
company_key: "yc-sante"
company: "Santé"
source_id: "yc-sante-news-import-0c9200f392aa"
canonical_url: "https://www.santehq.com/blog/how-to-set-up-customer-profiles-for-liquor-store"
published_at: "2026-08-08T12:24:24.510+00:00"
first_seen_at: "2026-08-10T02:49:33.513911+00:00"
fetched_at: "2026-08-10T02:49:35.593594+00:00"
content_hash: "sha256:7c6519212aead0eeba1b67324240f5403e7226b221a2a861524f6555ea483a83"
---

# How to Set Up Customer Profiles for Your Liquor Store (So You Can Run Loyalty + Targeted Promos)

Grocery stores and corporate chains can outspend you, undercut pricing, and flood the market with ads.
...
If you want more repeat customers, more[attractive promotions](https://www.santehq.com/blog/how-to-promote-your-liquor-store) , and a loyalty program that drives sales, customer profiles are the foundation, and this guide will show you how to set them up the right way.
...
- **Better decisions and better communication:** Profiles capture the customer[data you need to stock smarter](https://www.santehq.com/blog/sku-rationalization-liquor-stores) and keep people engaged with relevant updates like tastings, limited drops, and new arrivals
...
1. **Prompt at checkout:** After you ring up the sale, the screen asks if they want to join your loyalty program,[RSVP for an event](https://www.santehq.com/blog/how-liquor-store-events-drive-traffic-and-sales) or sign up for an account
...
- **A POS system that provides a built-in marketing platform so that you can activate this customer data with**[email and SMS campaigns](https://www.santehq.com/blog/increase-liquor-sales-with-email-and-sms-marketing)
...
A[liquor-specific POS](https://www.santehq.com/blog/what-is-liquor-store-pos-system) solves this problem by design.


Santé does that by putting in-store[POS and eCommerce on the same system](https://www.santehq.com/blog/winning-online-why-ecommerce-sales-matter-and-how-to-succeed) , using the same customer database, the same inventory, and the same CRM.


[Santé POS](https://www.santehq.com/) can host your storefront, meaning your website runs on Santé’s platform and stays connected to your POS. You just need to connect your product catalog, choose how you want to fulfill orders, set up payments, and publish your storefront under your branding.
...
One profile, one purchase history, and one foundation to run loyalty, rewards,[targeted promotions](https://www.santehq.com/blog/how-promotions-increase-traffic-for-liquor-stores) , and win-back campaigns that are all based on your customers' shopping habits.
...
[Book a demo with Santé POS](https://www.santehq.com/demo) to see how in-store checkout and eCommerce work together to power loyalty, targeted promos, innovative marketing, and repeat business.
