...
document_id: "578384662d4672aefa008d8a460cee4a193700df40fc9a88e8d0af74a9dd3abf"
company_key: "yc-lamin"
company: "Lamin"
source_id: "yc-lamin-news-import-1018c6ad32c5"
canonical_url: "https://blog.lamin.ai/sparse-measurements"
published_at: null
first_seen_at: "2026-07-24T09:27:52.013300+00:00"
fetched_at: "2026-07-28T21:37:36.757263+00:00"
content_hash: "sha256:1e87cd944850d056c4d4b21cafd55b1250a4a0d999f347f7f6be1c296ebe6b51"
---

# A data lakehouse for biology’s sparse measurements

- [Repository](https://github.com/laminlabs/lamindb) ·[LinkedIn](https://www.linkedin.com/feed/update/urn:li:activity:7434991882767716352/) ·[Tweet](https://x.com/laminlabs/status/2029225038562435195) ·[BlueSky](https://bsky.app/profile/laminlabs.bsky.social/post/3mganov2lnk2s)
- ⸻ 2026-03-04
...
- [Jesse Johnson](https://github.com/jejomath)
...
This option provides the best of both worlds: enough flexibility to store data from any assay/experiment/protocol that might come up, with enough structure to enable intuitive querying and model training while eliminating manual cleaning and bookkeeping. One specific implementation that’s based on integrating biological registries with support for biological data formats is put forward in the open-source tool` lamindb


` , and illustrated in the figure below.


You can pip install` lamindb


` or check it out on GitHub:[laminlabs/lamindb](https://github.com/laminlabs/lamindb) .


## About the author¶


Jesse has worked as a software engineer & engineering manager with a focus on data platforms at Google, Verily, Sanofi, Cellarity, and other companies. Today he runs a consulting company called Merelogic.
...
[previous Interactive visualization of multimodal and spatial data with Vitessce](https://blog.lamin.ai/vitessce)[next An introduction to LaminR](https://blog.lamin.ai/intro-to-laminr)
