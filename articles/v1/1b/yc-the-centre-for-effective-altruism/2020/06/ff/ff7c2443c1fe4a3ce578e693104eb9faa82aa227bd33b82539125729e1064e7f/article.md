...
document_id: "ff7c2443c1fe4a3ce578e693104eb9faa82aa227bd33b82539125729e1064e7f"
...
canonical_url: "https://www.effectivealtruism.org/articles/q-and-a-with-marcus-davis"
published_at: "2020-06-13T00:00:00+00:00"
first_seen_at: "2026-07-22T16:21:45.524774+00:00"
fetched_at: "2026-07-28T21:33:49.818370+00:00"
content_hash: "sha256:ae96561d8a33f6a922854073d387a636e6ed374635143af894caf0cc837a7d72"
---

# Q&A with Marcus Davis
...
*Marcus Davis is a co-founder and co-executive director at[Rethink Priorities](https://www.rethinkpriorities.org/) , where he leads research and strategy. He's also a co-founder of[Charity Entrepreneurship](https://www.charityentrepreneurship.com/) and[Charity Science Health](https://www.charitysciencehealth.com/) , where he previously systematically analyzed global poverty interventions, helped manage partnerships, and implemented the technical aspects of the projects.*


*Below is a transcript of the Q&A, which we’ve lightly edited for clarity. You can also watch it on[YouTube](https://www.youtube.com/watch?v=7JPuLzmYK8o) and discuss it on the[EA Forum](https://forum.effectivealtruism.org/posts/nq8ZabGBNPD8vJ7gS/q-and-a-with-marcus-davis) .*
...
We cover a number of causes. We're primarily focused on non-human animals, but we also do work on longtermism; we spent a good deal of 2019 researching \[the risks posed by\] nuclear weapons.[That work](https://www.rethinkpriorities.org/publications#ltf) was led by Luisa Rodriguez.
...
We've mentioned some already. In addition to our work on animals and longtermism, we’ve worked on movement building. We run the[EA Survey](https://www.rethinkpriorities.org/publications#easurvey) \[which collects data on many aspects of the EA community\] every year.


I’ll give the short version of how we came to \[work in these areas\]: Basically, we looked around the animal research space and saw that there just aren't that many players. It's not true that there aren't *any* existing organizations doing this work. There's[THL](http://www.humaneleaguelabs.org/) \[The Humane League\] Labs, for example, which does a lot of high-quality work, and many other organizations, including[ACE](https://animalcharityevaluators.org/) \[Animal Charity Evaluators\], which is a meta organization doing research.
...
**Marcus:** I'd say we are really interested in the scope of all research that would be useful, up to and including the possibility of very specific charity ideas that we have found to be plausible. We do some investigations of interventions that are currently happening. For example, Saulius Simcikas did an[investigation of corporate campaigns](https://forum.effectivealtruism.org/posts/L5EZjjXKdNgcm253H/corporate-campaigns-affect-9-to-120-years-of-chicken-life) currently under way to try to determine how cost-effective they were.
...
**Marcus:** I'll share my own story. When I started to intern at the[Charity Science Foundation](https://www.charityscience.com/) , in the summer of 2015, I wasn't confident that this would be the direction of my career. I thought it was a great opportunity, and that their organization was impactful in that I could potentially help others.
...
I probably would spend more time just learning how to manipulate[R](https://en.wikipedia.org/wiki/R_(programming_language)) , which comes up a lot in data analysis. I spent a lot of time back then learning Python, but R is where the action is if you’re doing statistics.
