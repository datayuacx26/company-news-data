...
document_id: "4ff512980dc00435625510cd64c53f6a0c4f86cd3e60272cff55771e1c636b40"
company_key: "yc-numero"
company: "Numero"
source_id: "yc-numero-rss-2718f20b56fd"
canonical_url: "https://www.numero.ai/blog/primary-election-strategies/"
...
content_hash: "sha256:0a418353a006fa7497352454ebe18ac912874d2b04388bca09146045903a537a"
---
...
[A primary election](https://www.numero.ai/blog/primary-vs-general-elections/) involves a pool of candidates competing to determine who will run in the general election. Such elections usually occur along party lines, but some states have different types of primaries (which we’ll discuss more in a bit).
...
To learn more about when primaries are held in your state, look for primary election schedules online. For example, the National Conference of State Legislatures has a[2022 State Primary Election schedule](https://www.ncsl.org/research/elections-and-campaigns/2022-state-primary-election-dates-and-filing-deadlines.aspx) showing the primary dates and filing deadlines for each state.
...
However, some states have rules that limit when a voter can switch their affiliations with a party. For example, in Idaho, voters who are unaffiliated with a party can register on the day of the primary. But voters who are already affiliated with a different party[must disaffiliate from the other party by the 10th Friday before the primary election](https://ballotpedia.org/Semi-closed_primary#:~:text=%20voters%20who%20are%20already%20affiliated%20with%20a%20political%20party%20must%20disaffiliate%20no%20later%20than%20the%2010th%20friday%20preceding%20the%20primary%20election%20in%20order%20to%20affiliate%20with%20another%20party%20and%20vote%20in%20its%20primary.) .
...
California, Washington, Nebraska, and Alaska are the[four states that hold nonpartisan primaries](https://ballotpedia.org/Primary_election_types_by_state#:~:text=primary-,In%202004%2C%20Washington,and%20congressional%20elections,-The) .
...
Not all general elections are equally competitive, but the estimated competitiveness of the general election will also[impact your campaign’s primary election strategies](http://eprints.lse.ac.uk/68744/1/blogs.lse.ac.uk-Primary%20election%20candidates%20change%20their%20campaign%20strategies%20in%20response%20to%20both%20their%20current%20and%20po.pdf) .
...
For local races, you can even save money by doing some of the work yourself. Roles in some state and local races can often be combined. A[campaign manager](https://www.numero.ai/blog/how-to-run-for-office/campaign-staff#:~:text=in%20smaller%20races%2C%20campaign%20managers%20can%20fill%20the%20gaps%20for%20other%20departments%2C%20such%20as%20fundraising%2C%20communications%2C%20and%20field.) could organize fundraising and voter outreach, for example. It’s also common for campaign managers to work part time during non-competitive primaries, especially for local and some state races.
...
Another way to use the primaries to appeal to potential supporters is by[collecting endorsements](https://www.numero.ai/blog/political-endorsements-the-2025-complete-candidates-guide) . Endorsements are more impactful during the primaries because you don’t have the full support of the party (voters included).
