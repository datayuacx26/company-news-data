...
document_id: "6a976de61277f31a7e405e1048eaef9568a841bc1238c667f1341846a29e6e87"
company_key: "yc-numero"
company: "Numero"
source_id: "yc-numero-rss-2718f20b56fd"
canonical_url: "https://www.numero.ai/blog/campaign-staff/"
...
content_hash: "sha256:a87c453241bdcaee4ab81dd8cbf24808492f3c55587dcbf4b7af5663b704f2ac"
---

# Political Campaign Staff: Structure, Rolls, Salaries, Consultants
...
To keep unnecessary costs at a minimum, ask yourself what tasks need to be covered by an additional staff member. For example, can your[campaign manager](https://www.numero.ai/blog/how-to-become-a-political-campaign-manager/) handle political relationships for your campaign? Do you need to hire a communications director if your campaign manager can write press releases and handle the occasional call from reporters? You don’t want to make one of the biggest regrets of first-time candidates: hiring a bloated staff only to realize you can’t afford a mail or[Get Out The Vote (GOTV)](https://www.numero.ai/blog/voter-engagement-gotv-field-events) program in October when it matters.


Once you’ve figured out your baseline needs, the interview and hiring process begins. The first step in recruiting staff is to reach out to your local or state parties, any campaign committee, or campaign consultants that may be supporting your run to see if they can generate leads for you to interview. Multiple job boards and listservs also exist, and these are monitored by political campaign staffers across the country. Here are a couple of examples:[JobsThatAreLeft](https://groups.google.com/forum/#!forum/jobsthatareleft) and[GAIN POWER](https://www.gainpower.org/democraticgain/) .
...
## The Political Campaign Organizational Structure \[with a chart\]
...
## Different Types of Political Campaign Positions
...
Finding and hiring a campaign manager will typically be one of your earliest (but may or may not be your first hire) and most important campaign decisions. So what does a[political campaign manager](https://www.numero.ai/blog/how-to-become-a-political-campaign-manager/) do?


Your campaign manager will have many responsibilities, including managing the rest of your staff, making strategic decisions, working with consultants, overseeing day-to-day operations and the[campaign budget](https://www.numero.ai/blog/political-campaign-budget) , and most importantly, keeping you organized. In smaller races, campaign managers can fill the gaps for other departments, such as[fundraising](https://www.numero.ai/blog/political-fundraising) , communications, and field.
...
Political Campaign Staff Salaries
...
One of the newest additions to political campaigning is the digital department, which can mean different things depending on its focus. Digital departments may cover anything from choosing the website builder with which you’ll build your[campaign website](https://www.numero.ai/blog/political-campaign-website-dos-and-donts/) to running social media accounts, managing and increasing digital organizing assets, purchasing digital advertising and running persuasion efforts, and executing your campaign’s email and online fundraising program.
...
##### **Creating the TV or digital spot**
...
##### **What do direct mail consultants do that I can’t?**
...
##### **Why do I need to send direct mail?**
...
**What do pollsters do?**Pollsters are a type of campaign consultant responsible for deciding if you need to poll, conducting the poll, analyzing the data, and advising your campaign and consultant team on what campaign strategies are likely to work based on the polling results.
...
### What Sort of Meetings Should a Campaign Have, and What Do I Cover?
...
1. Your campaign stays at the top of their minds as most consultants will have other clients.
2. Siloed work remains at an absolute minimum level.
3. That your consultant team is current on any campaign activities or milestones.
...
Consultant calls will usually be run by your campaign manager and most commonly attended by your media, mail, digital, and polling consultants. As a candidate, you’ll also regularly listen in in order to stay abreast of the strategy and ask the occasional question, but you shouldn’t actively run the meeting. You don’t usually have the same expertise or knowledge of the day-to-day as your campaign manager because it’s not your role in the campaign. Other stakeholders may be present too. For instance, it’s common practice for a supporting committee (e.g.,[DCCC](https://dccc.org/) ,[DSCC](https://www.dscc.org/) ) or endorsed organizations (e.g.,[Latino Victory Fund](https://latinovictory.us/) ) to join consultant calls. However, your campaign should think through carefully who you include, and then only include those with something to add to the meeting.
...
#### **Weekly one-on-one meetings with campaign staff**
...
#### **Field staff meetings: Morning and nightly stand-up**
...
What do campaign managers do after the election?


2.


Managing a campaign is always going to be a temporary job because all campaigns end. However, there is always another campaign to run and many campaign managers either work in consulting firms or function like freelance contractors. If you’re planning on managing campaigns as a career, you’ll need to have a solid network of industry peers to help you find the next race. If you’re planning to consult you’ll also need a network of candidates to bring on as clients. Keep in mind that some campaigns can last a couple of years, meaning that you could be working on the next campaign long before the election year.
...
Recently, Democratic campaigns have also started offering decent benefits with a solid healthcare plan (85%–100% of healthcare premiums covered).[↑](https://www.numero.ai/blog/campaign-staff/#post-2509-footnote-ref-0)
