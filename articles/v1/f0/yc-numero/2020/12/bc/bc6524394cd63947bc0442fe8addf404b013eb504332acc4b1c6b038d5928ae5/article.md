...
document_id: "bc6524394cd63947bc0442fe8addf404b013eb504332acc4b1c6b038d5928ae5"
company_key: "yc-numero"
company: "Numero"
source_id: "yc-numero-rss-2718f20b56fd"
canonical_url: "https://www.numero.ai/blog/voter-engagement-gotv-field-events/"
...
content_hash: "sha256:363e37cf40e1fef085437a26f47d33a98fbcf2389f17ce4fa6b9ac1bad2da7c1"
---

# The Complete Guide to Voter Engagement

This is the complete guide to voter engagement (how to turn out the vote).


## What is a Voter Engagement Field Program?
...
#### **Why do people intern, and how do I find them?**
...
For your campaign, consider contacting and building an internship program with a college professor or high school government teacher that may offer extra credit.[Young Democrats of America](https://www.yda.org/) or[College Democrats of America](https://democrats.org/cda/) chapters can also help find internship candidates. You could even set up a booth on college or high school campuses for registering students to vote and for setting up internships. College job boards can also be fruitful. There are also sites such as[WayUp](https://www.wayup.com/) that can help you recruit interns.
...
To apply, please email[\[email protected\]](https://www.numero.ai/cdn-cgi/l/email-protection#b9d1dcd5d5d6f9cad8d5d5c0dfd6cbdad6d7decbdccaca97dad6d4) with your resume and three references.


##### **Should I pay interns/fellows?**
...
##### **How are interns different from volunteers?**
...
##### **How much do interns/fellows work?**
...
### How Do I Organize and Run a Phonebank, Textbank, or Canvass?
...
First, create your list of prospective volunteers to call, and ask them to commit to a volunteer shift. To make your list, you can pull from a few places. Gather all of the strong supporters that you have previously identified during voter contact, any online volunteer sign-ups from your[campaign website](https://www.numero.ai/blog/political-campaign-website-dos-and-donts/) , in-district small-dollar donors, existing lists from local parties, and your network, to name a few sources. You can also add a question to your voter engagement scripts to ask strongly identified supporters if they are interested in volunteering.
...
[Campaign staffers](https://www.numero.ai/blog/campaign-staff/) will use language like “I’m counting on you” to communicate how important showing up to the volunteer shift is to the campaign. If a volunteer doesn’t pick up on your first round of confirmation calls, wait a few hours and try again—if they don’t pick up a second time, leave a message.
...
### How Do I Manage a Volunteer Shift?
...
During COVID, field campaigns have relied heavily on setting up virtual phonebanks for volunteers that allow them to call from home on their own computers and automatically log any responses and data directly into your CRM. In the rare case that your area is safe enough for door-knocking, consider using tools such as[miniVAN](https://act.ngpvan.com/minivan) that allow volunteers to receive a canvassing packet on their phone and automatically upload their data if they have cell service.


Here’s a suggested[sample timeline](https://docs.google.com/spreadsheets/d/1oG5FvJ2W7kgMckh4dNMlT-iCd9SZ783NuMQyNoO4uj8/edit#gid=0) for a volunteer shift:


A sample timeline for a volunteer shift


### How Do I Make Sure Volunteers Come Back?
...
## Campaign Events as Voter Engagement
...
### How and Why Should I Hold Campaign Events?
...
Voter engagement universe breakdown
...
**Voter path 1** Non-VBM Persuasion → Supportive ID → Non-VBM Turnout → Register to VBM → VBM Turnout → Vote


**Voter path 2** Non-VBM Persuasion → Register to VBM → VBM Persuasion → Supportive ID → VBM Turnout → Vote
...
**Voter path** VBM Persuasion → Supportive ID → VBM Turnout → Vote
...
**Voter path** Non-VBM Turnout → Register to VBM → VBM Turnout → Vote
...
**Voter path** VBM Turnout → Vote


Here’s a diagram of how a voter moves through the four universes of a vote-by-mail GOTV:


Voter engagement universe flow chart


#### **How do I prioritize my outreach to all these universes?**
...
### In-Person Early Vote Dominate State
...
Voter engagement chart for early voting states
...
### Non-Early Vote or Vote-by-Mail State
...
### How Does the Campaign Change Once GOTV Begins?
...
[Using social pressure to encourage low turnout voters to cast their ballot has proven highly effective](http://www.donaldgreen.com/wp-content/uploads/2015/09/Gerber-Green-and-Larimer-2010.pdf) . By letting voters know that their neighbors or X% of their precinct have already voted significantly increases the chance those voters will vote because such information pulls on the emotion of feeling left out or not being part of the winning team. As cliche as it sounds, much of the GOTV language centers on “voting is easy and fun. Everyone is doing it—why aren’t you?”
...
#### **Campaign culture and communication**
...
### What Are the Basic Forms of Paid Media?
...
### How Should I Layer My Voter Engagement Media Together (and Does Political Advertising Even Work)?
...
#### **How many pieces of direct mail should I run?**
...
#### **How do I send direct mail in bulk?**
...
#### **What kind of digital ads exist?**
...
**Pre-roll** A short video played before the content a user has selected. Ads are commonly 6, 15, or 30 seconds long.


**Mid-roll** A short video played in the middle of the content a user has selected. Ads are commonly 6, 15, or 30 seconds long.


**Skippable and non-skippable:**Videos can also be skippable immediately, after a few seconds, or not at all. Keep in mind, costs per impression will increase as the ad is harder to skip.
...
#### **What’s the lowest unit rate (LUR)?**


The lowest unit rate (LUR) is an FCC political advertising rule that guarantees (45 days before a primary and 60 days before a[general election](https://www.numero.ai/blog/primary-vs-general-elections) ) qualified candidate campaigns the lowest rate for a spot. For instance, as a candidate, you’ll get all the volume discounts that would be offered to a client buying hundreds of spots—even if you’re only buying one spot. LUR is only available to candidate committees (as separate from an independent expenditure or PAC), which is one of the main reasons that candidates raise money instead of relying on super PACs with unlimited[donor limits](https://www.numero.ai/blog/campaign-finance-laws) to buy their paid media voter engagement ads. This rule applies to you as a candidate at any level, regardless of whether you’re running for a federal, state, or local office.


## FAQs


1. **What is direct voter contact?**
2. Direct voter contact refers to your campaign’s efforts to identify and contact voters through door knocking, phonebanking, texting, and mail. These efforts towards voter engagement are meant to generate support for you, the candidate, and get your campaign ready for the GOTV stage of the campaign. Your campaign recruits volunteers to help implement the campaign field plan and maximize voter engagement.
3. **What does a field organizer do?**
4. Field organizers help with field work by building a pool of volunteers for your campaign. Such organizers are tasked with recruiting and training volunteers, and managing the volunteers while they’re contacting voters. They also plan and run campaign events and GOTV programs. Another part of a field organizer’s job is to collect voter data to help your campaign better target undecided, unregistered, or low-turnout supporters and motivate them to get out and vote.
5. **Is political canvassing soliciting?**
6. No. Because p[olitical canvassing](https://www.numero.ai/blog/political-canvassing-guide/) is not a commercial venture, it’s not considered soliciting. Contacting voters to persuade them to vote is legally distinct from trying to sell a product as a salesperson.
7. **What is phonebanking?**
8. Phonebanking is a voter engagement event that requires volunteers to call lists of potential voters and talk to them about voting for you, the candidate they represent. This personal interaction with hesitant or undecided voters has been shown to improve voter turnout on election day.
9. **How effective is political canvassing for voter engagement?**
10. That depends. Direct contact with voters can be an effective way to encourage voters to take action, whether that’s to support you as a candidate, register to vote, or get out to vote. A field plan that targets voters carefully and engages with them on a personal level can prove quite motivating for on-the-fence or inactive voters. If your campaign does its research, gets the timing right, and targets the appropriate voter pools, you could see an increase in turnout of up to 3%. Direct canvassing also tends to be more effective when used as part of your campaign’s GOTV efforts as it’s shown to be more motivating than persuasive (though undecided voters can be persuaded to vote for a candidate whose campaign spoke to them directly).
11. **When Do I Start GOTV** ?
12. Voter engagement through GOTV generally begins when voting starts for early vote and vote-by-mail states. However, in states where the vast majority of voters vote on election day, it’s traditional to hold a 4-day GOTV period starting the Saturday before election day and ending when polls close. Preparing for GOTV begins the day your field program starts with major milestones along the way.
