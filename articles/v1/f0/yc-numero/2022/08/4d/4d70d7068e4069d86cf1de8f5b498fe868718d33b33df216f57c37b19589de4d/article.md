...
**See how Numero can help you with your political call time.**
...
Perhaps you’re[closer to the general election](https://www.numero.ai/blog/primary-vs-general-elections/) and are ready to make a bigger ask to certain donors for a one-time donation. Follow up later with a relatively smaller ask that gets you closer to your goal and gets them closer to their max.


- **Establish a heightened sense of community with your supporters.** Consider your recurring monthly donors as the core folks at your events. Maybe they can join you for open[calltime](https://www.numero.ai/blog/call-time-lists/) (think office hours rather than an expensive event). Offer them a window to join you for a chat or add them as some of the first invited to a local event. Once you’ve decided on these community-building events, be sure to highlight them as perks for recurring donors!
...
Sending voicemail drops with[Numero Plus](https://www.numero.ai/) ? Try this script out for size:
...
Use Numero’s[contact codes](https://help.numero.ai/article/204-source-codes-member-codes-contact-codes-oh-my) to search your entire database for common causes between your donors and your campaign. An example might be a contact code of “[Moms Demand Action](https://momsdemandaction.org/) ” so you know this is a donor that cares about gun violence prevention. You can use the groups that they are members of, where else they volunteer, etc. as a way to make sure every conversation is personalized.


## A Recurring Donation That Matters


Relationship-building is the key to turning a first-time contribution into a recurring donation. If you successfully integrate these four techniques into your campaign fundraising you’ll be well on your way to building a community of supporters to your cause. And[Numero will be here to help you](https://www.numero.ai/getpricing/) every step of the way.
