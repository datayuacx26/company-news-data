...
document_id: "e69b5c8b962b464f1669498d0fba18a0ba7f7b464e71a609a5accbe8ab20f640"
company_key: "yc-numero"
company: "Numero"
source_id: "yc-numero-rss-2718f20b56fd"
canonical_url: "https://www.numero.ai/blog/political-fundraising/"
published_at: "2022-01-05T05:00:00+00:00"
first_seen_at: "2026-07-25T16:42:35.962761+00:00"
fetched_at: "2026-07-28T21:04:10.558196+00:00"
content_hash: "sha256:fc47e01654b237a81f5d88002cdab5b3a980cd7e091c7596e87f18def67fa13b"
---

# The Complete Political Fundraising Guide
...
As with any budget, your[campaign budge](https://www.numero.ai/blog/political-campaign-budget/) t is only as valuable as your commitment to operating within it and raising what’s necessary to run an effective campaign.
...
1. Your ability to raise money distinguishes your campaign and defines your credibility as a candidate. Decisions will be made about who to support and endorse based on the financial strength of your campaign. Early on, when it’s hard to tell which candidate to back, an early indicator for seasoned donors, party leaders, local delegates, prospective[campaign staff](https://www.numero.ai/blog/campaign-staff) , and volunteers is the amount of money you have raised compared to other candidates in your primary.
...
Every campaign at the[local](https://www.numero.ai/blog/how-to-run-for-local-office/) ,[state](https://www.numero.ai/blog/how-to-run-for-state-office/) , and[federal](https://www.numero.ai/blog/how-to-run-for-congress/) level must file a public report with itemized expenses and campaign contributions to ensure each campaign is complying with campaign regulations. The reporting period for the amount a campaign has raised varies by race, but the two most common reporting periods are quarterly and semi-annually.
...
4. [Grassroots Campaigns](https://www.counterpunch.org/2019/09/13/lessons-from-americas-greatest-grassroots-campaigns/) : Grassroots campaigns rely on smaller individual contributions, which helps with community outreach and is more compatible with online political fundraising efforts, such as social media marketing.
...
All past political contributions are public. You can find giving history for people you know by manually searching federal ([FEC donor search](https://www.fec.gov/introduction-campaign-finance/how-to-research-public-records/individual-contributions/) ), state, or local government sites that publish this information.
...
Having a bio of the donor you’re about to call is incredibly helpful in making an instant connection with that person so that you have the opportunity to talk with them. Donor bios are generally created by your finance director or[call time manager](https://www.numero.ai/blog/call-time-lists/) .
...
If you can’t find contact info in a Google search, the next step is looking up the information at[WhitePages.com](https://www.whitepages.com/) or other directories. These may cost some money, but it’s generally worth the investment.


You can also try to guess their email address, for example, by searching for addresses like[\[email protected\]](https://www.numero.ai/cdn-cgi/l/email-protection#aceac5dedfd8e2cdc1c9e0cddfd8e2cdc1c9eccbc1cdc5c082cfc3c1) or FirstInitialLastName@company domain.
...
Phone numbers can be harder to find, but if WhitePages.com doesn’t have the phone number you need, you can also try calling the main phone number of the potential donor’s company and ask to be transferred to the person.
...
Giving history for a person you know can come from a number of sources. For instance, giving histories can be learned from research in publicly available databases of political contributions history, such as the FEC donor search, OpenSecrets.org or FollowTheMoney.org. Such information also comes packaged with political fundraising software like[Numero](https://www.numero.ai/) ,[NationBuilder](https://nationbuilder.com/custom_solutions?utm_source=google&utm_medium=cpc&utm_campaign=brand&recruiter_id=852962&gclid=Cj0KCQiA7qP9BRCLARIsABDaZzgDccH0FAOXlvcqLS_7FlScOwGSsjPVG3K49rPrWC3GCrw0J_fF2xkaAqCqEALw_wcB) ,[CallTime](https://www.calltime.ai/) , or[NGP VAN](https://www.ngpvan.com/)
...
Your contacts live in four places: your cellphone’s address book (on either iPhone or Android phones), your email software’s address book (Gmail, etc.), LinkedIn, and other social networks you may use. To combine all of this data, you can paste all your contacts into a spreadsheet, or you can buy[ContactsPlus](https://www.contactsplus.com/) and upload all your contacts there. ContactsPlus will then go through and help you merge all of your duplicates.
...
You should aim to identify 3–5 anchor amounts. For example, for a federal campaign with a combined limit ([primary and general](https://www.numero.ai/blog/primary-vs-general-elections) ) contribution of[$5,600](https://www.fec.gov/help-candidates-and-committees/candidate-taking-receipts/contribution-limits/) , potential anchor amounts could be set at $5,600, $2,800, $1,000, $500, and $250. Reaching out to donors for lower than $250 donations for a federal race should be done via a personal or mass email.


A table of campaign contribution limits from the FEC


Source:[Federal Election Commission](https://www.fec.gov/help-candidates-and-committees/candidate-taking-receipts/contribution-limits/)
...
It’s best to not call people before 9 AM or after 8 PM their time on weekdays, and before 10 AM or after 5 PM on a weekend. While[statistically some times are better to call than others](https://medium.com/call-time/data-driven-the-best-time-to-schedule-call-time-e7fa2c5ecd59) , there isn’t a magic time to call an individual—most people will pick up when they can and won’t when they’re busy or in a meeting.
...
*The best place to make a contribution is[https://secure.numero.ai/contribute/janedoe](https://secure.numero.ai/contribute/janedoe)*
...
[Numero](https://www.numero.ai/) offers the only software that tracks and automatically fulfills your pledges in real time, saving your team 10–20 hours per month versus manually tracking everything.
...
A call time manager is part of your[campaign staff](https://www.numero.ai/blog/campaign-staff/) and is responsible for maximizing the number of contributions you receive during call time. When you’re calling 40–60 people an hour, it’s really helpful to have someone tracking who was called, recording what commitments were made, and sending follow-up emails based on the conversations.
...
To apply, please email[\[email protected\]](https://www.numero.ai/cdn-cgi/l/email-protection#76101f18171815133605171a1a0f10190415191811041305055815191b) with your resume and three references.
...
To apply, please email[\[email protected\]](https://www.numero.ai/cdn-cgi/l/email-protection#4b2d22252a25282e0b382a2727322d24392824252c392e383865282426) with your resume and three references.
...
3:45 PM YOU call \[STAFFER BRIEFING\]
...
2. It’s not really possible to run for office with no money, but don’t worry. Fundraising is the primary goal of every political campaign. Seeking contributions starts with those closest to you and fans out as supporters help spread your message. You’ll also need to invest in yourself by putting some of your own money into the campaign. This self-investment will show potential investors that you’re serious about your goals. Numero can make your campaign fundraising easier.[Schedule a demo with us today](https://www.numero.ai/getpricing) !
3. Why are political campaigns so expensive?
4. There are a lot of expenses in running a political campaign. Hiring staff and hosting events cost money, but so do tv and social media ads, mailers, stickers, yard signs, and more. You’ll want to invest in spreading your message far and wide to gain funding and voter support.
5. Are political campaign contributions tax deductible?
6. Simply put,[no](https://smartasset.com/taxes/are-political-contributions-tax-deductible#:~:text=Simply%20put%2C%20political%20contributions%20are,qualifies%20as%20a%20tax%20deduction.) ; they aren’t tax deductible.
7. What can political campaign funds be used for?
8. Political campaign funds can be used to cover daily operating expenses (staffing, office space, supplies, etc.), advertising (television, social media, merchandise, etc.), and other expenses—such as campaign-related traveling and hosting fundraising events. Campaign funds cannot be used to cover[personal expenses](https://www.fec.gov/help-candidates-and-committees/making-disbursements/personal-use/#:~:text=Campaign%20funds%20may%20be%20used%20to%20pay%20the%20costs%20of,duties%20as%20a%20federal%20officeholder.) .
