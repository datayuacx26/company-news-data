...
document_id: "b92f1ce958f8eb0265c4db3b170da5a0604e1795ac63ad0f67fad471dbce3dd5"
company_key: "yc-brex"
company: "Brex"
source_id: "yc-brex-news-import-5eb786253ae8"
canonical_url: "https://www.brex.com/journal/brex-benchmark-december-2025"
...
content_hash: "sha256:09495726722d01f0e928eaf7b4640e0c33116d54353d6bf0365907d1a444ccfd"
---
...
1. **Cursor (+1,000% YoY)** was the fastest-growing vendor among Brex customers, with 1,000% year-over-year growth at a significant scale. Among Brex customers, spending on Cursor compounded every single month in 2025, a feat no other vendor in our data can claim. AI is making engineering teams spend more, not less. Teams are hiring more. Building faster. And allocating bigger budgets to speed.


Cursor anchors a much larger movement across global business: **AI as infrastructure** . The rest of the top 5 fastest-growing vendors make that clear, from tools simplifying LLM model routing and deployment to automating voice, video, and search.
2. **OpenRouter** (+1,500% YoY) is the connective tissue for how developers access and compare frontier models, making multi-model workflows dead simple. There’s no deciding between LLMs; OpenRouter automatically routes to the best one for each job.
3. **Kling AI** ( +1,900% YoY) has redefined what “video production” means, letting anyone generate cinematic clips from text and image prompts. Its rapid quality improvements are pulling AI video from “experimental” into the standard creative toolkit.
4. **Retell AI** (+400% YoY) powers human-like customer service interactions and competes in a crowded and well-funded AI voice market. Its natural pacing and accuracy make Retell a trusted voice tool in real customer-facing workflows.
5. **Perplexity** (+300% YoY) is changing internet search one query at a time. At 300% YoY growth, we’ll need to verbify it soon (“just Plex it”?) because with fast, sourced answers and conversational results, it’s becoming the default way to find information.
...
We saw startups snapping up AI infrastructure in our[July Brex Benchmark](https://www.brex.com/journal/brex-benchmark-july-2025) , but it’s not just about compute anymore. The real momentum is in the orchestration layer — tools that connect every part of the stack, from LLM access to inference, databases, and deployment.
...
We highlighted this trend in our[June Brex Benchmark](https://www.brex.com/journal/brex-benchmark-june-2025) , and it’s only accelerating. Voice AI is now capable of handling repetitive or transactional conversations in a remarkably human-like way, making it a no-brainer for customer support, virtual agents, and product interactions.
...
## 5. We Didn’t Need Fewer Meetings. We Needed Better Ones.
...
1. **Recency weighting:** Last quarter matters more than last year (recent data gets 100% weight, a year ago just 25%).
2. **Sample size skepticism:** A vendor with five customers showing 90% retention? We pull that toward industry baseline until we see more data.
3. **Signal vs. noise:** We smooth monthly volatility to surface real trends, not random blips.
4. **Customer-adjusted impact:** We distinguish between vendor quality and customer quality. A vendor retaining customers who churn often from new products is worth more than those retaining customers who typically lock in to purchases for the long term.
