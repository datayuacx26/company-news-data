...
document_id: "60aedf522db7d6591b868f5203a0b9a9564eade447fb200394da7fe2024f3825"
company_key: "yc-sendbird"
company: "Sendbird"
source_id: "yc-sendbird-news-import-8f7056c4fa29"
canonical_url: "https://sendbird.com/blog/gen-ai-guardrails"
published_at: "2024-01-30T00:02:00+00:00"
first_seen_at: "2026-07-24T13:12:22.102175+00:00"
fetched_at: "2026-07-28T21:33:41.699737+00:00"
content_hash: "sha256:ce7d8b5a6221162ca76ce073cd36fcfb919d90a89cf8a5c15291f3ff193db1db"
---

# Guardrails for Generative AI in 2024

## The evolving landscape of Artificial Intelligence


As a first-time attendee at the World Economic Forum in Davos this year, I got a front-row seat to the evolving narrative around Artificial Intelligence (AI) and its impact on the global business landscape. As the CEO of Sendbird, a[communications platform](https://www.sendbird.com/) powering many of the largest consumer apps worldwide, I find this a timely topic.
...
Never have we been closer to automating intelligent business-to-customer conversations as we are today with generative AI. The transformative potential of generative AI is revolutionizing the[business communication landscape](https://sendbird.com/blog/business-communication-technology) by enabling autonomous conversations when only one customer or user is involved. In the B2C context, this translates to the ability of businesses to rapidly respond to customer queries with highly personalized replies and even predict customer needs before they arise, without any human labor or involvement.


That said, the power of generative AI also presents emerging ethical concerns around safety, trust, and ownership. Careful regulation and oversight of generative AI was an important topic of discussion at this year’s World Economic Forum. Leaders debated whether prompts should be copyrighted and how to differentiate between human-made and machine-generated content (where specific[experts predict the majority of online content](https://youtu.be/DgYCcdwGwrE?si=xvkzXMzvQDIEIuTc) will be AI-generated by 2025).


The careful balance of innovation and regulation of generative AI remains a vast topic following the event. The emphasis on ethical AI use mandates businesses to be more mindful of how AI is applied in customer communications. This involves ensuring data privacy and security, plus avoiding biases in AI algorithms and misinformation in[AI chatbot communications](https://sendbird.com/products/ai-chatbot__old) . But before jumping to strict government regulations, we should start with guidelines for restricted content along with[moderation](https://sendbird.com/products/chat-messaging/content-moderation) and authentication of the parties communicating.


Across the communications technology landscape, we already see providers moving toward moderation. For example, OpenAI offers a moderation endpoint for[moderating content](https://platform.openai.com/docs/guides/moderation/overview) based on its[usage policies](https://openai.com/policies/usage-policies) . Google has also announced an AI-generated content[policy that will go into effect on January 31, 2024](https://support.google.com/googleplay/android-developer/answer/13985936?sjid=5601262939205888504-NA) . Based on this policy, Google will require Android app developers to include a way for users to report offensive AI-generated content within any Google Play app that generates AI content. At Sendbird, our R&D team is investigating how to integrate a generative AI solution like our own[SmartAssistant](https://sendbird.com/products/ai-chatbot__old) into the advanced moderation process of our communications API platform.


There’s more to come on this topic! If you would like to learn more about how we’re leveraging generative AI to support[in-app communications](https://sendbird.com/products/chat-messaging) , please[book a meeting](https://sendbird.com/contact-us) with us.
