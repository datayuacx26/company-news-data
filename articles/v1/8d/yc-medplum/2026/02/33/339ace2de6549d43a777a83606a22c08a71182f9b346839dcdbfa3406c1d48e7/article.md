...
document_id: "339ace2de6549d43a777a83606a22c08a71182f9b346839dcdbfa3406c1d48e7"
company_key: "yc-medplum"
company: "Medplum"
source_id: "yc-medplum-atom-baaaecda9acc"
canonical_url: "https://www.medplum.com/blog/identity-management"
...
content_hash: "sha256:339fcc770a572d5b99f21cc0f821803eea0830bec4abb7005871746f444f5228"
---
...
```text
// Using the Medplum SDK for token exchange      const   medplum   =     new     MedplumClient  (  {         baseUrl  :     MEDPLUM_BASE_URL  ,         clientId  :     MEDPLUM_CLIENT_ID  ,      }  )  ;         // Exchange your external IDP token for a Medplum token      await   medplum  .  exchangeExternalAccessToken  (  OKTA_ACCESS_TOKEN  )  ;         // Now you can make FHIR API calls      const   patient   =     await   medplum  .  readResource  (  'Patient'  ,   patientId  )  ;
```
...
```text
curl 'https://api.medplum.com/fhir/R4/Patient' \      --user $CLIENT_ID:$CLIENT_SECRET \      -H 'content-type: application/fhir+json' \      -H 'x-medplum: extended' \      -H 'x-medplum-on-behalf-of: ProjectMembership/abc123' \      --data-raw '{"resourceType":"Patient","name":[{"given":["Homer"],"family":"Simpson"}]}'
```
