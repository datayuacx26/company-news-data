...
document_id: "926eb3ab259acda840256c238de3b49b902c00419750ee940c4b6d8ea214c87b"
company_key: "yc-yuma-ai"
company: "Yuma AI"
source_id: "yc-yuma-ai-rss-d56eac7ccbd5"
canonical_url: "https://yuma.ai/blogs/why-csat-fails-in-evaluating-ai-powered-customer-support-performance"
...
content_hash: "sha256:be0f4c5dc4a16415861c33846c0b70674ab39c7a74c2fdaebe016488e32fb5c0"
---
...
To state the obvious, AI ensures 24/7 support, faster response times, higher overall ticket quality thanks to a shared knowledge base, and streamlined centralized procedures. If you want a comprehensive look at how to put this into practice,[the full ecom CX playbook for gen AI](https://yuma.ai/blogs/the-ultimate-guide-to-delivering-e-commerce-customer-service-with-generative-ai) is worth reading before you commit to any new tooling.
...
By default, your AI will begin by handling the simplest cases and answering those quickly, often resulting in higher CSAT scores. This is because it’s relatively easy for any good AI to achieve good CSAT, especially as they tend to handle cases that align with customer expectations, such as avoiding denying refunds. Your AI having a good CSAT is basically a requirement and it’s easy to achieve. For more context on why this represents such a departure from older models, see[why gen AI outperforms traditional CX](https://yuma.ai/blogs/ai-and-customer-service-7-reasons-why-generative-ai-outperforms-traditional-customer-support) .
...
To conclude, while CSAT is still a reasonably good proxy overall, please avoid using it to distinguish between Humans and AI. Or if you still do, do it while being fully aware of all the biases in that split :) Beyond metrics, the architectural defenses matter too — see how[quality control architecture prevents AI hallucinations](https://yuma.ai/blogs/ai-hallucinations-in-customer-service-why-quality-control-architecture-matters) . If you're ready to move beyond CSAT and evaluate a smarter approach,[explore pricing options](https://yuma.ai/pricing) for Yuma's AI support platform.
