...
document_id: "9652bf31c52c674c97b7ebef2a7eca551d14bddcb31faebb0d9a6fe10afc7234"
company_key: "yc-proliferate"
company: "Proliferate"
source_id: "yc-proliferate-news-import-ca494a17b85f"
canonical_url: "https://proliferate.com/blog/ai-first-engineering-teams-what-roles-will-disappear-and-which-will-rise"
published_at: "2026-05-22T00:00:00+00:00"
first_seen_at: "2026-07-22T10:18:41.845619+00:00"
fetched_at: "2026-07-28T21:43:30.232286+00:00"
content_hash: "sha256:cba2fdbb39c5c3558fb4231eca1adcda56a76bf441f3368eefad836e9ed92498"
---
...
The conversation ended quietly, at least for anyone paying attention. Stripe's engineering team says its Minions coding agents now account for[more than 1,300 merged pull requests per week](https://stripe.dev/blog/minions-stripes-one-shot-end-to-end-coding-agents-part-2) , up from more than 1,000 in its earlier write-up. Humans still review the code, but the agents write it end to end.
...
The broader numbers reinforce what individual teams are experiencing. Capgemini's[World Quality Report 2024](https://www.capgemini.com/us-en/news/press-releases/world-quality-report-2024-shows-68-of-organizations-now-utilizing-gen-ai-to-advance-quality-engineering/) says 68% of organizations are either already using generative AI in quality engineering or have roadmaps following successful pilots. McKinsey, meanwhile, notes that as much as[70% of the software used by Fortune 500 companies was developed 20 or more years ago](https://www.mckinsey.com/capabilities/quantumblack/our-insights/ai-for-it-modernization-faster-cheaper-and-better) , which is exactly the kind of backlog agentic tooling is positioned to attack.
...
For engineering specifically, the trajectory is clearer.[McKinsey data shows 70% of Fortune 500 companies' software was developed 20+ years ago](https://www.mckinsey.com/capabilities/quantumblack/our-insights/ai-for-it-modernization-faster-cheaper-and-better) . Legacy modernization—migrations, refactoring, API updates—represents a massive backlog that AI agents can address at scale. Junior developer roles focused primarily on implementing well-specified, routine tasks face the most direct competition.


Manual QA positions face similar pressure.[IDC FutureScape: Developer & DevOps 2024 predicts 80% of software tests will be AI-generated by 2028](https://my.idc.com/research/viewtoc.jsp?containerId=US50136023) . That projection places the industry just three years from a fundamental shift in how code quality is assured. Teams that once employed dedicated testers to construct coverage suites now face a landscape where coverage generation is automated—and where[AI spotted 42% to 56% of potential security and compliance concerns in OutSystems and KPMG research](https://www.outsystems.com/news/ai-software-development-survey/) .
...
AI Orchestration Engineer Machine learning engineer[Indeed reports an average base salary of $189,061](https://www.indeed.com/career/machine-learning-engineer/salaries) in the United States, updated June 15, 2026


Agent Security Auditor Cybersecurity engineer[Indeed reports an average base salary of $129,106](https://www.indeed.com/career/cybersecurity-engineer/salaries) in the United States, updated June 15, 2026


Human-AI Workflow Designer Technical product manager[Indeed reports an average base salary of $141,914](https://www.indeed.com/career/technical-product-manager/salaries) in the United States, updated June 14, 2026


Exact public compensation for titles like "AI orchestration engineer" is still sparse, which is itself revealing: the role taxonomy is newer than the labor-market data. But the adjacent market signals are already plainly six-figure. Reliability engineering shows the same pattern.[Indeed reports an average U.S. reliability engineer salary of $119,263](https://www.indeed.com/career/reliability-engineer/salaries) , while the[Bureau of Labor Statistics reports a 2024 median wage of $124,910 for information security analysts](https://www.bls.gov/ooh/computer-and-information-technology/information-security-analysts.htm) . The money is already flowing toward the people who design, secure, and govern autonomous systems.


## Why Most AI Coding Tools Hit a Ceiling


Despite the productivity numbers, most AI coding initiatives fail to reach production.[68% of organizations are now utilizing generative AI to advance quality engineering](https://www.capgemini.com/us-en/news/press-releases/world-quality-report-2024-shows-68-of-organizations-now-utilizing-gen-ai-to-advance-quality-engineering/) —but that adoption rate masks a deployment gap. The tools that succeed share a common characteristic: production-grade infrastructure.
...
The business case practically writes itself. Coinbase documented[more than 25 hours per week reclaimed](https://www.coinbase.com/blog/building-enterprise-AI-agents-at-Coinbase) through two automations running in production within six weeks. That's the kind of ROI that makes infrastructure investment a different conversation with leadership—one grounded in output rather than speculation.
