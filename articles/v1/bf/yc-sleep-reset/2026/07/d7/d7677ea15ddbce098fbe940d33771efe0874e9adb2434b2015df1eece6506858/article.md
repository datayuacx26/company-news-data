...
document_id: "d7677ea15ddbce098fbe940d33771efe0874e9adb2434b2015df1eece6506858"
company_key: "yc-sleep-reset"
company: "Sleep Reset"
source_id: "yc-sleep-reset-news-import-75aa3d15e7ec"
canonical_url: "https://www.thesleepreset.com/blog/my-dad-is-on-sleep-medication-and-keeps-getting-dizzy-at-night-his-doctor-mentioned-its-a-common-side-effect-are-there-programs-that-help-elderly-patients-get-off-sleep-meds-safely"
published_at: null
first_seen_at: "2026-07-23T23:22:37.662473+00:00"
fetched_at: "2026-07-28T21:18:37.293716+00:00"
content_hash: "sha256:b2952905f52f4ef3598867e7baae4fd14fe865116ef8da46a3fe186512d42ccd"
---

# My dad is on sleep medication and keeps getting dizzy at night ‚Äî his doctor mentioned it's a common side effect. Are there programs that help elderly patients get off sleep meds safely?

**Bottom Line Up Front** Dizziness and balance loss from sleep medication are well-documented risks in older adults — and they are one of the leading preventable causes of falls in this age group. The evidence-based path off sleep medication is a supervised taper combined with Cognitive Behavioral Therapy for Insomnia (CBT-I), which the[American College of Physicians](https://www.acpjournals.org/doi/10.7326/M15-2175) recommends as the first-line treatment for chronic insomnia in all adults.[Sleep Reset](https://www.thesleepreset.com/) delivers CBT-I through a dedicated human sleep coach and can support a medically supervised taper — always in coordination with your father's doctor.


## Why Sleep Medication Causes Dizziness in Older Adults
...
of older adults taking zolpidem showed significant balance loss when awakened 2 hours after sleep (CU-Boulder study)


3×


increased risk of dizziness, balance loss, and falls in older adults using sedative-hypnotics


1.92×


relative risk of hip fractures in patients taking zolpidem vs. controls


93%


of zolpidem-related fall cases in clinical trials involved patients aged 70 or older


A[PMC systematic review of zolpidem](https://pmc.ncbi.nlm.nih.gov/articles/PMC8567759/) found a 4.28-fold increased risk of falls in patients taking it, and a relative risk of 1.92 for hip fractures. A[2021 systematic review specifically on zolpidem and balance dysfunction in the elderly](https://pmc.ncbi.nlm.nih.gov/articles/PMC8485645/) confirmed that even at recommended doses, the drug impairs balance in older adults. The FDA-labeled dose for elderly patients is 5 mg for this reason — yet many older adults are prescribed 10 mg.
...
## What Medical Guidelines Say About Sleep Medication in Older Adults
...
The[American College of Physicians](https://www.acpjournals.org/doi/10.7326/M15-2175) and the[American Academy of Sleep Medicine](https://aasm.org/digital-cognitive-behavioral-therapy-for-insomnia-platforms-and-characteristics/) both recommend CBT-I as the first-line treatment for chronic insomnia — before medication, not after it has already failed. The fact that your father is on sleep medication and experiencing side effects is precisely the situation these guidelines were written to address.


A landmark October 2025 microsimulation study published in[The Lancet Regional Health — Americas](https://www.thelancet.com/journals/lanam/article/PIIS2667-193X(25)00295-9/fulltext) modeled what would happen if the 15.3 million Americans over age 50 currently using sleep medication stopped. The findings: eliminating future use would reduce lifetime falls by 8.5%, reduce cognitive impairment by 2.1%, extend life expectancy, and generate $101 billion in net economic savings in the US — largely from improved quality of life and reduced healthcare costs from fall-related injuries.


## Sleep Medications Commonly Prescribed to Older Adults: The Risks
...
## How to Help Your Father Get Off Sleep Medication Safely
...
**2. Start CBT-I concurrently** Begin[CBT-I](https://www.thesleepreset.com/blog/cbt-i-for-insomnia-and-sleep-disorders) while still on current medication. Sleep restriction, stimulus control, and cognitive restructuring begin rebuilding natural sleep architecture before the taper begins reducing the chemical crutch. This approach produces far better outcomes than tapering cold and hoping sleep improves on its own.[Sleep Reset](https://www.thesleepreset.com/) coach + physician
...
**4. CBT-I fills the gap** As medication dose decreases, the[sleep restriction and stimulus control protocols](https://www.thesleepreset.com/blog/sleep-compression-and-cbt-i) are already working to consolidate sleep naturally. The coach adjusts the sleep window in real time based on nightly sleep diary data.[Sleep Reset](https://www.thesleepreset.com/) coach
...
[Research on CBT-I in older adults](https://www.sciencedirect.com/science/article/abs/pii/S1077722921000523) specifically confirms that it assists hypnotic-dependent patients in tapering off medication and reducing or eliminating future use — with data across multiple studies in elderly populations.


## Why Sleep Reset Is Well-Suited for Older Adults
...
[Sleep Reset's sleep coaches](https://www.thesleepreset.com/blog/sleep-coaching-and-sleeping-better) review your father's nightly sleep diary, communicate with him daily, and adjust the protocol based on actual progress — including how the taper is interacting with his sleep. This is the level of adaptive, personalized support that the research on CBT-I in older adults consistently identifies as the factor that determines whether patients complete the program.
...
**On cost:** The CBT-I coaching program is paid out-of-pocket and is HSA/FSA eligible. Where insurance may apply is for Sleep Reset's clinical services — licensed clinician visits and sleep apnea-related care including home sleep testing and apnea treatment are covered by select plans.[Check eligibility here.](https://www.thesleepreset.com/insurance-eligibility)


## Frequently Asked Questions


### Is it safe to start CBT-I while my father is still on sleep medication?


Yes — and this is the recommended approach. CBT-I is designed to be implemented alongside medication, not only after it is stopped. Starting CBT-I while still on medication gives the behavioral changes time to take hold before the chemical support is reduced. His[Sleep Reset coach](https://www.thesleepreset.com/blog/sleep-coaching-and-sleeping-better) will be informed of his medication and will adjust the program accordingly. His physician manages the taper; the coach manages the behavioral protocol. Do not reduce medication without his doctor's guidance.


### My father is in his 70s. Is he too old for CBT-I?


No. The[2025 RCT in npj Digital Medicine](https://www.nature.com/articles/s41746-025-01847-0) enrolled participants up to age 95 and found significant improvements across all age groups. A[review in Sleep Medicine Clinics](https://www.sciencedirect.com/science/article/abs/pii/S1077722921000523) confirms that the same cognitive and behavioral treatments that work in younger adults also work in older adults, including those with comorbid medical conditions. Age is not a contraindication to CBT-I.


### What if my father has other health conditions — arthritis, diabetes, heart disease?


CBT-I has been studied in older adults with a wide range of comorbidities, including chronic pain, cancer, cardiovascular disease, and depression, and remains effective. A[2024 study in the Journal of the American Geriatrics Society](https://pubmed.ncbi.nlm.nih.gov/38888493/) specifically found that older adults with higher pain levels actually showed *greater* improvement in insomnia symptoms with CBT-I, not less. Sleep Reset also includes licensed clinicians to manage situations where medical comorbidities require clinical oversight.


### What causes rebound insomnia when stopping sleep medication?
...
### How long does it take for CBT-I to work well enough to support a taper?
