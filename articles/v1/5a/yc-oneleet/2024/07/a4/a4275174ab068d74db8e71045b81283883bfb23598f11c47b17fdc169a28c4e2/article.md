...
document_id: "a4275174ab068d74db8e71045b81283883bfb23598f11c47b17fdc169a28c4e2"
company_key: "yc-oneleet"
company: "Oneleet"
source_id: "yc-oneleet-news-import-d01376dbbc95"
canonical_url: "https://www.oneleet.com/blog/insider-threats"
...
content_hash: "sha256:f174f5dc9810eaea2f2bb92926000b0201c5c4942ddc9263da35c9966f968119"
---

# Mitigating Insider Threats: How To Do It

Insiders (employees or partners) can hurt your business, and this is more serious than it seems. A[report](https://www.cybersecurity-insiders.com/2024-insider-threat-report-trends-challenges-and-solutions/) by Cybersecurity Insiders reveals that the percentage of organizations experiencing insider attacks rose from 66% in 2019 to 76% in 2024. Meanwhile, a report by the Ponemon Institute and Proofpoint[highlights](https://static.poder360.com.br/2022/01/pfpt-us-tr-the-cost-of-insider-threats-ponemon-report.pdf) that nearly half of these incidents, 44%, are due to displeased employees messing with the organization's systems, tools, or apps.
...
**Financial loss from insider threats can be huge, from stolen funds to costly investigations and lawsuits.** Techreport[indicates](https://techreport.com/statistics/cybersecurity/insider-threat-statistics) that "the average cost of an insider threat situation in 2022 was $15.38 million."
...
Regular access control and user behavior audits can help detect insider threats early.[Having](https://training.hr.ufl.edu/resources/LeadershipToolkit/job_aids/CreatingaCultureofTransparency.pdf) **a culture of transparency within the organization encourages employees to report suspicious activity without fear.** Security team and HR collaboration is key to insider threat management.
...
Proofpoint’s Insider Threat Management is a converged DLP and ITM[solution](https://www.proofpoint.com/us/products/insider-threat-management) that detects and prevents insider threats on the endpoint in real-time. Proofpoint provides real-time, contextual visibility into user activity to prevent users from exfiltrating data through multiple channels like USB, web uploads, cloud sync, and print.
