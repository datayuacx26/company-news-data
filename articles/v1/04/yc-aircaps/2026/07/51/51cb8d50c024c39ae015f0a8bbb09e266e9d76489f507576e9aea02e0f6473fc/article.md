...
document_id: "51cb8d50c024c39ae015f0a8bbb09e266e9d76489f507576e9aea02e0f6473fc"
company_key: "yc-aircaps"
company: "AirCaps"
source_id: "yc-aircaps-news-import-d6be7fd3a9e9"
canonical_url: "https://aircaps.com/blog/lipreading-with-captioning-glasses"
...
content_hash: "sha256:9dae0dc60168191b2365f454c3b484b57f8c5e482d456503019f92778593a70d"
---

# Lipreading Plus Captions: Why Combining Both Beats Either Alone
...
## Why Reading Lips and Reading Captions Together Beats Either One Alone


Skilled lipreaders watching a naturalistic story catch an average of just 50.7% of the words, with individual scores ranging from 6% to 100% ([PMC](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC9927859/) , 2023). Lipreading alone leaves half the message on the table. Captions alone, when they live on a phone in your lap, pull your eyes off the speaker's face and throw away a visual signal worth as much as 15 dB of clarity in noise ([Sumby & Pollack](https://pubs.aip.org/asa/jasa/article/26/2/212/598972/) , 1954). Combine both — read the lips and read the captions in the same glance — and each channel covers the other's blind spots.
...
>
>
> - Even skilled lipreaders average only 50.7% of words from a spoken narrative, with scores spanning 6% to 100% ([PMC](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC9927859/) , 2023), because roughly two-thirds of English speech sounds are not distinguishable on the lips
> - Seeing the talker's face is worth up to 15 dB of effective signal-to-noise improvement, with the largest gains in the noisiest rooms ([Sumby & Pollack](https://pubs.aip.org/asa/jasa/article/26/2/212/598972/) , 1954)
> - At a punishing minus 16 dB signal-to-noise ratio, listeners jumped from 9% words correct with audio alone to 38% when they could also see the face ([PMC](https://pmc.ncbi.nlm.nih.gov/articles/PMC6435873/) , 2019)
> - The brain fuses lips and sound automatically — the McGurk effect alters what up to 98% of adults perceive ([McGurk & MacDonald](https://www.nature.com/articles/264746a0) , 1976) — so keeping the face in view is neurological, not optional
...
- What Can Lipreading Actually Do on Its Own?
- Why Does Seeing a Face Make Speech Easier to Hear?
- Where Do Captions Alone Fall Short?
- The Look-Down Problem: How Phone Captions Throw Away the Visual Benefit
- How Captioning Glasses Keep Both Channels in One Field of View
- Lipreading Alone vs. Captions Alone vs. Both Together
- What This Means If You Rely on Lipreading
...
Lipreading is a remarkable skill and a limited one. In a controlled study of adults lipreading a naturalistic narrative, the mean score was 50.7% of words correct, and the spread ran from 6% all the way to 100% ([PMC](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC9927859/) , 2023). On isolated monosyllabic words the numbers are worse — human lipreaders scored around 32% ([arXiv](https://arxiv.org/pdf/1810.10597) , 2018). So even a talented speechreader is guessing at a large fraction of what's said.


The reason is baked into the anatomy of speech. English has far more phonemes than visemes — the distinct mouth shapes you can actually see. Voiced and unvoiced pairs like "p," "b," and "m" are produced with nearly identical lip movements, so they look the same on the face. These homophenes make whole clusters of words visually indistinguishable. The figure commonly cited in hearing-health literature is that only about 30% of English speech sounds can be told apart by sight alone ([Hearing Health & Technology Matters](https://hearinghealthmatters.org/better-hearing-consumer/2019/giving-good-lip-for-better-speechreading/) , 2019). Whether the exact number is 30% or a little higher, the mechanism is solid and well documented in the audiology literature ([American Journal of Audiology](https://pubs.asha.org/doi/10.1044/2021_AJA-21-00112) , 2022).


Then there's the cost. Lipreading is cognitively expensive. In a study of 200 deaf and hard-of-hearing adults, heavier reliance on speechreading correlated with more listening-related fatigue ([eScholarship](https://escholarship.org/uc/item/6sp319kw) , 2021). Anyone who has spent an evening straining to read a friend's lips across a loud table knows the feeling — you leave exhausted, and you still missed things. Lipreading is a real channel, but it was never meant to carry the whole message by itself.


> Citation capsule: Skilled adults lipreading a naturalistic narrative averaged 50.7% of words correct, with a range of 6% to 100% ([PMC](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC9927859/) , 2023). On isolated words, human lipreaders score around 32% ([arXiv](https://arxiv.org/pdf/1810.10597) , 2018). Homophenes — sounds like "p," "b," and "m" that look identical on the lips — are why the visual channel alone leaves so much ambiguous.
...
If you already lipread, you are not doing it wrong — you're doing heroic work with an incomplete signal. Roughly 1.5 billion people live with some degree of hearing loss worldwide, a figure projected to reach 2.5 billion by 2050 ([WHO](https://www.who.int/news-room/fact-sheets/detail/deafness-and-hearing-loss) , 2025), and in the US about 48 million people, or 1 in 7, have some hearing loss ([HLAA](https://www.hearingloss.org/understanding-hearing-loss/hearing-loss-101/hearing-loss-by-the-numbers/) , 2023). Many of them lean on lipreading daily, filling the gaps by hand and paying for it in fatigue.


The practical takeaway is to stop asking your lips to do all the work. Add a second visual channel that resolves the ambiguity, and keep it in the same field of view so you don't sacrifice the lips to get it. That's the case for captioning glasses over phone-based apps for anyone whose primary strategy is watching faces. In[professional settings](https://aircaps.com/meetings) the argument compounds: speaker identification labels who's talking in a group, and a searchable transcript means you don't have to hold the whole meeting in working memory while you lipread it in real time.
...
### How accurate is lipreading on its own?


Even skilled lipreaders average about 50.7% of words when reading a naturalistic spoken narrative, with individual scores ranging from 6% to 100% ([PMC](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC9927859/) , 2023). On isolated words, humans score closer to 32% ([arXiv](https://arxiv.org/pdf/1810.10597) , 2018). Homophenes — sounds like "p," "b," and "m" that look identical on the lips — are why so much stays ambiguous without a second channel like captions.


### Does seeing someone's face really help you hear them?


Yes, dramatically. Seeing the talker's face is worth up to 15 dB of effective signal-to-noise improvement, with the largest gains in the noisiest conditions ([Sumby & Pollack](https://pubs.aip.org/asa/jasa/article/26/2/212/598972/) , 1954). In one modern test, listeners went from 9% words correct with audio alone to 38% when they could also see the face at a minus 16 dB signal-to-noise ratio ([PMC](https://pmc.ncbi.nlm.nih.gov/articles/PMC6435873/) , 2019).


### Why not just use captions on my phone?


Phone captions work, but reading them means looking down and away from the speaker's face. That sacrifices the visual speech signal worth 3 to 15 dB of clarity in noise ([American Journal of Audiology](https://pubs.asha.org/doi/10.1044/2021_AJA-21-00112) , 2022). Captioning glasses put the text in your field of view near the face, so you keep the lips and add the captions instead of trading one for the other.


### What is the McGurk effect and why does it matter here?


The McGurk effect is proof that your brain fuses lips and sound automatically. Hearing "ba" while watching a face mouth "ga" makes most people perceive "da" — an illusion that alters perception in up to 98% of adults ([McGurk & MacDonald](https://www.nature.com/articles/264746a0) , 1976). You can't switch it off, which is why keeping the speaker's face in view is neurologically valuable, not just convenient.


### How fast do captions need to appear to sync with lips?


Viewers start noticing audiovisual desynchronization once the offset passes roughly 125 to 200 milliseconds ([arXiv](https://arxiv.org/pdf/2212.01686) , 2022). AirCaps renders captions at 300 milliseconds end-to-end, close enough that the text arrives while the mouth is still moving. That keeps the caption and the lips reading as one synchronized event rather than a lagging subtitle.


### Do captioning glasses replace lipreading or hearing aids?
...
*Sources:[PMC — Lipreading a Naturalistic Narrative](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC9927859/) , 2023.[arXiv — Lipreading Human Baseline](https://arxiv.org/pdf/1810.10597) , 2018.[Sumby & Pollack — Visual Contribution to Speech Intelligibility in Noise, JASA](https://pubs.aip.org/asa/jasa/article/26/2/212/598972/) , 1954.[PMC — Visual Speech Benefit in Clear and Degraded Speech](https://pmc.ncbi.nlm.nih.gov/articles/PMC6435873/) , 2019.[PMC — Multisensory Benefits for Speech Recognition in Noisy Environments](https://pmc.ncbi.nlm.nih.gov/articles/PMC9630463/) , 2022.[American Journal of Audiology — Lipreading: A Review](https://pubs.asha.org/doi/10.1044/2021_AJA-21-00112) , 2022.[McGurk & MacDonald — Hearing Lips and Seeing Voices, Nature](https://www.nature.com/articles/264746a0) , 1976.[Cognitive Research — Communication With Face Masks During COVID-19](https://cognitiveresearchjournal.springeropen.com/articles/10.1186/s41235-022-00376-8) , 2022.[PLOS One — Influence of Surgical and N95 Masks on Speech Perception](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0253874) , 2021.[Hearing Health & Technology Matters — Giving Good Lip for Better Speechreading](https://hearinghealthmatters.org/better-hearing-consumer/2019/giving-good-lip-for-better-speechreading/) , 2019.[Noise & Health — Noise in Restaurants](https://journals.lww.com/nohe/fulltext/2014/16730/noise_in_restaurants__levels_and_mathematical.4.aspx) , 2014.[NIDCD — Noise-Induced Hearing Loss](https://www.nidcd.nih.gov/health/noise-induced-hearing-loss) , 2024.[eScholarship — Listening-Related Fatigue and Cognitive Effort in Deaf and HoH Bilinguals](https://escholarship.org/uc/item/6sp319kw) , 2021.[arXiv — Audiovisual Desynchronization Perception](https://arxiv.org/pdf/2212.01686) , 2022.[WHO — Deafness and Hearing Loss Fact Sheet](https://www.who.int/news-room/fact-sheets/detail/deafness-and-hearing-loss) , 2025.[HLAA — Hearing Loss by the Numbers](https://www.hearingloss.org/understanding-hearing-loss/hearing-loss-101/hearing-loss-by-the-numbers/) , 2023. Image credits: Pexels (royalty-free).*
