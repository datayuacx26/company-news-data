...
document_id: "084f4e94ed4d04d6581beb4aae1b5d5c5469b085e952f7e4c6b18fb937599296"
company_key: "yc-torch"
company: "Torch"
source_id: "yc-torch-news-import-8877f8085fcd"
canonical_url: "https://torch.io/blog/how-social-learning-accelerates-ai-adoption/"
published_at: "2025-11-03T11:00:00+00:00"
first_seen_at: "2026-07-22T16:58:54.319775+00:00"
fetched_at: "2026-07-28T22:01:00.433769+00:00"
content_hash: "sha256:a706feb4c9f39134d43dff42dc9bb7087ef1756dda1fc160f4dc97eb9d6d47da"
---

# How social learning accelerates AI adoption

## What can help leaders more quickly gain value from AI?


The[5% of organizations](https://hbr.org/2025/09/what-companies-with-successful-ai-pilots-do-differently) succeeding with AI have leaders who can navigate uncertainty, build trust, and rethink work when AI handles routine tasks.[We’ve explored what makes these leaders different](https://torch.io/blog/95-of-ai-pilots-fail-heres-what-the-successful-5-get-right/) . Individual coaching helps as it gives leaders space and tools to develop critical leadership capacities.
...
Most leaders are consciously incompetent with AI, a term from the[conscious competence learning model](https://en.wikipedia.org/wiki/Four_stages_of_competence) popularized by[Noel Burch](https://www.gordontraining.com/learning-a-new-skill-is-easier-said-than-done/) in the 1970s. This framework describes four stages people move through when developing new skills: unconscious incompetence (you don’t know what you don’t know), conscious incompetence (you’re aware of what you don’t know), conscious competence (you can do it but must concentrate), and unconscious competence (the skill becomes automatic).
...
[Social learning theory](https://www.simplypsychology.org/bandura.html) emphasizes how leaders’ behaviors are reinforced by observing and modeling others.


-


[Sociocultural theory](https://www.simplypsychology.org/vygotsky.html) reveals how learning is grounded in culture and supported by knowledgeable others.


-


[Situated learning](https://en.wikipedia.org/wiki/Situated_learning) demonstrates that learning happens in the specific context where it can be directly applied.
...
[DDI’s Global Leadership Forecast 2025](https://media.ddiworld.com/research/global-leadership-forecast-2025-report.pdf#page=23.07) found that organizations that use five or more development approaches, including peer learning, are 4.9X more likely to report that their programs improve leadership capabilities. Multiple methods working together create the strongest impact.
...
**Group coaching for AI challenges** ****Cohorts of leaders work through AI adoption challenges with a coach facilitating. This combines expert guidance with peer learning, building psychological safety while developing leadership capacities together. At Torch, we design group coaching programs that address AI challenges in real-time.


-


**Cross-functional action learning** ****Small teams from different departments tackle real business problems using AI. Regular check-ins, shared accountability, and permission to fail all matter here. Marketing leaders partner with finance teams to redesign processes. They identify gaps, test assumptions collaboratively, and build solutions neither would have designed alone.


-


**Peer coaching partnerships** ****Pair leaders with different AI experience levels and give them protected time to share approaches, troubleshoot challenges, and explore use cases. Cross-department pairings work particularly well. Different perspectives reveal assumptions that might otherwise stay invisible.


-


**Executive learning communities** ****Bring together executives from across the organization (or even across non-competing companies) to share what they’re learning about AI strategy. Rotating facilitation, shared frameworks, and commitment to candid exchange make these work. Leaders need spaces where they can admit what they don’t know.


-


**Leaders as learning role models** ****Executives who visibly engage in collaborative AI learning (participating in group coaching, joining action learning teams, openly sharing what they’re trying and what’s not working) normalize experimentation and collective learning. Their presence signals that leaders shouldn’t figure this out alone.


## What the research shows


LinkedIn research found that professional networks are the #1 trusted source for advice, ahead of AI tools and search engines.[43% of professionals](https://news.linkedin.com/2025/networks--not-ai-or-search--are-the--1-trusted-source-amid-infor) rely on the people they know.
...
**For individuals:** Collaborative learning shows positive relationships with meta-cognitive skills, critical thinking, and creative thinking ([Khasawneh et al](https://files.eric.ed.gov/fulltext/EJ1353453.pdf) ). Managers with peer-based learning experiences are 18% more likely to excel ([Gartner](https://www.gartner.com/en/documents/3970399#:~:text=Summary,effective%20peer%20learning%20can%20happen.) ).


-


**For teams** :** **Performance improves measurably. One study found that positive social-emotional interactions during collaborative learning promoted conflict resolution ([Hu et al](https://dl.acm.org/doi/abs/10.1145/3498765.3498834) ). When teams more effectively regulated their learning during collaborative learning activities, they performed better than those with reduced regulation patterns ([Zhang et al](https://link.springer.com/article/10.1007/s11412-021-09339-5) ).


-


**For organizations:** Organizations using collaborative learning report measurable business outcomes: 56% see better efficiency, 52% better engagement, and 50% meet business objectives ([Intrepid Learning](https://www.intrepidlearning.com/images/uploads/Collaborative-Learning-The-Key-to-Better-Performance.pdf) ). Companies with comprehensive leadership programs are 4.2 times more likely to deliver superior financial performance ([Culture Partners](https://culturepartners.com/insights/leadership-development-building-tomorrows-leaders-through-strategic-growth-and-innovation/) ). Collaboration-centered initiatives can boost productivity by 20–25% ([McKinsey](https://www.mckinsey.com/industries/technology-media-and-telecommunications/our-insights/the-social-economy) ).
...
Organizational Development & Learning Strategist


Mekayla blends behavioral science with practical leadership experience to create learning that drives real change. She’s led curriculum and experience design across high-growth organizations, helping leaders build trust, navigate complexity, and strengthen teams.
