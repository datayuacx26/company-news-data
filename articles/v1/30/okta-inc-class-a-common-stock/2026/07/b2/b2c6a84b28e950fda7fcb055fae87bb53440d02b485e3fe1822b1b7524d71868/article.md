...
document_id: "b2c6a84b28e950fda7fcb055fae87bb53440d02b485e3fe1822b1b7524d71868"
company_key: "okta-inc-class-a-common-stock"
company: "Okta Inc."
source_id: "okta-inc-class-a-common-stock-news-import-144d960cd8f2"
canonical_url: "https://www.okta.com/blog/industry-insights/what-are-the-benefits-and-limitations-of-multi-cloud/"
published_at: "2026-07-31T07:00:00+00:00"
first_seen_at: "2026-08-01T08:47:40.249114+00:00"
fetched_at: "2026-08-01T08:47:41.617369+00:00"
content_hash: "sha256:83d3dfb550dadbe06d5e4d48b7a0d0abddb5a161b42dfa3923b8234475be6253"
---
...
Organizations are increasingly deploying and implementing cloud services to reduce the cost and complexity of their infrastructure while accelerating innovation. Many organizations take a multi-pronged approach: According to[Flexera's 2021 State of the Cloud Report](https://resources.flexera.com/web/pdf/report-cm-state-of-the-cloud-2021.pdf?elqTrackId=547c9629dcd04adebbb5ac27c53509bf&elqaid=6546&elqat=2&elqak=8AF5BBE823CFEB9F67F2B71763F8E8F419EBE2413D9740E536B56D6CE84FC6E32617&_gl=1*1gibu3u*_gcl_au*NzQ2MDI4ODY2LjE3ODUzNjM1NTM.*_ga*NzExMjM5MjQxLjE3ODUzNjM1NTM.*_ga_GXNEBN7LEE*czE3ODUzNjM1NTMkbzEkZzEkdDE3ODUzNjM2NDUkajQ1JGwwJGgw) , 92% of enterprises have deployed a multi-cloud strategy, while 80% deploy a hybrid cloud strategy. The average organization uses 5.3 clouds—both private and public.
...
[Hybrid cloud](https://www.okta.com/identity-101/what-is-hybrid-cloud-architecture/) refers to the use of a combination of private and public cloud infrastructure. A hybrid cloud approach involves using orchestration tools to deploy workloads and balance organizations' resources across private and public clouds.
...
Increasingly stringent data privacy and governance regulations—such as the[California Consumer Privacy Act (CCPA)](https://www.okta.com/legal/ccpa/) and the[General Data Protection Regulation (GDPR)](https://www.okta.com/legal/gdpr/) —require customer data to be stored in specific locations. Multi-cloud enables organizations to deliver this specificity without having to build and manage their own on-premises data centers or lakes.
...
As organizations add new cloud apps, they risk losing control over their identity processes,[access management](https://www.okta.com/identity-101/identity-and-access-management/) , and security. Perimeter-based security tools are not built to secure and manage environments spread across multiple locations, and[identity is paramount](https://www.okta.com/solutions/zero-trust/) . Companies need to oversee and stay up to date on their cloud applications without drastically increasing spending on cloud management tools.
...
A significant challenge for many organizations that want to migrate to the cloud is integrating the cloud environment with their[legacy systems](https://www.okta.com/resources/whitepapers/is-legacy-identity-infrastructure-holding-your-enterprise-back/) . Multi-cloud strategies can stretch security architectures beyond their limits.[Businesses need to assess their networks](https://www.okta.com/solutions/initiatives/modernize-infrastructure/) , environments, and security architectures before implementing multi-cloud to avoid potential risks and liabilities.


### Data privacy and protection


Cybersecurity provides a significant challenge for organizations that store all their data on-premises. But housing it in various locations in multiple data centers and cloud environments makes protecting data even more challenging. Organizations need to provide[seamless access to all of their cloud services](https://www.okta.com/products/advanced-server-access/) , maintain least-privilege access across their cloud environments, and[establish a robust identity architecture](https://www.okta.com/resources/datasheets/putting-the-spotlight-on-zero-trust-architecture/) that federates with any application or service.
...
Businesses require a[modern identity platform](https://www.okta.com/blog/identity-security/what-is-an-identity-platform/) that makes the user the new perimeter, ensures secure access to applications and services, and enables rapid adoption. A[Zero Trust security approach](https://www.okta.com/solutions/initiatives/adopt-a-zero-trust-security-model/) ensures:


- Context-based security
- Centralized identity control and reduced password mismanagement through[single sign-on](https://www.okta.com/products/single-sign-on-workforce-identity/)
- Protection of data through[multi-factor authentication (MFA)](https://www.okta.com/products/adaptive-multi-factor-authentication/)
- Automated user provisioning and deprovisioning
- Reduced IT overhead through automated workflows


The[Okta Integration Network](https://www.okta.com/integrations/) provides thousands of prebuilt integrations that enable customers to easily centralize user management, adopt the latest applications, and automate access workflows across cloud and on-premise environments—perfect for multi-cloud.
...
[Frederico Hakamine Former Sr. Technical Marketing Manager Frederico is a jack of all trades and master of none. He has been designing, developing, customizing, and breaking systems for more than 10 years in the field. Frederico spent his time at Okta developing code and promoting Okta’s Adaptive Multi-Factor Authentication Platform. In his spare time, he cracks some code for his wife's startup and works on silly projects like his own beer and music.](https://www.okta.com/blog/author/frederico-hakamine/)
