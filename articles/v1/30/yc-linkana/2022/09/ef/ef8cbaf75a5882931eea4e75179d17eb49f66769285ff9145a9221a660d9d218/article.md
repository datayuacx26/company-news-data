...
document_id: "ef8cbaf75a5882931eea4e75179d17eb49f66769285ff9145a9221a660d9d218"
company_key: "yc-linkana"
company: "Linkana"
source_id: "yc-linkana-rss-b8a570b33476"
canonical_url: "https://www.linkana.com/blog/gestao-de-fornecedores-para-a-area-de-saude/"
...
content_hash: "sha256:b505ee80a856fa8e9aca6f4a222b6e112d32f445ae08133bcae03eb4bf504410"
---

# Gestão de fornecedores para a área de saúde: 4 pontos que não podem faltar
...
Pensando em situações como essas, cabe aos profissionais de[procurement](https://www.linkana.com/blog/procurement-4-0/) encontrar boas maneiras para alcançar uma gestão de fornecedores para a área de saúde realmente eficiente.
...
A etapa de[avaliação de fornecedores hospitalares](https://www.linkana.com/blog/avaliacao-fornecedores-hospitalares/) tem algumas particularidades, a exemplo da **confirmação se o provedor atende aos padrões de qualidade e se está em conformidade com as regras estabelecidas pela Anvisa, Agência Nacional de Vigilância Sanitária.**
...
Dica de leitura: “[ISO 9001: o que é esse certificado, para que serve e como obtê-lo?](https://www.linkana.com/blog/iso-9001/) ”


### Obter garantias que prazos e quantidades serão atendidos


Mais uma vez, vale relembrar que os serviços prestados por hospitais e[clínicas](https://sanatte.com.br/) não podem ser interrompidos. Dessa forma, quem está à frente do gerenciamento de fornecedores precisa **se atentar à capacidade de atendimento do terceiro que está sendo contratado** .
...
Caso não esteja, a área de[procurement](https://www.linkana.com/blog/compras-e-procurement/) tem a chance de resolver esse problema de duas formas distintas: ou ajustando as falhas com esse mesmo terceiro, mantendo a parceria, ou buscando outro provedor qualificado no seu[cadastro de fornecedores.](https://www.linkana.com/blog/como-fazer-cadastro-fornecedores/)
...
Aproveite e leia também este artigo: “[4 indicadores de desempenho de fornecedores para agregar mais segurança e eficiência nas parcerias](https://www.linkana.com/blog/indicadores-de-desempenho-fornecedores/) ”


## Por que criar um bom relacionamento com fornecedores?


Todos esses pontos que acabamos de citar levam a outro tão importante quanto, que é a necessidade de criar um bom[relacionamento com os fornecedores](https://www.linkana.com/blog/relacionamento-fornecedores/) .
...
Assim como dissemos logo na abertura deste artigo, quando isso acontece, o dia a dia de hospitais e clínicas pode ser seriamente comprometido. Ou seja, na área de saúde, o estabelecimento de um[relacionamento estratégico](https://www.linkana.com/blog/relacionamento-estrategico/) com os fornecedores se torna ainda mais importante.


## Como uma ferramenta de gestão de fornecedores ajuda nesse processo?


É certo que para fazer tudo isso que acabamos de citar é essencial o uso de soluções próprias. Afinal, realizar[processos de homologação](https://www.linkana.com/blog/processo-homologacao-fornecedores/) de fornecedores na área de saúde, entre outros, de forma manual demanda tempo, eleva os custos operacionais, e abre margem para diversos erros.


A[Linkana é o primeiro e maior software de gestão de fornecedores](https://www.linkana.com/) em rede. Nossa base de dados de perfis compartilhados permite que compradores analisem fornecedores ativos e novos em alguns cliques.
...
- [monitoramento de alertas;](https://www.linkana.com/monitoramento-e-alertas/)
- [avaliação de performance](https://www.linkana.com/avaliacao-de-performance/) ;
- [perfis certificados de fornecedores](https://www.linkana.com/perfis-certificados-de-fornecedores/)
...
A[Unimed Fesp](https://www.linkana.com/en/unimeds-fesp/) , por exemplo, é uma dessas companhias que otimizou o trabalho da equipe de compras, deixou de lado planilhas manuais e reduziu o tempo de onboarding de novos fornecedores, com a plataforma simples, centralizada e automatizada da Linkana.
...
Quer saber em detalhes, como esse software funciona? Então **preencha agora mesmo o formulário abaixo** :
