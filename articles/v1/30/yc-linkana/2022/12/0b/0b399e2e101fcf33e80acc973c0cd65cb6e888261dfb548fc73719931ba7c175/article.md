...
document_id: "0b399e2e101fcf33e80acc973c0cd65cb6e888261dfb548fc73719931ba7c175"
company_key: "yc-linkana"
company: "Linkana"
source_id: "yc-linkana-rss-b8a570b33476"
canonical_url: "https://www.linkana.com/blog/desafios-e-beneficios-de-procurement-data-lake/"
...
content_hash: "sha256:d5b3980246de2fdf436bf500ba97b9160bf5e87a58d96264f1610dfb04a05628"
---

# Os principais desafios e benefícios de um Procurement Data Lake (PDL)

Quais seriam os desafios e benefícios de um[Procurement Data Lake (PDL)](https://www.linkana.com/en/blog/procurement-data-lake/) , ou seja, de um **repositório completo que agrega todos os dados gerados por uma empresa** ?


Para chegar a essa resposta,[Leo Cavalcanti](https://www.linkedin.com/in/leoazca/) , CEO da[Linkana](https://www.linkana.com/) , trouxe no segundo Linkana Talks o case da Comgás.


Tendo como mediador[José Borbolla Neto](https://www.linkedin.com/in/joseborbolla/) , Partner & Head of Education no Cappra Institute for Data Science, e participação de[Thiago Rolemberg](https://www.linkedin.com/in/thiago-rolemberg-msc-71a33a14/) , Gerente de Data & Advanced Analytics na Comgás;[Murilo Benjamin Baggio](https://www.linkedin.com/in/murilo-benjamin-baggio-/) , Gerente de Supply Excellence na Comgás; e[João Rondina](https://www.linkedin.com/in/jarondina/) , Case Leader na Elogroup, alguns dos principais apontamentos foram:
...
[https://open.spotify.com/episode/722KxERgMO98Lcp6ZmkoBb?si=GL6wZN8CT36ugPV8K5qXFg](https://open.spotify.com/episode/722KxERgMO98Lcp6ZmkoBb?si=GL6wZN8CT36ugPV8K5qXFg)
...
E a gente tem tentado falar sobre o que chamamos das principais tendências, das principais skills do[comprador do futuro](https://www.linkana.com/blog/gestor-de-compras-do-futuro/) .
...
Certamente já ouviram falar, de várias maneiras diferentes, sobre porque os[dados](https://www.linkana.com/blog/era-dos-dados-em-procurement/) são importantes, ciência de dados,[analytics](https://www.linkana.com/blog/data-analytics-o-que-e/) . Sei lá, qualquer outro nome que vocês já ouviram com mais frequência.
...
Bom, eu sou Murilo. Estou como Gerente de Excelência de[Supply Chain](https://www.linkana.com/blog/supply-chain/) na Comgás há um ano e um mês.


O nosso desafio é justamente unificar, centralizar as informações, dar informações de qualidade para os nossos negociadores, e fazer uma transformação em[suprimentos](https://www.linkana.com/blog/como-gerenciar-a-cadeia-de-suprimentos/) de uma maneira legal para trazê-los mais próximo do negócio.
...
A Comgás é uma empresa utility e baseada em SAP. Há, pelo menos, uns 4, 3 anos, já tínhamos a área, mas decidimos criar um plano de[transformação digital](https://www.linkana.com/blog/transformacao-digital-na-cadeia-de-suprimentos/) . Não só para a área de supply, mas para a companhia como um todo. Então foi daí que começou a nascer a necessidade.
...
Esses números eram uma grande incógnita. Nós não conseguimos falar o quanto de spending a gente tinha, que é uma informação básica para a área de suprimentos. Quanto cada comprador tinha de[gestão de contrato](https://www.linkana.com/blog/como-fazer-gestao-de-contratos/) , quanto era o consumo de cada contrato.
...
Falei: ‘Pô, é isso que a gente precisa, né?’ Já estávamos em um movimento de entender a origem dos dados, como fazia a[limpeza dos dados](https://www.linkana.com/blog/higienizacao-de-base-de-dados/) , como deveria apresentar, como eles precisam utilizar.
...
Hoje, tem até um detalhe muito interessante, que eu gosto de contar. Tivemos um evento de lideranças, com o presidente, e quem fala de dados é o presidente. Quem fala de[Inteligência Artificial](https://www.linkana.com/blog/inteligencia-artificial-na-analise-de-dados/) é o CFO.
...
Primeiro, vamos de trás para a frente. Quando resolvemos fazer a[transformação digital](https://www.linkana.com/blog/transformacao-digital-em-compras/) e todo o seu plano, não foi só um projeto que saiu. Nós desenhamos nove cases. Cada um desses que desenhamos, **a nossa métrica foi o VPL** — quanto eu vou investir, e quanto ele me retorna.
...
Quando a gente fala de modelo[Machine Learning](https://www.linkana.com/blog/machine-learning-supply-chain/) , até análise estatística é algo que é próximo do negócio, é algo que se consegue entender com um pouco mais de facilidade.
...
Sempre tem uma estrutura muito robusta que entra o Thiago e a interface que temos com ele — de arquitetura de[governança](https://www.linkana.com/blog/governanca-corporativa/) , que vai ajudar a gente que coloca a mão na massa, que implementa, que personaliza junto à área de negócio a conseguir trabalhar dentro de um mesmo padrão, formato, taxonomia, catalogação, para conseguirmos construir esse dado de forma bem estruturada.
...
E como estamos resolvendo isso? Debaixo da minha estrutura, da área que eu tenho lá — tenho uma área de engenharia de dados, uma de ciência de dados, uma de projetos, que é a que conecta bastante com o pessoal aqui, e tenho a área de[governança](https://www.linkana.com/blog/boas-praticas-de-governanca-corporativa/) , que pra mim é chave e o maior sucesso que tenho.
...
Eu estou conectando a plataforma de dados ao[Excel](https://www.linkana.com/blog/linkana-ou-planilha-de-excel/) . Mas aí você fala: ‘Cara, mas isso é loucura, você não quer matar o Excel?’. Mas o comprador trabalha com Excel. ‘Mas ele vai aprender o Power BI’.
...
Segundo, temos esse trabalho de comunicação, muito forte das iniciativas que a gente tem, não só para a companhia, mas internamente também: ‘Pessoal, agora estamos subindo e tem tal informação nova de fornecedor no[Linkana](https://www.linkana.com/blog/latka-saas-companies/) . Agora tem esse novo painel, esse novo BI, no qual vocês consultam XPTO informações’.
...
Erroneamente, as pessoas começaram: ‘Mas meu dado não é da[LGPD](https://www.linkana.com/blog/bases-legais-lgpd/) , por que você cortou? Eu posso exportar também’.
...
A ideia de governança, a[política de governança](https://www.linkana.com/blog/8-ps-governanca-corporativa-2/) , a maneira como ele se dá, ela evolui junto à medida que esses processo de evolução, de infraestrutura, de utilização e tal, vão mudando nas organizações. Como é enfrentar essa questão do ponto de vista da governança?
...
Não só mais dar o insumo, não sou mais dar a base para[tomada de decisão](https://www.linkana.com/blog/tomada-de-decisao-baseada-em-dados/) , mas o meu modelo vai definir a solução, priorizá-la e, às vezes, até ir lá e tocar essa solução de forma automática, com uma inteligência por trás.
...
Para mim é[ESG](https://www.linkana.com/blog/esg) , em uma agenda extremamente horizontal. E, para nós mesmos, faz parte da nossa cesta de metas.


E, pensando na nossa área, não adianta nada a gente ser tão inteligente, com tanta informação, com tantos dados para fazer essa[negociação com os fornecedores](https://www.linkana.com/blog/negociacao-com-fornecedores/) , com os parceiros e, ainda, ter parceiros que estão utilizando carros com alta queima de combustão. Como a gente reduz a emissão de CO2?
...
É[ESG](https://www.linkana.com/blog/o-que-e-esg/) , é a parte social, é o primeiro ponto que eu vejo muito forte para o futuro são pessoas.
