...
document_id: "36b963135fcc770d187146e6f87b01ffd7dde5010008b9304baf69dd740f46f7"
company_key: "yc-linkana"
company: "Linkana"
source_id: "yc-linkana-rss-b8a570b33476"
canonical_url: "https://www.linkana.com/blog/fraude-setor-compras/"
...
content_hash: "sha256:44322fbd5146aaeb9635f2a9a4503e7b8d79257bd0090a3aa51691492e489cbb"
---
...
Ao[estruturar o departamento de compras](https://www.linkana.com/como-estruturar-um-departamento-de-compras/) , é preciso **definir as políticas e diretrizes que serão usadas para que ele cumpra o seu papel** , que consiste em encontrar suprimentos necessários para a operação da empresa em fornecedores confiáveis, em Compliance, e com o melhor custo-benefício para a empresa.
...
Segundo levantamentos da **Consultoria KPMG** , cerca de[7 em cada 10 empresas nacionais já sofreram com fraudes corporativas](https://exame.com/blog/primeiro-lugar/fraude-atinge-sete-em-10-empresas-no-brasil/) . O índice atingiu 74% em 2018, aumento de 20% se comparado ao valor obtido pelo mesmo relatório em 2012.


Outro estudo, conduzido pela **PWC - Price Waterhouse Coopers** , apontou que[44% das fraudes ocorrem no setor de compras](https://saudebusiness.com/sem-categoria/44-das-fraudes-em-empresas-nacionais-surgiram-no-setor-de-compras/) , além de indicar que a prática de fraudes acontece pelas oportunidades oferecidas ao longo do processo de qualificação de fornecedores.
...
[https://www.youtube.com/watch?v=YUQFF1kU15w](https://www.youtube.com/watch?v=YUQFF1kU15w)


## Principais tipos de fraudes no setor de compras


Uma fraude pode ser entendida como uma ação desonesta ou ardilosa, feita para lesar ou enganar terceiros em um processo, por meio de práticas que vão contra o determinado e exigido por uma[conduta ética](https://www.linkana.com/etica-compras/) e de acordo com a legislação vigente.
...
- **Fraude contábil** : as fraudes de contabilidade ocorrem quando os dados obtidos pelos relatórios de compras e faturamento são alterados, comumente para apresentar maiores lucros do que os reais.[Fraudes contábeis já foram as causas de grandes escândalos](http://fenacon.org.br/noticias/os-9-maiores-escandalos-contabeis-do-mundo-2609/) , como aconteceu com a Toshiba nos anos 2000, que inflou o próprio lucro em bilhões de dólares para atrair investidores;
...
Isso envolve desenvolver um código de conduta e desenhar os processos a serem adotados pelo setor de compras, levando em conta fatores como princípios éticos, obediência à legislação vigente, respeito aos procedimentos de controle e formação de uma[cultura organizacional](https://www.siteware.com.br/gestao-estrategica/como-implementar-cultura-organizacional/) em Compliance.
...
Durante o **processo de qualificação de fornecedores** , é recomendado **ter não só um processo de **[Compliance e governança](https://www.linkana.com/diferenca-entre-governanca-e-compliance/) , mas também ter critérios técnicos de controle e homologação para seleção e manutenção de fornecedores.
...
No decorrer das operações do setor de procurement, deve ser priorizada a coleta de dados e acompanhamento dos[KPI de compras](https://www.linkana.com/kpi-compras/) , que são os **indicadores-chave de performance das negociações efetuadas** .
...
A realização de[auditorias em compras](https://www.linkana.com/auditoria-compras/) internas e externas, sobretudo para empresas com ativos na bolsa de valores, deve ser frequente. Como esses estudos se aprofundam nos números apresentados e buscam comprovar os indicadores, são eles os principais responsáveis por detectar fraudes.
...
Para **combater as fraudes no setor de compras** , é preciso **compreender as ameaças inerentes** à operação, **criar processos mais transparentes** e **fáceis de monitorar** , além de contar com a[tecnologia](https://www.linkana.com/tecnologia-setor-compras/) para **agilizar e aumentar a confiabilidade** das operações de aquisição de suprimentos.


Quer saber como a tecnologia pode ajudar sua empresa a encontrar fornecedores em Compliance? A Linkana te ajuda, somos especialistas em transformar a qualificação de fornecedores em um processo mais ágil e sem burocracia.


Preencha o formulário abaixo e nossos representantes entrarão em contato para dar mais informações:
