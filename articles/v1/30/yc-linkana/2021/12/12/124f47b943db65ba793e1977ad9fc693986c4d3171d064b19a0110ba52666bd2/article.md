...
document_id: "124f47b943db65ba793e1977ad9fc693986c4d3171d064b19a0110ba52666bd2"
company_key: "yc-linkana"
company: "Linkana"
source_id: "yc-linkana-rss-b8a570b33476"
canonical_url: "https://www.linkana.com/blog/como-saber-o-cnae-de-uma-empresa/"
...
content_hash: "sha256:96551911acbb90558216fd0a1a93803c0980f3c45e9a2cf2dab16bb47a6af3f2"
---
...
Continue a leitura e entenda o que é CNAE, para que serve, como saber a CNAE de uma empresa e porque é importante checar a Classificação de[fornecedores no processo de homologação](https://www.linkana.com/blog/processo-homologacao-fornecedores/) .


## O que é CNAE?


De acordo com a Receita Federal, a[CNAE](https://concla.ibge.gov.br/busca-online-cnae.html) é “o instrumento de padronização nacional dos códigos de atividade econômica e dos critérios de enquadramento utilizados pelos diversos órgãos da Administração Tributária do país”.
...
Com essa categorização é possível dimensionar, por exemplo, a quantidade de profissionais envolvidos no[SESMT](https://www.gov.br/trabalho/pt-br/inspecao/seguranca-e-saude-no-trabalho/sesmt-servicos-especializados-em-engenharia-de-seguranca-e-em-medicina-do-trabalho) (Serviços Especializados em Engenharia de Segurança e Medicina do Trabalho) e na[CIPA](https://www.saudeevida.com.br/cipa/) (Comissão Interna de Prevenção de Acidentes) da empresa.
...
Esses dígitos representam as seções, divisões, grupos, classes e subclasses das corporação.[Eles se dividem](https://concla.ibge.gov.br/busca-online-cnae.html?view=atividades) como:
...
O CNAE principal da[Linkana](https://www.linkana.com/) , por exemplo, é 63.11-9-00 - Tratamento de dados, provedores de serviços de aplicação e serviços de hospedagem na internet. Isso significa que essa é a atividade principal da organização.
...
- **Divisão 63:** atividades de[prestação de serviços de informação](https://encontreumnerd.com.br/blog/cnae-ti)
...
- Acesse a área “[Emissão de Comprovante de Inscrição e de Situação Cadastral](https://servicos.receita.fazenda.gov.br/servicos/cnpjreva/cnpjreva_solicitacao.asp) ” no site da Receita Federal;
...
Isso porque cada CNAE possui um[enquadramento tributário](https://www.linkana.com/blog/o-que-e-compliance-tributario/) diferente, que responsabiliza a empresa por diferentes obrigações fiscais e a obriga a atuar nos limites da sua atividade.


Por exemplo: enquanto o[CNAE de varejista](https://nfe.io/blog/gestao-empresarial/cnae-para-e-commerce/) de calçados pede uma contribuição com o ICMS (Imposto sobre a Circulação de Mercadorias e Serviços) estadual, um fornecedor que produz as solas dos sapatos pode ter que pagar o IPI (Imposto sobre Produtos Industrializados).
...
A boa notícia é que existem softwares como a[Linkana](https://www.linkana.com/) para ajudar a simplificar o controle de todos os dados do fornecedor.


Desenvolvida a partir de[Machine Learning](https://www.linkana.com/blog/compliance-machine-learning/) e Robot Process Automation, nossa plataforma faz a consulta pública de documentos de modo automático, sem comprometer o tempo da sua equipe com tarefas repetitivas e burocráticas. Assim você consegue saber o CNAE e diversas outras informações de uma empresa apenas inserindo o CNPJ da empresa na ferramenta e deixando nossos robôs fazerem o resto.
