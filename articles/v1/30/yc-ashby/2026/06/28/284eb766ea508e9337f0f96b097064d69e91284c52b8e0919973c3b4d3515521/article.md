...
document_id: "284eb766ea508e9337f0f96b097064d69e91284c52b8e0919973c3b4d3515521"
company_key: "yc-ashby"
company: "Ashby"
source_id: "yc-ashby-news-import-72f22fd66301"
canonical_url: "https://www.ashbyhq.com/blog/engineering/ai-ashby-engineering-and-the-future"
...
content_hash: "sha256:c6ce1a88027e7830047588ed7e96f89ef50f11055ccbab3f4deb93b1f6647da2"
---
...
There’s a lot of great material out there that gives an introduction to how LLMs work ([this post](https://ngrok.com/blog/prompt-caching) by Sam Rose is a good one).
...
**We’re also using linters,**[DangerJS](https://github.com/danger/danger-js) **, and AI to help with code review** . Many common issues are caught by our linters and Danger rules, and our team actively invests in expanding these automated checks. We use third-party tools like[CodeRabbit](https://www.coderabbit.ai/) to do a first pass before a human. We’ve also built our own code review tool focused on finding edge-case bugs that are hard to deal with in production. We find it's better at this than third-party tools because we can use more tokens and tightly control the context.
...
Sound good?[We’re hiring](https://www.ashbyhq.com/careers?ashby_department_id=2c32d70f-d7cb-4a06-bd87-048084e3eb10) for fully remote engineers across Europe and the Americas.
