...
Co-founders[Adam](https://www.ashbyhq.com/blog/culture/letter-talent-llama-joining-ashby) and[Ben](https://www.ashbyhq.com/blog/culture/letter-talent-llama-joining-ashby) are repeat founders who spent the last two years building, iterating, and learning directly from customers in a similar way we approached building Ashby at its onset. When we went through technical diligence, it became clear that they could both accelerate our timeline on an AI interviewer as well as contribute to our broader AI platform.
...
For many customers, we’re still early on how AI interviewing will shape recruiting. Our goal, as is true for everything else we commit to, is to[build this in a way](https://trust.ashbyhq.com/?itemUid=25ecde5a-2c4a-450d-ab9e-01d5efa02128&source=click) that is actually useful in practice.


## What happens next


The version we announced today is an early step. Like most things we build, it will go through the same iterative process working with design partners ([sign up for waitlist here](https://www.ashbyhq.com/ai-interviewer-waitlist) ), refining based on real usage, and expanding over time. As always, we’ll stay close to customer feedback as this evolves.
