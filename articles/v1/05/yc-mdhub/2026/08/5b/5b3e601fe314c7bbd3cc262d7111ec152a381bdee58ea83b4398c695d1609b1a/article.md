...
document_id: "5b3e601fe314c7bbd3cc262d7111ec152a381bdee58ea83b4398c695d1609b1a"
company_key: "yc-mdhub"
company: "mdhub"
source_id: "yc-mdhub-news-import-bbf3c05d7e92"
canonical_url: "https://www.mdhub.ai/blog-posts/90834-cpt-code"
published_at: "2026-08-19T13:50:36.751+00:00"
first_seen_at: "2026-08-19T22:22:23.045662+00:00"
fetched_at: "2026-08-19T22:22:25.362481+00:00"
content_hash: "sha256:26c968760f1b2010124d897eb666ddf937ea5d2a5a490995c53e9631f4389b15"
---
...
90832 16 to 37 minutes Brief individual psychotherapy. A session under 16 minutes does not meet the threshold for any psychotherapy code.


**90834** **38 to 52 minutes** Routine outpatient individual psychotherapy. The standard "45 minute hour" and the most frequently billed psychotherapy code.


90837 53 minutes or more Extended individual psychotherapy. No upper limit, and the code payers scrutinise most.


Two boundaries matter more than the rest. A session that ends at 37 minutes is a 90832, not a 90834. A session that reaches 53 minutes is a[90837](https://www.mdhub.ai/blog-posts/90837-cpt-code) , and billing it as 90834 is under-billing your own work. One minute decides the code at either end, which is why the time in the note has to be the time that actually elapsed.
...
The correct response is to bill the code the documentation supports and make the documentation strong enough to survive review. A 90837 note that names the modality, the clinical reason the session needed the additional time, and the elapsed time is a note that holds up. Our[guide to psychiatric billing](https://www.mdhub.ai/blog-posts/the-complete-guide-to-psychiatric-billing-from-e-m-to-psychotherapy-with-ai-powered-support) covers how the codes sit together across a full practice.
...
Downcoding sits in the same operational blind spot as underpayments, and the fix is the same: reconcile what was paid against what was billed rather than against what was expected. Our notes on[denial management](https://www.mdhub.ai/blog-posts/denial-management) go further into the workflow.
...
For the Medicare figure that applies to you, use the[CMS Physician Fee Schedule Look-Up Tool](https://www.cms.gov/medicare/physician-fee-schedule/search) , entering 90834 with your locality and the current year. For commercial rates, the number that matters is the one in your fee schedule, and the number worth watching is what you were actually paid against it. The official code definition is maintained by the[AMA](https://www.ama-assn.org/practice-management/cpt/cpt-code-90834-psychotherapy-45-minutes) , and[APA Services](https://www.apaservices.org/practice/reimbursement/health-codes/psychotherapy) maintains practical guidance on the psychotherapy code set.
...
Notes that fail review usually fail on two of these: time that mirrors the appointment slot rather than the session, and interventions described in language identical to every other note for that patient. Both are products of writing notes hours later from memory. Our[note structure guide](https://www.mdhub.ai/blog-posts/soap-note-example) covers the format side, and[behavioral health billing](https://www.mdhub.ai/blog-posts/behavioral-health-billing) covers where these fields land on the claim.
...
That is a workflow question rather than a coding question, and it is where[billing software built for behavioral health](https://www.mdhub.ai/use-cases/mental-health-billing-software) earns its place: the time, the modality and the code arrive on the claim from the session itself, and the clinician confirms rather than remembers.


## Streamline Your Practice


Accurate 90834 billing comes down to whether session time and clinical detail were captured while they were still facts. Emma handles the documentation and surfaces the coding so that answer is yes by default, and your clinicians review rather than reconstruct. To see it inside a live practice,[book a demo with the mdhub team](https://calendly.com/d/dtp5-2fp-g9w) .
