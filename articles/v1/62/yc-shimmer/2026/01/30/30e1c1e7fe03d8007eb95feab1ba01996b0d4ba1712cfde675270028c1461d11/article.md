...
document_id: "30e1c1e7fe03d8007eb95feab1ba01996b0d4ba1712cfde675270028c1461d11"
company_key: "yc-shimmer"
company: "Shimmer"
source_id: "yc-shimmer-news-import-3bb3ff482d8c"
canonical_url: "https://www.shimmer.care/blog/is-the-gtd-method-adhd-friendly"
published_at: "2026-01-21T05:31:22.466+00:00"
first_seen_at: "2026-07-22T13:19:34.618746+00:00"
fetched_at: "2026-07-28T21:58:17.349618+00:00"
content_hash: "sha256:dd83a9b282c4a4e91d4aa31ebbbbcd466a7426852c2fabe3d79dc486c117c92f"
---

# Is the GTD Method ADHD-friendly?
...
Large tasks can be daunting, so[breaking them](https://www.shimmer.care/blog/breaking-down-tasks) into specific, small steps can make them more approachable. For example, instead of just writing “organize closet,” list steps like: sort shoes, fold sweaters, and arrange hangers. This way, you can start with just one mini-task, and each step you complete builds momentum.
...
> ***Tip*** *: You can try out*[body doubling](https://www.shimmer.care/blog/optimize-body-doubling) *for accountability. Pick rewards you genuinely look forward to — they make even small wins feel more satisfying.*


## **⚖️ What are the pros and cons of GTD for ADHD?**
...
1. **Clear structure and routine.** GTD offers a structure that can be grounding for minds with adult ADHD. The method’s five key stages create a consistent pattern to reduce the mental clutter associated with scattered, unstructured tasks.
2. **Prioritization is made simple.** One of the hallmarks of ADHD is the challenge of prioritizing tasks effectively. GTD’s workflow guides users to clarify and organize tasks, making it easier to determine what needs attention now versus what can be deferred. This helps with maintaining focus and prevents getting lost in endless to-do lists.
3. **Reduces procrastination and decision fatigue.** The capture phase in GTD encourages catching tasks as soon as they come to mind, reducing the likelihood of procrastination. This also lightens the cognitive load by freeing up mental space, as there’s less need to hold information in working memory.


### **Cons**


1. **Overwhelming steps and complexity.** The detailed steps of GTD can become daunting, especially for ADHD minds that may struggle with extensive systems. The method's requirements for capturing and categorizing can feel like an extra workload, creating friction instead of facilitating ease.
2. **Perfectionism.** ADHD minds may struggle with perfectionism, and GTD’s emphasis on organization can sometimes exacerbate this tendency. When things don’t go exactly as planned, it’s easy to abandon the system altogether, rather than make small adjustments to adapt.
3. **Maintenance can be challenging.** ADHD minds often struggle with consistency, and GTD requires regular “reviews” to stay on top of tasks. Keeping up with these reviews can feel tedious and lead to burnout, making it difficult to sustain the system long-term without solid routines in place.
