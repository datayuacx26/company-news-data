...
document_id: "b17082085612f4856973ba1ac4b7d1bbd70ba00a4d8076d3678dd12e7578581d"
company_key: "yc-coloop"
company: "CoLoop"
source_id: "yc-coloop-news-import-dd8852a3f7c4"
canonical_url: "https://www.coloop.ai/blog/fast-food-research-ai-insights-qual360-berlin-2026"
...
content_hash: "sha256:24fbb8463840635e4e7b5e9f6825f93be880136b5292b5fc3bd57cee1e323bb2"
---

# Ultra-Processed Insights: Build Trust in AI Research
...
As the Jess Holbrook, the Head of UX at Microsoft AI[recently noted](https://genpurpose.substack.com/p/research-slop) , AI slop is high-volume, low-effort output that people don't take pride in. It floods communication channels, crowds out quality, and reduces the signal-to-noise ratio in any information ecosystem it inhabits.
...
Prior to Figma, good design was a luxury available only to those who could afford expensive Adobe packages and powerful workstations. Figma leveraged browser-based technology to break those barriers, making high-quality aesthetics a possibility for every team. Their CEO, Dylan Field, famously[championed the idea](https://www.figma.com/blog/figma-ipo-founder-letter/) that "design is everyone’s business."


The scale of this shift is staggering. In 2019, only[10% of Figma users were non-designers](https://cloud.substack.com/p/top-10-insights-from-figmas-ipo-docs) . By 2025, that number has skyrocketed to 67%. More than two-thirds of the people using the world's leading design tool today are not professional designers. This didn't ruin high-quality design; it scaled it.
...
The data from the[2025 State of User Research Report](https://www.userinterviews.com/state-of-user-research-report#:~:text=m%20expected%20to.%22-,%2D%20State%20of%20User%20Research%202025%20Participant,not%20always%20as%20traditional%20Researchers.)) shows that researchers are leaning into the technology: 73% find AI makes their work more efficient, and 66% report better quality reports. Yet, a massive 91% remain concerned about accuracy and trust as they adopt these tools.
...
- Impact Over Volume: In academia,[20% of research papers make 80% of the citations](http://researchgate.net/publication/249886753_The_8020_Rule_and_Core_Journals?__cf_chl_rt_tk=_LK7GrJ7uQGJi3IahmuNT81kZHvEsZnLBFT32xbT9BE-1770257665-1.0.1.1-X7igM6Lf_oEOTMK2JJUrXuqorF.UzS96mwLxQJrrdTs) . These are the foundational works that move fields forward. Stop aiming for a high volume of ignored reports. Aim to be in that top 20% of work that actually changes the trajectory of the business.
...
[Book a demo](https://www.coloop.ai/book-a-call) to see how CoLoop helps you scale insights without sacrificing rigor.


If you want to see the live presentation from Qual360 you can[watch it here](https://www.youtube.com/watch?v=63xA_uHu3UM&list=PLQkYoFAGKfuuHLmL5KFxis0TrwFDHYaCG) .
