...
document_id: "948422351cf6f894c29f598d47f55cec74dbad13f1f5a863b907e73f5102dca6"
company_key: "yc-truenorth"
company: "TrueNorth"
source_id: "yc-truenorth-news-import-894f45f583bc"
canonical_url: "https://www.truenorthfleet.com/articles/business/csa-scores"
published_at: null
first_seen_at: "2026-08-10T04:16:20.572603+00:00"
fetched_at: "2026-08-10T04:16:21.465603+00:00"
content_hash: "sha256:9c66ba6e851843e83cea646bb3bc1527170af2876c7865f8db6a1e875254cc2f"
---

# Why CSA Scores Should Be Treated Like a Team Sport

Every carrier with a Department of Transportation (DOT) number receives an ongoing and updated safety score as part of the[Compliance, Safety, Accountability (CSA)](https://csa.fmcsa.dot.gov/) program. These safety scores indicate the success of that carrier, impacting the way drivers, inspectors, shippers, receivers, brokers, and more, interact with them.
...
The[Federal Motor Carrier Safety Administration (FMCSA)](https://www.fmcsa.dot.gov/) manages the CSA (Compliance, Safety, Accountability) program, all under the DOT umbrella. The intent of the program is to improve safety on the roads through preventing accidents. It's also a way to identify carriers with higher risks for accidents by holding them accountable for their own actions.


The CSA program focuses on data using a three-prong approach:


1. Measure. It starts with the[Safety Measurement System (SMS)](https://csa.fmcsa.dot.gov/About/Measure) . This involves the data evaluations from inspections, investigations, and accident reports.
2. Intervene. Then, when needed, there are Interventions. This involves formal processes to highlight and monitor carriers that have poor scores with the intent to help the carriers improve.
3. Evaluate. Finally, there is the[Safety and Fitness Determination (SFD)](https://safer.fmcsa.dot.gov/) rating system. Not all carriers end up with a SFD score and no rating in this area generally is not a problem.
...
The SMS (Safety Measurement System) uses data from inspections, investigations, and accident reports to measure seven[Behavior Analysis and Safety Improvement Categories (BASICs)](https://csa.fmcsa.dot.gov/Documents/CSA_GRS_Visor_S.pdf) :


*The seven BASICs of safety*


- [Unsafe Driving](https://csa.fmcsa.dot.gov/Documents/FMC_CSA_12_008_BASICs_UnsafeDriving.pdf) : Actions while driving such as speeding, texting, not wearing a seatbelt, improper lane changes, etc.
- [Hours-of-Service (HOS) Compliance](https://csa.fmcsa.dot.gov/Documents/FMC_CSA_13_004_BASICs_HOS_Compliance.pdf) : Failing to adhere to drive-time mandates and/or proper logging of that time.
- [Driver Fitness](https://csa.fmcsa.dot.gov/Documents/FMC_CSA_12_006_BASICs_DriverFitness.pdf) : How fit a driver is (CDL, medical certificates, driving records, etc)
- [Vehicle Maintenance](https://csa.fmcsa.dot.gov/Documents/FMC_CSA_12_009_BASICs_VehMaint.pdf) : The condition of your equipment through parts such as tires, brakes, lights, cargo securement, and other, as evaluated through pre- and post-trip inspections, vehicle defects, and repairs.
- [Crash Indicator](https://csa.fmcsa.dot.gov/Documents/FMC_CSA_12_005_BASICs_Crash_Indicator.pdf) : Frequency and severity of crashes (defined as when a fatality or injury occurs, or when the vehicle requires transportation from the scene).
- [Controlled Substances / Alcohol](https://csa.fmcsa.dot.gov/Documents/FMC_CSA_12_004_BASICs_ControlledSub.pdf) : Driving under the influence of alcohol (including having alcoholic beverages in the cab) or illegal drugs (and includes the abuse of prescription or over-the-counter medications).
- [Hazardous Material Compliance](https://csa.fmcsa.dot.gov/Documents/FMC_CSA_13_001_BASICs_HM_Compliance.pdf) : The handling of a hazmat load (packaging, marking, attendance, etc).
...
***While some carriers may have differences on how the SMS program was designed and is administered, what is clear is***[carriers with BASIC scores above the threshold have more accidents](https://ai.fmcsa.dot.gov/SMS/Images/ET/ETByNumBASIC.png) ***than carriers with BASIC scores below the threshold.***


[DataQs](https://dataqs.fmcsa.dot.gov/Default.aspx?enc=ol9vFk5DikOfdCY6b1umpBX/fS24GCR8E8ytm4qawihZbbWf1qeU9NuDGyPOLCqm62JREHhM94lNie87bN4NPpqdvigIiMhyDhrYEkjRy6Qd/8ghz6ng5hkEMEndGBN6ZMtq5x/LocXREkz8AzJord1N8xXrxW0cUolvf0NEisc=) is a system that allows you to challenge a violation if you feel it is unwarranted or unjustified. It should be noted that it is not easy to successfully challenge a violation. When it does happen, it's often because there is physical evidence such as a dashcam. It should also be noted that the ability to challenge a violation only applies to citations. You cannot challenge a warning (meaning that warnings always count toward your CSA score).
...
CSA scores are closely related with[Pre-Employment Screening Program (PSP)](https://www.psp.fmcsa.dot.gov/psp/Public) scores. This is the driver's individual rating, which the FMCSA maintains, and provides “electronic access to a commercial driver's five-year crash and three-year inspection history from the FMCSA Motor Carrier Management Information System (MCMIS).” Essentially, the inspections that count against (or for) the carrier also count against (or for) the driver’s PSP data.


A driver can[request a copy of his/her PSP score](https://www.psp.fmcsa.dot.gov/psp/?redirectUrl=termsAndConditions&accountType=mah) for a nominal fee. A carrier can get access to the individual score if the driver grants permission by signing a release, especially as part of the pre-employment process. Carriers that are focused on safety, such as TrueNorth, check a driver's PSP as part of the hiring process, and evaluate the driver's individual score against a certain threshold.


Heath, Operations Manager at TrueNorth, tells us,


“Drivers often don't realize that their cumulative CSA points that come from accidents and violations remain on their record for 3 years and the carrier's record for 2 years, even when that person leaves the fleet.”
...
There are two ways to improve your CSA score by lowering it - minimizing violations and when peers’ scores increase.


First, minimizing violations. Having more good, clean inspections with no violations will drive the percentage of bad ones down. There are many things a fleet and a driver can do to work toward this. Fleets can implement a solid road safety plan, compliance training, and regular maintenance requirements. Drivers have the choice to always ensure compliance with the rules and regulations of the seven BASIC categories. For example, completing the[pre- and post-trip inspections](https://www.truenorthfleet.com/owner-ops-only/safety/dvir-pre-trip-and-post-trip-inspections?rq=trip) are critical in identifying and fixing issues before an inspector does. For details on ways to prepare for inspections, check out our article on[CVSA Inspections](https://www.truenorthfleet.com/owner-ops-only/safety/cvsa-inspections) .
...
[DVIR: Pre-Trip and Post-Trip Inspections](https://www.gettruenorth.com/articles/business/dvir-pre-trip-post-trip-inspections)


[CVSA Inspections: Understanding and Preparing for Them](https://www.gettruenorth.com/articles/business/cvsa-inspections)


[How to Stay DOT Compliant](https://www.gettruenorth.com/articles/business/dot-compliance)
