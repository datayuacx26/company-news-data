...
document_id: "e6dad70db1b46d3efa923d9d7338888f51d0a4a080c5f24bc82e88ff8539c922"
company_key: "yc-substack"
company: "Substack"
source_id: "yc-substack-rss-533faed816c8"
canonical_url: "https://on.substack.com/p/model-behavior-taylor-lorenz"
published_at: "2026-07-29T17:58:58+00:00"
first_seen_at: "2026-07-29T19:58:46.152019+00:00"
fetched_at: "2026-07-29T19:58:48.058521+00:00"
content_hash: "sha256:09a78a73b2ae0bd2e3d9227af69ab35d0d164a5a6f6f10ba6c35a708380a4859"
---
...
### Kicking off an honest series about writers, thinkers, creators, and AI—how a tech journalist works with AI
...
We start off this week with


[Taylor Lorenz](https://open.substack.com/users/1153079-taylor-lorenz?utm_source=mentions)


, the founder of


[User Mag](https://www.usermag.co/) .
...
Aggregate research: when I’m getting up to speed on something I don’t know well, like security and LLMs for this week’s episode on the China open source model debate, I’ll take posts from someone I trust (in this instance


[Alex Stamos](https://open.substack.com/users/1589222-alex-stamos?utm_source=mentions)


) and ask AI to pull together everything he’s said on the topic.


2.


Search Gemini, and run queries on Grok to check for anything I missed.


3.


Paste what I’ve gathered into Claude and ask it to organize the information.


4.


Run similar searches across models to track the differences in their responses and understand each one’s capabilities better.
...
Schedule a Riverside conversation with my guest for that week.


2.


Record the conversation itself, human talking to human, no AI. I don’t write questions ahead of time; it makes the conversation feel less natural.
...
Sometimes do a first cut myself in Adobe Premiere, sometimes send it straight to my human podcast editor.


2.


My editor levels the audio, cuts any flubs, and puts together a draft of the episode, using AI tools in his process, especially for audio processing, while doing the cut manually in Premiere.
...
Save the edited video to my computer.


2.


A script I built with Claude Code takes over from there, copies the video into the correct folder, and automatically transcribes the file, generating a transcript.
...
Run the transcript through five different models—Claude, Gemini, Grok, DeepSeek, and ChatGPT—with the same prompt.
...
Pick whichever headline and description I like best and tweak it myself from there.
...
Use the thumbnail ideas generated for me, plus my own ideas, to build a thumbnail in Canva. This takes me over an hour at least; I’m not great at digital design. Canva’s AI tools let me auto-expand and transform images until I get something coherent.


2.


Upload the draft video to VidIQ, which analyzes it and suggests tweaks to the thumbnail and alternate titles.


3.


Go back into Canva and make VidIQ’s suggested changes. I usually go through about three rounds of this until I have a working thumbnail and title.
...
Tweak the SEO-optimized description with my own wording, or reword anything that doesn’t read well.


2.


Upload the video to YouTube, then upload separate copies to Patreon and Spotify.
...
Check Spotify first, since their auto-clipper generally picks the best moments.


2.


Re-create those clips from scratch in CapCut, since Spotify’s short-form clips can’t be downloaded, reworking the aspect ratio and adding stock footage from Pexels.


3.


Run each piece of short-form content through VidIQ to optimize the title and hashtags.


4.


I’ve also been experimenting with OpusClip for generating short-form content.
...
Take the SEO-optimized YouTube video description and put it at the top of the newsletter, sometimes tweaking it or adding an opening line or two.


2.


Embed the YouTube video below that. This stays above the paywall, and it’s built this way to keep that top section optimized for search.
...
Curate about 30 to 40 news items I’m following that week, always 100% human-curated.


2.


Hand it to Claude to sort into categories, something readers specifically asked for. Claude still isn’t great at this, so it takes some cleanup afterward.
...
Search YouTube for the highest-performing recent videos covering similar topics and analyze:
...
Search current news headlines and discussions across the web related to this topic to identify trending language, names, and keywords people are actively searching for.


2.


Optimize every recommendation using those findings rather than simply describing the video. Base recommendations on current trends, but do not invent facts or promise things the video does not deliver.
