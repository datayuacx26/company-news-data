...
document_id: "b2a31679e668aec166c9b00d813c76ff48c3f9183be20cf259ceb923f0d046e6"
company_key: "yc-partnerstack"
company: "PartnerStack"
source_id: "yc-partnerstack-news-import-642216cc1449"
canonical_url: "https://blog.partnerstack.com/post/how-19-saas-companies-got-their-first-100-partners"
published_at: null
first_seen_at: "2026-07-25T18:49:56.215767+00:00"
fetched_at: "2026-07-28T21:16:50.994015+00:00"
content_hash: "sha256:ff197b2e29738a7c628c14e3b87c0bf5a2bef8930cda690a42e781ce657b3ff2"
---
...
In partnership with the research team at[Databox](http://www.databox.com/) , we asked 19 SaaS companies how they got theirs started.
...
[Virtru](http://www.virtru.com/) ’s Roy Duckles said a good partner program has these six qualities:


1. **Branded** – Indicates what it does for the partner
2. **Simple** – Clear and structured partner model
3. **Manageable** – Easy to deliver, use and operate
4. **Measurable** – Effective processes for business governance
5. **Accountable** – Cost effective and economic
6. **Adaptive** – Scalable, and flexible”
...
When we asked Nataliya Lysyk how the[CallPage](https://www.callpage.io/) team worked to get their first 100 partners, her answer was simple: “We made a helicopter view on the situation.”
...
[Sprout Social](https://sproutsocial.com/) ’s Tara Robertson says: “Rather than jumping in and building a partner program based on what the industry was doing, we took a customer-led approach and spent our first few months with our customers learning what would help them grow and where they would see value in a program.”
...
Chris Samila told us that[FullStory](http://www.fullstory.com/) gained their first 100 partners after reaching “out to existing digital agencies and consulting firms using our technology and explained the value proposition of having a more official relationship that could help them build new service line revenue off helping other customer\[s\] use the technology.”
...
[Drift](https://www.drift.com/) ’s Michele Albanese also invited existing customers to become partners before opening the floodgates to anyone and everyone: “When we started the program, we began with a small handful of 12 companies already active in our community.”
...
Michał Szczygłowski from[LiveChat](https://www.livechatinc.com/) reported the same success with recruiting partners from their install base, “We found partners in a few places: people who have written valuable content in our industry, as well as our existing clients who are marketing agencies and freelancers.”


## 4. Headhunt your ideal partners


“We started off by identifying the pain points and advantages we could offer (not just financial), then began a multi-platform approach following successes based on reporting back the source and keyword of active referring Partners,” explains Pete Allcock of[Ruler Analytics](https://www.ruleranalytics.com/) .
...
[ClickFunnels](https://www.clickfunnels.com/) ’ Dave Woodward also echoed Allcock’s advice to actively headhunt the companies you want to partner with. To do this, his team “would send them something in the mail that was relevant to them and their business. We would then follow up with them via email, FB messenger, text etc. Whichever way we thought would get us the best response.”


[monday.com](https://monday.com/) ’s Avital Cohen used this strategy with a twist. The team opened two programs: “1 for referral partners and the second for resellers. The referral partners had a kind of organic growth, starting from existing monday.com clients who asked to promote monday.com.”
...
But if you’re struggling to headhunt companies who would be a great fit, take a leaf from[CrazyCall](https://www.crazycall.com/) ’s book: “We started to reach out to companies who are already someone else's affiliate (not exactly our direct competitors but a SaaS partner),” explains Szymon Golyski.


## 5. Run webinars to educate partners


When Peter Caputa IV started[HubSpot](https://www.hubspot.com/) ’s partner program back in 2009, he noticed a trend in the way agencies run:
...
Barbara Derkowska of[Brand24](https://brand24.com/) explains how this initial understanding helped build their program: “At the very beginning, we invited several "testing Partners,” picked from our customer base, industry, and the closest network. It brought us precious feedback and let us improve the program before launching it on a bigger scale.”


Following the launch, Derkowska’s next move was to invite “a selected, yet larger, group of satisfied customers and entered[PartnerStack's marketplace](https://market.growsumo.com/) .”
...
Going back to bringing your customers onboard as partners,[Hike](https://hikeseo.co/) ’s Andy Allen says: “Our partners are marketing agencies/consultants who use Hike to deliver SEO to their existing, or future, client base.”
...
Peter Caputa IV,[Databox](https://databox.com/) ’s CEO, also started their partner program in a similar way—by giving “the product to 20 marketing agencies for free for 6 months with a promise that we would make it very inexpensive for their first 10 clients.”
...
The answer to that question should be plastered everywhere—including your sign-up form, information page, and even your onboarding emails—because[people often need incentives](https://www.gavelintl.com/the-psychology-of-incentives/) to do something.


“We created a super to join easy affiliate program without any approval process,” explains Maros Kortis of[Mangools](https://mangools.com/) —who also “offer lifetime 30% commission, ssince our subscriptions have both monthly and annual billing cycles.”
...
When we asked David Batchelor how[DialMyCalls.com](https://www.dialmycalls.com/) got their first 100 partners, he mentioned how their success lied in the onboarding process: “One thing we've found is making the program fun and more "game-like" has really helped our success from it.''
...
[JetRails](https://jetrails.com/) ’ Robert Rand also advises to focus on your onboarding process: “Have a process for onboarding partners, and supporting them through next-steps. This can include scheduling kickoff calls, creating press releases and various other co-marketing activities, and setting up joint Slack channels for communication.”


## 10. Be cautious of over-automation


One report found[55% of B2B companies](https://www.emailmonday.com/marketing-automation-statistics-overview/) are using some form of marketing automation.


But Jean-Francois Poirier said the team at[VidCruiter](http://www.vidcruiter.com/) “designated a partner relations/community outreach manager very early on”—something he credits the success of their partner program to.


Kent Raju answered similarly, and said[Folderit Ltd](https://www.folderit.com/) ’s partner program “had a very personal touch with our sellers from the start, and we still do. That's what should make any reseller program different from affiliate programs.”
...
To retain their partners and keep them happy, Allcock’s team “have recently started a[Partner Listing page](https://www.ruleranalytics.com/partner-agencies/) on the site.” He says “only a small proportion of partners are on this so far, and it's quite basic, but it's been a good way to keep \[that\] contact up, as well as offering a link back to partners domains.”


[Seventh Sense](https://www.theseventhsense.com/) ’s Mike Donnelly recommends this, too. His team are “now on version 3.5 of our partner program based on successes, challenges and most importantly, feedback from the agency partner community.”
...
2. Put the right person in charge. They need to have a special set of marketing, sales, account and program management skills.
3. Consider starting an affiliate program first. Quickly, provide a path for affiliates to become referral and reseller partners, though.
4. Market your program to your install base and audience, first.
5. Market your program, in general, to attract the right partners.
6. Tweak your packaging and pricing and maybe even how you product works, so that it serves your partner’s needs, not just their clients.
7. Spend some time recruiting the best partners.
8. Show partners how to make money by wrapping services around your product and by banking commissions. Consider making commissions recurring.
9. Onboard your partners properly.
10. Keep tabs on your partners and provide them the right level of support.
11. Make it a two-way street by helping your partners get business too. Build a marketplace and do co-marketing that helps them show off their expertise.
