...
document_id: "5ef2c7a2b59ffa4278d9bab3a3020717b31da03d7ae67ef230908dbe6a551530"
company_key: "yc-scrimba"
company: "Scrimba"
source_id: "yc-scrimba-news-import-2d86273fd3f5"
canonical_url: "https://scrimba.com/articles/how-to-learn-to-code-for-free-2026/"
published_at: "2026-08-05T09:47:34+00:00"
first_seen_at: "2026-08-05T11:16:48.798882+00:00"
fetched_at: "2026-08-05T11:16:50.764777+00:00"
content_hash: "sha256:818d4aabf7c19ea85e2f1fe8934367892bc5266ccb231f30405595d0e1afe3fb"
---
...
One structural obstacle deserves naming early. The U.S. Bureau of Labor Statistics lists a bachelor's degree as the[typical entry-level education](https://www.bls.gov/ooh/computer-and-information-technology/software-developers.htm?ref=scrimba.com) for software developers, so a self-taught applicant enters the field without the default credential. The portfolio has to do that work instead, which is why projects start in week two of the plan below and not week ten.


Self-directed free learning is not a beginner's compromise either. In the[2025 Stack Overflow Developer Survey](https://survey.stackoverflow.co/2025/developers/?ref=scrimba.com) , 69% of working developers had learned something new in the past year, drawing mostly on technical documentation (67.8%) and other online resources (58.7%) rather than formal courses (32.7%).


For calendar expectations, the guide on[how long it takes to learn to code](https://scrimba.com/articles/how-long-does-it-take-to-learn-to-code-a-realistic-timeline/) beats any platform's marketing as a planning tool.
...
Websites and web apps HTML and CSS, then JavaScript[Learn HTML and CSS](https://scrimba.com/learn-html-and-css-c0p?ref=scrimba.com) (5.7 hrs), then[Learn JavaScript](https://scrimba.com/learn-javascript-c0v?ref=scrimba.com) (9.4 hrs)


Data, scripting, automation Python[Learn Python](https://scrimba.com/learn-python-c03?ref=scrimba.com) (5.6 hrs) or freeCodeCamp's Python certification


Backend services and APIs JavaScript, then SQL[Learn Node.js](https://scrimba.com/learn-nodejs-c00ho9qqh6?ref=scrimba.com) (3.5 hrs) and[Learn SQL](https://scrimba.com/learn-sql-c0aviq0aha?ref=scrimba.com) (3.8 hrs)
...
Scrimba's honest limit belongs here too: the free tier spans roughly 25 courses with certificates but caps interactive challenge attempts at 10 slots across the whole account, and the four career paths require Pro. Lessons remain watchable after that cap. The[Scrimba vs freeCodeCamp](https://scrimba.com/articles/scrimba-vs-freecodecamp-interactive-courses-vs-free-tutorials/) comparison covers where each format wins.


Satellites are for lookup, not sequence.[MDN Web Docs](https://developer.mozilla.org/en-US/docs/Learn_web_development?ref=scrimba.com) is the reference professional developers keep open, and documentation plus search is what the Stack Overflow data shows they rely on most.


If the open question is still *which* free platforms exist and where each paywall sits, the companion piece on the[best free coding websites and resources](https://scrimba.com/articles/best-free-coding-websites-and-resources-2026/) compares twelve of them side by side. This guide assumes that choice is made and deals with what happens afterward.
...
7-8 Command line, Git, deployment[Command Line Basics](https://scrimba.com/command-line-basics-c08b87ogl0?ref=scrimba.com) (101 min),[Deploying with Netlify](https://scrimba.com/deploying-with-netlify-c013?ref=scrimba.com) (23 min) The week 5 app deployed, with a public repository 8-10


9-10 One framework or one data layer[Learn React](https://scrimba.com/learn-react-c0e?ref=scrimba.com) (15.1 hrs) or Learn SQL A multi-screen app, or a queryable dataset 10-14


11-12 Unassigned project and portfolio[Build and Deploy Your Portfolio](https://scrimba.com/build-and-deploy-your-portfolio-c012?ref=scrimba.com) (2.4 hrs) Something nobody assigned you, plus a portfolio site 10-14
...
The shortlist of[coding project ideas for beginners](https://scrimba.com/articles/best-coding-project-ideas-for-beginners/) helps when step three stalls on what to build.
...
- [Exercism](https://exercism.org/mentoring?ref=scrimba.com) offers free human mentoring from volunteer developers across 83 language tracks. It is the closest thing to real code review that costs nothing.
...
- Jordan, Katy. "Massive Open Online Course Completion Rates Revisited: Assessment, Length and Attrition." International Review of Research in Open and Distributed Learning 16, no. 3, 2015.[https://files.eric.ed.gov/fulltext/EJ1067937.pdf](https://files.eric.ed.gov/fulltext/EJ1067937.pdf?ref=scrimba.com)
- U.S. Bureau of Labor Statistics. "Software Developers, Quality Assurance Analysts, and Testers." Occupational Outlook Handbook, 2026.[https://www.bls.gov/ooh/computer-and-information-technology/software-developers.htm](https://www.bls.gov/ooh/computer-and-information-technology/software-developers.htm?ref=scrimba.com)
- Stack Overflow. "2025 Developer Survey: Developers." 2025.[https://survey.stackoverflow.co/2025/developers/](https://survey.stackoverflow.co/2025/developers/?ref=scrimba.com)
- freeCodeCamp. "Curriculum." August 2026.[https://www.freecodecamp.org/learn/](https://www.freecodecamp.org/learn/?ref=scrimba.com)
- The Odin Project. "Paths." August 2026.[https://www.theodinproject.com/paths](https://www.theodinproject.com/paths?ref=scrimba.com)
- Harvard University. "CS50x 2026: Introduction to Computer Science." August 2026.[https://cs50.harvard.edu/x/](https://cs50.harvard.edu/x/?ref=scrimba.com)
- University of Helsinki. "Full Stack Open: General Info." August 2026.[https://fullstackopen.com/en/part0/general_info](https://fullstackopen.com/en/part0/general_info?ref=scrimba.com)
- Exercism. "Mentoring." August 2026.[https://exercism.org/mentoring](https://exercism.org/mentoring?ref=scrimba.com)
- Mozilla. "Learn web development." MDN Web Docs, August 2026.[https://developer.mozilla.org/en-US/docs/Learn_web_development](https://developer.mozilla.org/en-US/docs/Learn_web_development?ref=scrimba.com)
- Scrimba. Self-reported product data: free course durations, certificates, free-tier limits, Pro pricing. August 2026.
