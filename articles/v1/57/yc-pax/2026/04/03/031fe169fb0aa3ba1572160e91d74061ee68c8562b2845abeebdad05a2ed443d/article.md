...
- **Audit before you claim.** The audit is where the lasting value lives — most importers find classification errors, missed program claims, and valuation issues that have been costing them money for years. It is also your defense if CBP runs your entry data against its own revenue-enforcement targets once you file. A post-summary correction or prior disclosure filed now is a different conversation than a CF-28 that shows up four months later.
- **Concentrate audit effort where it pays.** Auditing every IEEPA-era entry to a CBP-defensible standard is ideal, but often impractical at scale. In practice, importers concentrate audit effort on two groups first: high-value entries, where a single misclassification or valuation error can move hundreds of thousands of dollars; and entries already on a protest track or headed for a court case, where the record has to hold up under adversarial scrutiny.
