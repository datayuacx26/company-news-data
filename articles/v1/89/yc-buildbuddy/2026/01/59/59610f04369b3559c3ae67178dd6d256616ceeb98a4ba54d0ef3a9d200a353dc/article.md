...
document_id: "59610f04369b3559c3ae67178dd6d256616ceeb98a4ba54d0ef3a9d200a353dc"
company_key: "yc-buildbuddy"
company: "BuildBuddy"
source_id: "yc-buildbuddy-rss-9eed3a34e5de"
canonical_url: "https://www.buildbuddy.io/blog/action-merging"
...
content_hash: "sha256:45b9656b20c5db6bcd4d70055dad6b883f342b2e5c1b6e8c758e8e78fcc6acc3"
---
...
*A timeline of Alice and Bob's unmerged BigSlowTest executions.*
...
*A simple action and an execution of that action.*


### BuildBuddy​


BuildBuddy's remote cache and remote execution is primarily implemented by two services: stateful "apps" that store and serve the cache, interact with databases, and perform scheduling; and stateless autoscaling "executors" that run remote executions. BuildBuddy uses the[Sparrow scheduling algorithm](https://www.buildbuddy.io/blog/distributed-scheduling-for-faster-builds) to schedule remote executions.
...
*A simplified overview of BuildBuddy's architecture and scheduling.*
...
*How hedging unblocks merges against stuck executions.*
...
Action merging saves our users time and resources by deduplicating identical in-flight executions of an action. But, like most distributed system designs, it's tricky to get right and there are some interesting corner cases. We hope this blog post helps you understand why this feature is important and how it works. If you want to learn more, we recommend checking out[Christian Scott's talk on this topic at Bazelcon, 2024](https://www.youtube.com/watch?v=zZB_Q-BKJ04&list=PLbzoR-pLrL6ptKfAQNZ5RS4HMdmeilBcw&index=6) ,[Sushain Cherivirala's blog post on remote caching and execution optimizations](https://stripe.com/blog/fast-secure-builds-choose-two) , or reaching out via[Slack](https://buildbuddy.slack.com/) orEmail . And if you made it this far and found this interesting,[we're hiring](https://www.buildbuddy.io/careers) !
