...
document_id: "cfaccbb204130d1c135d3e612c5c8e57eb719539007f5d72f0ed75b30e2ac318"
company_key: "yc-finlens"
company: "Finlens"
source_id: "yc-finlens-news-import-eb6409796ae1"
canonical_url: "https://www.finlens.app/blogs/cost-segregation-for-real-estate"
published_at: "2026-07-29T00:00:00+00:00"
first_seen_at: "2026-07-30T08:12:02.916072+00:00"
fetched_at: "2026-07-30T08:12:04.374298+00:00"
content_hash: "sha256:f3fc4a76f40317b6c1f7dd8ab998826012228e38f32d86376aec3adbb1369f10"
---
...
- [Finlens](https://www.finlens.app/accountants) automates QBO ledger cleanup capital improvements, placed-in-service dates, cost basis that feeds study's input schedule
...
Related:[Section 179 vs bonus depreciation (MACRS)](https://www.finlens.app/blogs/section-179-vs-bonus-depreciation) covers underlying bonus depreciation and OBBBA reset in depth.
...
Related:[Section 174 R&D capitalization guide](https://www.finlens.app/blogs/section-174-r-and-d-capitalization) covers parallel engineering-workpaper standard for R&E capitalization workpapers.
...
1. Property was placed in service in a prior year (say, 2020) using default 27.5 or 39-year straight-line depreciation
2. In 2026, owner engages a cost segregation study
3. Study reclassifies portions of basis into 5-, 7-, and 15-year property retroactive to 2020
4. **The additional depreciation that should have been claimed 2020–2025 is calculated** sum of five prior years' catch-up
5. **File Form 3115 (Change in Accounting Method)** automatic consent, no user-fee required for cost segregation
6. **The catch-up depreciation is claimed on current year return as a §481(a) adjustment** no amended returns, no interest paid
...
1. **Section 179 expensing (Part I of Form 4562)** up to 2026 limit of $2,560,000, subject to net income limitation. For short-term rental owners with W-2 income and passive-activity-loss rules, §179 usually can't be used on rental property (rental doesn't rise to trade-or-business status for most owners) bonus depreciation is primary lever.
2. **Bonus depreciation (Part II of Form 4562)** 100% under OBBBA for property acquired and placed in service after 1/19/2025. Applied class-wide (all 5-year property or none, all 7-year property or none, etc.).
3. **Regular MACRS depreciation (Part III)** declining-balance recovery on remaining basis, including residual 27.5/39-year building shell.
...
Related:[QBI deduction (Section 199A) 2026](https://www.finlens.app/blogs/qbi-deduction) covers how depreciation and passive-loss interactions flow to QBI calculation.
...
## Cost seg study coming up?
Books need a clean pool.


Finlens separates capital improvements from repairs, tags placed-in-service dates, and books vendor payments at gross — so the engineering firm's input pool holds up on audit.
...
*Cost segregation study standards, MACRS class assignments, bonus depreciation percentages, OBBBA acquired-date cutoffs, and Form 3115 mechanics change frequently. This article reflects guidance current as of 2026-07-29 (P.L. 119-21, IRS Cost Segregation Audit Techniques Guide). Verify current thresholds and IRS Form 3115 / 4562 instructions at*[irs.gov](https://www.irs.gov/) *before filing. Nothing in this article is legal or tax advice engage a licensed CPA, EA, or attorney and an ASCSP-affiliated engineering firm for actual cost segregation planning and study performance. Third-party trademarks (QuickBooks®, Stripe®, KBKG®, CBIZ®) belong to their respective owners.*
