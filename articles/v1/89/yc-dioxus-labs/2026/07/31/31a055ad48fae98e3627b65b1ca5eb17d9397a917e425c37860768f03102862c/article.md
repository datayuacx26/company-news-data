...
document_id: "31a055ad48fae98e3627b65b1ca5eb17d9397a917e425c37860768f03102862c"
company_key: "yc-dioxus-labs"
company: "Dioxus Labs"
source_id: "yc-dioxus-labs-news-import-610e1dfdd9fb"
canonical_url: "https://dioxuslabs.com/blog/release-060/"
published_at: null
first_seen_at: "2026-07-25T01:44:03.157109+00:00"
fetched_at: "2026-07-28T21:36:14.883471+00:00"
content_hash: "sha256:808adb652ef36841117fc08e9b2e0c95b2774f32d8f1ecb33098c54a875af5d3"
---
...
- **[dx serve for mobile](https://dioxuslabs.com/blog/release-060#android-and-ios-support-for-dx-serve)** : Serve your app on Android and iOS simulators and devices.
- **[Magical Hot-Reloading](https://dioxuslabs.com/blog/release-060#completely-revamped-hot-reloading)** : Hot-Reloading of formatted strings, properties, and nested` rsx!{}` .
- **[Interactive CLI](https://dioxuslabs.com/blog/release-060#interactive-command-line-tools)** : Rewrite of the Dioxus CLI with a new, interactive UX inspired by Astro.
- **[Inline Stack Traces](https://dioxuslabs.com/blog/release-060#inline-wasm-stacktraces-and-tracing-integration)** : Capture WASM panics and logs directly into your terminal.
- **[Server Functions for Native](https://dioxuslabs.com/blog/release-060#fullstack-desktop-and-mobile)** : Inline Server RPC for Desktop and Mobile apps.


We also improved the developer experience across the entire framework, fixing long standing bugs and improving tooling:


- **[Toasts and Loading Screens](https://dioxuslabs.com/blog/release-060#toasts-and-loading-screens)** : New toasts and loading screens for web apps in development.
- **[Improved Autocomplete](https://dioxuslabs.com/blog/release-060#completely-revamped-autocomplete)** : Massively improved autocomplete of RSX.
- **[asset! Stabilization](https://dioxuslabs.com/blog/release-060#stabilizing-manganis-asset-system)** : Stabilizing our linker-based asset system integrated for native apps.
- **[Streaming HTML](https://dioxuslabs.com/blog/release-060#suspense-and-html-streaming-for-the-web)** : Stream` Suspense` and` Error` Boundaries from the server to the client.
- **[SSG and ISG](https://dioxuslabs.com/blog/release-060#static-site-generation-and-isg)** : Support for Static Site Generation and Incremental Static Regeneration.
- **[Error Handling with ?](https://dioxuslabs.com/blog/release-060#question-mark-error-handling)** : Use` ?` to handle errors in event handlers, tasks, and components.
- **[Meta Elements](https://dioxuslabs.com/blog/release-060#document-elements-title---link---stylesheet--and-meta-)** : New` Head` ,` Title` ,` Meta` , and` Link` elements for setting document attributes.
- **[Synchronous prevent_default](https://dioxuslabs.com/blog/release-060#synchronous-prevent-default)** : Handle events synchronously across all platforms.
- **[onresize Event Handler](https://dioxuslabs.com/blog/release-060#tracking-size-with-onresize)** : Track an element's size without an IntersectionObserver.
- **[onvisible Event Handler](https://dioxuslabs.com/blog/release-060#tracking-visibility-with-onvisible)** : Track an element's visibility without an IntersectionObserver.
- **[WGPU Integration](https://dioxuslabs.com/blog/release-060#hybrid-wgpu-overlays)** : Render Dioxus as an overlay on top of WGPU surfaces and child windows.
- **[dx bundle for Web, iOS, and Android](https://dioxuslabs.com/blog/release-060#web-ios-and-android-bundle-support)** : Complete` dx bundle` support for every platform.
- **[json mode](https://dioxuslabs.com/blog/release-060#json-output-for-ci--cli)** : Emit CLI messages as JSON for use by 3rd party tools and CI/CD pipelines.
- **[New Templates](https://dioxuslabs.com/blog/release-060#new-starter-templates)** : Three new starter templates for cross-platform apps.
- **[Nightly Tutorial and Guides](https://dioxuslabs.com/blog/release-060#nightly-docs-tutorials-and-new-guides)** : New tutorials and guides for Dioxus 0.6 and beyond.
- **[Binary Patching Prototype](https://dioxuslabs.com/blog/release-060#preview-of-in-place-binary-patching)** : Prototype of our new pure Rust hot-reloading engine.


## [About this Release](https://dioxuslabs.com/blog/release-060#about-this-release)
...
## [Interactive Command Line Tools](https://dioxuslabs.com/blog/release-060#interactive-command-line-tools)
...
You can install the new CLI using[cargo binstall](https://github.com/cargo-bins/cargo-binstall) with` cargo binstall[\[email protected\]](https://dioxuslabs.com/cdn-cgi/l/email-protection) --force` .


## [Android and iOS support for dx serve](https://dioxuslabs.com/blog/release-060#android-and-ios-support-for-dx-serve)
...
## [Completely Revamped Hot-Reloading](https://dioxuslabs.com/blog/release-060#completely-revamped-hot-reloading)
...
## [Completely Revamped Autocomplete](https://dioxuslabs.com/blog/release-060#completely-revamped-autocomplete)
...
## [Inline WASM stacktraces and tracing integration](https://dioxuslabs.com/blog/release-060#inline-wasm-stacktraces-and-tracing-integration)
...
## [Toasts and Loading Screens](https://dioxuslabs.com/blog/release-060#toasts-and-loading-screens)
...
## [Fullstack Desktop and Mobile](https://dioxuslabs.com/blog/release-060#fullstack-desktop-and-mobile)
...
## [Stabilizing Manganis asset!() system](https://dioxuslabs.com/blog/release-060#stabilizing-manganis-asset-system)
...
## [Suspense and HTML Streaming for the Web](https://dioxuslabs.com/blog/release-060#suspense-and-html-streaming-for-the-web)
...
## [Static Site Generation and ISG](https://dioxuslabs.com/blog/release-060#static-site-generation-and-isg)
...
## [Document Elements: Title {} , Link {} , Stylesheet , and Meta {}](https://dioxuslabs.com/blog/release-060#document-elements-title---link---stylesheet--and-meta-)
...
## [Question Mark Error Handling](https://dioxuslabs.com/blog/release-060#question-mark-error-handling)
...
## [Synchronous prevent_default](https://dioxuslabs.com/blog/release-060#synchronous-prevent-default)
...
## [Tracking size with onresize](https://dioxuslabs.com/blog/release-060#tracking-size-with-onresize)
...
## [Tracking visibility with onvisible](https://dioxuslabs.com/blog/release-060#tracking-visibility-with-onvisible)
...
## [Hybrid WGPU Overlays](https://dioxuslabs.com/blog/release-060#hybrid-wgpu-overlays)
...
## [Web, iOS, and Android bundle support](https://dioxuslabs.com/blog/release-060#web-ios-and-android-bundle-support)
...
## [JSON Output for CI / CLI](https://dioxuslabs.com/blog/release-060#json-output-for-ci--cli)
...
## [New Starter Templates](https://dioxuslabs.com/blog/release-060#new-starter-templates)
...
## [Nightly Docs, Tutorials, and New Guides](https://dioxuslabs.com/blog/release-060#nightly-docs-tutorials-and-new-guides)
...
## [Upgrading from 0.5 to 0.6](https://dioxuslabs.com/blog/release-060#upgrading-from-05-to-06)
...
## [Conclusion](https://dioxuslabs.com/blog/release-060#conclusion)
...
## [Thanks to the community!](https://dioxuslabs.com/blog/release-060#thanks-to-the-community)
