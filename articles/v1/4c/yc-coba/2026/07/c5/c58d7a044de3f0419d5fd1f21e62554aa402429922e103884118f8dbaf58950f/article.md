...
document_id: "c58d7a044de3f0419d5fd1f21e62554aa402429922e103884118f8dbaf58950f"
company_key: "yc-coba"
company: "Coba"
source_id: "yc-coba-atom-20474b558f09"
canonical_url: "https://blog.coba.ai/post/move-usd-mxn-from-ibc-bank-to-hsbc-mexico/"
published_at: "2026-07-17T00:00:00+00:00"
first_seen_at: "2026-07-24T22:45:10.768066+00:00"
fetched_at: "2026-07-28T20:37:08.491459+00:00"
content_hash: "sha256:8d340ea401f11a8389d04c68519b093a5b6dd7c328293643887651d3648b60e9"
---

# How to move USD to MXN from IBC Bank to HSBC México

If your logistics or transport company keeps dollars at IBC Bank and needs to pay people in Mexico through HSBC México, the question is not only *can I send the money?* It is *which route gives me the right timing, proof, FX control, and operational visibility?*
...
A US-side company has USD available at IBC Bank. The Mexico-side obligation is in pesos at HSBC México: supplier invoices, customs-related services, yard expenses, carrier payments, payroll support, taxes, or urgent operating costs.
...
HSBC México is relevant for companies with cross-border or global trade exposure because of its international banking, FX, and commercial banking footprint.
...
## Option 1: send a SWIFT wire from IBC Bank to HSBC México


For a larger or one-off payment, a traditional international wire can make sense. Your team can ask IBC Bank for the correct process to send funds to Mexico and ask HSBC México for the beneficiary instructions.
...
- Does the beneficiary account at HSBC México receive USD, MXN, or both?
...
- Can IBC Bank send MXN to HSBC México, or only USD?
...
Some Mexican business accounts can receive USD, usually under specific eligibility rules and documentation. If the recipient has a USD-capable account at HSBC México, a US company may be able to send USD and let the Mexico-side business decide when to convert.
...
Use this route only after confirming the account details directly with HSBC México. Do not assume that every CLABE receives USD.
...
For the IBC Bank to HSBC México scenario, SPID is usually not the first step from the US bank. It becomes relevant after dollars are already inside Mexico and the Mexican company wants to move USD between eligible Mexican bank accounts or then convert using its bank’s own services.


The important point: SPID availability is bank and account specific. Ask HSBC México whether the account supports USD receipts, SPID, internal conversion, and MXN payout workflows.
...
4. Send MXN locally in Mexico by SPEI to HSBC México or another Mexican bank.
...
IBC Bank and HSBC México can both be good banks. The problem for logistics companies is that cross-border operations do not always fit neatly into bank cutoffs, manual FX calls, wire references, and back-office reconciliation.
...
[Explore Coba USD/MXN business payments](https://www.coba.ai/banking/usd-mxn-business-payments/?utm_source=blog&utm_medium=seo_content&utm_campaign=banking_seo&utm_content=move_usd_mxn_from_ibc_bank_to_hsbc_mexico) or[start an application](https://app.coba.ai/registrations/new?utm_source=blog&utm_medium=seo_content&utm_campaign=banking_seo&utm_content=move_usd_mxn_from_ibc_bank_to_hsbc_mexico_signup) . If you want to compare your current IBC Bank to HSBC México process first,[book a short discovery call](https://cal.com/coba-came/discovery-call?utm_source=blog&utm_medium=seo_content&utm_campaign=banking_seo&utm_content=move_usd_mxn_from_ibc_bank_to_hsbc_mexico_call) .
