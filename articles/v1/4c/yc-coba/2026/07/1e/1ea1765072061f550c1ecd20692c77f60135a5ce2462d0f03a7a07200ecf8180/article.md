...
document_id: "1ea1765072061f550c1ecd20692c77f60135a5ce2462d0f03a7a07200ecf8180"
company_key: "yc-coba"
company: "Coba"
source_id: "yc-coba-atom-20474b558f09"
canonical_url: "https://blog.coba.ai/post/move-usd-mxn-from-ibc-bank-to-santander-mexico/"
published_at: "2026-07-17T00:00:00+00:00"
first_seen_at: "2026-07-24T22:45:10.768066+00:00"
fetched_at: "2026-07-28T20:37:08.491459+00:00"
content_hash: "sha256:e4604935b4980dff51e57b4ef174b243b6129aeb8252002313c19eaa29bdf92d"
---

# How to move USD to MXN from IBC Bank to Santander México

If your logistics or transport company keeps dollars at IBC Bank and needs to pay people in Mexico through Santander México, the question is not only *can I send the money?* It is *which route gives me the right timing, proof, FX control, and operational visibility?*
...
A US-side company has USD available at IBC Bank. The Mexico-side obligation is in pesos at Santander México: supplier invoices, customs-related services, yard expenses, carrier payments, payroll support, taxes, or urgent operating costs.


IBC Bank is a high-priority bank for this content cluster because it is closely associated with South Texas and border-market business banking. For logistics teams around Laredo and the US-Mexico corridor, it is a natural bank to compare against an operational USD to MXN workflow.


Santander México is a common business banking destination with international, FX, and corporate banking relevance. It is also a practical example for companies checking USD account, SPID, or internal conversion options.
...
## Option 1: send a SWIFT wire from IBC Bank to Santander México


For a larger or one-off payment, a traditional international wire can make sense. Your team can ask IBC Bank for the correct process to send funds to Mexico and ask Santander México for the beneficiary instructions.
...
- Does the beneficiary account at Santander México receive USD, MXN, or both?
...
## Option 2: ask IBC Bank to handle the currency exchange
...
- Can IBC Bank send MXN to Santander México, or only USD?
...
Some Mexican business accounts can receive USD, usually under specific eligibility rules and documentation. If the recipient has a USD-capable account at Santander México, a US company may be able to send USD and let the Mexico-side business decide when to convert.
...
Use this route only after confirming the account details directly with Santander México. Do not assume that every CLABE receives USD.
...
For the IBC Bank to Santander México scenario, SPID is usually not the first step from the US bank. It becomes relevant after dollars are already inside Mexico and the Mexican company wants to move USD between eligible Mexican bank accounts or then convert using its bank’s own services.


The important point: SPID availability is bank and account specific. Ask Santander México whether the account supports USD receipts, SPID, internal conversion, and MXN payout workflows.
...
1. Connect or authorize your existing US bank account, such as IBC Bank, where supported.
2. Pull USD into the Coba flow using direct debit or another supported funding method.
3. Convert USD to MXN.
4. Send MXN locally in Mexico by SPEI to Santander México or another Mexican bank.
5. Keep payment status, beneficiary details, and receipts in one operating workflow.
...
IBC Bank and Santander México can both be good banks. The problem for logistics companies is that cross-border operations do not always fit neatly into bank cutoffs, manual FX calls, wire references, and back-office reconciliation.
...
[Explore Coba USD/MXN business payments](https://www.coba.ai/banking/usd-mxn-business-payments/?utm_source=blog&utm_medium=seo_content&utm_campaign=banking_seo&utm_content=move_usd_mxn_from_ibc_bank_to_santander_mexico) or[start an application](https://app.coba.ai/registrations/new?utm_source=blog&utm_medium=seo_content&utm_campaign=banking_seo&utm_content=move_usd_mxn_from_ibc_bank_to_santander_mexico_signup) . If you want to compare your current IBC Bank to Santander México process first,[book a short discovery call](https://cal.com/coba-came/discovery-call?utm_source=blog&utm_medium=seo_content&utm_campaign=banking_seo&utm_content=move_usd_mxn_from_ibc_bank_to_santander_mexico_call) .
