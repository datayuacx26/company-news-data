...
document_id: "64956cd44a4ce451f4049df6dc103392214dbe233fcbffc85c90b0536d7d9039"
company_key: "yc-coba"
company: "Coba"
source_id: "yc-coba-atom-20474b558f09"
canonical_url: "https://blog.coba.ai/post/move-usd-mxn-from-wells-fargo-to-santander-mexico/"
published_at: "2026-07-17T00:00:00+00:00"
first_seen_at: "2026-07-24T22:45:10.768066+00:00"
fetched_at: "2026-07-28T20:37:08.491459+00:00"
content_hash: "sha256:b154455146027c4f7214a45496528d6f5a19f1ef0ba795fed17a0672a12c4831"
---

# How to move USD to MXN from Wells Fargo to Santander México

If your logistics or transport company keeps dollars at Wells Fargo and needs to pay people in Mexico through Santander México, the question is not only *can I send the money?* It is *which route gives me the right timing, proof, FX control, and operational visibility?*
...
A US-side company has USD available at Wells Fargo. The Mexico-side obligation is in pesos at Santander México: supplier invoices, customs-related services, yard expenses, carrier payments, payroll support, taxes, or urgent operating costs.


Wells Fargo is a common business banking and treasury starting point for US companies with supplier, payroll, or vendor obligations across borders.
...
## Option 1: send a SWIFT wire from Wells Fargo to Santander México


For a larger or one-off payment, a traditional international wire can make sense. Your team can ask Wells Fargo for the correct process to send funds to Mexico and ask Santander México for the beneficiary instructions.
...
## Option 2: ask Wells Fargo to handle the currency exchange
...
- Can Wells Fargo send MXN to Santander México, or only USD?
...
For the Wells Fargo to Santander México scenario, SPID is usually not the first step from the US bank. It becomes relevant after dollars are already inside Mexico and the Mexican company wants to move USD between eligible Mexican bank accounts or then convert using its bank’s own services.
...
1. Connect or authorize your existing US bank account, such as Wells Fargo, where supported.
...
Wells Fargo and Santander México can both be good banks. The problem for logistics companies is that cross-border operations do not always fit neatly into bank cutoffs, manual FX calls, wire references, and back-office reconciliation.
...
[Explore Coba USD/MXN business payments](https://www.coba.ai/banking/usd-mxn-business-payments/?utm_source=blog&utm_medium=seo_content&utm_campaign=banking_seo&utm_content=move_usd_mxn_from_wells_fargo_to_santander_mexico) or[start an application](https://app.coba.ai/registrations/new?utm_source=blog&utm_medium=seo_content&utm_campaign=banking_seo&utm_content=move_usd_mxn_from_wells_fargo_to_santander_mexico_signup) . If you want to compare your current Wells Fargo to Santander México process first,[book a short discovery call](https://cal.com/coba-came/discovery-call?utm_source=blog&utm_medium=seo_content&utm_campaign=banking_seo&utm_content=move_usd_mxn_from_wells_fargo_to_santander_mexico_call) .
