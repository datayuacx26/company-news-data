...
document_id: "b4a1006b63c6884f7163fc3529a61c72d9dfdfb50ab63d8da22a40cb996bc18f"
company_key: "yc-coba"
company: "Coba"
source_id: "yc-coba-atom-20474b558f09"
canonical_url: "https://blog.coba.ai/post/move-usd-mxn-from-falcon-bank-to-santander-mexico/"
published_at: "2026-07-17T00:00:00+00:00"
first_seen_at: "2026-07-24T22:45:10.768066+00:00"
fetched_at: "2026-07-28T20:37:08.491459+00:00"
content_hash: "sha256:25f921547e41b214270a373ccbe133482f08a06a8802ea4f0dfe65d6adbd27c8"
---

# How to move USD to MXN from Falcon Bank to Santander México

If your logistics or transport company keeps dollars at Falcon Bank and needs to pay people in Mexico through Santander México, the question is not only *can I send the money?* It is *which route gives me the right timing, proof, FX control, and operational visibility?*
...
A US-side company has USD available at Falcon Bank. The Mexico-side obligation is in pesos at Santander México: supplier invoices, customs-related services, yard expenses, carrier payments, payroll support, taxes, or urgent operating costs.


Falcon Bank is relevant for South Texas and border businesses, including companies that prefer local or regional bank relationships while operating across the US-Mexico corridor.
...
## Option 1: send a SWIFT wire from Falcon Bank to Santander México


For a larger or one-off payment, a traditional international wire can make sense. Your team can ask Falcon Bank for the correct process to send funds to Mexico and ask Santander México for the beneficiary instructions.
...
## Option 2: ask Falcon Bank to handle the currency exchange
...
- Can Falcon Bank send MXN to Santander México, or only USD?
...
For the Falcon Bank to Santander México scenario, SPID is usually not the first step from the US bank. It becomes relevant after dollars are already inside Mexico and the Mexican company wants to move USD between eligible Mexican bank accounts or then convert using its bank’s own services.
...
1. Connect or authorize your existing US bank account, such as Falcon Bank, where supported.
...
Falcon Bank and Santander México can both be good banks. The problem for logistics companies is that cross-border operations do not always fit neatly into bank cutoffs, manual FX calls, wire references, and back-office reconciliation.
...
[Explore Coba USD/MXN business payments](https://www.coba.ai/banking/usd-mxn-business-payments/?utm_source=blog&utm_medium=seo_content&utm_campaign=banking_seo&utm_content=move_usd_mxn_from_falcon_bank_to_santander_mexico) or[start an application](https://app.coba.ai/registrations/new?utm_source=blog&utm_medium=seo_content&utm_campaign=banking_seo&utm_content=move_usd_mxn_from_falcon_bank_to_santander_mexico_signup) . If you want to compare your current Falcon Bank to Santander México process first,[book a short discovery call](https://cal.com/coba-came/discovery-call?utm_source=blog&utm_medium=seo_content&utm_campaign=banking_seo&utm_content=move_usd_mxn_from_falcon_bank_to_santander_mexico_call) .
