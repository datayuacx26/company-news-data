...
document_id: "67f51a4f31955cf755aaee40ed1833be9b28e91907111ffb6f91ad16bdc97c2b"
company_key: "yc-coba"
company: "Coba"
source_id: "yc-coba-atom-20474b558f09"
canonical_url: "https://blog.coba.ai/post/move-usd-mxn-from-ibc-bank-to-banamex/"
published_at: "2026-07-17T00:00:00+00:00"
first_seen_at: "2026-07-24T22:45:10.768066+00:00"
fetched_at: "2026-07-28T20:37:08.491459+00:00"
content_hash: "sha256:ebe7c5c03136e0dee07d109eec0395eb568e250562f1682b3264c30659f1f708"
---

# How to move USD to MXN from IBC Bank to Banamex

If your logistics or transport company keeps dollars at IBC Bank and needs to pay people in Mexico through Banamex, the question is not only *can I send the money?* It is *which route gives me the right timing, proof, FX control, and operational visibility?*
...
A US-side company has USD available at IBC Bank. The Mexico-side obligation is in pesos at Banamex: supplier invoices, customs-related services, yard expenses, carrier payments, payroll support, taxes, or urgent operating costs.
...
Banamex, also searched as Citibanamex, remains a major commercial banking destination in Mexico for business accounts, treasury, payroll, and supplier payments.
...
## Option 1: send a SWIFT wire from IBC Bank to Banamex


For a larger or one-off payment, a traditional international wire can make sense. Your team can ask IBC Bank for the correct process to send funds to Mexico and ask Banamex for the beneficiary instructions.
...
- Does the beneficiary account at Banamex receive USD, MXN, or both?
...
- Can IBC Bank send MXN to Banamex, or only USD?
...
Some Mexican business accounts can receive USD, usually under specific eligibility rules and documentation. If the recipient has a USD-capable account at Banamex, a US company may be able to send USD and let the Mexico-side business decide when to convert.
...
Use this route only after confirming the account details directly with Banamex. Do not assume that every CLABE receives USD.
...
For the IBC Bank to Banamex scenario, SPID is usually not the first step from the US bank. It becomes relevant after dollars are already inside Mexico and the Mexican company wants to move USD between eligible Mexican bank accounts or then convert using its bank’s own services.


The important point: SPID availability is bank and account specific. Ask Banamex whether the account supports USD receipts, SPID, internal conversion, and MXN payout workflows.
...
4. Send MXN locally in Mexico by SPEI to Banamex or another Mexican bank.
...
IBC Bank and Banamex can both be good banks. The problem for logistics companies is that cross-border operations do not always fit neatly into bank cutoffs, manual FX calls, wire references, and back-office reconciliation.
...
[Explore Coba USD/MXN business payments](https://www.coba.ai/banking/usd-mxn-business-payments/?utm_source=blog&utm_medium=seo_content&utm_campaign=banking_seo&utm_content=move_usd_mxn_from_ibc_bank_to_banamex) or[start an application](https://app.coba.ai/registrations/new?utm_source=blog&utm_medium=seo_content&utm_campaign=banking_seo&utm_content=move_usd_mxn_from_ibc_bank_to_banamex_signup) . If you want to compare your current IBC Bank to Banamex process first,[book a short discovery call](https://cal.com/coba-came/discovery-call?utm_source=blog&utm_medium=seo_content&utm_campaign=banking_seo&utm_content=move_usd_mxn_from_ibc_bank_to_banamex_call) .
