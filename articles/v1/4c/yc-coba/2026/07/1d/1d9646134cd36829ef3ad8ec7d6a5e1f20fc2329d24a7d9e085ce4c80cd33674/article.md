...
document_id: "1d9646134cd36829ef3ad8ec7d6a5e1f20fc2329d24a7d9e085ce4c80cd33674"
company_key: "yc-coba"
company: "Coba"
source_id: "yc-coba-atom-20474b558f09"
canonical_url: "https://blog.coba.ai/post/move-usd-mxn-from-ibc-bank-to-bbva-bancomer/"
published_at: "2026-07-17T00:00:00+00:00"
first_seen_at: "2026-07-24T22:45:10.768066+00:00"
fetched_at: "2026-07-28T20:37:08.491459+00:00"
content_hash: "sha256:931d7374abb7d0a5f5e00b995d98361f6a08a07b35008e3bfe9e25f9b28e8593"
---

# How to move USD to MXN from IBC Bank to BBVA Bancomer

If your logistics or transport company keeps dollars at IBC Bank and needs to pay people in Mexico through BBVA Bancomer, the question is not only *can I send the money?* It is *which route gives me the right timing, proof, FX control, and operational visibility?*
...
A US-side company has USD available at IBC Bank. The Mexico-side obligation is in pesos at BBVA Bancomer: supplier invoices, customs-related services, yard expenses, carrier payments, payroll support, taxes, or urgent operating costs.
...
BBVA México, still often searched as Bancomer, is a major Mexican bank destination for business payments, supplier accounts, payroll support, and operating expenses.
...
## Option 1: send a SWIFT wire from IBC Bank to BBVA Bancomer


For a larger or one-off payment, a traditional international wire can make sense. Your team can ask IBC Bank for the correct process to send funds to Mexico and ask BBVA Bancomer for the beneficiary instructions.
...
- Does the beneficiary account at BBVA Bancomer receive USD, MXN, or both?
...
- Can IBC Bank send MXN to BBVA Bancomer, or only USD?
...
Some Mexican business accounts can receive USD, usually under specific eligibility rules and documentation. If the recipient has a USD-capable account at BBVA Bancomer, a US company may be able to send USD and let the Mexico-side business decide when to convert.
...
Use this route only after confirming the account details directly with BBVA Bancomer. Do not assume that every CLABE receives USD.
...
For the IBC Bank to BBVA Bancomer scenario, SPID is usually not the first step from the US bank. It becomes relevant after dollars are already inside Mexico and the Mexican company wants to move USD between eligible Mexican bank accounts or then convert using its bank’s own services.


The important point: SPID availability is bank and account specific. Ask BBVA Bancomer whether the account supports USD receipts, SPID, internal conversion, and MXN payout workflows.
...
4. Send MXN locally in Mexico by SPEI to BBVA Bancomer or another Mexican bank.
...
IBC Bank and BBVA Bancomer can both be good banks. The problem for logistics companies is that cross-border operations do not always fit neatly into bank cutoffs, manual FX calls, wire references, and back-office reconciliation.
...
[Explore Coba USD/MXN business payments](https://www.coba.ai/banking/usd-mxn-business-payments/?utm_source=blog&utm_medium=seo_content&utm_campaign=banking_seo&utm_content=move_usd_mxn_from_ibc_bank_to_bbva_bancomer) or[start an application](https://app.coba.ai/registrations/new?utm_source=blog&utm_medium=seo_content&utm_campaign=banking_seo&utm_content=move_usd_mxn_from_ibc_bank_to_bbva_bancomer_signup) . If you want to compare your current IBC Bank to BBVA Bancomer process first,[book a short discovery call](https://cal.com/coba-came/discovery-call?utm_source=blog&utm_medium=seo_content&utm_campaign=banking_seo&utm_content=move_usd_mxn_from_ibc_bank_to_bbva_bancomer_call) .
