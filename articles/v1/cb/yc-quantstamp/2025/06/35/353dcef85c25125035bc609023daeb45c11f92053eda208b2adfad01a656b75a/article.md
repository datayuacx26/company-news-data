...
document_id: "353dcef85c25125035bc609023daeb45c11f92053eda208b2adfad01a656b75a"
company_key: "yc-quantstamp"
company: "Quantstamp"
source_id: "yc-quantstamp-rss-54cdced55685"
canonical_url: "https://quantstamp.com/blog/quantstamp-germany-has-launched-and-were-hiring"
published_at: "2025-06-04T18:23:59+00:00"
first_seen_at: "2026-07-25T20:14:20.321573+00:00"
fetched_at: "2026-07-28T22:01:03.825556+00:00"
content_hash: "sha256:43e6b2305483ea9f2dacfbba06e8e3e889ea095fca8f71847283c9c5012dc17a"
---
...
Dr. Sebastian (Sebi) Banescu, formerly IT Security Specialist at BMW AG, received PhD in Computer Security from Technical University of Munich -[LinkedIn](https://www.linkedin.com/in/sebastianbanescu/)[Twitter](https://twitter.com/banescusebi) ‍


Dr. Mohsen Ahmadvand, formerly Security Specialist at SAP Hybris, recieved PhD in Computer Security from Technical University of Munich -[LinkedIn](https://www.linkedin.com/in/mahmadvand/) ‍


Christoph Michel, author of[Learn EOS](https://learneos.dev/) , winner of the Günter Hotz medal for outstanding academic graduate studies, received MSc. in Theoretical Cryptography from the University of Saarland -[LinkedIn](https://www.linkedin.com/in/christoph-michel-dev/)[Twitter](https://twitter.com/cmichelio)
...
This is where Quantstamp fits in. We have already secured over 100 billion USD worth of digital assets for over 220 clients and, in doing so, established ourselves as leaders in the security space. Quantstamp developed state-of-the-art expertise by auditing leading DeFi and NFT projects and helping NGOs, private industry, and government entities develop blockchain applications. Our clients include Siemens, Toyota, Mitsubishi, eToro, Binance, Crypto.com, and Chainlink. We are a[Y Combinator alumni](https://www.ycombinator.com/companies/quantstamp) and we are also backed by Outliers, Plug and Play Japan, and Dubai Future Accelerators. The investors that we can publicly disclose include[Nomura Holdings](https://www.nomuraholdings.com/company/outline/#NomuraGroup) ,[VentureSouq](https://www.venturesouq.com/) ,[Fifty Years](https://fiftyyears.com/) ,[Pioneer Fund](https://www.pioneerfund.vc/) ,[DG Lab](https://www.dglab.com/en/about) ,[Translink Capital](https://translinkcapital.com/) ,[Y Combinator](https://www.ycombinator.com/) ,[Bloccelerate](https://www.bloccelerate.vc/) ,[SVKCrypto](https://www.svkcrypto.com/) , and[Keisuke Honda](https://en.wikipedia.org/wiki/Keisuke_Honda) .
...
[MPro: Combining Static and Symbolic Analysis for Scalable Testing of Smart Contract](https://ieeexplore.ieee.org/abstract/document/8987460)


[Constant-Time Updates Using Token Mechanics](https://ieeexplore.ieee.org/abstract/document/9284727)
...
- Our engineers are involved in open source research projects such as[GodMode](https://github.com/xGodMode/godmode) , a testing tool that allows you to easily modify the state of the Ethereum Virtual Machine. We highly encourage open source contributions from the Quantstamp team.
- For those engineers looking to patent their ideas on Quantstamp’s behalf, we also financially support the full patenting process and currently have a[patent pending](https://patents.google.com/?assignee=Quantstamp%2c+Inc.) .
- Quantstamp is also one of the[Global Innovators in Blockchain of the World Economic Forum](https://www.weforum.org/communities/global-innovators) and, as part of that engagement, our engineers have the opportunity to join various[research projects and initiatives in collaboration with the World Economic Forum](https://quantstamp.com/blog/quantstamp-serving-as-technical-contributor-to-world-economic-forums-cbdc-project) .
- Quantstamp is also[part of the Mobility Open Blockchain Initiative (MOBI)](https://quantstamp.com/blog/building-the-future-of-mobility) , which is developing the future of mobility with the help of Distributed Ledger Technologies. Our team members have co-authored the first ever Vehicle Identity Standard as well as reference implementation architectures for Vehicle Identity, Supply Chain, Finance Securitization, and Smart Contracts. See all documents co-authored by our team on the[official MOBI website](https://dlt.mobi/standards/) .
- In terms of smart contract community collaboration and research, our team members are actively contributing to the[Smart Contract Research Forum](https://www.smartcontractresearch.org/) .
- Back in 2019, we published the first book on smart contract security entitled[Fundamentals of Smart Contract Security](https://books.google.de/books/about/Fundamentals_of_Smart_Contract_Security.html?id=AX6aDwAAQBAJ) .
...
Multi-billion dollar finance companies are already exploring blockchain implementations with the aim of speeding up asset settlement and currency transfers including CitiGroup, Depository Trust and Clearing Group, UBS, and JPMorgan Chase ([source](https://www.forbes.com/sites/michaeldelcastillo/2019/04/16/blockchain-50-billion-dollar-babies/?sh=fee46f257ccb) ). Allianz SE is also actively exploring how to speed up the processing of insurance claims using this technology.
