...
document_id: "66d10a13a19b312c276d6408ad1faed4a0595029f1252086c1bee260dc08b814"
company_key: "yc-quantstamp"
company: "Quantstamp"
source_id: "yc-quantstamp-rss-54cdced55685"
canonical_url: "https://quantstamp.com/blog/the-new-rockstars-building-the-future-of-defi"
published_at: "2025-06-04T18:23:59+00:00"
first_seen_at: "2026-07-25T20:14:20.321573+00:00"
fetched_at: "2026-07-28T22:01:03.825556+00:00"
content_hash: "sha256:3ace46ccbca7ad639228beaf2eff4106510378a2013116fa88ea238454228485"
---
...
Maker's impact does not end there. A lesser known fact about Maker is that they facilitate the success of cutting-edge DeFi projects by providing them with funding and support through the[Maker Community Grants Program](https://community-development.makerdao.com/grants) . We highlight some of the rockstar grantees below. In addition, if these projects are to become the future of our monetary system, security will also be paramount in order to safeguard the value managed by these apps. As a result, Maker and Quantstamp are enabling these grantees and the next generation of DeFi applications.
...
[MakerChat](https://chat.makerdao.com/home)


‍


### Providing liquidity and reducing intermediaries with Ramp
...
[Ramp Network](https://ramp.network/) is innovative because it removes the need for centralized exchanges to act as a bridge between the world of fiat currency and digital assets.[Ramp Network](https://ramp.network/) created a trust minimized and decentralized architecture that allows users to purchase digital assets directly from each other using fiat currency without a centralized exchange.


Ramp Network enabled peer-to-peer sales by connecting smart contracts to[open banking oracles](https://home.kpmg/xx/en/home/insights/2019/05/open-banking-for-greater-customer-value-fs.html) to settle trades. When a seller wants to trade a digital asset for fiat money, the digital asset gets locked in a smart contract escrow account. The smart contract releases the digital asset once a buyer completes a direct wire transfer which is detected by open banking oracles.
...
[Discord](https://discordapp.com/invite/qv8Zprw)
...
Follow PoolTogether on:


[Twitter](https://twitter.com/PoolTogether_)


[Discord](https://discordapp.com/invite/hxPhPDW)
...
### Using BTC and more as collateral with Kava


[Kava](https://www.kava.io/) is developing the first DeFi platform offering collateralized loans using BTC, ATOM, XRP and BNB as collateral. This platform is similar to the Maker vault system: however, one of the key differences is that each of the digital assets used as collateral in Kava belongs to a unique blockchain. Maker currently only uses digital assets that are Ethereum native as collateral, ETH and BAT.
...
Kava has the potential to bring BTC and other digital assets in play as collateral for the DeFi ecosystem.[BTC’s liquid market cap](https://onchainfx.com/) is currently over $140 billion. Kava is designed to be a bridge that makes this value easily available in the DeFi ecosystem.
...
[Quantstamp](https://quantstamp.com/) is a blockchain security company whose mission is to facilitate the mainstream adoption of blockchain applications by providing state-of-the-art security services. Currently, over[700 million USD](https://defipulse.com/) worth of cryptocurrency is locked in DeFi smart contracts. Smart contracts are not bulletproof. In 2017, over a quarter billion USD worth of cryptocurrency was lost or stolen due to vulnerabilities in smart contracts.
...
Over the last year, Quantstamp has been working closely with the[Maker Grant Foundation](https://community-development.makerdao.com/grants) who has sponsored security audits for over eleven promising DeFi projects including Kava, Ramp, and PoolTogether.
...
Follow Quantstamp on:


[Twitter](https://twitter.com/Quantstamp)


[LinkedIn](https://www.linkedin.com/company/25057251/admin/)
