...
document_id: "ebbb6108279fbd8fa8a57f4f0fa2ebe93c004756b03f8607bb75ea5ef0dc1ac5"
company_key: "yc-the-flex-company"
company: "The Flex Company"
source_id: "yc-the-flex-company-rss-644824277772"
canonical_url: "https://flexfits.com/blog/difference-between-menstrual-cup-and-disc/"
published_at: "2026-03-13T20:53:12+00:00"
first_seen_at: "2026-07-20T23:24:17.122975+00:00"
fetched_at: "2026-07-28T21:58:45.685125+00:00"
content_hash: "sha256:1356659efa02ef139197ddc5d8910c4b280fde1b149088b492fee6b86dad597a"
---

# The difference between a menstrual cup and menstrual disc
...
- Cups are always reusable; discs come in[reusable](https://flexfits.com/collections/shop-all/products/flex-reusable-disc) or[disposable](https://flexfits.com/collections/shop-all/products/flex-disc) (single-use) versions
- Research found **menstrual discs have the highest capacity** of any period product **** tested, averaging 61 mL versus 20-50 mL for tampons, pads, and cups1
- [Flex Cup’s](https://flexfits.com/collections/shop-all/products/flex-cup) patented pull-tab removes without suction, which may reduce IUD expulsion risk (a concern with traditional cups); discs use no suction at all2


## The full read:


Calling a[menstrual disc](https://flexfits.com/faq/what-is-flex-menstrual-disc) and a[menstrual cup](https://flexfits.com/faq/what-is-flex-cup) the same product would be like equating eyeglasses to contact lenses. Sure, both correct your vision, but they’re entirely different products used in different ways.
...
A **menstrual disc** sits in the[vaginal fornix](https://flexfits.com/blog/what-is-the-vaginal-fornix) , , the space at the very end of the vaginal canal that cups around the base of your[cervix](https://my.clevelandclinic.org/health/body/23279-cervix) . Because this is the widest part of your vaginal anatomy, discs are wider and flatter than cups.


A **menstrual cup** sits in the narrower, lower portion of the vaginal canal, below the cervix. If you’re familiar with[tampons](https://health.clevelandclinic.org/tampons) , cups and tampons occupy roughly the same position, though with a cup you have more control over exactly how far up to place it, since you use your fingers rather than an applicator.
...
To remove most menstrual cups, you must break the suction seal first by pinching the base. The **[Flex Cup](https://flexfits.com/products/flex-cup)** works differently: its patented pull-tab stem is engineered to break the suction seal automatically as you pull, so removal never requires reaching up to pinch. This makes it easier for beginners and people with limited dexterity. As discussed in the IUD section below, it may also be a meaningful advantage for IUD users.


## How are a period disc and cup inserted?


**Inserting a menstrual disc** starts with[pinching it in half](https://flexfits.com/pages/how-it-works-disc) with the catch (the soft middle portion) facing down toward the floor so the disc looks like a bowl. Then, insert it into the vaginal canal: Use one finger to push it as far back as possible into the vaginal fornix so that the center is surrounding your cervix. To secure the disc in place, tuck the front rim behind the pubic bone.


**Inserting a menstrual cup** requires[folding the cup](https://flexfits.com/faq/how-do-i-insert-remove-flex-cup) (not just pinching) before insertion. Common folding techniques include the C-fold, the punchdown fold, and the 7-fold. The entire cup and stem must be placed inside of the vaginal canal. Once the cup is in a comfortable position, you verify the rim has fully opened and formed a circular seal against the vaginal walls. Some users gently rotate the cup to help it seal completely.
...
- **Reusable discs have a shorter lifespan than cups.** While a quality menstrual cup can last 5-10 years, most[reusable disc](https://flexfits.com/products/flex-reusable-disc) brands recommend replacing every one to two years.
...
One big advantage discs have here: the[self-empty feature](https://flexfits.com/a/faq) . Many users can empty their disc mid-wear without full removal (by bearing down while sitting on the toilet), which reduces how often you need to do a full removal during the day.
...
Some people who experience[menstrual cramps](https://flexfits.com/blog/period-cramps/) (or more severely, dysmenorrhea) report that menstrual discs feel more comfortable during their period than tampons or cups. The proposed reason: because a disc sits in the fornix rather than the vaginal canal, the vaginal walls are not constricted during wear, potentially allowing the uterus to contract with less resistance.


That said, large-scale clinical evidence specifically studying discs and pain reduction is still limited. If you experience significant[dysmenorrhea](https://flexfits.com/blog/period-flu/) , it’s worth discussing all of your options with a healthcare provider.
...
A menstrual disc does not occupy the vaginal canal. Because of its high, wide placement in the fornix, penetrative[period sex](https://flexfits.com/blog/the-ins-and-outs-of-period-sex) is possible while wearing a disc, and most couples report neither partner can feel it during intercourse. This is one of the most cited reasons people switch from cups to discs.
...
**Disposable menstrual discs** are made from medical-grade polymers, which are FDA-regulated materials used in many types of medical devices. The original Flex Disc uses a[medical-grade polymer](https://flexfits.com/blog/flex-free-of-bpas-latex-pfoas) that softens slightly at body temperature, conforming to your anatomy.
...
What makes these materials worth paying attention to is that they’re **biologically inert** , meaning they don’t interact with human tissue, don’t host harmful bacteria, and don’t[disrupt your vaginal pH](https://flexfits.com/blog/ph-balance/) the way porous materials like cotton can.4


This is one reason cups and discs are associated with a very low risk of[toxic shock syndrome (TSS)](https://flexfits.com/blog/toxic-shock-syndrome/) . A large 2019 analysis published in *The Lancet Public Health* reviewed 43 studies and data from over 3,000 people and found only five reported cases of TSS linked to menstrual cup use; an extremely rare occurrence by any measure.5
...
Reusable cups and discs should be emptied and rinsed between uses, and boiled for 5-10 minutes at the end of each period cycle to fully disinfect them. For daily cleaning, use a mild, fragrance-free soap formulated for silicone (like[Flex Foaming Cleanser](https://flexfits.com/collections/shop-all/products/foaming-cup-wash) ) to avoid breaking down the material.


## An important note for IUD users: disc vs. cup


If you[have an IUD](https://flexfits.com/blog/menstrual-cup-disc-with-iud/) , this section is worth reading carefully before you choose a product. And before you make any switch, a conversation with your healthcare provider is always a good idea.
...
If you have a **dropped uterus, uterine prolapse, or a[tilted uterus](https://flexfits.com/blog/retroverted-uterus/)** , a menstrual cup may not sit in place properly. A disc may be a more comfortable option in these cases, but always consult your provider first.
...
**Flex product**[Flex Disc](https://flexfits.com/collections/shop-all/products/flex-disc) /[Flex Reusable Disc](https://flexfits.com/collections/shop-all/products/flex-reusable-disc)[Flex Cup](https://flexfits.com/products/flex-cup) N/A
...
Have questions about Flex Cup, Flex Reusable Disc, or Flex Disc? Our Flexperts are always here to help. Email us athello@flexfits.com .
