...
document_id: "9da66283b0d05aba1c94f13e95eac94505381d6546c1dc2fc6c34f1de55cf088"
...
canonical_url: "https://unity.com/blog/rephobia-therapy-led-vr-technology-overcome-phobias"
...
content_hash: "sha256:72712097dfae6e927d3fd5c72e469612f2c8c9e476192f57e1764cd83b339c52"
---

# Rephobia: Where technology meets therapy to overcome fear

*Liam Harte is a Computer Science student at Queen’s University Belfast and the founder of[Rephobia](https://rephobia.com/) , a therapist-led virtual reality platform that helps people confront and overcome their phobias. Rephobia was named one of the winners of the 2025[Unity for Humanity](https://unity.com/blog/announcing-the-2025-unity-for-humanity-winners) program, recognizing its potential to make mental health treatment more accessible. Liam has also been supported through Catalyst’s Co-Founders Programme and QUBIS, and was named by Belfast City Council as one of the region’s top young entrepreneurs in the “21 Under 21” awards.*
...
Rephobia was founded in 2024 with a clear mission: to make treatment for phobias more accessible, safe, and affordable. The idea was sparked by both personal experience and a gap in[mental health care](https://unity.com/solutions/healthcare) . Exposure therapy works, but it isn’t reaching enough of the people who need it most.


Image courtesy Rephobia. Concept mockup of Rephobia’s VR therapy platform: users interact with phobia triggers, like spiders, in a safe, controlled environment. The system records anxiety levels in real time, helping therapists tailor each session.
...
Image courtesy Rephobia. Unity-built VR environment simulating arachnophobia, where users can safely confront spiders during therapy sessions.
...
Image courtesy Rephobia. Concept mockup of Rephobia’s VR welcome screen, where users begin their therapy journey alongside a connected therapist.
...
Image courtesy Rephobia. Unity-built VR environment for acrophobia, where users gradually face their fear of heights in a safe, controlled setting.


Building immersive therapy environments requires both technical flexibility and clinical precision.[Unity’s engine](https://unity.com/products/unity-engine) gives us that balance. By leveraging Unity’s VR frameworks and physics systems, we can design interactive scenarios where phobia triggers behave in a realistic yet controlled way. Our environments are built using modular assets, which allows therapists to scale difficulty, for example, by adjusting proximity, quantity, or intensity of the trigger - while keeping the user safe within VR.


Unity’s[cross-platform](https://unity.com/solutions/multiplatform) support is also key. We can develop once and deploy across a range of headsets, ensuring therapists and clinics aren’t locked into a single device ecosystem. This flexibility means a single library of scenarios can be adapted and updated over time, without costly redevelopment.


From a development perspective, Unity enables rapid prototyping and iteration. We can test environment design in real time, refine interaction mechanics based on therapist feedback, and ensure each scenario aligns with exposure therapy principles. Combined with Unity’s performance[profiling](https://docs.unity3d.com/6000.0/Documentation/Manual/performance-profiling-tools.html) and[rendering tools](https://unity.com/features/srp/universal-render-pipeline) , we can optimize for smooth, reliable sessions - essential for maintaining a sense of presence and minimizing VR fatigue.


**From individuals to the NHS: A scalable path forward**


Our early research is promising. In collaboration with the[QUest program](https://www.qub.ac.uk/sites/inqubate/News/QUEstCelebrationMarksCulminationofGroundbreakingEntrepreneurshipProgramme.html) , we surveyed more than 400 people with phobias. The majority expressed strong interest in VR treatment, citing accessibility, affordability, and therapist support as top priorities.
...
Image courtesy Rephobia. Unity-built VR environment for arachnophobia, where scenarios become progressively more intense to support gradual exposure therapy
...
[Explore Unity Industry](https://unity.com/products/unity-industry)[Get free trial](https://service-store.unity.com/order/create?product=UTY-INDUSTRY-TRIAL&variant=unity-industry-30-day-trial)
