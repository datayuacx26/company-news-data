...
document_id: "28ec7292b3e3c1d19e77ff8d1724063fc2b5d2ef65d780170ac9463706084812"
company_key: "yc-rippling"
company: "Rippling"
source_id: "yc-rippling-news-import-758faf74b02a"
canonical_url: "https://www.rippling.com/blog/llc-expenses-cheat-sheet"
published_at: null
first_seen_at: "2026-07-22T11:59:36.706542+00:00"
fetched_at: "2026-07-28T21:38:24.318832+00:00"
content_hash: "sha256:2c8df2036357c1f7dccffbc450c4487199ff10b6e1719441fb8fe45f0e4aa299"
---

# LLC Expenses Cheat Sheet: 15 Tax Write-Offs for 2026
...
## 15 LLC tax write-offs: deductible expenses
...
Below, we list some of the most[common tax deductions for LLCs](https://www.rippling.com/blog/small-business-tax-deductions) . Remember, however, that LLCs can choose from three different tax statuses — sole proprietorship, corporation, or partnership — and not all deductions will apply in all circumstances. Check with a tax professional if you’re unsure.
...
Most LLCs are pass-through entities, so owners can also claim the Qualified Business Income (QBI) deduction, which lets you deduct up to 20% of your share of the business's net income on top of your other write-offs. The 2025 One Big Beautiful Bill Act made this deduction permanent. For 2026, the full deduction is available to single filers with taxable income under roughly $203,000 and married couples filing jointly under roughly $406,000; above those thresholds, the rules get more complex, particularly for service-based businesses like law, consulting, and accounting firms.
...
Certain types of equipment and machinery can begin to lose value due to wear and tear. To offset this depreciation against the asset's value, you can file[Form 4562](https://www.irs.gov/pub/irs-pdf/i4562.pdf) and claim a deduction under Section 179. For 2026, businesses can deduct up to $2,560,000 in qualifying equipment and software purchases this way, with the deduction phasing out once total qualifying purchases exceed $4,090,000. Many businesses pair Section 179 with 100% bonus depreciation, which currently applies to qualifying property placed in service after January 19, 2025, to maximize first-year write-offs.
...
Manage your business spend with Rippling
...
[Form 1120](https://www.irs.gov/forms-pubs/about-form-1120) **.** Corporations use this form to report income or losses and claim credits or deductions.


-


[Form 1120-S.](https://www.irs.gov/forms-pubs/about-form-1120-s) LLCs that elect S-corporation taxation use this form to report income, deductions, and credits, then pass results through to owners via Schedule K-1.


-


[Form 1065.](https://www.irs.gov/forms-pubs/about-form-1065) Multi-member LLCs, also known as partnerships, use this form to provide the IRS with information about income and claim deductions.


-


[Schedule C.](https://www.irs.gov/pub/irs-pdf/f1040sc.pdf) Sole proprietor LLCs don’t need to complete a separate business tax return. Instead, business owners attach this form to their personal tax returns to report business expenses and self-employment tax deductions.
...
## Special considerations for LLC expenses


The Corporate Transparency Act technically still requires beneficial ownership information (BOI) reporting, but in March 2025, FinCEN issued a rule exempting all US-formed companies — including LLCs — and their owners from this requirement. Only foreign entities registered to do business in the US currently have to file BOI reports with FinCEN. If you already filed a BOI report as a domestic LLC, you don’t need to update or correct it. Because FinCEN has signaled it may revisit this exemption, it’s worth keeping your ownership records organized in case reporting requirements change again.


## How to manage LLC expenses


Effective[spend management](https://www.rippling.com/blog/spend-management) not only supports your LLC’s financial health, it streamlines tax preparation, too. By categorizing expenses and[tracking](https://www.rippling.com/blog/small-business-expense-tracking) them accurately, you’re better positioned to spot opportunities to claim deductions and reduce your taxable income.
...
Setting clear expectations around allowable expenses,[reimbursements](https://www.rippling.com/blog/employee-reimbursement) , and documentation requirements can help control employee spending and simplify tax preparation. Depending on the size of your business, you may need to set multiple[expense policies](https://www.rippling.com/blog/expense-policy) for different departments or roles within your organization.


### 3. Implement expense tracking software


Using[spend management software](https://www.rippling.com/blog/how-to-manage-business-finances) can simplify how your company tracks spending and help with monitoring expenses for each part of the business. Understanding where and when your business makes major purchases can help you plan effectively or implement control measures.


## Rippling Spend: easy expense management for your LLC


[Rippling Spend](https://www.rippling.com/rippling-spend) consolidates corporate cards, expense management, bill pay, and travel — giving you an up-to-date view of cash flow across your company and offering unprecedented control over spending patterns.


While most expense management solutions only allow for basic employee-manager approval chains, with Rippling Spend's[expense management software](https://www.rippling.com/expense-management) advanced policy engine, you can set hyper-custom policies based on the vendor, dollar amount, and expense category, helping you easily block out-of-policy expenses. You can also tee up automated workflows that help you control spend, like triggering an alert when a department’s expenses sharply increase.


Expense claims, receipts, and reimbursements are neatly organized and recorded in a[general ledger](https://www.rippling.com/blog/how-does-a-general-ledger-work) and other accounting systems, giving your LLC compliant documentation at the ready if the IRS or other regulatory agencies come knocking.
...
What's the difference between filing taxes as a single-member LLC vs. a multi-member LLC?


A single-member LLC is taxed as a sole proprietorship by default, meaning the owner reports business income and expenses on Schedule C of their personal tax return. A multi-member LLC is taxed as a partnership by default, filing Form 1065 to report income and deductions, then issuing each member a Schedule K-1 to report their share on their personal return. Either type can elect corporate taxation instead.


Can I deduct mileage for my LLC?


Yes, business use of a vehicle can be deducted using either the standard mileage rate or the actual expense method. The IRS sets a standard mileage rate each year that covers gas, maintenance, and depreciation in a single per-mile figure; the actual expense method instead deducts the business-use percentage of fuel, repairs, insurance, and depreciation. You must choose one method and keep a mileage log to support whichever you use.


Can I deduct expenses I paid before officially forming my LLC?


Generally no. You can't deduct costs incurred before you've made a specific decision to start a particular business, since the IRS treats general idea exploration as a personal expense. Once you've committed to forming the LLC, qualifying startup costs like legal fees, market research, and filing fees become deductible (up to $5,000 immediately, with the remainder amortized) even if you pay them before the LLC is officially registered.


What's the difference between Form 1120, Form 1065, and Schedule C for an LLC?


Form 1120, Form 1065, and Schedule C all report business income and deductions, but they apply to different LLC tax statuses. Form 1120 is for LLCs that elect to be taxed as a C-corporation, where the business itself pays tax on its income. Form 1065 is for multi-member LLCs taxed as partnerships, which file an informational return and pass income through to members via Schedule K-1. Schedule C is for single-member LLCs taxed as sole proprietorships, attached directly to the owner's personal Form 1040.
