...
document_id: "ed24eeab320023a1daa22365c81e1f84264036fe6f247640204ca5a6788415aa"
company_key: "yc-empirical-health"
company: "Empirical Health"
source_id: "yc-empirical-health-news-import-485d82c6bcdb"
canonical_url: "https://www.empirical.health/blog/pcsk9-inhibitor-insurance-coverage/"
published_at: "2026-06-10T00:00:00+00:00"
first_seen_at: "2026-07-21T18:04:02.816963+00:00"
fetched_at: "2026-07-28T21:54:56.147054+00:00"
content_hash: "sha256:37fdedbb0569f4b6dec7f1e9fdf11b5dd284636f0aa24ee6609ca6cd14390bf0"
---
...
PCSK9 inhibitors lower LDL cholesterol by an[additional 45% to 64% on top of a statin](https://www.lipid.org/sites/default/files/nla_non-statin_tear_sheets_pcsk9_inhibitors_v2_042025.pdf) , and they cut heart attacks and strokes. PCSK9 inhibitors are also expensive, so insurers wrap them in prior authorization. In one study,[between 82% and 97% of patients](https://www.ahajournals.org/doi/10.1161/circoutcomes.117.003939) needed a prior authorization, and many were denied on the first try. That reputation scares people off a drug that could help them.


I analyzed coverage rules for PCSK9 inhibitors across most major insurers: UnitedHealthcare, Aetna, Cigna, Anthem, and the Blue plans. Roughly 80% of the criteria for PCSK9 inhibitors are identical between insurers. This post starts with what these drugs actually cost, then walks through what every insurer requires for PCSK9 inhibitors, the handful of places carriers differ, how Medicare and Medicaid handle these drugs, and the specific gaps that get people denied. Coverage rules are about to get more interesting: the[FDA approved the first oral PCSK9 inhibitor (Lipfendra) on July 16, 2026](https://www.empirical.health/blog/oral-pcsk9-inhibitor-lipfendra) , and insurers are likely to wrap the pill in the same prior authorization they use for the injections until it earns its own formulary spot.


*Four gates show up in almost every PCSK9 policy. Carrier-specific rules sit on top of these.*


## PCSK9 inhibitor price


The list price of a PCSK9 inhibitor is[about $6,900 a year](https://www.goodrx.com/repatha) . That number is roughly the same for all three drugs. Repatha (evolocumab) and Praluent (alirocumab) both list around $6,900 a year,[down from about $14,000 at launch](https://www.tctmd.com/news/alirocumab-price-cut-makes-second-pcsk9-inhibitor-more-affordable) after 60% price cuts in 2018 and 2019. Leqvio (inclisiran) runs[about $3,250 per dose](https://www.tctmd.com/news/pricey-inclisiran-rolling-out-buy-and-bill-model-may-smooth-its-path) , given twice a year, for a similar annual total.


Almost nobody pays the list price. What you actually pay depends on your coverage. The clearest example is Medicare, because it now has a hard cap.


### PCSK9 inhibitor cost on Medicare


A PCSK9 inhibitor sits on a Part D specialty tier, so you pay a percentage of the cost rather than a flat copay. For years that share was open-ended, and a bad stretch could run hundreds of dollars a month. That changed in 2025. Medicare Part D now caps your total out-of-pocket drug spending at[$2,100 in 2026](https://www.empirical.health/blog/medicare-glp1-coverage/) .


So the practical answer for a Medicare patient: the list price is about $6,900 a year, but you pay at most $2,100 out of pocket in 2026. That cap covers all of your Part D drugs combined, not just the PCSK9 inhibitor, so if you already take other expensive medications the PCSK9 inhibitor may add little once you hit it. You can also spread the $2,100 into level monthly payments through the Medicare Prescription Payment Plan.


If you have commercial insurance, the brand antibodies often come with a manufacturer copay card (Repatha and Praluent both advertise as little as $5 a month for eligible commercially insured patients; copay cards are not allowed on Medicare). And if you are paying cash, Amgen sells Repatha direct for[about $239 a month](https://www.goodrx.com/repatha) , roughly $2,900 a year.
...
Yes. There is no single national Medicare rule for PCSK9 inhibitors. Instead, each Part D drug plan sets its own prior authorization criteria, which closely mirror the commercial criteria above. About[97% of Part D plans require prior authorization](https://medicareagentshub.com/articles/does-medicare-cover-repatha) , and PCSK9 inhibitors almost always sit on a specialty tier.


For years, the real Medicare barrier was not the clinical rules, it was cost. That changed in 2025, when Part D capped annual out-of-pocket spending at $2,100 (in 2026), removing the open-ended bills that used to push beneficiaries off these drugs. SeePCSK9 inhibitor cost on Medicare above for what that means in dollars.
...
Prior authorization across US payers (AHA)[ahajournals.org](https://www.ahajournals.org/doi/10.1161/circoutcomes.117.003939)


National Lipid Association PCSK9 patient sheet[lipid.org](https://www.lipid.org/sites/default/files/nla_non-statin_tear_sheets_pcsk9_inhibitors_v2_042025.pdf)


UnitedHealthcare commercial Praluent policy[uhcprovider.com](https://www.uhcprovider.com/content/dam/provider/docs/public/prior-auth/drugs-pharmacy/commercial/h-p/PA-Med-Nec-Praluent.pdf)


Aetna inclisiran (Leqvio) policy, CPB 1004[aetna.com](https://www.aetna.com/cpb/medical/data/1000_1099/1004.html)


Cigna Repatha prior authorization policy[cigna.com](https://static.cigna.com/assets/chcp/pdf/coveragePolicies/cnf/cnf_605_coveragepositioncriteria_proprotein_convertase_subtilisin_kexin_type_9_inhibitors_repatha_pa.pdf)


Anthem/Elevance PCSK9 clinical criteria[anthem.com](https://files.providernews.anthem.com/5333/CC-0010-PCSK9-Inhibitor-(final).pdf)


Blue Shield of California Repatha policy[blueshieldca.com](https://www.blueshieldca.com/content/dam/bsca/en/provider/docs/2023/January/PRV_MP_Evolocumab_Repatha.pdf)


---


*This post is part of our series on heart health and coverage. See also:[PCSK9 inhibitors explained](https://www.empirical.health/blog/pcsk9-inhibitors) ,[Medicare coverage of cardiovascular medications](https://www.empirical.health/blog/medicare-cardiovascular-medications) , and[how to lower ApoB](https://www.empirical.health/blog/how-to-lower-apob) .*


**Whether you qualify for a PCSK9 inhibitor comes down to your numbers.** Empirical Health's[heart health panel](https://www.empirical.health/product/heart-health-panel?utm_source=pcsk9_coverage_blog) measures LDL, ApoB, Lp(a), and the other markers your doctor needs to build a prior authorization that holds up.
