...
document_id: "5c145479ce7a787822374e6e7f78a8a802e9066486b96ca6d69ecefcea4e39a6"
...
canonical_url: "https://www.servicetitan.com/blog/how-to-calculate-percentage-of-completion-method"
published_at: null
first_seen_at: "2026-08-11T03:44:35.960281+00:00"
fetched_at: "2026-08-11T03:44:36.668847+00:00"
content_hash: "sha256:017508556d3219d7d1844071acb62f8589e821d33782dad463888b94eb27eb2a"
---
...
The most common approach for calculating percent complete in[construction accounting](https://www.servicetitan.com/blog/construction-billing-methods) is the cost-to-cost method. This is also the method ServiceTitan uses for its revenue recognition calculations.
...
`` (recognized revenue) = Percent complete × Total contract amount (contract price)`


` **Gross profit recognized**


`` = Revenue earned − Costs incurred to date`


A worked example makes this concrete.


Say you're a mechanical contractor with a commercial HVAC installation. The total contract amount is $500,000. Your estimated total cost to complete the job is $375,000. Three months in, you've incurred $150,000 in actual costs (labor,[materials](https://www.servicetitan.com/blog/construction-materials-tracking) ,[equipment](https://www.servicetitan.com/blog/construction-equipment-types) , subcontractor charges).
...
One detail that trips people up is the denominator in the percent complete formula. You're not dividing by the *original*


budgeted cost. You're dividing by the *forecasted total cost*


, which is your costs incurred to date plus your estimated cost to complete the remaining work.
...
`` = Costs incurred to date + Forecasted cost to complete`
...
The project manager or controller pulls up a spreadsheet — sometimes one per project, sometimes a master WIP schedule — and starts updating numbers. Actual costs come from the accounting system, but they need to be reconciled against[purchase orders](https://www.servicetitan.com/templates/construction/purchase-order) that haven't been received yet,[subcontractor invoices](https://www.servicetitan.com/templates/construction/subcontractor-invoice) that haven't arrived, and labor costs that haven't been posted. Some of those numbers are in the ERP or project management software. Some are in email threads. Some are in someone's head.
...
[Change orders](https://www.servicetitan.com/templates/construction/change-order) are another weak point. A change order affects the contract price, the estimated total cost, and potentially the scope and timeline. In a spreadsheet-based process, someone needs to update the contract value, update the cost estimate, and make sure the revised numbers flow through to the percent complete calculation. If the change order gets approved in the field but doesn't make it into the spreadsheet until next month, that month's WIP report is wrong.
...
The compounding problem is that **these inaccuracies aren't isolated**


. An outdated cost to complete on one project affects your total recognized revenue, which affects your gross profit, which affects your financial reporting across the business. Multiply that by 20 or 40 projects and the cumulative error can be material.
...
The[WIP (Work in Progress) report](https://help.servicetitan.com/docs/work-in-progress-wip-report-1) in ServiceTitan is the central tool for percentage of completion reporting. You set a project start date and an "as of" date, run the report, and it generates a line for every active project with the full picture:
...
*For a downloadable WIP schedule template you can use in the meantime, check out our free*


[construction WIP schedule template](https://www.servicetitan.com/templates/construction/wip-schedule) *.*
...
Maybe you're anticipating[cost overruns](https://www.servicetitan.com/blog/construction-overruns) on a specific phase that haven't hit the books yet. Maybe the remaining work will come in under budget because you found a better material supplier. Either way, you can[manually adjust the cost to complete](https://help.servicetitan.com/v1/docs/edit-cost-to-complete) , and the override flows directly into the WIP calculation. Both the custom and default values stay visible, so you can always see the gap between the formula's output and the project manager's judgment.
...
ServiceTitan's project label system lets you build a hierarchy of cost categories — labor, materials, subcontractors, equipment — and map them to your pricebook items, job types, and technicians. Those labels carry through to the[Budget vs. Actual](https://www.servicetitan.com/templates/construction/budget-vs-actual) table on every project, so you can drill into exactly where you're over or under budget at any level of detail.
...
Because ServiceTitan handles[progress billings](https://help.servicetitan.com/roofing/docs/progress-billing-overview-and-setup) and[payment applications](https://www.servicetitan.com/templates/construction/subcontractor-application-for-payment) in the same platform where your costs and revenue recognition live, there's no reconciliation gap between what you've billed and what your WIP report shows as recognized revenue. Your[schedule of values](https://www.servicetitan.com/templates/construction/subcontractor-schedule-of-values) , completed work, and approved change orders all feed into the billing workflow, and the billing data feeds back into the WIP report.
...
ServiceTitan's WIP reporting and[project management tools](https://www.servicetitan.com/blog/construction-project-management-app) were built for contractors running this exact process across multiple long-term projects.


If you're interested in exploring other specific features and functionality, start by visiting our main[construction software page](https://www.servicetitan.com/market/construction-software) .


*For a more detailed look at how ServiceTitan can support you,*


[schedule a call](https://www.servicetitan.com/demo) *for a live walk-through tailored to your business.*
