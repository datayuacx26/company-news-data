...
document_id: "84d721bb5a3a058068ac4e1e72527fafa82c09ec64d27c3483c8f3174df52277"
company_key: "yc-posthog"
company: "PostHog"
source_id: "yc-posthog-rss-39b8c8c5a5d1"
canonical_url: "https://posthog.com/blog/multi-modal-llm-user-behavior-analysis"
published_at: "2025-12-03T00:00:00+00:00"
first_seen_at: "2026-07-20T23:20:52.157750+00:00"
fetched_at: "2026-07-28T21:58:33.663804+00:00"
content_hash: "sha256:6f3535d773cf1f6a3831ab09bf00d452d6bf176bb7dff282dc8af433d7c8e214"
---

# How we built user behavior analysis with multi-modal LLMs (in 5 not-so-easy steps)

Organizing fantastic amounts of data


# How we built user behavior analysis with multi-modal LLMs (in 5 not-so-easy steps)


- [Alex Lebedev](https://posthog.com/community/profiles/33371)
...
PostHog captures a lot of user behavior data — the pages people visit, the buttons they click, and everything in between, all captured as events and[session recordings](https://posthog.com/session-replay)


. By “a lot,” I mean billions of events and terabytes of S3 snapshots. Watching those sessions is incredibly useful for understanding how products are actually used, but there’s an obvious problem: there are far too many to review manually.


So, we created a tool to watch and analyze user sessions. It highlights the issues - so you can find what's broken without watching hundreds of hours of recordings yourself. It's called[Session Summaries](https://posthog.com/docs/posthog-ai/session-summaries)


, **we release it in beta today** . You can use it right now, for free, with PostHog AI.


In this post, I'll walk through what we learned through the process of building it, where we messed up, and lots of practical tips on how to make user behavior analysis work in production. All the code is[open-source](https://github.com/PostHog/posthog)


, and here's a 36-second demo of how it works:
...
Carefully select what data goes into the pipeline
...
Here's how you can get a summary of a single session from chat, or Replay player
...
- We programmatically pre-filter events that look like[exceptions](https://posthog.com/docs/error-tracking/issues-and-exceptions)


, especially if one causes multiple others as an avalanche, and they create a context that LLM can't ignore. For example, drop all JS exceptions that aren't API errors.
...
You can check the pattern based on severity and issue types
...
**Our approach:** We use a four-phase pipeline instead of a single prompt:
...
Temporal workflow logic on a small sample of sessions
...
Session Summaries are available now in free, public beta. So, if you want to check our findings above, give it a try. Just ask[PostHog AI](https://posthog.com/blog/8-learnings-from-1-year-of-agents-posthog-ai)


to summarize your sessions. Worst case: you’ll notice where we messed up. Best case: you’ll learn something useful about your users and your product.
...
P.S. If you are still reading and find it interesting, we're hiring[AI Product Engineers](https://posthog.com/careers/ai-product-engineer)


. We have tons of ideas to ship, and we'd love to hear yours.
