...
document_id: "141544c3dda1ef7978f9df45d9fe6de3b08d646b6d5f3051db4ab0f3c86fad6a"
company_key: "yc-posthog"
company: "PostHog"
source_id: "yc-posthog-rss-39b8c8c5a5d1"
canonical_url: "https://posthog.com/blog/transparent-enterprise-pricing"
published_at: "2022-06-01T00:00:00+00:00"
first_seen_at: "2026-07-20T23:20:52.157750+00:00"
fetched_at: "2026-07-28T21:03:24.473366+00:00"
content_hash: "sha256:48e2a4fc67fae04a2a23830944610739e0b68660e3a9fd671c1d6feb35ed20ed"
---
...
Even if you're deemed worthy enough for a sales rep to call you, it's likely you still won't find out the price until you've answered a *lot* of questions.
...
For those new to PostHog, it's an all-in-one product analytics suite that replaces siloed tools for[product analytics](https://posthog.com/product#product-analytics)


,[Session Recording](https://posthog.com/product/session-recording)


,[Feature Flags](https://posthog.com/product/feature-flags)


, and Experimentation. It's open source and you can host it yourself, giving you complete control over your data – we have a Cloud version too if that's your thing.


As an open-source business, we put great value in transparency. We make our processes, policies, team structure – even[how we pay people](https://posthog.com/handbook/people/compensation)


– available for anyone to read in our[company handbook](https://posthog.com/handbook)


, and the vast majority of our comms is visible for anyone to read on[our GitHub repo](https://github.com/PostHog/posthog/issues)
...
There are three options for[self-hosting PostHog](https://posthog.com/pricing)
...
People expect self-hosted deployments to be cheaper than PostHog Cloud as they incur the additional infrastructure costs.
...
Developing and supporting a self-hosted platform is more complex than a traditional SaaS offering (and we offer both)


2.


We are willing to invest a significant amount of our time in ensuring our large, self-hosted deployments are tuned effectively so customers have the best PostHog experience possible.
...
If all this talk of self-serving and automation isn't for you then don't worry – you can still always[contact sales](https://posthog.com/talk-to-a-human)


. We love hearing from our customers, but it's your choice when you do.
