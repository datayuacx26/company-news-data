...
document_id: "01c87bb9671718b71e761cf28fcc5daef8a9e20ac5cf6861c0bbe9917aca74fd"
company_key: "yc-posthog"
company: "PostHog"
source_id: "yc-posthog-rss-39b8c8c5a5d1"
canonical_url: "https://posthog.com/blog/experiments"
published_at: "2022-03-23T00:00:00+00:00"
first_seen_at: "2026-07-20T23:20:52.157750+00:00"
fetched_at: "2026-07-28T21:04:01.772019+00:00"
content_hash: "sha256:11fee663376323b6aa812c1a42a9aeb30dc11c5c5f8860f35eaaf680bba1dafd"
---
...
- [Neil Kakkar](https://posthog.com/community/profiles/28695)
...
It was a no brainer product decision: Since you're already analysing your data in PostHog, and you're already using[Feature Flags](https://posthog.com/product/feature-flags)


to roll out new features, why not have the capability to test how well these features are doing? Plus, what is the world without a[great open-source A/B testing tool](https://posthog.com/blog/best-open-source-ab-testing-tools)
...
It's a powerful tool for building great products, but that's enough about how experiments work for now. If you're interested in the technical details, check out the[Experimentation user guide](https://posthog.com/docs/user-guides/experimentation)
...
> This article is Chapter III in our[A Universe of New Features launch week](https://posthog.com/blog/launch-week-universe-of-new-features)
>
>
> series
...
Another advantage of local metrics over global is that it can be hard to reliably move global metrics2


. Local metrics allow you to see changes faster, since they're narrower in scope, and thus move quicker.
...
To answer the why, you need to talk through the causes.[Create hypotheses about why this is happening](https://neilkakkar.com/Bayes-Theorem-Framework-for-Critical-Thinking.html)


, watch user session recordings, and then make a call about what you want to do.
...
To solve the Taking-action-without-enough-information problem, we made it clear in our UI when it was okay to end an experiment. Specifically, this is when results become significant, or the pre-determined duration for peeking has passed.1


This changed the conversation from 'peeking early and ending experiment if results look good' to 'waiting for the green light to switch on', and led to an overall much better experience.


That's all for this post, we'd love to have you start your own experiments and tell us what you learn. Feel free to open an issue in[our Github repo](https://github.com/PostHog/posthog)


, join us directly for a[call](https://calendly.com/posthog-feedback)


with our Product & Engineering team, or[submit a ticket](https://app.posthog.com/home#supportModal)
...
1. Depends a lot on how big and mature your product is, and how many sub features it has. If there's only one thing the app does, the local metric is the global metric.↩


2. A bit contrived, but easier to keep this blogpost manageable without explaining the ins and outs of PostHog graphs :). Also, don't tell our designer, they'll scream if they hear about this design revamp.↩


3. If you're looking for how we calculate this, see the[user guide](https://posthog.com/docs/user-guides/experimentation)
