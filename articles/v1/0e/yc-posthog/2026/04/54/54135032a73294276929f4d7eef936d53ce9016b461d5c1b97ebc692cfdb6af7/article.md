...
document_id: "54135032a73294276929f4d7eef936d53ce9016b461d5c1b97ebc692cfdb6af7"
company_key: "yc-posthog"
company: "PostHog"
source_id: "yc-posthog-rss-39b8c8c5a5d1"
canonical_url: "https://posthog.com/blog/your-lifecycle-emails-are-wrong"
published_at: "2026-04-14T00:00:00+00:00"
first_seen_at: "2026-07-20T23:20:52.157750+00:00"
fetched_at: "2026-07-28T22:00:13.771809+00:00"
content_hash: "sha256:aa21667dd9be754c5dd693fdb86f54c4534ae55bfc8cd20b5a252737b23098fc"
---
...
Most teams build their messaging stack early, when[event tracking](https://posthog.com/blog/events-you-should-track-with-posthog)


is still basic. Signup event, maybe a key action or two. So the sequences were time-based, because that was all you could reliably trigger on. Day 1 welcome. Day 3 nudge. Day 7 check-in. It shipped, it ran, and it was good enough.


Then the product got more instrumented. Feature usage,[activation](https://posthog.com/newsletter/wtf-is-activation)


milestones, plan changes – all of it flowing into the analytics tool. But the sequences kept running on the old architecture, because the open rates looked acceptable and there was always something more urgent.
...
The deeper problem is that you're running behavioral logic in a tool that doesn't have the data to evaluate it properly.[Evan Rallis from Grantable](https://posthog.com/customers/grantable)


– who'd rebuilt complex production automation on Zapier and Make before moving to[PostHog Workflows](https://posthog.com/workflows)
...
[Jorge López at Croissant](https://posthog.com/customers/croissant)


, who'd used Zapier, Windmill, and most of the alternatives, made the same observation from a different angle:
...
And you can finally measure whether your sequences are working – not just open rates and clicks, but whether users who entered a flow actually did the thing. (If you need a framework for what to measure, start with[product engagement](https://posthog.com/blog/how-to-measure-product-engagement)


.) Because the data for measuring it lives in the same place as the data that triggered it.
