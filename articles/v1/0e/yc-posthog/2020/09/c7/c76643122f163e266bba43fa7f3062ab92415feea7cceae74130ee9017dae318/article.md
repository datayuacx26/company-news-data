...
document_id: "c76643122f163e266bba43fa7f3062ab92415feea7cceae74130ee9017dae318"
company_key: "yc-posthog"
company: "PostHog"
source_id: "yc-posthog-rss-39b8c8c5a5d1"
canonical_url: "https://posthog.com/founders/remote-culture"
published_at: "2020-09-01T00:00:00+00:00"
first_seen_at: "2026-07-20T23:20:52.157750+00:00"
fetched_at: "2026-07-28T21:05:18.773660+00:00"
content_hash: "sha256:3b2c14b953cb4173b9078fd7dee54dc1d0bcdc3855bb5ccc5d8ddc9e2e17b4d0"
---
...
- [Founders](https://posthog.com/founders/founders)


,
- [Culture](https://posthog.com/founders/culture)


,
- [People](https://posthog.com/founders/people)
...
[Communication is perhaps the single most important value](https://posthog.com/blog/ceo-diary-6)


for us at PostHog. In our view, getting this right is essential to running an all-remote company successfully. As such, we highly value the following concepts:
...
We also don't send internal emails. Zero, zilch, *nada* . 99% of the time, we're talking on GitHub, Slack, or a call. We also mostly use Slack for non-work-related, private, and more urgent conversations. If it doesn't fit one of those categories, chances are it could be on GitHub.
...
As such, when someone needs some info, they don't need to message a team member to get what they need. They can just find it immediately. We extend this concept quite deeply, having our entire[Company Handbook](https://posthog.com/handbook)


public, which outlines things like how we do sales calls, our approach to talking to investors, and how we hire people. As such, if there's ever a question about how we operate as a company, referring to the handbook will usually get you the answer.
...
For this reason, we believe in asynchrony, as mentioned before, but also the concept of[shipping whenever](https://posthog.com/blog/we-ship-whenever)
...
At PostHog, on a small scale, this means not waiting for our designer to make an amazing blog illustration to put our a new post, or waiting for QA to change a typo on the website. On a larger scale, it can also mean not waiting for a feature to be perfect to launch it to our users. The[PostHog Toolbar](https://posthog.com/docs/user-guides/toolbar)
...
The idea is, if you find a bug that needs fixing, or want to build a new feature, if you can do it without much work, you should just do it. Rather than opening a ticket for someone else to handle, just pick it up on the spot and fix it.
...
This can mean[discussions about what a "biscuit" is](https://www.youtube.com/watch?v=8EUSPmz6n-E)


, as well as having a team member run a call with a customer because they share a native language.
