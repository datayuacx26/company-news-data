...
document_id: "beca8bff9e00dbc396cdb7f033564f44e6d938d854135faafa5330a2012ef6f1"
company_key: "yc-unify"
company: "Unify"
source_id: "yc-unify-rss-3d614756e1ae"
canonical_url: "https://unifyai.substack.com/p/the-deep-dive-issue-30"
published_at: "2024-06-20T16:09:45+00:00"
first_seen_at: "2026-07-24T05:11:59.311365+00:00"
fetched_at: "2026-07-28T22:01:08.511319+00:00"
content_hash: "sha256:3cc18ccc449cf79a74ac99845fd260eb189a34708fe0b56fffc36c9fb4d18069"
---
...
*Visual representation of back-propagation-based editing using textual feedback. Source: [Original Paper](https://arxiv.org/pdf/2406.07496)*
...
[repository](https://github.com/zou-group/textgrad) to get started.


[Share](https://unifyai.substack.com/p/the-deep-dive-issue-30?utm_source=substack&utm_medium=email&utm_content=share&action=share)
...
LLMs are good at generating text, there is debate about whether they can reason or plan like humans. The


[LLM-Modulo Framework](https://arxiv.org/pdf/2402.01817) investigates if LLMs can create workable plans on their own and verify their correctness.
...
To study if LLMs can learn to engage in increasingly sophisticated forms of specification gaming, the


[paper](https://arxiv.org/pdf/2406.10162) discusses a series of tests on increasingly complex gameable environments. At first, the tasks are simple, like tailoring an answer based on the user's political views (sycophancy). As the scenarios progress, the tasks require more cunning, like inflating the rating of a user's poem and even modifying a checklist to make it seem like tasks were completed.
...
**One model to teach them all -** NVIDIA has released


[Nemotron-4 340B](https://blogs.nvidia.com/blog/nemotron-4-synthetic-data-generation-llm-training/) , a family of open-source models designed to generate synthetic data for LLMs. The Nemotron-4 340B family is optimized for use with NVIDIA NeMo and TensorRT-LLM, allowing developers to fine-tune and optimize their models for specific use cases and domains.


**Seeking assistance -** DeepSeek, has released


[DeepSeek Coder V2](https://venturebeat.com/ai/chinas-deepseek-coder-becomes-first-open-source-coding-model-to-beat-gpt-4-turbo/) , an open-source code LLM outperforming closed-source models like GPT-4 Turbo in coding and math tasks. It supports over 300 programming languages and boasts a larger context window to handle complex coding projects. The model is available under the MIT license, allowing for both research and commercial use.


**Deeply productive -** Google DeepMind, is transitioning from a research-focused lab to an


[AI product factory](https://www.bloomberg.com/news/articles/2024-06-17/google-deepmind-shifts-from-research-lab-to-ai-product-factory) in response to growing competition from companies like OpenAI and Microsoft. This shift, which involves merging Google Brain and DeepMind, aims to accelerate the development of commercial AI products while maintaining foundational research.
