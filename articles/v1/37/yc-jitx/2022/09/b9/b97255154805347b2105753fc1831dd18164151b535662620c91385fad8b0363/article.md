...
document_id: "b97255154805347b2105753fc1831dd18164151b535662620c91385fad8b0363"
company_key: "yc-jitx"
company: "JITX"
source_id: "yc-jitx-news-import-ca0082c4ce50"
canonical_url: "https://blog.jitx.com/jitx-corporate-blog/jitx-series-a-announcement"
published_at: "2022-09-18T23:14:00+00:00"
first_seen_at: "2026-07-22T00:57:30.944798+00:00"
fetched_at: "2026-07-28T21:33:46.196319+00:00"
content_hash: "sha256:6c8c2055b2f0badddf9b6a5765ca0318574a866940ff9f3901dae95933a91bac"
---

# JITX Launches General Availability and Announces Series A from Sequoia Capital
...
and that we raised a $12M Series A round, led by Sequoia Capital, with participation from Y Combinator, Funders Club and Liquid 2.


JITX lets electrical engineers write code to design circuit boards.


Circuit boards are in every piece of electronics you have ever owned from your smartphone to your car, and are designed today by the determined efforts of expert electrical engineers. Unfortunately, the deck is increasingly stacked against these engineers.


[The component shortage](https://spectrum.ieee.org/chip-shortage-rewiring-tech)


is causing engineers to redesign products to accommodate available parts. Adding to the complexities, systems are getting harder to design, and experts are retiring and not being replaced.
...
A small design turning JITX code into a board design


The engineers we talk to want automation that increases quality and lets them go faster. Everyone knows that they could be designing better, but today they find their days occupied by busywork that could have been avoided if they had the right tools to lean on. For example, one of our customers wrote about


[how they used JITX to reduce the risk of hardware development](https://www.geocene.com/tech/hardware/2022/05/03/coding-up-an-iot-pcb-design) .
...
We started JITX by dogfooding our tools. We took on circuit board design work from real customers and used JITX to create custom hardware for them. We did projects like building hardware for this


[OpenAI experiment](https://openai.com/blog/solving-rubiks-cube/) :
...
The JITX UI guiding import of an existing design


We started a database of components to automate bill of materials optimization, and design checking.


Adding an STM32 microcontroller from the part database
...
Reusable code created from an Altium schematic


Today we are launching the general availability of JITX for professional engineers. You can sign up to get started with the product


[here](https://www.jitx.com/) . And if you are as excited about JITX as we are and interested in joining our team, you can check out our open roles


[here](https://www.jitx.com/careers) .
