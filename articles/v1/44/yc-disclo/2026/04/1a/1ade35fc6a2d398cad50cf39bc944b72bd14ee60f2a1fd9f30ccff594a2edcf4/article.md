...
document_id: "1ade35fc6a2d398cad50cf39bc944b72bd14ee60f2a1fd9f30ccff594a2edcf4"
company_key: "yc-disclo"
company: "Disclo"
source_id: "yc-disclo-news-import-6f0f92e02a2c"
canonical_url: "https://www.disclo.com/resources/accommodation-process-hr-worst-administrative-nightmare"
...
content_hash: "sha256:7a70996fa282cf0686a34ba2e1b4e84baa96ff95352a642b580dd3b4f3ec8276"
---

# The Accommodation Process Is One of HR's Worst Administrative Nightmares. It Doesn't Have To Be.

We were inspired by a recent issue of Hebba Youssef’s[‘I Hate It Here’ newsletter](https://hateithere.co/) from earlier this week. The gist of it went something like this:
...
## **What accommodations actually cost HR**


An employee reaches out. They need an accommodation — modified schedule, ergonomic equipment, remote work, something. From that moment, the HR team is legally required to engage in an “[interactive process](https://www.disclo.com/resources/interactive-process-template-ada-accommodations) ” — a documented, good-faith dialogue to find a reasonable accommodation. The ADA requires it. Doing it badly creates real legal exposure.
...
- An email chain starts. Then another. They're not connected.
- Medical documentation is requested. Weeks of back-and-forth with the employee’s healthcare provider ensue. It finally arrives somewhere — a shared drive, an inbox, a folder someone made in 2021 called “ADA stuff.”
- HR reviews the documentation. Nobody trained them for this.
- A decision gets made. It might be documented. It might not.
- The employee follows up six times because nobody told them what was happening.
- Three months later, legal asks for the case file. HR sends seventeen emails and a prayer.
...
## **This is exactly what Disclo is built for.**


Here's what the process looks like when it runs through Disclo:


- The employee submits their request through a guided intake process focused on functional limitations and work impact — no diagnosis required, no PHI flowing to the case manager.
- The case manager gets a clean dashboard: what's been requested, what the employee described, where the case stands.
- If medical verification is needed, it's triggered with a click. Disclo's verification team handles provider outreach, documentation collection, and clinical review — the case manager receives only a non-confidential summary.
- Every interaction, note, and decision is logged automatically. The interactive process is documented as it happens, not reconstructed after the fact.
- The employee receives automated updates throughout. Periodic check-ins go out automatically once an accommodation is approved.
- Leave as an accommodation or return-to-work accommodations? We can do those too, and we’ll work with your leave provider to ensure a seamless experience.
