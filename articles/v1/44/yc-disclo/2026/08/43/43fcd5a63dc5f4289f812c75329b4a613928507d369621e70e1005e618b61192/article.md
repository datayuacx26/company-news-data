...
document_id: "43fcd5a63dc5f4289f812c75329b4a613928507d369621e70e1005e618b61192"
company_key: "yc-disclo"
company: "Disclo"
source_id: "yc-disclo-news-import-6f0f92e02a2c"
canonical_url: "https://www.disclo.com/resources/how-gen-z-is-changing-workplace-accommodations"
published_at: "2026-08-17T00:00:00+00:00"
first_seen_at: "2026-08-17T22:26:26.408502+00:00"
fetched_at: "2026-08-17T22:26:27.090014+00:00"
content_hash: "sha256:974929a4e6169e87e096384eaa8f31de71fe8c676ea8c5b0c172f899204b04a3"
---

# How Gen Z Is Changing Workplace Accommodations

Earlier this month, Disclo’s co-founder[Hannah Olson](https://www.linkedin.com/in/hanrosols/) spoke at the[DMEC Annual Conference](https://dmec.org/conferences-and-webinars/annual-conference-presentations/) about a shift nearly every leave and accommodations professional is beginning to experience: Gen Z is changing not only ***what*** employees expect from work, but ***how*** they understand their rights, advocate for support, and navigate workplace accommodation processes.
...
## **Gen Z has been practicing self-advocacy for years**


This is not a future workforce trend. Gen Z has already overtaken Baby Boomers as a share of the U.S. workforce, and the[Bureau of Labor Statistics projections](https://www.bls.gov/opub/mlr/2021/article/projections-overview-and-highlights-2020-30.htm#:~:text=Between%202020%20and%202030%2C%20the,of%20165.4%20million%20in%202030.) estimate that the generation will represent roughly 30% of the workforce by 2030.
...
## **They arrive well-researched (and sometimes AI-assisted)**
...
A[2025 survey](https://www.shrm.org/topics-tools/news/how-social-media-is-redefining-job-hunting-gen-z) cited in the presentation found that 92% of Gen Z respondents trusted TikTok for career advice. At the same time, 55% said they had followed workplace advice that later turned out to be misleading.
...
## **The requests themselves are changing**
...
Gen Z reports high levels of anxiety and greater engagement with mental health care than previous generations.[Gallup data](https://www.gallup.com/analytics/506663/american-youth-research.aspx) found that approximately 47% of Gen Z often or always feel anxious, while roughly 39% report having worked with a mental health professional.
...
## **Why the “difficult employee” label creates risk**
...
## **Four pressures on accommodation programs today**
...
1. **Volume is increasing:** We all know that accommodation requests are rising. More employees are willing to disclose conditions and request support, often earlier in the employment relationship. But intake itself is only part of the workload. Much of the administrative burden comes afterward: status questions, anxious check-ins, and repeated follow-up when employees cannot see what is happening with their request.
2. **Documentation expectations are changing:** Employers are no longer simply trying to extract enough information from reluctant employees. Increasingly, employees arrive with documentation and their own understanding of what an employer is permitted to request. Teams need to know the actual standard rather than relying on forms or practices simply because “that is how we have always done it.”
3. **Cases are becoming more complex:** Episodic conditions, intermittent needs, invisible disabilities, and overlapping leave and accommodation requirements create more opportunities for inconsistency and administrative error.
4. **The process is increasingly conducted on the record:** Employees screenshot emails, record digital experiences, and share workplace interactions online in real time. Rather than treating that as a threat, employers can treat it as a useful design standard: a process built to withstand that level of scrutiny is simply a stronger process.


‍


## **Technology should close the experience gap**
...
## **What Gen Z wants is also what makes a program more defensible**
...
- **Consistency** reduces the likelihood that two similarly situated employees have materially different experiences depending on which manager or analyst handles their request.
- **Transparency** reduces uncertainty and gives employees confidence that their request is actually moving through a process.
- **Documentation** creates accountability and provides a reliable record if a decision is later questioned.
...
## **Five moves employers can make now**
...
1. **Become the trusted source of information:** Publish clear, plain-language information about workplace accommodations, your request process, documentation expectations, and what happens after an employee submits a request.
2. **Standardize the interactive process:** Reduce analyst-by-analyst and manager-by-manager variation. Consistent intake, routing, documentation standards, and core workflows strengthen both the employee experience and the organization’s compliance posture.
3. **Train managers to separate behavior from merits:** An assertive tone, polished language, legal vocabulary, or familiarity with the accommodation process does not determine whether a request is legitimate.
4. **Modernize intake and status transparency:** Make it easy for employees to initiate a request and understand what happens next. Visibility can reduce unnecessary administrative follow-up while creating a more responsive experience.
5. **Establish clear governance for AI:** Use AI and automation where they improve administrative efficiency, but maintain human review and judgment at decision points. Organizations should also establish clear practices for how AI-generated information is documented, retained, and protected.
...
That is, in many ways, what[Disclo](https://www.disclo.com/demo) has been building for from the beginning: a workplace accommodation experience designed for a workforce that expects clarity, accessibility, consistency, and transparency — without sacrificing the structure and defensibility employers need.
