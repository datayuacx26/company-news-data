...
document_id: "faf6ee69516d7d46646c668e36b21aca69d36a00f01ae7803c46aec1a9fdcd4a"
company_key: "yc-norra"
company: "Norra"
source_id: "yc-norra-news-import-9994af1578fd"
canonical_url: "https://www.norra.io/blog/how-to-prepare-for-state-survey-skilled-nursing"
published_at: "2026-07-27T00:00:00+00:00"
first_seen_at: "2026-07-27T22:18:31.081892+00:00"
fetched_at: "2026-07-28T21:33:52.463534+00:00"
content_hash: "sha256:40378a2da9602d952a9298fe4e4d8154c2dd65eef7a82a7b93997f766a70d0ca"
---

# How to Prepare for a State Survey at a Skilled Nursing Facility
...
You cannot prepare for something you picture wrong, so start with the mechanics. State surveys of skilled nursing facilities are conducted by state survey agencies on behalf of CMS under the federal survey and certification rules in[42 CFR Part 488](https://www.ecfr.gov/current/title-42/chapter-IV/subchapter-G/part-488) . Two facts shape everything about how you prepare.
...
Surveyors spend several days on site. They observe care, interview residents, families, and staff, review records, and inspect the physical environment and equipment. Findings that fall short of a requirement are cited as deficiencies, tagged with an "F-tag" that maps to a specific rule in[42 CFR Part 483](https://www.ecfr.gov/current/title-42/chapter-IV/subchapter-G/part-483) , the requirements for long-term care facilities. If you are new to the tag system, our[SNF survey readiness checklist](https://www.norra.io/blog/snf-survey-readiness-checklist) lays out the sequence step by step.
...
The point is that readiness is a state you maintain, not a project you start. The scramble version of this, where a building tries to compress a year of upkeep into a frantic week, is exactly the failure mode we describe in[the survey-week equipment scramble](https://www.norra.io/blog/survey-week-equipment-scramble-nursing-home) .
...
Essential equipment must be kept in safe operating condition. That is not a soft expectation, it is the substance of F908, **Essential Equipment, Safe Operating Condition** , at[42 CFR 483.90(d)(2)](https://www.ecfr.gov/current/title-42/chapter-IV/subchapter-G/part-483/subpart-B/section-483.90) , which requires facilities to "maintain all mechanical, electrical, and patient care equipment in safe operating condition." Preventive maintenance runs on the manufacturer's recommended schedule, repairs are tracked, and out-of-service items are tagged and pulled, not left in circulation. A visibly broken chair or an overdue lift is a finding waiting to happen. We go deeper on that tag in[F908, essential equipment maintained](https://www.norra.io/blog/f908-essential-equipment-maintained-snf) .


### Document


Locating and maintaining only count if you can prove them. When a surveyor asks for a specific lift's service history or the preventive maintenance record for your beds, the answer needs to be a document, not a promise to look. The buildings that fumble here are usually the ones keeping maintenance history in a binder that lives in one person's office, or worse, in that person's memory. Instant, itemized records are the difference between a clean line of questioning and a deficiency. Our guide to[equipment documentation for a nursing home survey](https://www.norra.io/blog/equipment-documentation-nursing-home-survey) covers exactly what to keep and how.
...
The one to know first is **F689, Free of Accident Hazards, Supervision, and Devices** , at[42 CFR 483.25(d)](https://www.ecfr.gov/current/title-42/chapter-IV/subchapter-G/part-483) , which is consistently among the most frequently cited tags on standard surveys. It covers keeping the environment as free of accident hazards as possible and giving residents the supervision and assistive devices they need to prevent avoidable accidents. The clinical judgment and supervision inside that tag are a whole-building responsibility. But a missing or broken assistive device, or a hazard nobody flagged because nobody could see the equipment, is a concrete and preventable contributor.


Equipment also brushes up against the tags for pressure-ulcer support surfaces, respiratory care equipment, and infection-control cleaning of shared devices. The regulatory substance of each lives in[42 CFR Part 483](https://www.ecfr.gov/current/title-42/chapter-IV/subchapter-G/part-483) , and the interpretive guidance surveyors use is in the CMS State Operations Manual Appendix PP, published at[cms.gov](https://www.cms.gov/) . In every one of them, the clinical care is yours to run. The narrow, honest role of good equipment practice is to remove the equipment-shaped reasons a citation gets written.
