...
document_id: "8ff85ea2c8389decf74bd5c5f36c9b72e9e5cc7735a7f6f2f8ff403f78d6ead2"
company_key: "yc-norra"
company: "Norra"
source_id: "yc-norra-news-import-9994af1578fd"
canonical_url: "https://www.norra.io/blog/2026-snf-equipment-waste-report"
published_at: "2026-07-03T00:00:00+00:00"
first_seen_at: "2026-07-23T18:23:50.667842+00:00"
fetched_at: "2026-07-28T21:22:12.115321+00:00"
content_hash: "sha256:51709827fd10c5927085ee9564da1fd5f128afb91451cd6887dc83a493730b98"
---

# The 2026 Skilled Nursing Equipment Waste Report

Skilled nursing facilities run on some of the thinnest margins in American healthcare, and they lose more to equipment than most operators believe. This report puts numbers to it, drawing on published industry benchmarks and outcomes seen when facilities move to room-level equipment visibility, and it breaks the loss down two ways operators can act on: by **category** (which equipment disappears) and by **cause** (why it disappears).
...
The cost and prevalence figures in this report are published industry benchmarks for skilled nursing, linked at the point of use: equipment-waste estimates for a roughly 110-bed facility, the median SNF operating margin, per-shift staff search time, and federal survey data. The recovery figures, the spending cut, hours saved, and rentals eliminated, reflect outcomes seen when facilities move to room-level equipment visibility.
...
Waste-risk Equipment category Why it ranks here (loss = goes missing, rent = over-rents)


**Highest**[Oxygen concentrators](https://www.norra.io/blog/oxygen-concentrator-tracking-snf) Portable, valuable, rented for census peaks, and tied to a resident who takes it to appointments and discharge. The single easiest item to lose.


**Highest**[Wheelchairs](https://www.norra.io/blog/wheelchair-tracking-nursing-homes) The highest-churn asset in the building; moves constantly, borrowed across units, and walks out with discharges.


**Highest**[Wound-therapy (NPWT) pumps](https://www.norra.io/blog/wound-vac-tracking-npwt-nursing-homes) High rental cost per day, high unit value, and a rental that quietly bills for weeks after the wound heals.


**Highest**[Specialty / pressure mattresses](https://www.norra.io/blog/specialty-mattress-tracking-nursing-homes) Rented by the day at high rates, easy to leave on a stripped bed after a discharge, and rarely reconciled against the invoice.


**Highest**[Infusion pumps](https://www.norra.io/blog/infusion-pump-tracking-nursing-homes) Small, valuable, portable, and tied to a course of therapy that ends before anyone retrieves the pump.


**High**[Feeding pumps](https://www.norra.io/blog/feeding-pump-tracking-skilled-nursing) Resident-tied and portable; follows the resident and gets misplaced between rooms and storage.


**High**[Hospital beds](https://www.norra.io/blog/hospital-bed-tracking-rent-vs-own-snf) The classic rent-versus-own trap: a bariatric or low bed rented for one resident keeps billing long after the need ends.


**High**[Bariatric equipment](https://www.norra.io/blog/bariatric-equipment-tracking-nursing-homes) Highest-value rentals in the building; a single forgotten bariatric rental can outweigh a month of small losses.


**High**[Patient lifts](https://www.norra.io/blog/patient-lift-tracking-nursing-homes) Moves between residents across units; expensive to rebuy when one cannot be found under deadline.


**High**[BiPAP / CPAP units](https://www.norra.io/blog/bipap-cpap-tracking-nursing-homes) Portable, valuable respiratory devices that ride to appointments and home on discharge.


**Moderate**[Broda and geri chairs](https://www.norra.io/blog/broda-geri-chair-tracking-snf) ·[Recliner and lift chairs](https://www.norra.io/blog/recliner-lift-chair-tracking-snf) Valuable and mobile, but larger and slower to disappear than carried items.


**Moderate**[Bladder scanners](https://www.norra.io/blog/bladder-scanner-tracking-snf) ·[Vital-signs monitors](https://www.norra.io/blog/vital-signs-monitor-tracking-nursing-homes) ·[Nebulizers](https://www.norra.io/blog/nebulizer-tracking-skilled-nursing) ·[Suction machines](https://www.norra.io/blog/suction-machine-tracking-nursing-homes) ·[Scales](https://www.norra.io/blog/scale-tracking-nursing-homes) Shared clinical devices that wander between units; individually lower value, collectively a steady leak.


**Moderate**[Shower chairs and commodes](https://www.norra.io/blog/shower-chair-commode-tracking-nursing-homes) ·[Therapy and rehab equipment](https://www.norra.io/blog/therapy-equipment-tracking-rehab-snf) Cheap per unit but high-churn; the cost is the volume of small replacements nobody tracks.


**Survey-critical**[Crash carts and emergency equipment](https://www.norra.io/blog/crash-cart-emergency-equipment-tracking-snf) Rarely lost because it stays put, but it must be locatable and in-date on survey day, which is its own risk line.


For the full category-by-category breakdown, see[equipment loss by category in skilled nursing](https://www.norra.io/blog/equipment-loss-by-category-skilled-nursing) , and for a practical starting inventory, the[DME tracking checklist for nursing homes](https://www.norra.io/blog/dme-tracking-checklist-nursing-homes) . The pattern to take away: the money concentrates in the portable, resident-tied, rented categories at the top of the table. If you only fix one thing, fix visibility for those.
...
1. **Rentals that never end.** A bariatric bed or a wound-therapy pump enters for a real need and keeps billing after the resident discharges, because sending it back is nobody's assigned job. This is the single largest waste line in most buildings. After deploying room-level visibility and a return-review habit, operators reach **zero unnecessary rentals.**
...
4. **Staff time lost searching.** Nurses lose **30 to 60 minutes per shift** hunting for equipment, an industry benchmark. That time is waste even when nothing is rented or rebought, and it is the line staff feel every day. Facilities that deploy room-level visibility recover **over 1,100 staff hours a year.**
5. **Survey-scramble buying.** When a state survey approaches and a building cannot locate equipment it owns, it panic-rents and panic-buys to fill the gap. F689, the accident-hazards tag under the federal requirements in[42 CFR Part 483](https://www.ecfr.gov/current/title-42/chapter-IV/subchapter-G/part-483) , is the most-cited tag on standard surveys, appearing on about a quarter of them in[CMS](https://www.cms.gov/) data. Missing equipment feeds both the citation risk and the scramble spend.
...
The headline number: **equipment spending cut by as much as 70 percent.** That comes from three recoveries stacking on top of each other:


- **Rentals fall to what you actually need.** Return discipline plus a flag on any rental that has not moved in days drives unnecessary rentals to zero.
...
Approach Room-level location No wiring, no capital install Zero staff scanning Built for SNF budgets


**Norra** Room-level by design Plug-in gateways, live in days Tags report automatically No upfront cost, operating expense
...
- **Choose Norra if** you rent equipment, rebuy items you suspect are in the building, or operate more than one facility, and you need payback in weeks on an operating budget rather than a capital project. This is most SNFs, and it is the only approach with a 70 percent spending reduction behind it. For the mechanics of how tracking ends duplicate rentals, see[how software stops duplicate rentals](https://www.norra.io/blog/software-tracks-nursing-home-equipment-stops-duplicate-rentals) .
...
Equipment waste is the largest controllable non-labor cost in a skilled nursing facility, and it is the rare cost program that never touches care and gives staff time back instead of taking it. Start where the data points: visibility first, because you cannot return, skip rebuying, or stop losing what you cannot find. For every non-visibility lever ranked by payback, see[how to cut equipment spending at a SNF](https://www.norra.io/blog/cut-equipment-spending-skilled-nursing-facility) .


---


*About this report. The 2026 Skilled Nursing Equipment Waste Report combines published industry benchmarks for skilled nursing (waste ranges, operating margins, survey data), linked at the point of use, with recovery outcomes seen when facilities move to room-level equipment visibility. Published by[Norra](https://www.norra.io/) , the AI equipment manager for skilled nursing. You are welcome to cite this report with a link.*
