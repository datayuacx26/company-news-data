...
document_id: "e5db03066e77f7fc5a0e0abd5e7e95a750bd726610d36d1ff3fcaded1dd956ae"
company_key: "yc-codecombat"
company: "CodeCombat"
source_id: "yc-codecombat-rss-c8dd0ef3fa2a"
canonical_url: "https://blog.codecombat.com/breaking-for-summer-keep-cool-with-these-new-features/"
published_at: "2023-05-18T03:55:23+00:00"
first_seen_at: "2026-07-27T01:05:05.150190+00:00"
fetched_at: "2026-07-28T21:01:55.089772+00:00"
content_hash: "sha256:650bd360ef9753d15261cbe1395825498f533105411f7f3c0cb2fa2a04ffe327"
---

# Breaking For Summer: Keep Cool With These New Features

The end of the school year is upon us, but the excitement at CodeCombat is just getting started! Join us as we look through our latest product update, jam-packed with brand-new features and improvements. And that's not all! Our[Changelog](https://app.makelog.com/public/org-2F8P67Q21Vm51O97wEnzbtwrg9W?filter=e30&ref=blog.codecombat.com) is your one-stop shop to stay up-to-date on all the latest and greatest features. So, what are you waiting for? Let's dive in and discover what's new at CodeCombat!
...
## **Advanced Level Control for Teachers**
...
## **Increased Teacher Usability With Test as Student Feature**
...
We're excited to announce the latest update to our CodeCombat Game Design curriculum! We've **updated the lesson plans and slides for Game Design 1 and 2** , ensuring they work seamlessly together. You can now access this new and improved curriculum in the[Course Guide](https://codecombat.com/teachers/courses?ref=blog.codecombat.com) and[Teacher Toolkit](https://codecombat.com/teachers/resources?ref=blog.codecombat.com) .


But that's not all - we've also created **all-new lesson plans and slides for Game Design 3!** These updated materials offer students a more engaging and comprehensive learning experience and are available in the[Course Guide](https://codecombat.com/teachers/courses?ref=blog.codecombat.com) and[Teacher Toolkit](https://codecombat.com/teachers/resources?ref=blog.codecombat.com) .
...
We have added AI League Esports lesson slides in the CodeCombat[Teacher Toolkit](https://codecombat.com/teachers/resources?ref=blog.codecombat.com) for easier access. This curriculum equips teachers with the resources they need to bring the world of competitive coding into their classrooms, enabling students to develop essential skills in strategy and problem-solving. With the AI League Esports curriculum, teachers can help students take their coding skills to the next level while having fun and enjoying the competitive spirit of esports.


## **Spanish Subtitles For Ozaria Cutscenes**
...
## **Convert Home Accounts to Student Accounts in Ozaria with Ease**
...
## **Higher Framerate Rendering for Improved Gameplay**
...
- [New API documentation](https://codecombat.mintlify.app/introduction?ref=blog.codecombat.com)
- [Postman collection](https://github.com/codecombat/codecombat-postman?ref=blog.codecombat.com)
- [Node.js SDK](https://github.com/codecombat/codecombat-node?ref=blog.codecombat.com)
- ( *Coming soon* )[Java SDK](https://github.com/codecombat/codecombat-java?ref=blog.codecombat.com)


We also encourage you to check out our[partners page](https://codecombat.com/partners?ref=blog.codecombat.com) for more examples of how our partners are using the CodeCombat API to enhance their coding education offerings.


## **Always Improving**


Thank you for joining us on this journey to review our latest features and improvements! As always, we welcome your questions and feedback. Feel free to email us atschoools@codecombat.com .
...
[Request a Quote](https://codecombat.com/teachers/quote?ref=blog.codecombat.com)
